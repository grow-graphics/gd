...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("FBXState"))
...
func init() {classdb.Register("FBXState", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
