...
*/
func (self Instance) AddMeshPeer(peer_id int, host gdclass.ENetConnection) gd.Error {
...
*/
func (self Instance) GetPeer(id int) gdclass.ENetPacketPeer {
...
func (self Instance) Host() gdclass.ENetConnection {
