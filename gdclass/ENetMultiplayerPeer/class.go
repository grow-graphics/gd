...
func (self Go) CreateClient(address string, port int) gd.Error {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Error(class(self).CreateClient(gc.String(address), gd.Int(port), gd.Int(0), gd.Int(0), gd.Int(0), gd.Int(0)))
}
...
func (self Go) SetBindIp(ip string) {
	gc := gd.GarbageCollector(); _ = gc
	class(self).SetBindIp(gc.String(ip))
}
...
func (self Go) GetPeer(id int) gdclass.ENetPacketPeer {
	gc := gd.GarbageCollector(); _ = gc
	return gdclass.ENetPacketPeer(class(self).GetPeer(gc, gd.Int(id)))
}
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ENetMultiplayerPeer"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self Go) Host() gdclass.ENetConnection {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.ENetConnection(class(self).GetHost(gc))
}
...
//go:nosplit
func (self class) GetHost(ctx gd.Lifetime) gdclass.ENetConnection {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	...
	var ret gdclass.ENetConnection
...
*/
//go:nosplit
func (self class) GetPeer(ctx gd.Lifetime, id gd.Int) gdclass.ENetPacketPeer {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
func init() {classdb.Register("ENetMultiplayerPeer", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
