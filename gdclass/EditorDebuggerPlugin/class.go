...
Override this method to be notified when a breakpoint line has been clicked in the debugger breakpoint panel.
*/
func (Instance) _goto_script_line(impl func(ptr unsafe.Pointer, script gdclass.Script, line int)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
...
Override this method to be notified when a breakpoint is set in the editor.
*/
func (Instance) _breakpoint_set_in_tree(impl func(ptr unsafe.Pointer, script gdclass.Script, line int, enabled bool)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var script = gdclass.Script{pointers.New[classdb.Script]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(script[0])
		var line = gd.UnsafeGet[gd.Int](p_args, 1)
...
*/
func (self Instance) GetSession(id int) gdclass.EditorDebuggerSession {
	return gdclass.EditorDebuggerSession(class(self).GetSession(gd.Int(id)))
}
...
Override this method to be notified when a breakpoint line has been clicked in the debugger breakpoint panel.
*/
func (class) _goto_script_line(impl func(ptr unsafe.Pointer, script gdclass.Script, line gd.Int)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var script = gdclass.Script{pointers.New[classdb.Script]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(script[0])
		var line = gd.UnsafeGet[gd.Int](p_args, 1)
...
Override this method to be notified when a breakpoint is set in the editor.
*/
func (class) _breakpoint_set_in_tree(impl func(ptr unsafe.Pointer, script gdclass.Script, line gd.Int, enabled bool)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var script = gdclass.Script{pointers.New[classdb.Script]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(script[0])
		var line = gd.UnsafeGet[gd.Int](p_args, 1)
...
*/
//go:nosplit
func (self class) GetSession(id gd.Int) gdclass.EditorDebuggerSession {
	...
	var ret = gdclass.EditorDebuggerSession{classdb.EditorDebuggerSession(gd.PointerWithOwnershipTransferredToGo(r_ret.Get()))}
	frame.Free()
	return ret
}
