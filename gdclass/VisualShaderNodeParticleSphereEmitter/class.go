...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeParticleSphereEmitter(object)}
}
...
func init() {classdb.Register("VisualShaderNodeParticleSphereEmitter", func(ptr gd.Object) any { return classdb.VisualShaderNodeParticleSphereEmitter(ptr) })}
