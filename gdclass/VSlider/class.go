...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VSlider"))
...
func init() {classdb.Register("VSlider", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
