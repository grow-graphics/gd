...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeIf"))
...
func init() {classdb.Register("VisualShaderNodeIf", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
