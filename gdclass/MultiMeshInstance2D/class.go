...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("MultiMeshInstance2D"))
...
func init() {classdb.Register("MultiMeshInstance2D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
