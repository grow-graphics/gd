...
Override this method to modify properties in [param char_fx]. The method must return [code]true[/code] if the character could be transformed successfully. If the method returns [code]false[/code], it will skip transformation to avoid displaying broken text.
*/
func (Instance) _process_custom_fx(impl func(ptr unsafe.Pointer, char_fx gdclass.CharFXTransform) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var char_fx = gdclass.CharFXTransform{pointers.New[classdb.CharFXTransform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
...
Override this method to modify properties in [param char_fx]. The method must return [code]true[/code] if the character could be transformed successfully. If the method returns [code]false[/code], it will skip transformation to avoid displaying broken text.
*/
func (class) _process_custom_fx(impl func(ptr unsafe.Pointer, char_fx gdclass.CharFXTransform) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var char_fx = gdclass.CharFXTransform{pointers.New[classdb.CharFXTransform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(char_fx[0])
		self := reflect.ValueOf(class).UnsafePointer()
