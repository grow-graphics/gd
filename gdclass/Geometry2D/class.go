...
func singleton() {
	gc := gd.Static
	obj := gc.API.Object.GetSingleton(gc, gc.API.Singletons.Geometry2D)
...
func SegmentIntersectsSegment(from_a gd.Vector2, to_a gd.Vector2, from_b gd.Vector2, to_b gd.Vector2) gd.Variant {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.Variant(class(self).SegmentIntersectsSegment(gc, from_a, to_a, from_b, to_b))
}
...
func LineIntersectsLine(from_a gd.Vector2, dir_a gd.Vector2, from_b gd.Vector2, dir_b gd.Vector2) gd.Variant {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.Variant(class(self).LineIntersectsLine(gc, from_a, dir_a, from_b, dir_b))
}
...
func GetClosestPointsBetweenSegments(p1 gd.Vector2, q1 gd.Vector2, p2 gd.Vector2, q2 gd.Vector2) []gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return []gd.Vector2(class(self).GetClosestPointsBetweenSegments(gc, p1, q1, p2, q2).AsSlice())
}
...
func IsPolygonClockwise(polygon []gd.Vector2) bool {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return bool(class(self).IsPolygonClockwise(gc.PackedVector2Slice(polygon)))
}
...
func IsPointInPolygon(point gd.Vector2, polygon []gd.Vector2) bool {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return bool(class(self).IsPointInPolygon(point, gc.PackedVector2Slice(polygon)))
}
...
func TriangulatePolygon(polygon []gd.Vector2) []int32 {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return []int32(class(self).TriangulatePolygon(gc, gc.PackedVector2Slice(polygon)).AsSlice())
}
...
func TriangulateDelaunay(points []gd.Vector2) []int32 {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return []int32(class(self).TriangulateDelaunay(gc, gc.PackedVector2Slice(points)).AsSlice())
}
...
func ConvexHull(points []gd.Vector2) []gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return []gd.Vector2(class(self).ConvexHull(gc, gc.PackedVector2Slice(points)).AsSlice())
}

/*
Decomposes the [param polygon] into multiple convex hulls and returns an array of [PackedVector2Array].
*/
func DecomposePolygonInConvex(polygon []gd.Vector2) gd.ArrayOf[gd.PackedVector2Array] {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.ArrayOf[gd.PackedVector2Array](class(self).DecomposePolygonInConvex(gc, gc.PackedVector2Slice(polygon)))
}
...
*/
func MergePolygons(polygon_a []gd.Vector2, polygon_b []gd.Vector2) gd.ArrayOf[gd.PackedVector2Array] {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.ArrayOf[gd.PackedVector2Array](class(self).MergePolygons(gc, gc.PackedVector2Slice(polygon_a), gc.PackedVector2Slice(polygon_b)))
}
...
*/
func ClipPolygons(polygon_a []gd.Vector2, polygon_b []gd.Vector2) gd.ArrayOf[gd.PackedVector2Array] {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.ArrayOf[gd.PackedVector2Array](class(self).ClipPolygons(gc, gc.PackedVector2Slice(polygon_a), gc.PackedVector2Slice(polygon_b)))
}
...
*/
func IntersectPolygons(polygon_a []gd.Vector2, polygon_b []gd.Vector2) gd.ArrayOf[gd.PackedVector2Array] {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.ArrayOf[gd.PackedVector2Array](class(self).IntersectPolygons(gc, gc.PackedVector2Slice(polygon_a), gc.PackedVector2Slice(polygon_b)))
}
...
The operation may result in an outer polygon (boundary) and inner polygon (hole) produced which could be distinguished by calling [method is_polygon_clockwise].
*/
func ExcludePolygons(polygon_a []gd.Vector2, polygon_b []gd.Vector2) gd.ArrayOf[gd.PackedVector2Array] {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.ArrayOf[gd.PackedVector2Array](class(self).ExcludePolygons(gc, gc.PackedVector2Slice(polygon_a), gc.PackedVector2Slice(polygon_b)))
}
...
*/
func ClipPolylineWithPolygon(polyline []gd.Vector2, polygon []gd.Vector2) gd.ArrayOf[gd.PackedVector2Array] {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.ArrayOf[gd.PackedVector2Array](class(self).ClipPolylineWithPolygon(gc, gc.PackedVector2Slice(polyline), gc.PackedVector2Slice(polygon)))
}
...
*/
func IntersectPolylineWithPolygon(polyline []gd.Vector2, polygon []gd.Vector2) gd.ArrayOf[gd.PackedVector2Array] {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.ArrayOf[gd.PackedVector2Array](class(self).IntersectPolylineWithPolygon(gc, gc.PackedVector2Slice(polyline), gc.PackedVector2Slice(polygon)))
}
...
[/codeblocks]
*/
func OffsetPolygon(polygon []gd.Vector2, delta float64) gd.ArrayOf[gd.PackedVector2Array] {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.ArrayOf[gd.PackedVector2Array](class(self).OffsetPolygon(gc, gc.PackedVector2Slice(polygon), gd.Float(delta), 0))
}
...
The operation may result in an outer polygon (boundary) and inner polygon (hole) produced which could be distinguished by calling [method is_polygon_clockwise].
*/
func OffsetPolyline(polyline []gd.Vector2, delta float64) gd.ArrayOf[gd.PackedVector2Array] {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.ArrayOf[gd.PackedVector2Array](class(self).OffsetPolyline(gc, gc.PackedVector2Slice(polyline), gd.Float(delta), 0, 3))
}
...
func MakeAtlas(sizes []gd.Vector2) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.Dictionary(class(self).MakeAtlas(gc, gc.PackedVector2Slice(sizes)))
}
...
func init() {classdb.Register("Geometry2D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
