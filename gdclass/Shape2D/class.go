...
*/
func (self Instance) Collide(local_xform gd.Transform2D, with_shape gdclass.Shape2D, shape_xform gd.Transform2D) bool {
...
*/
func (self Instance) CollideWithMotion(local_xform gd.Transform2D, local_motion gd.Vector2, with_shape gdclass.Shape2D, shape_xform gd.Transform2D, shape_motion gd.Vector2) bool {
...
This method needs the transformation matrix for this shape ([param local_xform]), the shape to check collisions with ([param with_shape]), and the transformation matrix of that shape ([param shape_xform]).
*/
func (self Instance) CollideAndGetContacts(local_xform gd.Transform2D, with_shape gdclass.Shape2D, shape_xform gd.Transform2D) []gd.Vector2 {
...
This method needs the transformation matrix for this shape ([param local_xform]), the movement to test on this shape ([param local_motion]), the shape to check collisions with ([param with_shape]), the transformation matrix of that shape ([param shape_xform]), and the movement to test onto the other object ([param shape_motion]).
*/
func (self Instance) CollideWithMotionAndGetContacts(local_xform gd.Transform2D, local_motion gd.Vector2, with_shape gdclass.Shape2D, shape_xform gd.Transform2D, shape_motion gd.Vector2) []gd.Vector2 {
...
*/
//go:nosplit
func (self class) CollideAndGetContacts(local_xform gd.Transform2D, with_shape gdclass.Shape2D, shape_xform gd.Transform2D) gd.PackedVector2Array {
	var frame = callframe.New()
	callframe.Arg(frame, local_xform)
	callframe.Arg(frame, pointers.Get(with_shape[0])[0])
	callframe.Arg(frame, shape_xform)
...
*/
//go:nosplit
func (self class) CollideWithMotionAndGetContacts(local_xform gd.Transform2D, local_motion gd.Vector2, with_shape gdclass.Shape2D, shape_xform gd.Transform2D, shape_motion gd.Vector2) gd.PackedVector2Array {
	var frame = callframe.New()
	callframe.Arg(frame, local_xform)
	callframe.Arg(frame, local_motion)
	callframe.Arg(frame, pointers.Get(with_shape[0])[0])
