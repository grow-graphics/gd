...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ResourceImporterMP3"))
...
func init() {classdb.Register("ResourceImporterMP3", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
