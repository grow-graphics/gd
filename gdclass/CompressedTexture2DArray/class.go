...
*/
type Go [1]classdb.CompressedTexture2DArray
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("CompressedTexture2DArray"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsCompressedTexture2DArray() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsCompressedTexture2DArray() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("CompressedTexture2DArray", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
