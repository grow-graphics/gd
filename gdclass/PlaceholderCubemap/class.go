...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("PlaceholderCubemap"))
...
func init() {classdb.Register("PlaceholderCubemap", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
