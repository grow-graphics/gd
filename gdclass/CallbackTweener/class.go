...
[/codeblock]
*/
func (self Instance) SetDelay(delay float64) gdclass.CallbackTweener {
...
func init() {
	classdb.Register("CallbackTweener", func(ptr gd.Object) any { return classdb.CallbackTweener(ptr) })
}
