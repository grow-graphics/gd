...
func New() Go {
	...
	return Go{classdb.AudioEffectSpectrumAnalyzer(object)}
}
...
func init() {classdb.Register("AudioEffectSpectrumAnalyzer", func(ptr gd.Object) any { return classdb.AudioEffectSpectrumAnalyzer(ptr) })}
