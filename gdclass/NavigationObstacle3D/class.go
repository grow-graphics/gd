...
func New() Go {
	...
	return Go{classdb.NavigationObstacle3D(object)}
}
...
func init() {classdb.Register("NavigationObstacle3D", func(ptr gd.Object) any { return classdb.NavigationObstacle3D(ptr) })}
