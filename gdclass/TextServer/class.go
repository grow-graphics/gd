...
*/
func (self Instance) FontSetTextureImage(font_rid gd.RID, size gd.Vector2i, texture_index int, image gdclass.Image) {
...
*/
func (self Instance) FontGetTextureImage(font_rid gd.RID, size gd.Vector2i, texture_index int) gdclass.Image {
	return gdclass.Image(class(self).FontGetTextureImage(font_rid, size, gd.Int(texture_index)))
}
...
*/
//go:nosplit
func (self class) FontGetTextureImage(font_rid gd.RID, size gd.Vector2i, texture_index gd.Int) gdclass.Image {
	var frame = callframe.New()
	callframe.Arg(frame, font_rid)
	callframe.Arg(frame, size)
	callframe.Arg(frame, texture_index)
