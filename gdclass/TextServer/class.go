...
*/
func (self Go) FontGetSizeCacheList(font_rid gd.RID) gd.Array {
...
*/
func (self Go) FontGetKerningList(font_rid gd.RID, size int) gd.Array {
...
*/
func (self Go) ShapedTextAddString(shaped gd.RID, text string, fonts gd.Array, size int) bool {
...
*/
func (self Go) ShapedSetSpanUpdateFont(shaped gd.RID, index int, fonts gd.Array, size int) {
...
*/
func (self Go) ShapedTextGetGlyphs(shaped gd.RID) gd.Array {
...
*/
func (self Go) ShapedTextSortLogical(shaped gd.RID) gd.Array {
...
*/
func (self Go) ShapedTextGetEllipsisGlyphs(shaped gd.RID) gd.Array {
...
*/
func (self Go) ParseStructuredText(parser_type classdb.TextServerStructuredTextParser, args gd.Array, text string) gd.Array {
...
func New() Go {
	...
	return Go{classdb.TextServer(object)}
}
...
func (self class) ShapedTextSetCustomPunctuation(shaped gd.RID, punct gd.String)  {
	var frame = callframe.New()
	callframe.Arg(frame, shaped)
	callframe.Arg(frame, discreet.Get(punct))
	var r_ret callframe.Nil
...
func (self class) ShapedTextAddString(shaped gd.RID, text gd.String, fonts gd.Array, size gd.Int, opentype_features gd.Dictionary, language gd.String, meta gd.Variant) bool {
	...
	callframe.Arg(frame, discreet.Get(fonts))
	callframe.Arg(frame, size)
	callframe.Arg(frame, discreet.Get(opentype_features))
	callframe.Arg(frame, discreet.Get(language))
...
func (self class) ShapedTextGetLineBreaksAdv(shaped gd.RID, width gd.PackedFloat32Array, start gd.Int, once bool, break_flags classdb.TextServerLineBreakFlag) gd.PackedInt32Array {
	var frame = callframe.New()
	callframe.Arg(frame, shaped)
	callframe.Arg(frame, discreet.Get(width))
	callframe.Arg(frame, start)
...
func (self class) FormatNumber(number gd.String, language gd.String) gd.String {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(number))
	callframe.Arg(frame, discreet.Get(language))
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func (self class) IsConfusable(s gd.String, dict gd.PackedStringArray) gd.Int {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(s))
	callframe.Arg(frame, discreet.Get(dict))
	var r_ret = callframe.Ret[gd.Int](frame)
...
func init() {classdb.Register("TextServer", func(ptr gd.Object) any { return classdb.TextServer(ptr) })}
