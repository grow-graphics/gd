...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ResourceImporterBMFont"))
...
func init() {classdb.Register("ResourceImporterBMFont", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
