...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("EditorSceneFormatImporterBlend"))
...
func init() {classdb.Register("EditorSceneFormatImporterBlend", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
