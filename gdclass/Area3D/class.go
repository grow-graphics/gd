...
*/
type Instance [1]classdb.Area3D
...
func (self Instance) GravitySpaceOverride() classdb.Area3DSpaceOverride {
	return classdb.Area3DSpaceOverride(class(self).GetGravitySpaceOverrideMode())
}

func (self Instance) SetGravitySpaceOverride(value classdb.Area3DSpaceOverride) {
...
func (self Instance) LinearDampSpaceOverride() classdb.Area3DSpaceOverride {
	return classdb.Area3DSpaceOverride(class(self).GetLinearDampSpaceOverrideMode())
}

func (self Instance) SetLinearDampSpaceOverride(value classdb.Area3DSpaceOverride) {
...
func (self Instance) AngularDampSpaceOverride() classdb.Area3DSpaceOverride {
	return classdb.Area3DSpaceOverride(class(self).GetAngularDampSpaceOverrideMode())
}

func (self Instance) SetAngularDampSpaceOverride(value classdb.Area3DSpaceOverride) {
...
func (self Instance) OnBodyShapeEntered(cb func(body_rid gd.RID, body gdclass.Node3D, body_shape_index int, local_shape_index int)) {
	self[0].AsObject().Connect(gd.NewStringName("body_shape_entered"), gd.NewCallable(cb), 0)
}

func (self Instance) OnBodyShapeExited(cb func(body_rid gd.RID, body gdclass.Node3D, body_shape_index int, local_shape_index int)) {
	self[0].AsObject().Connect(gd.NewStringName("body_shape_exited"), gd.NewCallable(cb), 0)
}

func (self Instance) OnBodyEntered(cb func(body gdclass.Node3D)) {
	self[0].AsObject().Connect(gd.NewStringName("body_entered"), gd.NewCallable(cb), 0)
}

func (self Instance) OnBodyExited(cb func(body gdclass.Node3D)) {
	self[0].AsObject().Connect(gd.NewStringName("body_exited"), gd.NewCallable(cb), 0)
}

func (self Instance) OnAreaShapeEntered(cb func(area_rid gd.RID, area gdclass.Area3D, area_shape_index int, local_shape_index int)) {
	self[0].AsObject().Connect(gd.NewStringName("area_shape_entered"), gd.NewCallable(cb), 0)
}

func (self Instance) OnAreaShapeExited(cb func(area_rid gd.RID, area gdclass.Area3D, area_shape_index int, local_shape_index int)) {
	self[0].AsObject().Connect(gd.NewStringName("area_shape_exited"), gd.NewCallable(cb), 0)
}

func (self Instance) OnAreaEntered(cb func(area gdclass.Area3D)) {
	self[0].AsObject().Connect(gd.NewStringName("area_entered"), gd.NewCallable(cb), 0)
}

func (self Instance) OnAreaExited(cb func(area gdclass.Area3D)) {
