...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeParticleRandomness(object)}
}
...
func init() {classdb.Register("VisualShaderNodeParticleRandomness", func(ptr gd.Object) any { return classdb.VisualShaderNodeParticleRandomness(ptr) })}
