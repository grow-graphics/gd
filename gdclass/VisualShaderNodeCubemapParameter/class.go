...
*/
type Go [1]classdb.VisualShaderNodeCubemapParameter
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeCubemapParameter"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsVisualShaderNodeCubemapParameter() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsVisualShaderNodeCubemapParameter() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("VisualShaderNodeCubemapParameter", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
