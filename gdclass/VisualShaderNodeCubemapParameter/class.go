...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeCubemapParameter(object)}
}
...
func init() {classdb.Register("VisualShaderNodeCubemapParameter", func(ptr gd.Object) any { return classdb.VisualShaderNodeCubemapParameter(ptr) })}
