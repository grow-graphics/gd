...
func New() Go {
	...
	return Go{classdb.Separator(object)}
}

func (self class) AsSeparator() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsSeparator() Go { return *((*Go)(unsafe.Pointer(&self))) }
