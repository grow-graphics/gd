...
func New() Go {
	...
	return Go{classdb.XRControllerTracker(object)}
}
...
func init() {classdb.Register("XRControllerTracker", func(ptr gd.Object) any { return classdb.XRControllerTracker(ptr) })}
