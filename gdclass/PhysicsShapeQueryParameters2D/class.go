...
func New() Go {
	...
	return Go{classdb.PhysicsShapeQueryParameters2D(object)}
}
...
func init() {classdb.Register("PhysicsShapeQueryParameters2D", func(ptr gd.Object) any { return classdb.PhysicsShapeQueryParameters2D(ptr) })}
