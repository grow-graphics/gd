...
*/
func (self Instance) GetCurrentTabControl() gdclass.Control {
...
*/
func (self Instance) GetTabBar() gdclass.TabBar {
...
*/
func (self Instance) GetTabControl(tab_idx int) gdclass.Control {
...
*/
func (self Instance) SetTabIcon(tab_idx int, icon gdclass.Texture2D) {
...
*/
func (self Instance) GetTabIcon(tab_idx int) gdclass.Texture2D {
...
*/
func (self Instance) SetTabButtonIcon(tab_idx int, icon gdclass.Texture2D) {
...
*/
func (self Instance) GetTabButtonIcon(tab_idx int) gdclass.Texture2D {
...
*/
func (self Instance) GetTabIdxFromControl(control gdclass.Control) int {
...
*/
func (self Instance) SetPopup(popup gdclass.Node) {
...
*/
func (self Instance) GetPopup() gdclass.Popup {
