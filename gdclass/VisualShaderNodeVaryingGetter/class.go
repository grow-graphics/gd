...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeVaryingGetter"))
...
func init() {classdb.Register("VisualShaderNodeVaryingGetter", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
