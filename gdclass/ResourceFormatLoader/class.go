...
*/
type Go [1]classdb.ResourceFormatLoader
...
func (self class) AsResourceFormatLoader() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsResourceFormatLoader() Go { return *((*Go)(unsafe.Pointer(&self))) }
