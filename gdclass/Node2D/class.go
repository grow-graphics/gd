...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("Node2D"))
...
func init() {classdb.Register("Node2D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
