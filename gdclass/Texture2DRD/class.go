...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("Texture2DRD"))
...
func init() {classdb.Register("Texture2DRD", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
