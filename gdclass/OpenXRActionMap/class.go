...
*/
func (self Instance) FindActionSet(name string) gdclass.OpenXRActionSet {
...
*/
func (self Instance) GetActionSet(idx int) gdclass.OpenXRActionSet {
...
Add an action set.
*/
func (self Instance) AddActionSet(action_set gdclass.OpenXRActionSet) {
...
*/
func (self Instance) RemoveActionSet(action_set gdclass.OpenXRActionSet) {
...
*/
func (self Instance) FindInteractionProfile(name string) gdclass.OpenXRInteractionProfile {
...
*/
func (self Instance) GetInteractionProfile(idx int) gdclass.OpenXRInteractionProfile {
...
*/
func (self Instance) AddInteractionProfile(interaction_profile gdclass.OpenXRInteractionProfile) {
...
*/
func (self Instance) RemoveInteractionProfile(interaction_profile gdclass.OpenXRInteractionProfile) {
