...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VScrollBar"))
...
func init() {classdb.Register("VScrollBar", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
