...
*/
type Go [1]classdb.PlaceholderTextureLayered
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("PlaceholderTextureLayered"))
...
func (self class) AsPlaceholderTextureLayered() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsPlaceholderTextureLayered() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("PlaceholderTextureLayered", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
