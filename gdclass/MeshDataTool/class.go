...
*/
func (self Instance) CreateFromSurface(mesh gdclass.ArrayMesh, surface int) gd.Error {
...
*/
func (self Instance) CommitToSurface(mesh gdclass.ArrayMesh) gd.Error {
...
*/
func (self Instance) GetMaterial() gdclass.Material {
