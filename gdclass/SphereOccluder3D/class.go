...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("SphereOccluder3D"))
...
func init() {classdb.Register("SphereOccluder3D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
