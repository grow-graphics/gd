...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("SphereMesh"))
...
func init() {classdb.Register("SphereMesh", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
