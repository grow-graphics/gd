...
func New() Go {
	...
	return Go{classdb.ResourceImporterDynamicFont(object)}
}
...
func init() {classdb.Register("ResourceImporterDynamicFont", func(ptr gd.Object) any { return classdb.ResourceImporterDynamicFont(ptr) })}
