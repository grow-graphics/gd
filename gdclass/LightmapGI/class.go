...
*/
type Instance [1]classdb.LightmapGI
...
func (self Instance) SetQuality(value classdb.LightmapGIBakeQuality) {
...
func (self Instance) EnvironmentMode() classdb.LightmapGIEnvironmentMode {
	return classdb.LightmapGIEnvironmentMode(class(self).GetEnvironmentMode())
}

func (self Instance) SetEnvironmentMode(value classdb.LightmapGIEnvironmentMode) {
	class(self).SetEnvironmentMode(value)
}

func (self Instance) EnvironmentCustomSky() gdclass.Sky {
	return gdclass.Sky(class(self).GetEnvironmentCustomSky())
}

func (self Instance) SetEnvironmentCustomSky(value gdclass.Sky) {
...
func (self Instance) GenerateProbesSubdiv() classdb.LightmapGIGenerateProbes {
	return classdb.LightmapGIGenerateProbes(class(self).GetGenerateProbes())
}

func (self Instance) SetGenerateProbesSubdiv(value classdb.LightmapGIGenerateProbes) {
	class(self).SetGenerateProbes(value)
}

func (self Instance) LightData() gdclass.LightmapGIData {
	return gdclass.LightmapGIData(class(self).GetLightData())
}

func (self Instance) SetLightData(value gdclass.LightmapGIData) {
...
//go:nosplit
func (self class) GetLightData() gdclass.LightmapGIData {
	var frame = callframe.New()
	...
	var ret = gdclass.LightmapGIData{classdb.LightmapGIData(gd.PointerWithOwnershipTransferredToGo(r_ret.Get()))}
	frame.Free()
	return ret
}
...
//go:nosplit
func (self class) GetEnvironmentCustomSky() gdclass.Sky {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
	...
	var ret = gdclass.Sky{classdb.Sky(gd.PointerWithOwnershipTransferredToGo(r_ret.Get()))}
	frame.Free()
	return ret
}
