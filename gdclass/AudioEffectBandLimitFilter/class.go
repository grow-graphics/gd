...
*/
type Go [1]classdb.AudioEffectBandLimitFilter
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("AudioEffectBandLimitFilter"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsAudioEffectBandLimitFilter() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsAudioEffectBandLimitFilter() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("AudioEffectBandLimitFilter", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
