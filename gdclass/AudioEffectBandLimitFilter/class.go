...
func New() Go {
	...
	return Go{classdb.AudioEffectBandLimitFilter(object)}
}
...
func init() {classdb.Register("AudioEffectBandLimitFilter", func(ptr gd.Object) any { return classdb.AudioEffectBandLimitFilter(ptr) })}
