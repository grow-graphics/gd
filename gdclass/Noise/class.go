...
*/
//go:nosplit
func (self class) GetImage(width gd.Int, height gd.Int, invert bool, in_3d_space bool, normalize bool) gdclass.Image {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetSeamlessImage(width gd.Int, height gd.Int, invert bool, in_3d_space bool, skirt gd.Float, normalize bool) gdclass.Image {
	var frame = callframe.New()
	callframe.Arg(frame, width)
	callframe.Arg(frame, height)
	callframe.Arg(frame, invert)
