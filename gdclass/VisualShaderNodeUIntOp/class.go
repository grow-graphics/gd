...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeUIntOp"))
...
func init() {classdb.Register("VisualShaderNodeUIntOp", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
