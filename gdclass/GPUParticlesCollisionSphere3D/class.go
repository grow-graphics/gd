...
func New() Go {
	...
	return Go{classdb.GPUParticlesCollisionSphere3D(object)}
}
...
func init() {classdb.Register("GPUParticlesCollisionSphere3D", func(ptr gd.Object) any { return classdb.GPUParticlesCollisionSphere3D(ptr) })}
