...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("HSeparator"))
...
func init() {classdb.Register("HSeparator", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
