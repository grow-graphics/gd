...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("EditorExportPlatformIOS"))
...
func init() {classdb.Register("EditorExportPlatformIOS", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
