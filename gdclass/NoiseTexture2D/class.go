...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("NoiseTexture2D"))
...
func init() {classdb.Register("NoiseTexture2D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
