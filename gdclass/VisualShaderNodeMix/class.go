...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeMix(object)}
}
...
func init() {classdb.Register("VisualShaderNodeMix", func(ptr gd.Object) any { return classdb.VisualShaderNodeMix(ptr) })}
