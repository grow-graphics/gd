...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("WebRTCDataChannelExtension"))
...
func init() {classdb.Register("WebRTCDataChannelExtension", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
