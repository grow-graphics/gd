...
*/
func (self Go) GetCollisionPoint(index int) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
...
*/
func (self Go) GetCollisionNormal(index int) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ShapeCast2D"))
...
func (self class) AsShapeCast2D() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsShapeCast2D() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("ShapeCast2D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
