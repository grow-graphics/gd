...
*/
func (self Instance) FromNode(shape_node gdclass.CollisionShape3D) gdclass.GLTFPhysicsShape {
...
*/
func (self Instance) ToNode() gdclass.CollisionShape3D {
...
*/
func (self Instance) FromResource(shape_resource gdclass.Shape3D) gdclass.GLTFPhysicsShape {
...
*/
func (self Instance) ToResource() gdclass.Shape3D {
...
*/
func (self Instance) FromDictionary(dictionary gd.Dictionary) gdclass.GLTFPhysicsShape {
...
func (self Instance) ImporterMesh() gdclass.ImporterMesh {
	return gdclass.ImporterMesh(class(self).GetImporterMesh())
}

func (self Instance) SetImporterMesh(value gdclass.ImporterMesh) {
