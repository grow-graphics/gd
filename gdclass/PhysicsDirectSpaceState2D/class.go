...
*/
func (self Go) IntersectPoint(parameters gdclass.PhysicsPointQueryParameters2D) gd.Array {
...
The number of intersections can be limited with the [param max_results] parameter, to reduce the processing time.
*/
func (self Go) IntersectShape(parameters gdclass.PhysicsShapeQueryParameters2D) gd.Array {
...
*/
func (self Go) CollideShape(parameters gdclass.PhysicsShapeQueryParameters2D) gd.Array {
...
func New() Go {
	...
	return Go{classdb.PhysicsDirectSpaceState2D(object)}
}
...
func init() {classdb.Register("PhysicsDirectSpaceState2D", func(ptr gd.Object) any { return classdb.PhysicsDirectSpaceState2D(ptr) })}
