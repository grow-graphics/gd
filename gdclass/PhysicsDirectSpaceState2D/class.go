...
*/
func (self Instance) IntersectPoint(parameters gdclass.PhysicsPointQueryParameters2D) gd.Array {
...
*/
func (self Instance) IntersectRay(parameters gdclass.PhysicsRayQueryParameters2D) gd.Dictionary {
...
The number of intersections can be limited with the [param max_results] parameter, to reduce the processing time.
*/
func (self Instance) IntersectShape(parameters gdclass.PhysicsShapeQueryParameters2D) gd.Array {
...
*/
func (self Instance) CastMotion(parameters gdclass.PhysicsShapeQueryParameters2D) []float32 {
...
*/
func (self Instance) CollideShape(parameters gdclass.PhysicsShapeQueryParameters2D) gd.Array {
...
[code]shape[/code]: The shape index of the colliding shape.
*/
func (self Instance) GetRestInfo(parameters gdclass.PhysicsShapeQueryParameters2D) gd.Dictionary {
...
*/
//go:nosplit
func (self class) IntersectPoint(parameters gdclass.PhysicsPointQueryParameters2D, max_results gd.Int) gd.Array {
...
*/
//go:nosplit
func (self class) IntersectRay(parameters gdclass.PhysicsRayQueryParameters2D) gd.Dictionary {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(parameters[0])[0])
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) IntersectShape(parameters gdclass.PhysicsShapeQueryParameters2D, max_results gd.Int) gd.Array {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(parameters[0])[0])
	callframe.Arg(frame, max_results)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) CastMotion(parameters gdclass.PhysicsShapeQueryParameters2D) gd.PackedFloat32Array {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(parameters[0])[0])
...
*/
//go:nosplit
func (self class) CollideShape(parameters gdclass.PhysicsShapeQueryParameters2D, max_results gd.Int) gd.Array {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(parameters[0])[0])
	callframe.Arg(frame, max_results)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetRestInfo(parameters gdclass.PhysicsShapeQueryParameters2D) gd.Dictionary {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(parameters[0])[0])
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func init() {
	classdb.Register("PhysicsDirectSpaceState2D", func(ptr gd.Object) any { return classdb.PhysicsDirectSpaceState2D(ptr) })
}
