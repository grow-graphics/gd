...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeTexture2DParameter(object)}
}
...
func init() {classdb.Register("VisualShaderNodeTexture2DParameter", func(ptr gd.Object) any { return classdb.VisualShaderNodeTexture2DParameter(ptr) })}
