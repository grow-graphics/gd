...
*/
type Go [1]classdb.VisualShaderNodeTexture2DParameter
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeTexture2DParameter"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsVisualShaderNodeTexture2DParameter() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsVisualShaderNodeTexture2DParameter() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("VisualShaderNodeTexture2DParameter", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
