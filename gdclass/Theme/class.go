...
*/
func (self Instance) SetIcon(name string, theme_type string, texture gdclass.Texture2D) {
...
*/
func (self Instance) GetIcon(name string, theme_type string) gdclass.Texture2D {
	return gdclass.Texture2D(class(self).GetIcon(gd.NewStringName(name), gd.NewStringName(theme_type)))
}
...
*/
func (self Instance) SetStylebox(name string, theme_type string, texture gdclass.StyleBox) {
...
*/
func (self Instance) GetStylebox(name string, theme_type string) gdclass.StyleBox {
	return gdclass.StyleBox(class(self).GetStylebox(gd.NewStringName(name), gd.NewStringName(theme_type)))
}
...
*/
func (self Instance) SetFont(name string, theme_type string, font gdclass.Font) {
...
*/
func (self Instance) GetFont(name string, theme_type string) gdclass.Font {
	return gdclass.Font(class(self).GetFont(gd.NewStringName(name), gd.NewStringName(theme_type)))
}
...
*/
func (self Instance) MergeWith(other gdclass.Theme) {
...
func (self Instance) DefaultFont() gdclass.Font {
	return gdclass.Font(class(self).GetDefaultFont())
}

func (self Instance) SetDefaultFont(value gdclass.Font) {
...
*/
//go:nosplit
func (self class) GetIcon(name gd.StringName, theme_type gd.StringName) gdclass.Texture2D {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(name))
	callframe.Arg(frame, pointers.Get(theme_type))
...
*/
//go:nosplit
func (self class) GetStylebox(name gd.StringName, theme_type gd.StringName) gdclass.StyleBox {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(name))
	callframe.Arg(frame, pointers.Get(theme_type))
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetFont(name gd.StringName, theme_type gd.StringName) gdclass.Font {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(name))
	callframe.Arg(frame, pointers.Get(theme_type))
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
//go:nosplit
func (self class) GetDefaultFont() gdclass.Font {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
