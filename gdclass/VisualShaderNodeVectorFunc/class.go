...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeVectorFunc(object)}
}
...
func init() {classdb.Register("VisualShaderNodeVectorFunc", func(ptr gd.Object) any { return classdb.VisualShaderNodeVectorFunc(ptr) })}
