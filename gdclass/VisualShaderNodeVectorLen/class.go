...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeVectorLen"))
...
func init() {classdb.Register("VisualShaderNodeVectorLen", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
