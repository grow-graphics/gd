...
*/
func (self Instance) AddSource(source gdclass.TileSetSource) int {
...
*/
func (self Instance) GetSource(source_id int) gdclass.TileSetSource {
...
*/
func (self Instance) SetPhysicsLayerPhysicsMaterial(layer_index int, physics_material gdclass.PhysicsMaterial) {
...
*/
func (self Instance) GetPhysicsLayerPhysicsMaterial(layer_index int) gdclass.PhysicsMaterial {
...
*/
func (self Instance) AddPattern(pattern gdclass.TileMapPattern) int {
...
*/
func (self Instance) GetPattern() gdclass.TileMapPattern {
