...
[b]Note:[/b] If the properties of [param tile_data] object should change over time, use [method notify_runtime_tile_data_update] to notify the TileMap it needs an update.
*/
func (Instance) _tile_data_runtime_update(impl func(ptr unsafe.Pointer, layer int, coords gd.Vector2i, tile_data gdclass.TileData)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var layer = gd.UnsafeGet[gd.Int](p_args, 0)
		var coords = gd.UnsafeGet[gd.Vector2i](p_args, 1)
		var tile_data = gdclass.TileData{pointers.New[classdb.TileData]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 2)})}
...
*/
func (self Instance) GetCellTileData(layer int, coords gd.Vector2i) gdclass.TileData {
...
If [param layer] is negative, the layers are accessed from the last one.
*/
func (self Instance) GetPattern(layer int, coords_array gd.Array) gdclass.TileMapPattern {
...
If [param layer] is negative, the layers are accessed from the last one.
*/
func (self Instance) SetPattern(layer int, position gd.Vector2i, pattern gdclass.TileMapPattern) {
...
[b]Note:[/b] If the properties of [param tile_data] object should change over time, use [method notify_runtime_tile_data_update] to notify the TileMap it needs an update.
*/
func (class) _tile_data_runtime_update(impl func(ptr unsafe.Pointer, layer gd.Int, coords gd.Vector2i, tile_data gdclass.TileData)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var layer = gd.UnsafeGet[gd.Int](p_args, 0)
		var coords = gd.UnsafeGet[gd.Vector2i](p_args, 1)
		var tile_data = gdclass.TileData{pointers.New[classdb.TileData]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 2)})}
