...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("InputEventMouseMotion"))
...
func init() {classdb.Register("InputEventMouseMotion", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
