...
*/
type Go [1]classdb.VisualShaderNodeVec3Constant
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeVec3Constant"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self Go) Constant() gd.Vector3 {
	gc := gd.GarbageCollector(); _ = gc
		return gd.Vector3(class(self).GetConstant())
}

func (self Go) SetConstant(value gd.Vector3) {
	gc := gd.GarbageCollector(); _ = gc
...
func (self class) AsVisualShaderNodeVec3Constant() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsVisualShaderNodeVec3Constant() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("VisualShaderNodeVec3Constant", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
