...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeVec3Constant(object)}
}
...
func init() {classdb.Register("VisualShaderNodeVec3Constant", func(ptr gd.Object) any { return classdb.VisualShaderNodeVec3Constant(ptr) })}
