...
*/
type Go [1]classdb.EditorVCSInterface

/*
Initializes the VCS plugin when called from the editor. Returns whether or not the plugin was successfully initialized. A VCS project is initialized at [param project_path].
*/
func (Go) _initialize(impl func(ptr unsafe.Pointer, project_path string) bool, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var project_path = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(project_path)
...
Set user credentials in the underlying VCS. [param username] and [param password] are used only during HTTPS authentication unless not already mentioned in the remote URL. [param ssh_public_key_path], [param ssh_private_key_path], and [param ssh_passphrase] are only used during SSH authentication.
*/
func (Go) _set_credentials(impl func(ptr unsafe.Pointer, username string, password string, ssh_public_key_path string, ssh_private_key_path string, ssh_passphrase string) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var username = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(username)
		var password = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,1))
		defer discreet.End(password)
		var ssh_public_key_path = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,2))
		defer discreet.End(ssh_public_key_path)
		var ssh_private_key_path = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,3))
		defer discreet.End(ssh_private_key_path)
		var ssh_passphrase = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,4))
		defer discreet.End(ssh_passphrase)
		self := reflect.ValueOf(class).UnsafePointer()
...
Returns an [Array] of [Dictionary] items (see [method create_status_file]), each containing the status data of every modified file in the project folder.
*/
func (Go) _get_modified_files_data(impl func(ptr unsafe.Pointer) gd.Array, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self)
...
Stages the file present at [param file_path] to the staged area.
*/
func (Go) _stage_file(impl func(ptr unsafe.Pointer, file_path string) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var file_path = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(file_path)
		self := reflect.ValueOf(class).UnsafePointer()
...
Unstages the file present at [param file_path] from the staged area to the unstaged area.
*/
func (Go) _unstage_file(impl func(ptr unsafe.Pointer, file_path string) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var file_path = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(file_path)
		self := reflect.ValueOf(class).UnsafePointer()
...
Discards the changes made in a file present at [param file_path].
*/
func (Go) _discard_file(impl func(ptr unsafe.Pointer, file_path string) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var file_path = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(file_path)
		self := reflect.ValueOf(class).UnsafePointer()
...
Commits the currently staged changes and applies the commit [param msg] to the resulting commit.
*/
func (Go) _commit(impl func(ptr unsafe.Pointer, msg string) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var msg = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(msg)
		self := reflect.ValueOf(class).UnsafePointer()
...
Returns an array of [Dictionary] items (see [method create_diff_file], [method create_diff_hunk], [method create_diff_line], [method add_line_diffs_into_diff_hunk] and [method add_diff_hunks_into_diff_file]), each containing information about a diff. If [param identifier] is a file path, returns a file diff, and if it is a commit identifier, then returns a commit diff.
*/
func (Go) _get_diff(impl func(ptr unsafe.Pointer, identifier string, area int) gd.Array, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var identifier = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(identifier)
...
Shuts down VCS plugin instance. Called when the user either closes the editor or shuts down the VCS plugin through the editor UI.
*/
func (Go) _shut_down(impl func(ptr unsafe.Pointer) bool, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self)
		gd.UnsafeSet(p_back, ret)
...
Returns the name of the underlying VCS provider.
*/
func (Go) _get_vcs_name(impl func(ptr unsafe.Pointer) string, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self)
...
Returns an [Array] of [Dictionary] items (see [method create_commit]), each containing the data for a past commit.
*/
func (Go) _get_previous_commits(impl func(ptr unsafe.Pointer, max_commits int) gd.Array, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
...
Gets an instance of an [Array] of [String]s containing available branch names in the VCS.
*/
func (Go) _get_branch_list(impl func(ptr unsafe.Pointer) gd.Array, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self)
ptr, ok := discreet.End(ret)
...
Returns an [Array] of [String]s, each containing the name of a remote configured in the VCS.
*/
func (Go) _get_remotes(impl func(ptr unsafe.Pointer) gd.Array, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self)
ptr, ok := discreet.End(ret)
...
Creates a new branch named [param branch_name] in the VCS.
*/
func (Go) _create_branch(impl func(ptr unsafe.Pointer, branch_name string) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var branch_name = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(branch_name)
		self := reflect.ValueOf(class).UnsafePointer()
...
Remove a branch from the local VCS.
*/
func (Go) _remove_branch(impl func(ptr unsafe.Pointer, branch_name string) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var branch_name = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(branch_name)
		self := reflect.ValueOf(class).UnsafePointer()
...
Creates a new remote destination with name [param remote_name] and points it to [param remote_url]. This can be an HTTPS remote or an SSH remote.
*/
func (Go) _create_remote(impl func(ptr unsafe.Pointer, remote_name string, remote_url string) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var remote_name = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(remote_name)
		var remote_url = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,1))
		defer discreet.End(remote_url)
		self := reflect.ValueOf(class).UnsafePointer()
...
Remove a remote from the local VCS.
*/
func (Go) _remove_remote(impl func(ptr unsafe.Pointer, remote_name string) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var remote_name = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(remote_name)
		self := reflect.ValueOf(class).UnsafePointer()
...
Gets the current branch name defined in the VCS.
*/
func (Go) _get_current_branch_name(impl func(ptr unsafe.Pointer) string, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self)
ptr, ok := discreet.End(gd.NewString(ret))
...
Checks out a [param branch_name] in the VCS.
*/
func (Go) _checkout_branch(impl func(ptr unsafe.Pointer, branch_name string) bool, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var branch_name = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(branch_name)
		self := reflect.ValueOf(class).UnsafePointer()
...
Pulls changes from the remote. This can give rise to merge conflicts.
*/
func (Go) _pull(impl func(ptr unsafe.Pointer, remote string) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var remote = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(remote)
		self := reflect.ValueOf(class).UnsafePointer()
...
Pushes changes to the [param remote]. If [param force] is [code]true[/code], a force push will override the change history already present on the remote.
*/
func (Go) _push(impl func(ptr unsafe.Pointer, remote string, force bool) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var remote = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(remote)
...
Fetches new changes from the [param remote], but doesn't write changes to the current working directory. Equivalent to [code]git fetch[/code].
*/
func (Go) _fetch(impl func(ptr unsafe.Pointer, remote string) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var remote = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(remote)
		self := reflect.ValueOf(class).UnsafePointer()
...
Returns an [Array] of [Dictionary] items (see [method create_diff_hunk]), each containing a line diff between a file at [param file_path] and the [param text] which is passed in.
*/
func (Go) _get_line_diff(impl func(ptr unsafe.Pointer, file_path string, text string) gd.Array, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var file_path = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		defer discreet.End(file_path)
...
*/
func (self Go) CreateDiffLine(new_line_no int, old_line_no int, content string, status string) gd.Dictionary {
...
*/
func (self Go) CreateDiffHunk(old_start int, new_start int, old_lines int, new_lines int) gd.Dictionary {
...
*/
func (self Go) CreateDiffFile(new_file string, old_file string) gd.Dictionary {
...
*/
func (self Go) CreateCommit(msg string, author string, id string, unix_timestamp int, offset_minutes int) gd.Dictionary {
...
*/
func (self Go) CreateStatusFile(file_path string, change_type classdb.EditorVCSInterfaceChangeType, area classdb.EditorVCSInterfaceTreeArea) gd.Dictionary {
...
*/
func (self Go) AddDiffHunksIntoDiffFile(diff_file gd.Dictionary, diff_hunks gd.Array) gd.Dictionary {
...
*/
func (self Go) AddLineDiffsIntoDiffHunk(diff_hunk gd.Dictionary, line_diffs gd.Array) gd.Dictionary {
...
*/
func (self Go) PopupError(msg string) {
...
func New() Go {
	...
	return Go{classdb.EditorVCSInterface(object)}
}
...
Returns an [Array] of [Dictionary] items (see [method create_status_file]), each containing the status data of every modified file in the project folder.
*/
func (class) _get_modified_files_data(impl func(ptr unsafe.Pointer) gd.Array, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self)
ptr, ok := discreet.End(ret)
...
Returns an array of [Dictionary] items (see [method create_diff_file], [method create_diff_hunk], [method create_diff_line], [method add_line_diffs_into_diff_hunk] and [method add_diff_hunks_into_diff_file]), each containing information about a diff. If [param identifier] is a file path, returns a file diff, and if it is a commit identifier, then returns a commit diff.
*/
func (class) _get_diff(impl func(ptr unsafe.Pointer, identifier gd.String, area gd.Int) gd.Array, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var identifier = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		var area = gd.UnsafeGet[gd.Int](p_args,1)
		self := reflect.ValueOf(class).UnsafePointer()
...
Returns an [Array] of [Dictionary] items (see [method create_commit]), each containing the data for a past commit.
*/
func (class) _get_previous_commits(impl func(ptr unsafe.Pointer, max_commits gd.Int) gd.Array, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var max_commits = gd.UnsafeGet[gd.Int](p_args,0)
		self := reflect.ValueOf(class).UnsafePointer()
...
Gets an instance of an [Array] of [String]s containing available branch names in the VCS.
*/
func (class) _get_branch_list(impl func(ptr unsafe.Pointer) gd.Array, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self)
ptr, ok := discreet.End(ret)
...
Returns an [Array] of [String]s, each containing the name of a remote configured in the VCS.
*/
func (class) _get_remotes(impl func(ptr unsafe.Pointer) gd.Array, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self)
ptr, ok := discreet.End(ret)
...
Returns an [Array] of [Dictionary] items (see [method create_diff_hunk]), each containing a line diff between a file at [param file_path] and the [param text] which is passed in.
*/
func (class) _get_line_diff(impl func(ptr unsafe.Pointer, file_path gd.String, text gd.String) gd.Array, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var file_path = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,0))
		var text = discreet.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args,1))
		self := reflect.ValueOf(class).UnsafePointer()
...
func (self class) CreateDiffLine(new_line_no gd.Int, old_line_no gd.Int, content gd.String, status gd.String) gd.Dictionary {
	...
	callframe.Arg(frame, discreet.Get(content))
	callframe.Arg(frame, discreet.Get(status))
...
func (self class) CreateDiffFile(new_file gd.String, old_file gd.String) gd.Dictionary {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(new_file))
	callframe.Arg(frame, discreet.Get(old_file))
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func (self class) CreateCommit(msg gd.String, author gd.String, id gd.String, unix_timestamp gd.Int, offset_minutes gd.Int) gd.Dictionary {
	...
	callframe.Arg(frame, discreet.Get(author))
...
func (self class) CreateStatusFile(file_path gd.String, change_type classdb.EditorVCSInterfaceChangeType, area classdb.EditorVCSInterfaceTreeArea) gd.Dictionary {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(file_path))
...
func (self class) AddDiffHunksIntoDiffFile(diff_file gd.Dictionary, diff_hunks gd.Array) gd.Dictionary {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(diff_file))
	callframe.Arg(frame, discreet.Get(diff_hunks))
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func (self class) AddLineDiffsIntoDiffHunk(diff_hunk gd.Dictionary, line_diffs gd.Array) gd.Dictionary {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(diff_hunk))
	callframe.Arg(frame, discreet.Get(line_diffs))
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func (self class) AsEditorVCSInterface() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsEditorVCSInterface() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("EditorVCSInterface", func(ptr gd.Object) any { return classdb.EditorVCSInterface(ptr) })}
