...
Defines the API that the editor uses to extract information from the underlying VCS. The implementation of this API is included in VCS plugins, which are GDExtension plugins that inherit [EditorVCSInterface] and are attached (on demand) to the singleton instance of [EditorVCSInterface]. Instead of performing the task themselves, all the virtual functions listed below are calling the internally overridden functions in the VCS plugins to provide a plug-n-play experience. A custom VCS plugin is supposed to inherit from [EditorVCSInterface] and override each of these virtual functions.
	...
	type EditorVCSInterface interface {
		...
		GetDiff(identifier string, area int) gd.ArrayOf[gd.Dictionary]
		...
		GetPreviousCommits(max_commits int) gd.ArrayOf[gd.Dictionary]
		...
		GetLineDiff(file_path string, text string) gd.ArrayOf[gd.Dictionary]
	}
...
Returns an [Array] of [Dictionary] items (see [method create_status_file]), each containing the status data of every modified file in the project folder.
*/
func (Go) _get_modified_files_data(impl func(ptr unsafe.Pointer) gd.ArrayOf[gd.Dictionary], api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		gc := gd.NewLifetime(api)
		class.SetTemporary(gc)
		self := reflect.ValueOf(class).UnsafePointer()
...
Returns an array of [Dictionary] items (see [method create_diff_file], [method create_diff_hunk], [method create_diff_line], [method add_line_diffs_into_diff_hunk] and [method add_diff_hunks_into_diff_file]), each containing information about a diff. If [param identifier] is a file path, returns a file diff, and if it is a commit identifier, then returns a commit diff.
*/
func (Go) _get_diff(impl func(ptr unsafe.Pointer, identifier string, area int) gd.ArrayOf[gd.Dictionary], api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		gc := gd.NewLifetime(api)
		class.SetTemporary(gc)
...
Returns an [Array] of [Dictionary] items (see [method create_commit]), each containing the data for a past commit.
*/
func (Go) _get_previous_commits(impl func(ptr unsafe.Pointer, max_commits int) gd.ArrayOf[gd.Dictionary], api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		gc := gd.NewLifetime(api)
		class.SetTemporary(gc)
...
Gets an instance of an [Array] of [String]s containing available branch names in the VCS.
*/
func (Go) _get_branch_list(impl func(ptr unsafe.Pointer) gd.ArrayOf[gd.String], api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		gc := gd.NewLifetime(api)
		class.SetTemporary(gc)
		self := reflect.ValueOf(class).UnsafePointer()
...
Returns an [Array] of [String]s, each containing the name of a remote configured in the VCS.
*/
func (Go) _get_remotes(impl func(ptr unsafe.Pointer) gd.ArrayOf[gd.String], api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		gc := gd.NewLifetime(api)
		class.SetTemporary(gc)
		self := reflect.ValueOf(class).UnsafePointer()
...
Returns an [Array] of [Dictionary] items (see [method create_diff_hunk]), each containing a line diff between a file at [param file_path] and the [param text] which is passed in.
*/
func (Go) _get_line_diff(impl func(ptr unsafe.Pointer, file_path string, text string) gd.ArrayOf[gd.Dictionary], api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		gc := gd.NewLifetime(api)
		class.SetTemporary(gc)
		var file_path = mmm.Let[gd.String](gc.Lifetime, gc.API, gd.UnsafeGet[uintptr](p_args,0))
...
func (self Go) CreateDiffLine(new_line_no int, old_line_no int, content string, status string) gd.Dictionary {
	...
	return gd.Dictionary(class(self).CreateDiffLine(gc, gd.Int(new_line_no), gd.Int(old_line_no), gc.String(content), gc.String(status)))
}
...
func (self Go) CreateDiffHunk(old_start int, new_start int, old_lines int, new_lines int) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(class(self).CreateDiffHunk(gc, gd.Int(old_start), gd.Int(new_start), gd.Int(old_lines), gd.Int(new_lines)))
}
...
func (self Go) CreateDiffFile(new_file string, old_file string) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(class(self).CreateDiffFile(gc, gc.String(new_file), gc.String(old_file)))
}
...
func (self Go) CreateCommit(msg string, author string, id string, unix_timestamp int, offset_minutes int) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(class(self).CreateCommit(gc, gc.String(msg), gc.String(author), gc.String(id), gd.Int(unix_timestamp), gd.Int(offset_minutes)))
}
...
func (self Go) CreateStatusFile(file_path string, change_type classdb.EditorVCSInterfaceChangeType, area classdb.EditorVCSInterfaceTreeArea) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(class(self).CreateStatusFile(gc, gc.String(file_path), change_type, area))
}

/*
Helper function to add an array of [param diff_hunks] into a [param diff_file].
*/
func (self Go) AddDiffHunksIntoDiffFile(diff_file gd.Dictionary, diff_hunks gd.ArrayOf[gd.Dictionary]) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(class(self).AddDiffHunksIntoDiffFile(gc, diff_file, diff_hunks))
}

/*
Helper function to add an array of [param line_diffs] into a [param diff_hunk].
*/
func (self Go) AddLineDiffsIntoDiffHunk(diff_hunk gd.Dictionary, line_diffs gd.ArrayOf[gd.Dictionary]) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(class(self).AddLineDiffsIntoDiffHunk(gc, diff_hunk, line_diffs))
}
...
func (self Go) PopupError(msg string) {
	gc := gd.GarbageCollector(); _ = gc
	class(self).PopupError(gc.String(msg))
}
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("EditorVCSInterface"))
...
func init() {classdb.Register("EditorVCSInterface", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
