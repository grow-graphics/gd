...
*/
func (self Instance) IntersectPoint(parameters gdclass.PhysicsPointQueryParameters3D) gd.Array {
...
*/
func (self Instance) IntersectRay(parameters gdclass.PhysicsRayQueryParameters3D) gd.Dictionary {
...
*/
func (self Instance) IntersectShape(parameters gdclass.PhysicsShapeQueryParameters3D) gd.Array {
...
*/
func (self Instance) CastMotion(parameters gdclass.PhysicsShapeQueryParameters3D) []float32 {
...
[b]Note:[/b] This method does not take into account the [code]motion[/code] property of the object.
*/
func (self Instance) CollideShape(parameters gdclass.PhysicsShapeQueryParameters3D) gd.Array {
...
[b]Note:[/b] This method does not take into account the [code]motion[/code] property of the object.
*/
func (self Instance) GetRestInfo(parameters gdclass.PhysicsShapeQueryParameters3D) gd.Dictionary {
