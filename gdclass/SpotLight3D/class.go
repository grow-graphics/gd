...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("SpotLight3D"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsSpotLight3D() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsSpotLight3D() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("SpotLight3D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
