...
func New() Go {
	...
	return Go{classdb.AudioStreamGenerator(object)}
}
...
func init() {classdb.Register("AudioStreamGenerator", func(ptr gd.Object) any { return classdb.AudioStreamGenerator(ptr) })}
