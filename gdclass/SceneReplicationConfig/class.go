...
*/
func (self Go) GetProperties() gd.Array {
...
func New() Go {
	...
	return Go{classdb.SceneReplicationConfig(object)}
}
...
func init() {classdb.Register("SceneReplicationConfig", func(ptr gd.Object) any { return classdb.SceneReplicationConfig(ptr) })}
