...
Implement this function with your custom rendering code. [param effect_callback_type] should always match the effect callback type you've specified in [member effect_callback_type]. [param render_data] provides access to the rendering state, it is only valid during rendering and should not be stored.
*/
func (Instance) _render_callback(impl func(ptr unsafe.Pointer, effect_callback_type int, render_data gdclass.RenderData)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var effect_callback_type = gd.UnsafeGet[gd.Int](p_args, 0)
		var render_data = gdclass.RenderData{pointers.New[classdb.RenderData]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
Implement this function with your custom rendering code. [param effect_callback_type] should always match the effect callback type you've specified in [member effect_callback_type]. [param render_data] provides access to the rendering state, it is only valid during rendering and should not be stored.
*/
func (class) _render_callback(impl func(ptr unsafe.Pointer, effect_callback_type gd.Int, render_data gdclass.RenderData)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var effect_callback_type = gd.UnsafeGet[gd.Int](p_args, 0)
		var render_data = gdclass.RenderData{pointers.New[classdb.RenderData]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
		defer pointers.End(render_data[0])
