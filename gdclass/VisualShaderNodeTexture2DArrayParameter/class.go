...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeTexture2DArrayParameter"))
...
func init() {classdb.Register("VisualShaderNodeTexture2DArrayParameter", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
