...
*/
func (self Instance) GetModification(mod_idx int) gdclass.SkeletonModification2D {
...
*/
func (self Instance) AddModification(modification gdclass.SkeletonModification2D) {
...
*/
func (self Instance) SetModification(mod_idx int, modification gdclass.SkeletonModification2D) {
...
*/
func (self Instance) GetSkeleton() gdclass.Skeleton2D {
