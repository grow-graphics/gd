...
func (self Go) ConnectToHost(address string, port int) gdclass.ENetPacketPeer {
	return gdclass.ENetPacketPeer(class(self).ConnectToHost(gd.NewString(address), gd.Int(port), gd.Int(0), gd.Int(0)))
}
...
func (self Go) DtlsClientSetup(hostname string) gd.Error {
	return gd.Error(class(self).DtlsClientSetup(gd.NewString(hostname), ([1]gdclass.TLSOptions{}[0])))
}
...
*/
func (self Go) GetPeers() gd.Array {
...
func New() Go {
	...
	return Go{classdb.ENetConnection(object)}
}
...
*/
//go:nosplit
func (self class) ConnectToHost(address gd.String, port gd.Int, channels gd.Int, data gd.Int) gdclass.ENetPacketPeer {
	var frame = callframe.New()
...
func (self class) SocketSend(destination_address gd.String, destination_port gd.Int, packet gd.PackedByteArray)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(destination_address))
...
func init() {classdb.Register("ENetConnection", func(ptr gd.Object) any { return classdb.ENetConnection(ptr) })}
