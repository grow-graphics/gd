...
*/
func (self Instance) ConnectToHost(address string, port int) gdclass.ENetPacketPeer {
...
*/
func (self Instance) DtlsServerSetup(server_options gdclass.TLSOptions) gd.Error {
