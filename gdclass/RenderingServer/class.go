...
func Texture2dGet(texture gd.RID) gdclass.Image {
	once.Do(singleton)
	return gdclass.Image(class(self).Texture2dGet(texture))
}
...
func Texture2dLayerGet(texture gd.RID, layer int) gdclass.Image {
	once.Do(singleton)
	return gdclass.Image(class(self).Texture2dLayerGet(texture, gd.Int(layer)))
}
...
func SkyBakePanorama(sky gd.RID, energy float64, bake_irradiance bool, size gd.Vector2i) gdclass.Image {
	once.Do(singleton)
	return gdclass.Image(class(self).SkyBakePanorama(sky, gd.Float(energy), bake_irradiance, size))
}
...
func EnvironmentBakePanorama(environment gd.RID, bake_irradiance bool, size gd.Vector2i) gdclass.Image {
	once.Do(singleton)
	return gdclass.Image(class(self).EnvironmentBakePanorama(environment, bake_irradiance, size))
}
...
func GlobalShaderParameterGetType(name string) classdb.RenderingServerGlobalShaderParameterType {
	once.Do(singleton)
	return classdb.RenderingServerGlobalShaderParameterType(class(self).GlobalShaderParameterGetType(gd.NewStringName(name)))
}
...
func GetRenderingDevice() gdclass.RenderingDevice {
	once.Do(singleton)
	return gdclass.RenderingDevice(class(self).GetRenderingDevice())
}
...
func CreateLocalRenderingDevice() gdclass.RenderingDevice {
	once.Do(singleton)
	return gdclass.RenderingDevice(class(self).CreateLocalRenderingDevice())
}
...
*/
//go:nosplit
func (self class) Texture3dCreate(format classdb.ImageFormat, width gd.Int, height gd.Int, depth gd.Int, mipmaps bool, data gd.Array) gd.RID {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) Texture2dGet(texture gd.RID) gdclass.Image {
	var frame = callframe.New()
	callframe.Arg(frame, texture)
...
*/
//go:nosplit
func (self class) Texture2dLayerGet(texture gd.RID, layer gd.Int) gdclass.Image {
	var frame = callframe.New()
	callframe.Arg(frame, texture)
	callframe.Arg(frame, layer)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) SkyBakePanorama(sky gd.RID, energy gd.Float, bake_irradiance bool, size gd.Vector2i) gdclass.Image {
	var frame = callframe.New()
	callframe.Arg(frame, sky)
	callframe.Arg(frame, energy)
...
*/
//go:nosplit
func (self class) EnvironmentBakePanorama(environment gd.RID, bake_irradiance bool, size gd.Vector2i) gdclass.Image {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetRenderingDevice() gdclass.RenderingDevice {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
	...
	var ret = gdclass.RenderingDevice{classdb.RenderingDevice(gd.PointerMustAssertInstanceID(r_ret.Get()))}
	frame.Free()
	return ret
}
...
*/
//go:nosplit
func (self class) CreateLocalRenderingDevice() gdclass.RenderingDevice {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
