...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeParticleOutput"))
...
func init() {classdb.Register("VisualShaderNodeParticleOutput", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
