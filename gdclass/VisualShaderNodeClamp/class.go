...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeClamp(object)}
}
...
func init() {classdb.Register("VisualShaderNodeClamp", func(ptr gd.Object) any { return classdb.VisualShaderNodeClamp(ptr) })}
