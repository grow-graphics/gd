...
func New() Go {
	...
	return Go{classdb.AnimationNodeBlend2(object)}
}
...
func init() {classdb.Register("AnimationNodeBlend2", func(ptr gd.Object) any { return classdb.AnimationNodeBlend2(ptr) })}
