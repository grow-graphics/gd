...
func New() Go {
	...
	return Go{classdb.PlaceholderTexture2DArray(object)}
}
...
func init() {classdb.Register("PlaceholderTexture2DArray", func(ptr gd.Object) any { return classdb.PlaceholderTexture2DArray(ptr) })}
