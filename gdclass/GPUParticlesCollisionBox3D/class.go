...
*/
type Go [1]classdb.GPUParticlesCollisionBox3D
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("GPUParticlesCollisionBox3D"))
...
func (self class) SetSize(size gd.Vector3)  {
	...
	mmm.API(selfPtr).Object.MethodBindPointerCall(mmm.API(selfPtr).Methods.GPUParticlesCollisionBox3D.Bind_set_size, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	frame.Free()
}
//go:nosplit
func (self class) GetSize() gd.Vector3 {
	...
	mmm.API(selfPtr).Object.MethodBindPointerCall(mmm.API(selfPtr).Methods.GPUParticlesCollisionBox3D.Bind_get_size, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
func (self class) AsGPUParticlesCollisionBox3D() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsGPUParticlesCollisionBox3D() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("GPUParticlesCollisionBox3D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
