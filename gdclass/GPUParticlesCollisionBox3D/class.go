...
func New() Go {
	...
	return Go{classdb.GPUParticlesCollisionBox3D(object)}
}
...
func init() {classdb.Register("GPUParticlesCollisionBox3D", func(ptr gd.Object) any { return classdb.GPUParticlesCollisionBox3D(ptr) })}
