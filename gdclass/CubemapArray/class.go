...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("CubemapArray"))
...
func init() {classdb.Register("CubemapArray", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
