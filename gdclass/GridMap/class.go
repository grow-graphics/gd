...
func (self Instance) MeshLibrary() gdclass.MeshLibrary {
	return gdclass.MeshLibrary(class(self).GetMeshLibrary())
}

func (self Instance) SetMeshLibrary(value gdclass.MeshLibrary) {
	class(self).SetMeshLibrary(value)
}

func (self Instance) PhysicsMaterial() gdclass.PhysicsMaterial {
	return gdclass.PhysicsMaterial(class(self).GetPhysicsMaterial())
}

func (self Instance) SetPhysicsMaterial(value gdclass.PhysicsMaterial) {
