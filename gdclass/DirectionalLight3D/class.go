...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("DirectionalLight3D"))
...
func init() {classdb.Register("DirectionalLight3D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
