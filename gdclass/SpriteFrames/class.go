...
*/
func (self Instance) AddFrame(anim string, texture gdclass.Texture2D) {
...
*/
func (self Instance) SetFrame(anim string, idx int, texture gdclass.Texture2D) {
...
*/
func (self Instance) GetFrameTexture(anim string, idx int) gdclass.Texture2D {
