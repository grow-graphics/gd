...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("HScrollBar"))
...
func init() {classdb.Register("HScrollBar", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
