...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeScreenNormalWorldSpace"))
...
func init() {classdb.Register("VisualShaderNodeScreenNormalWorldSpace", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
