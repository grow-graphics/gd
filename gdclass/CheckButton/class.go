...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("CheckButton"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsCheckButton() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsCheckButton() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("CheckButton", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
