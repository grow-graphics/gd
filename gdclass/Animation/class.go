...
*/
func (self Instance) AudioTrackInsertKey(track_idx int, time float64, stream gdclass.Resource) int {
...
*/
func (self Instance) AudioTrackSetKeyStream(track_idx int, key_idx int, stream gdclass.Resource) {
...
*/
func (self Instance) AudioTrackGetKeyStream(track_idx int, key_idx int) gdclass.Resource {
...
*/
func (self Instance) CopyTrack(track_idx int, to_animation gdclass.Animation) {
