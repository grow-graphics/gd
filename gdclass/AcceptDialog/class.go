...
*/
func (self Instance) GetOkButton() gdclass.Button {
...
[b]Warning:[/b] This is a required internal node, removing and freeing it may cause a crash. If you wish to hide it or any of its children, use their [member CanvasItem.visible] property.
*/
func (self Instance) GetLabel() gdclass.Label {
...
*/
func (self Instance) AddButton(text string) gdclass.Button {
...
You can use [method remove_button] method to remove a button created with this method from the dialog.
*/
func (self Instance) AddCancelButton(name string) gdclass.Button {
...
*/
func (self Instance) RemoveButton(button gdclass.Button) {
...
*/
func (self Instance) RegisterTextEnter(line_edit gdclass.LineEdit) {
