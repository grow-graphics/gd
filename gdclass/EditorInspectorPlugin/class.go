...
To use [EditorInspectorPlugin], register it using the [method EditorPlugin.add_inspector_plugin] method first.
	...
	type EditorInspectorPlugin interface {
		...
		ParseProperty(obj gd.Object, atype gd.VariantType, name string, hint_type gdconst.PropertyHint, hint_string string, usage_flags gdconst.PropertyUsageFlags, wide bool) bool
...
Called to allow adding property-specific editors to the property list for [param object]. The added editor control must extend [EditorProperty]. Returning [code]true[/code] removes the built-in editor for this property, otherwise allows to insert a custom editor before the built-in one.
*/
func (Instance) _parse_property(impl func(ptr unsafe.Pointer, obj gd.Object, atype gd.VariantType, name string, hint_type gdconst.PropertyHint, hint_string string, usage_flags gdconst.PropertyUsageFlags, wide bool) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var obj = pointers.New[gd.Object]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})
		defer pointers.End(obj)
		...
		var hint_type = gd.UnsafeGet[gdconst.PropertyHint](p_args, 3)
		var hint_string = pointers.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args, 4))
		defer pointers.End(hint_string)
		var usage_flags = gd.UnsafeGet[gdconst.PropertyUsageFlags](p_args, 5)
...
*/
func (self Instance) AddCustomControl(control gdclass.Control) {
...
*/
func (self Instance) AddPropertyEditor(property string, editor gdclass.Control) {
...
*/
func (self Instance) AddPropertyEditorForMultipleProperties(label string, properties []string, editor gdclass.Control) {
...
Called to allow adding property-specific editors to the property list for [param object]. The added editor control must extend [EditorProperty]. Returning [code]true[/code] removes the built-in editor for this property, otherwise allows to insert a custom editor before the built-in one.
*/
func (class) _parse_property(impl func(ptr unsafe.Pointer, obj gd.Object, atype gd.VariantType, name gd.String, hint_type gdconst.PropertyHint, hint_string gd.String, usage_flags gdconst.PropertyUsageFlags, wide bool) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var obj = pointers.New[gd.Object]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})
		defer pointers.End(obj)
		var atype = gd.UnsafeGet[gd.VariantType](p_args, 1)
