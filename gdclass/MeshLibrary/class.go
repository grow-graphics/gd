...
*/
func (self Instance) SetItemMesh(id int, mesh gdclass.Mesh) {
...
*/
func (self Instance) SetItemNavigationMesh(id int, navigation_mesh gdclass.NavigationMesh) {
...
*/
func (self Instance) SetItemPreview(id int, texture gdclass.Texture2D) {
...
*/
func (self Instance) GetItemMesh(id int) gdclass.Mesh {
...
*/
func (self Instance) GetItemNavigationMesh(id int) gdclass.NavigationMesh {
...
*/
func (self Instance) GetItemPreview(id int) gdclass.Texture2D {
