...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("EditorExportPlatformMacOS"))
...
func init() {classdb.Register("EditorExportPlatformMacOS", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
