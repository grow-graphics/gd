...
*/
func (self Instance) SetBytecode(bytecode gdclass.RDShaderSPIRV) {
...
*/
func (self Instance) GetSpirv() gdclass.RDShaderSPIRV {
...
func init() {
	classdb.Register("RDShaderFile", func(ptr gd.Object) any { return classdb.RDShaderFile(ptr) })
}
