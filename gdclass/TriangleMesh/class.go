...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("TriangleMesh"))
...
func init() {classdb.Register("TriangleMesh", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
