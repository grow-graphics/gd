...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeCompare"))
...
func init() {classdb.Register("VisualShaderNodeCompare", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
