...
func (self Instance) TextureAlbedo() gdclass.Texture2D {
	return gdclass.Texture2D(class(self).GetTexture(0))
}

func (self Instance) SetTextureAlbedo(value gdclass.Texture2D) {
...
func (self Instance) TextureOrm() gdclass.Texture2D {
	return gdclass.Texture2D(class(self).GetTexture(2))
}

func (self Instance) SetTextureOrm(value gdclass.Texture2D) {
	class(self).SetTexture(2, value)
}

func (self Instance) TextureEmission() gdclass.Texture2D {
	return gdclass.Texture2D(class(self).GetTexture(3))
}

func (self Instance) SetTextureEmission(value gdclass.Texture2D) {
