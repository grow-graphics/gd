...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("EditorExportPlatformLinuxBSD"))
...
func init() {classdb.Register("EditorExportPlatformLinuxBSD", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
