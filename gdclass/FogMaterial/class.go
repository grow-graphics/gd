...
func New() Go {
	...
	return Go{classdb.FogMaterial(object)}
}
...
func (self class) SetDensityTexture(density_texture gdclass.Texture3D)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(density_texture[0])[0])
	var r_ret callframe.Nil
...
func init() {classdb.Register("FogMaterial", func(ptr gd.Object) any { return classdb.FogMaterial(ptr) })}
