...
func New() Go {
	...
	return Go{classdb.GPUParticlesAttractorBox3D(object)}
}
...
func init() {classdb.Register("GPUParticlesAttractorBox3D", func(ptr gd.Object) any { return classdb.GPUParticlesAttractorBox3D(ptr) })}
