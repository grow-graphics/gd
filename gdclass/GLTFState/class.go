...
*/
func (self Instance) GetAnimationPlayer(idx int) gdclass.AnimationPlayer {
...
*/
func (self Instance) GetSceneNode(idx int) gdclass.Node {
...
*/
func (self Instance) GetNodeIndex(scene_node gdclass.Node) int {
