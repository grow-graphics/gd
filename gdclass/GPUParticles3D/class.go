...
func (self Instance) ProcessMaterial() gdclass.Material {
	return gdclass.Material(class(self).GetProcessMaterial())
}

func (self Instance) SetProcessMaterial(value gdclass.Material) {
...
func (self Instance) DrawPass1() gdclass.Mesh {
	return gdclass.Mesh(class(self).GetDrawPassMesh(0))
}

func (self Instance) SetDrawPass1(value gdclass.Mesh) {
	class(self).SetDrawPassMesh(0, value)
}

func (self Instance) DrawPass2() gdclass.Mesh {
	return gdclass.Mesh(class(self).GetDrawPassMesh(1))
}

func (self Instance) SetDrawPass2(value gdclass.Mesh) {
	class(self).SetDrawPassMesh(1, value)
}

func (self Instance) DrawPass3() gdclass.Mesh {
	return gdclass.Mesh(class(self).GetDrawPassMesh(2))
}

func (self Instance) SetDrawPass3(value gdclass.Mesh) {
	class(self).SetDrawPassMesh(2, value)
}

func (self Instance) DrawPass4() gdclass.Mesh {
	return gdclass.Mesh(class(self).GetDrawPassMesh(3))
}

func (self Instance) SetDrawPass4(value gdclass.Mesh) {
	class(self).SetDrawPassMesh(3, value)
}

func (self Instance) DrawSkin() gdclass.Skin {
	return gdclass.Skin(class(self).GetSkin())
}

func (self Instance) SetDrawSkin(value gdclass.Skin) {
