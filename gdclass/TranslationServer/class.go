...
func GetTranslationObject(locale string) gdclass.Translation {
	once.Do(singleton)
	return gdclass.Translation(class(self).GetTranslationObject(gd.NewString(locale)))
}
...
func (self class) CompareLocales(locale_a gd.String, locale_b gd.String) gd.Int {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(locale_a))
	callframe.Arg(frame, discreet.Get(locale_b))
...
func (self class) GetCountryName(country gd.String) gd.String {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(country))
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func (self class) AddTranslation(translation gdclass.Translation)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(translation[0])[0])
	var r_ret callframe.Nil
...
*/
//go:nosplit
func (self class) GetTranslationObject(locale gd.String) gdclass.Translation {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(locale))
	var r_ret = callframe.Ret[[1]uintptr](frame)
	...
	var ret = gdclass.Translation{classdb.Translation(gd.PointerWithOwnershipTransferredToGo(r_ret.Get()))}
	frame.Free()
	return ret
}
/*
...
func init() {classdb.Register("TranslationServer", func(ptr gd.Object) any { return classdb.TranslationServer(ptr) })}
