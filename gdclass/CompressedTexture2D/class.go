...
*/
type Go [1]classdb.CompressedTexture2D
...
func New() Go {
	...
	return Go{classdb.CompressedTexture2D(object)}
}
...
func (self class) AsCompressedTexture2D() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsCompressedTexture2D() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("CompressedTexture2D", func(ptr gd.Object) any { return classdb.CompressedTexture2D(ptr) })}
