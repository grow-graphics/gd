...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("AudioEffectSpectrumAnalyzerInstance"))
...
func init() {classdb.Register("AudioEffectSpectrumAnalyzerInstance", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
