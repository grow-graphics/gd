...
func New() Go {
	...
	return Go{classdb.ResourceImporterImage(object)}
}
...
func init() {classdb.Register("ResourceImporterImage", func(ptr gd.Object) any { return classdb.ResourceImporterImage(ptr) })}
