...
*/
type Go [1]classdb.ResourceImporterImage
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ResourceImporterImage"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsResourceImporterImage() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsResourceImporterImage() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("ResourceImporterImage", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
