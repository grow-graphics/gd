...
Allocates a [Texture2D] in which decoded video frames will be drawn.
*/
func (Instance) _get_texture(impl func(ptr unsafe.Pointer) gdclass.Texture2D) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self)
...
Allocates a [Texture2D] in which decoded video frames will be drawn.
*/
func (class) _get_texture(impl func(ptr unsafe.Pointer) gdclass.Texture2D) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self)
		ptr, ok := pointers.End(ret[0])
...
func init() {
	classdb.Register("VideoStreamPlayback", func(ptr gd.Object) any { return classdb.VideoStreamPlayback(ptr) })
}
