...
*/
func (self Instance) FromNode(light_node gdclass.Light3D) gdclass.GLTFLight {
...
*/
func (self Instance) ToNode() gdclass.Light3D {
...
*/
func (self Instance) FromDictionary(dictionary gd.Dictionary) gdclass.GLTFLight {
