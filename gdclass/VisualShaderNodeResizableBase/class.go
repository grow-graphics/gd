...
*/
type Go [1]classdb.VisualShaderNodeResizableBase
...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeResizableBase(object)}
}
...
func (self class) AsVisualShaderNodeResizableBase() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsVisualShaderNodeResizableBase() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("VisualShaderNodeResizableBase", func(ptr gd.Object) any { return classdb.VisualShaderNodeResizableBase(ptr) })}
