...
*/
func (self Instance) GetStatus() classdb.HTTPClientStatus {
...
func (self Instance) Connection() gdclass.StreamPeer {
	return gdclass.StreamPeer(class(self).GetConnection())
}

func (self Instance) SetConnection(value gdclass.StreamPeer) {
