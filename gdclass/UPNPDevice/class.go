...
*/
type Instance [1]classdb.UPNPDevice
...
func (self Instance) IgdStatus() classdb.UPNPDeviceIGDStatus {
	return classdb.UPNPDeviceIGDStatus(class(self).GetIgdStatus())
}

func (self Instance) SetIgdStatus(value classdb.UPNPDeviceIGDStatus) {
