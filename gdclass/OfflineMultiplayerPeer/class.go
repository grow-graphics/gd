...
func New() Go {
	...
	return Go{classdb.OfflineMultiplayerPeer(object)}
}
...
func init() {classdb.Register("OfflineMultiplayerPeer", func(ptr gd.Object) any { return classdb.OfflineMultiplayerPeer(ptr) })}
