...
func (self Go) LoadBitmapFont(path string) gd.Error {
	...
	return gd.Error(class(self).LoadBitmapFont(gc.String(path)))
}
...
func (self Go) LoadDynamicFont(path string) gd.Error {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Error(class(self).LoadDynamicFont(gc.String(path)))
}
...
*/
func (self Go) GetSizeCacheList(cache_index int) gd.ArrayOf[gd.Vector2i] {
	gc := gd.GarbageCollector(); _ = gc
	return gd.ArrayOf[gd.Vector2i](class(self).GetSizeCacheList(gc, gd.Int(cache_index)))
}
...
func (self Go) GetVariationCoordinates(cache_index int) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(class(self).GetVariationCoordinates(gc, gd.Int(cache_index)))
}
...
func (self Go) GetTextureImage(cache_index int, size gd.Vector2i, texture_index int) gdclass.Image {
	gc := gd.GarbageCollector(); _ = gc
	return gdclass.Image(class(self).GetTextureImage(gc, gd.Int(cache_index), size, gd.Int(texture_index)))
}
...
func (self Go) SetTextureOffsets(cache_index int, size gd.Vector2i, texture_index int, offset []int32) {
	gc := gd.GarbageCollector(); _ = gc
	class(self).SetTextureOffsets(gd.Int(cache_index), size, gd.Int(texture_index), gc.PackedInt32Slice(offset))
}
...
func (self Go) GetTextureOffsets(cache_index int, size gd.Vector2i, texture_index int) []int32 {
	gc := gd.GarbageCollector(); _ = gc
	return []int32(class(self).GetTextureOffsets(gc, gd.Int(cache_index), size, gd.Int(texture_index)).AsSlice())
}
...
func (self Go) GetGlyphList(cache_index int, size gd.Vector2i) []int32 {
	gc := gd.GarbageCollector(); _ = gc
	return []int32(class(self).GetGlyphList(gc, gd.Int(cache_index), size).AsSlice())
}
...
*/
func (self Go) GetKerningList(cache_index int, size int) gd.ArrayOf[gd.Vector2i] {
	gc := gd.GarbageCollector(); _ = gc
	return gd.ArrayOf[gd.Vector2i](class(self).GetKerningList(gc, gd.Int(cache_index), gd.Int(size)))
}
...
func (self Go) SetLanguageSupportOverride(language string, supported bool) {
	gc := gd.GarbageCollector(); _ = gc
	class(self).SetLanguageSupportOverride(gc.String(language), supported)
}
...
func (self Go) GetLanguageSupportOverride(language string) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(class(self).GetLanguageSupportOverride(gc.String(language)))
}
...
func (self Go) RemoveLanguageSupportOverride(language string) {
	gc := gd.GarbageCollector(); _ = gc
	class(self).RemoveLanguageSupportOverride(gc.String(language))
}
...
func (self Go) GetLanguageSupportOverrides() []string {
	gc := gd.GarbageCollector(); _ = gc
	return []string(class(self).GetLanguageSupportOverrides(gc).Strings(gc))
}
...
func (self Go) SetScriptSupportOverride(script string, supported bool) {
	gc := gd.GarbageCollector(); _ = gc
	class(self).SetScriptSupportOverride(gc.String(script), supported)
}
...
func (self Go) GetScriptSupportOverride(script string) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(class(self).GetScriptSupportOverride(gc.String(script)))
}
...
func (self Go) RemoveScriptSupportOverride(script string) {
	gc := gd.GarbageCollector(); _ = gc
	class(self).RemoveScriptSupportOverride(gc.String(script))
}
...
func (self Go) GetScriptSupportOverrides() []string {
	gc := gd.GarbageCollector(); _ = gc
	return []string(class(self).GetScriptSupportOverrides(gc).Strings(gc))
}
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("FontFile"))
...
func (self Go) OpentypeFeatureOverrides() gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
		return gd.Dictionary(class(self).GetOpentypeFeatureOverrides(gc))
}
...
*/
//go:nosplit
func (self class) GetTextureImage(ctx gd.Lifetime, cache_index gd.Int, size gd.Vector2i, texture_index gd.Int) gdclass.Image {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, cache_index)
	callframe.Arg(frame, size)
...
func init() {classdb.Register("FontFile", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
