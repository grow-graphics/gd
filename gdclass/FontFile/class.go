...
*/
func (self Instance) SetTextureImage(cache_index int, size gd.Vector2i, texture_index int, image gdclass.Image) {
...
*/
func (self Instance) GetTextureImage(cache_index int, size gd.Vector2i, texture_index int) gdclass.Image {
