...
[/codeblock]
*/
func (self Instance) Initialize() gd.Error {
...
*/
func (self Instance) CreateDataChannel(label string) gdclass.WebRTCDataChannel {
...
*/
func (self Instance) CreateOffer() gd.Error {
...
*/
func (self Instance) SetLocalDescription(atype string, sdp string) gd.Error {
...
*/
func (self Instance) SetRemoteDescription(atype string, sdp string) gd.Error {
...
*/
func (self Instance) AddIceCandidate(media string, index int, name string) gd.Error {
...
func (self Instance) OnDataChannelReceived(cb func(channel gdclass.WebRTCDataChannel)) {
