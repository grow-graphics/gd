...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ResourceImporter"))
...
func init() {classdb.Register("ResourceImporter", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
