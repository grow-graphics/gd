...
func (Go) _integrate_forces(impl func(ptr unsafe.Pointer, state gdclass.PhysicsDirectBodyState2D) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = gdclass.PhysicsDirectBodyState2D{discreet.New[classdb.PhysicsDirectBodyState2D]([3]uintptr{gd.UnsafeGet[uintptr](p_args,0)})}
...
func New() Go {
	...
	return Go{classdb.RigidBody2D(object)}
}
...
func init() {classdb.Register("RigidBody2D", func(ptr gd.Object) any { return classdb.RigidBody2D(ptr) })}
