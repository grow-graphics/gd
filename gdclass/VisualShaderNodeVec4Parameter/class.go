...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeVec4Parameter(object)}
}
...
func init() {classdb.Register("VisualShaderNodeVec4Parameter", func(ptr gd.Object) any { return classdb.VisualShaderNodeVec4Parameter(ptr) })}
