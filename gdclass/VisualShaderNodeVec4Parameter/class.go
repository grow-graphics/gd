...
*/
type Go [1]classdb.VisualShaderNodeVec4Parameter
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeVec4Parameter"))
...
func (self Go) DefaultValue() gd.Vector4 {
	gc := gd.GarbageCollector(); _ = gc
		return gd.Vector4(class(self).GetDefaultValue())
}

func (self Go) SetDefaultValue(value gd.Vector4) {
	gc := gd.GarbageCollector(); _ = gc
...
func (self class) AsVisualShaderNodeVec4Parameter() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsVisualShaderNodeVec4Parameter() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("VisualShaderNodeVec4Parameter", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
