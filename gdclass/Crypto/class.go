...
*/
func (self Instance) GenerateRsa(size int) gdclass.CryptoKey {
...
[/codeblocks]
*/
func (self Instance) GenerateSelfSignedCertificate(key gdclass.CryptoKey) gdclass.X509Certificate {
...
*/
func (self Instance) Sign(hash_type classdb.HashingContextHashType, hash []byte, key gdclass.CryptoKey) []byte {
...
*/
func (self Instance) Verify(hash_type classdb.HashingContextHashType, hash []byte, signature []byte, key gdclass.CryptoKey) bool {
...
*/
func (self Instance) Encrypt(key gdclass.CryptoKey, plaintext []byte) []byte {
...
*/
func (self Instance) Decrypt(key gdclass.CryptoKey, ciphertext []byte) []byte {
