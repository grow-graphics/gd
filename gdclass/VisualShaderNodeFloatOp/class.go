...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeFloatOp(object)}
}
...
func init() {classdb.Register("VisualShaderNodeFloatOp", func(ptr gd.Object) any { return classdb.VisualShaderNodeFloatOp(ptr) })}
