...
Called after the scene was imported. This method must return the modified version of the scene.
*/
func (Instance) _post_import(impl func(ptr unsafe.Pointer, scene gdclass.Node) gd.Object) (cb gd.ExtensionClassCallVirtualFunc) {
...
Called after the scene was imported. This method must return the modified version of the scene.
*/
func (class) _post_import(impl func(ptr unsafe.Pointer, scene gdclass.Node) gd.Object) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var scene = gdclass.Node{pointers.New[classdb.Node]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(scene[0])
		self := reflect.ValueOf(class).UnsafePointer()
