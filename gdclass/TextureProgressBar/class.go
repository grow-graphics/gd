...
func (self Instance) TextureUnder() gdclass.Texture2D {
	return gdclass.Texture2D(class(self).GetUnderTexture())
}

func (self Instance) SetTextureUnder(value gdclass.Texture2D) {
	class(self).SetUnderTexture(value)
}

func (self Instance) TextureOver() gdclass.Texture2D {
	return gdclass.Texture2D(class(self).GetOverTexture())
}

func (self Instance) SetTextureOver(value gdclass.Texture2D) {
	class(self).SetOverTexture(value)
}

func (self Instance) TextureProgress() gdclass.Texture2D {
	return gdclass.Texture2D(class(self).GetProgressTexture())
}

func (self Instance) SetTextureProgress(value gdclass.Texture2D) {
