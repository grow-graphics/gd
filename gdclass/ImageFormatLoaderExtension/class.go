...
Loads the content of [param fileaccess] into the provided [param image].
*/
func (Instance) _load_image(impl func(ptr unsafe.Pointer, image gdclass.Image, fileaccess gdclass.FileAccess, flags classdb.ImageFormatLoaderLoaderFlags, scale float64) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var image = gdclass.Image{pointers.New[classdb.Image]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(image[0])
		var fileaccess = gdclass.FileAccess{pointers.New[classdb.FileAccess]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
Loads the content of [param fileaccess] into the provided [param image].
*/
func (class) _load_image(impl func(ptr unsafe.Pointer, image gdclass.Image, fileaccess gdclass.FileAccess, flags classdb.ImageFormatLoaderLoaderFlags, scale gd.Float) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var image = gdclass.Image{pointers.New[classdb.Image]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(image[0])
		var fileaccess = gdclass.FileAccess{pointers.New[classdb.FileAccess]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
