...
*/
func (self Instance) LightmapUnwrap(transform gd.Transform3D, texel_size float64) gd.Error {
...
func (self Instance) ShadowMesh() gdclass.ArrayMesh {
	return gdclass.ArrayMesh(class(self).GetShadowMesh())
}

func (self Instance) SetShadowMesh(value gdclass.ArrayMesh) {
