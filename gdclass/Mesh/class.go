...
Virtual method to override the setting of a [param material] at the given [param index] for a custom class extending [Mesh].
*/
func (Instance) _surface_set_material(impl func(ptr unsafe.Pointer, index int, material gdclass.Material)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var index = gd.UnsafeGet[gd.Int](p_args, 0)
		var material = gdclass.Material{pointers.New[classdb.Material]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
Virtual method to override the surface material for a custom class extending [Mesh].
*/
func (Instance) _surface_get_material(impl func(ptr unsafe.Pointer, index int) gdclass.Material) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var index = gd.UnsafeGet[gd.Int](p_args, 0)
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self, int(index))
...
*/
func (self Instance) SurfaceSetMaterial(surf_idx int, material gdclass.Material) {
...
*/
func (self Instance) SurfaceGetMaterial(surf_idx int) gdclass.Material {
	return gdclass.Material(class(self).SurfaceGetMaterial(gd.Int(surf_idx)))
}
...
*/
func (self Instance) CreateTrimeshShape() gdclass.ConcavePolygonShape3D {
	return gdclass.ConcavePolygonShape3D(class(self).CreateTrimeshShape())
}
...
*/
func (self Instance) CreateConvexShape() gdclass.ConvexPolygonShape3D {
	return gdclass.ConvexPolygonShape3D(class(self).CreateConvexShape(true, false))
}
...
*/
func (self Instance) CreateOutline(margin float64) gdclass.Mesh {
	return gdclass.Mesh(class(self).CreateOutline(gd.Float(margin)))
}
...
*/
func (self Instance) GenerateTriangleMesh() gdclass.TriangleMesh {
	return gdclass.TriangleMesh(class(self).GenerateTriangleMesh())
}
...
Virtual method to override the setting of a [param material] at the given [param index] for a custom class extending [Mesh].
*/
func (class) _surface_set_material(impl func(ptr unsafe.Pointer, index gd.Int, material gdclass.Material)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var index = gd.UnsafeGet[gd.Int](p_args, 0)
		var material = gdclass.Material{pointers.New[classdb.Material]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
		defer pointers.End(material[0])
...
Virtual method to override the surface material for a custom class extending [Mesh].
*/
func (class) _surface_get_material(impl func(ptr unsafe.Pointer, index gd.Int) gdclass.Material) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var index = gd.UnsafeGet[gd.Int](p_args, 0)
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self, index)
...
*/
//go:nosplit
func (self class) SurfaceGetMaterial(surf_idx gd.Int) gdclass.Material {
	var frame = callframe.New()
	callframe.Arg(frame, surf_idx)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) CreateTrimeshShape() gdclass.ConcavePolygonShape3D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
	...
	var ret = gdclass.ConcavePolygonShape3D{classdb.ConcavePolygonShape3D(gd.PointerWithOwnershipTransferredToGo(r_ret.Get()))}
	frame.Free()
	return ret
}
...
*/
//go:nosplit
func (self class) CreateConvexShape(clean bool, simplify bool) gdclass.ConvexPolygonShape3D {
	var frame = callframe.New()
	...
	var ret = gdclass.ConvexPolygonShape3D{classdb.ConvexPolygonShape3D(gd.PointerWithOwnershipTransferredToGo(r_ret.Get()))}
	frame.Free()
	return ret
}
...
*/
//go:nosplit
func (self class) CreateOutline(margin gd.Float) gdclass.Mesh {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GenerateTriangleMesh() gdclass.TriangleMesh {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
	...
	var ret = gdclass.TriangleMesh{classdb.TriangleMesh(gd.PointerWithOwnershipTransferredToGo(r_ret.Get()))}
	frame.Free()
	return ret
}
