...
*/
func (self Instance) Rpc(peer int, obj gd.Object, method string) gd.Error {
...
*/
func (self Instance) ObjectConfigurationAdd(obj gd.Object, configuration gd.Variant) gd.Error {
...
[b]Note:[/b] This method is mostly relevant when extending or overriding the MultiplayerAPI behavior via [MultiplayerAPIExtension].
*/
func (self Instance) ObjectConfigurationRemove(obj gd.Object, configuration gd.Variant) gd.Error {
...
*/
func (self Instance) CreateDefaultInterface() gdclass.MultiplayerAPI {
...
func (self Instance) MultiplayerPeer() gdclass.MultiplayerPeer {
	return gdclass.MultiplayerPeer(class(self).GetMultiplayerPeer())
}

func (self Instance) SetMultiplayerPeer(value gdclass.MultiplayerPeer) {
