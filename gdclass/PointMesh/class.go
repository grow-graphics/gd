...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("PointMesh"))
...
func init() {classdb.Register("PointMesh", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
