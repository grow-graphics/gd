...
*/
type Go [1]classdb.RemoteTransform3D
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("RemoteTransform3D"))
...
func (self class) AsRemoteTransform3D() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsRemoteTransform3D() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("RemoteTransform3D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
