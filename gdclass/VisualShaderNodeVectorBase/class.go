...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeVectorBase"))
...
func init() {classdb.Register("VisualShaderNodeVectorBase", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
