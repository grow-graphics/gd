...
func New() Go {
	...
	return Go{classdb.SkeletonModification2DJiggle(object)}
}
...
func init() {classdb.Register("SkeletonModification2DJiggle", func(ptr gd.Object) any { return classdb.SkeletonModification2DJiggle(ptr) })}
