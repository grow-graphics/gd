...
func (self Go) GetCurrentNavigationResult() gdclass.NavigationPathQueryResult2D {
	gc := gd.GarbageCollector(); _ = gc
	return gdclass.NavigationPathQueryResult2D(class(self).GetCurrentNavigationResult(gc))
}
...
func (self Go) GetCurrentNavigationPath() []gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return []gd.Vector2(class(self).GetCurrentNavigationPath(gc).AsSlice())
}
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("NavigationAgent2D"))
...
*/
//go:nosplit
func (self class) GetCurrentNavigationResult(ctx gd.Lifetime) gdclass.NavigationPathQueryResult2D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	...
	var ret gdclass.NavigationPathQueryResult2D
...
func init() {classdb.Register("NavigationAgent2D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
