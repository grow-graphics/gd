...
*/
//go:nosplit
func (self class) GetCurrentNavigationResult() gdclass.NavigationPathQueryResult2D {
	var frame = callframe.New()
	...
	var ret = gdclass.NavigationPathQueryResult2D{classdb.NavigationPathQueryResult2D(gd.PointerWithOwnershipTransferredToGo(r_ret.Get()))}
	frame.Free()
	return ret
}
