...
func New() Go {
	...
	return Go{classdb.SkeletonProfileHumanoid(object)}
}
...
func init() {classdb.Register("SkeletonProfileHumanoid", func(ptr gd.Object) any { return classdb.SkeletonProfileHumanoid(ptr) })}
