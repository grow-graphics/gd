...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeBooleanParameter(object)}
}
...
func init() {classdb.Register("VisualShaderNodeBooleanParameter", func(ptr gd.Object) any { return classdb.VisualShaderNodeBooleanParameter(ptr) })}
