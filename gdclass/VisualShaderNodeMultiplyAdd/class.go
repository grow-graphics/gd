...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeMultiplyAdd"))
...
func init() {classdb.Register("VisualShaderNodeMultiplyAdd", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
