...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("MarginContainer"))
...
func init() {classdb.Register("MarginContainer", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
