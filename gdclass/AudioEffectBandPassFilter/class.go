...
func New() Go {
	...
	return Go{classdb.AudioEffectBandPassFilter(object)}
}
...
func init() {classdb.Register("AudioEffectBandPassFilter", func(ptr gd.Object) any { return classdb.AudioEffectBandPassFilter(ptr) })}
