...
*/
type Instance [1]classdb.RichTextLabel
...
*/
func (self Instance) AddImage(image gdclass.Texture2D) {
...
*/
func (self Instance) UpdateImage(key gd.Variant, mask classdb.RichTextLabelImageUpdateMask, image gdclass.Texture2D) {
...
*/
func (self Instance) PushFont(font gdclass.Font) {
...
*/
func (self Instance) PushList(level int, atype classdb.RichTextLabelListType, capitalize bool) {
...
*/
func (self Instance) PushDropcap(s string, font gdclass.Font, size int) {
...
*/
func (self Instance) PushCustomfx(effect gdclass.RichTextEffect, env gd.Dictionary) {
...
*/
func (self Instance) GetVScrollBar() gdclass.VScrollBar {
...
*/
func (self Instance) GetMenu() gdclass.PopupMenu {
...
*/
//go:nosplit
func (self class) AddImage(image gdclass.Texture2D, width gd.Int, height gd.Int, color gd.Color, inline_align gdconst.InlineAlignment, region gd.Rect2, key gd.Variant, pad bool, tooltip gd.String, size_in_percent bool) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) UpdateImage(key gd.Variant, mask classdb.RichTextLabelImageUpdateMask, image gdclass.Texture2D, width gd.Int, height gd.Int, color gd.Color, inline_align gdconst.InlineAlignment, region gd.Rect2, pad bool, tooltip gd.String, size_in_percent bool) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(key))
