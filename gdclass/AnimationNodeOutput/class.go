...
*/
type Go [1]classdb.AnimationNodeOutput
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("AnimationNodeOutput"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsAnimationNodeOutput() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsAnimationNodeOutput() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("AnimationNodeOutput", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
