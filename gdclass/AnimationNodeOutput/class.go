...
func New() Go {
	...
	return Go{classdb.AnimationNodeOutput(object)}
}
...
func init() {classdb.Register("AnimationNodeOutput", func(ptr gd.Object) any { return classdb.AnimationNodeOutput(ptr) })}
