...
func New() Go {
	...
	return Go{classdb.CompressedCubemapArray(object)}
}
...
func init() {classdb.Register("CompressedCubemapArray", func(ptr gd.Object) any { return classdb.CompressedCubemapArray(ptr) })}
