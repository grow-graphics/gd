...
func New() Go {
	...
	return Go{classdb.ResourceImporterBitMap(object)}
}
...
func init() {classdb.Register("ResourceImporterBitMap", func(ptr gd.Object) any { return classdb.ResourceImporterBitMap(ptr) })}
