...
*/
type Go [1]classdb.ResourceImporterBitMap
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ResourceImporterBitMap"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsResourceImporterBitMap() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsResourceImporterBitMap() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("ResourceImporterBitMap", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
