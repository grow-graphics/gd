...
func New() Go {
	...
	return Go{classdb.EditorResourceConversionPlugin(object)}
}
...
func init() {classdb.Register("EditorResourceConversionPlugin", func(ptr gd.Object) any { return classdb.EditorResourceConversionPlugin(ptr) })}
