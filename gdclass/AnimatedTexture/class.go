...
func (self Go) GetFrameTexture(frame_ int) gdclass.Texture2D {
	return gdclass.Texture2D(class(self).GetFrameTexture(gd.Int(frame_)))
}
...
func New() Go {
	...
	return Go{classdb.AnimatedTexture(object)}
}
...
*/
//go:nosplit
func (self class) GetFrameTexture(frame_ gd.Int) gdclass.Texture2D {
	var frame = callframe.New()
	callframe.Arg(frame, frame_)
...
func init() {classdb.Register("AnimatedTexture", func(ptr gd.Object) any { return classdb.AnimatedTexture(ptr) })}
