...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("CompressedCubemap"))
...
func init() {classdb.Register("CompressedCubemap", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
