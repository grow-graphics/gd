...
*/
type Go [1]classdb.HBoxContainer
// GD is a 1:1 low-level instance of the class, undocumented, for those who know what they are doing.
type GD = class
type class [1]classdb.HBoxContainer
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("HBoxContainer"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsHBoxContainer() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsHBoxContainer() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("HBoxContainer", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
