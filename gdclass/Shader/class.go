...
*/
func (self Instance) SetDefaultTextureParameter(name string, texture gdclass.Texture2D) {
...
[b]Note:[/b] If the sampler array is used use [param index] to access the specified texture.
*/
func (self Instance) GetDefaultTextureParameter(name string) gdclass.Texture2D {
