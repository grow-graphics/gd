...
*/
func (self Instance) Setup(server_options gdclass.TLSOptions) gd.Error {
...
*/
func (self Instance) TakeConnection(udp_peer gdclass.PacketPeerUDP) gdclass.PacketPeerDTLS {
