...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("EditorExportPlatformPC"))
...
func init() {classdb.Register("EditorExportPlatformPC", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
