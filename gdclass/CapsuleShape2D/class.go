...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("CapsuleShape2D"))
...
func init() {classdb.Register("CapsuleShape2D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
