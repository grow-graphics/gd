...
*/
func (self Instance) GetHScrollBar() gdclass.HScrollBar {
...
*/
func (self Instance) SetLineGutterIcon(line int, gutter int, icon gdclass.Texture2D) {
...
*/
func (self Instance) GetLineGutterIcon(line int, gutter int) gdclass.Texture2D {
	return gdclass.Texture2D(class(self).GetLineGutterIcon(gd.Int(line), gd.Int(gutter)))
}
...
func (self Instance) SyntaxHighlighter() gdclass.SyntaxHighlighter {
	return gdclass.SyntaxHighlighter(class(self).GetSyntaxHighlighter())
}

func (self Instance) SetSyntaxHighlighter(value gdclass.SyntaxHighlighter) {
...
*/
//go:nosplit
func (self class) GetLineGutterIcon(line gd.Int, gutter gd.Int) gdclass.Texture2D {
	var frame = callframe.New()
	callframe.Arg(frame, line)
	callframe.Arg(frame, gutter)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
//go:nosplit
func (self class) GetSyntaxHighlighter() gdclass.SyntaxHighlighter {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
	...
	var ret = gdclass.SyntaxHighlighter{classdb.SyntaxHighlighter(gd.PointerWithOwnershipTransferredToGo(r_ret.Get()))}
	frame.Free()
	return ret
}
