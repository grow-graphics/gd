...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeColorFunc(object)}
}
...
func init() {classdb.Register("VisualShaderNodeColorFunc", func(ptr gd.Object) any { return classdb.VisualShaderNodeColorFunc(ptr) })}
