...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeVaryingSetter(object)}
}
...
func init() {classdb.Register("VisualShaderNodeVaryingSetter", func(ptr gd.Object) any { return classdb.VisualShaderNodeVaryingSetter(ptr) })}
