...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("Parallax2D"))
...
func init() {classdb.Register("Parallax2D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
