...
func (self Go) GetSlideCollision(slide_idx int) gdclass.KinematicCollision3D {
	gc := gd.GarbageCollector(); _ = gc
	return gdclass.KinematicCollision3D(class(self).GetSlideCollision(gc, gd.Int(slide_idx)))
}
...
func (self Go) GetLastSlideCollision() gdclass.KinematicCollision3D {
	gc := gd.GarbageCollector(); _ = gc
	return gdclass.KinematicCollision3D(class(self).GetLastSlideCollision(gc))
}
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("CharacterBody3D"))
...
*/
//go:nosplit
func (self class) GetSlideCollision(ctx gd.Lifetime, slide_idx gd.Int) gdclass.KinematicCollision3D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetLastSlideCollision(ctx gd.Lifetime) gdclass.KinematicCollision3D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
func init() {classdb.Register("CharacterBody3D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
