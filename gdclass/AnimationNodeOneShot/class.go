...
func New() Go {
	...
	return Go{classdb.AnimationNodeOneShot(object)}
}
...
func init() {classdb.Register("AnimationNodeOneShot", func(ptr gd.Object) any { return classdb.AnimationNodeOneShot(ptr) })}
