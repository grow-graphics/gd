...
func (self Instance) FadeinCurve() gdclass.Curve {
	return gdclass.Curve(class(self).GetFadeinCurve())
}

func (self Instance) SetFadeinCurve(value gdclass.Curve) {
...
func (self Instance) FadeoutCurve() gdclass.Curve {
	return gdclass.Curve(class(self).GetFadeoutCurve())
}

func (self Instance) SetFadeoutCurve(value gdclass.Curve) {
...
//go:nosplit
func (self class) GetFadeinCurve() gdclass.Curve {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetFadeoutCurve() gdclass.Curve {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
