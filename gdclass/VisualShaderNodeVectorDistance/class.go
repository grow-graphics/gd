...
*/
type Go [1]classdb.VisualShaderNodeVectorDistance
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeVectorDistance"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsVisualShaderNodeVectorDistance() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsVisualShaderNodeVectorDistance() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("VisualShaderNodeVectorDistance", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
