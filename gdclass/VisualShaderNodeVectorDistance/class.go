...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeVectorDistance(object)}
}
...
func init() {classdb.Register("VisualShaderNodeVectorDistance", func(ptr gd.Object) any { return classdb.VisualShaderNodeVectorDistance(ptr) })}
