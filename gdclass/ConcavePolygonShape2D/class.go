...
func New() Go {
	...
	return Go{classdb.ConcavePolygonShape2D(object)}
}
...
func init() {classdb.Register("ConcavePolygonShape2D", func(ptr gd.Object) any { return classdb.ConcavePolygonShape2D(ptr) })}
