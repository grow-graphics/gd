...
*/
func (self Instance) FromNode(body_node gdclass.CollisionObject3D) gdclass.GLTFPhysicsBody {
...
*/
func (self Instance) ToNode() gdclass.CollisionObject3D {
...
*/
func (self Instance) FromDictionary(dictionary gd.Dictionary) gdclass.GLTFPhysicsBody {
