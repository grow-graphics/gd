...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeIntFunc"))
...
func init() {classdb.Register("VisualShaderNodeIntFunc", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
