...
func (Go) _space_get_contacts(impl func(ptr unsafe.Pointer, space gd.RID) []gd.Vector3, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		...
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self, space)
ptr, ok := discreet.End(gd.NewPackedVector3Slice(ret))
		if !ok {
			return
		}
		gd.UnsafeSet(p_back, ptr)
...
func (Go) _soft_body_update_rendering_server(impl func(ptr unsafe.Pointer, body gd.RID, rendering_server_handler gdclass.PhysicsServer3DRenderingServerHandler) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var body = gd.UnsafeGet[gd.RID](p_args,0)
		var rendering_server_handler = gdclass.PhysicsServer3DRenderingServerHandler{discreet.New[classdb.PhysicsServer3DRenderingServerHandler]([3]uintptr{gd.UnsafeGet[uintptr](p_args,1)})}
		defer discreet.End(rendering_server_handler[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
func (Go) _soft_body_get_collision_exceptions(impl func(ptr unsafe.Pointer, body gd.RID) gd.Array, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var body = gd.UnsafeGet[gd.RID](p_args,0)
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self, body)
...
func (Go) _soft_body_set_state(impl func(ptr unsafe.Pointer, body gd.RID, state classdb.PhysicsServer3DBodyState, variant gd.Variant) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var body = gd.UnsafeGet[gd.RID](p_args,0)
		var state = gd.UnsafeGet[classdb.PhysicsServer3DBodyState](p_args,1)
		var variant = discreet.New[gd.Variant](gd.UnsafeGet[[3]uintptr](p_args,2))
		defer discreet.End(variant)
		self := reflect.ValueOf(class).UnsafePointer()
...
func New() Go {
	...
	return Go{classdb.PhysicsServer3DExtension(object)}
}
...
func (class) _soft_body_get_collision_exceptions(impl func(ptr unsafe.Pointer, body gd.RID) gd.Array, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var body = gd.UnsafeGet[gd.RID](p_args,0)
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self, body)
...
func init() {classdb.Register("PhysicsServer3DExtension", func(ptr gd.Object) any { return classdb.PhysicsServer3DExtension(ptr) })}
