...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeFloatFunc(object)}
}
...
func init() {classdb.Register("VisualShaderNodeFloatFunc", func(ptr gd.Object) any { return classdb.VisualShaderNodeFloatFunc(ptr) })}
