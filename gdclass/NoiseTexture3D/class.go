...
func (self Instance) Noise() gdclass.Noise {
	return gdclass.Noise(class(self).GetNoise())
}

func (self Instance) SetNoise(value gdclass.Noise) {
...
func init() {
	classdb.Register("NoiseTexture3D", func(ptr gd.Object) any { return classdb.NoiseTexture3D(ptr) })
}
