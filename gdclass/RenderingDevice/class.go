...
*/
func (self Instance) TextureCreate(format gdclass.RDTextureFormat, view gdclass.RDTextureView) gd.RID {
...
*/
func (self Instance) TextureCreateShared(view gdclass.RDTextureView, with_texture gd.RID) gd.RID {
...
*/
func (self Instance) TextureCreateSharedFromSlice(view gdclass.RDTextureView, with_texture gd.RID, layer int, mipmap int) gd.RID {
...
*/
func (self Instance) TextureGetFormat(texture gd.RID) gdclass.RDTextureFormat {
	return gdclass.RDTextureFormat(class(self).TextureGetFormat(texture))
}
...
Once finished with your RID, you will want to free the RID using the RenderingDevice's [method free_rid] method.
*/
func (self Instance) SamplerCreate(state gdclass.RDSamplerState) gd.RID {
...
*/
func (self Instance) ShaderCompileSpirvFromSource(shader_source gdclass.RDShaderSource) gdclass.RDShaderSPIRV {
	return gdclass.RDShaderSPIRV(class(self).ShaderCompileSpirvFromSource(shader_source, true))
}
...
*/
func (self Instance) ShaderCompileBinaryFromSpirv(spirv_data gdclass.RDShaderSPIRV) []byte {
...
*/
func (self Instance) ShaderCreateFromSpirv(spirv_data gdclass.RDShaderSPIRV) gd.RID {
...
*/
func (self Instance) CreateLocalDevice() gdclass.RenderingDevice {
	return gdclass.RenderingDevice(class(self).CreateLocalDevice())
}
...
*/
//go:nosplit
func (self class) TextureCreate(format gdclass.RDTextureFormat, view gdclass.RDTextureView, data gd.Array) gd.RID {
...
*/
//go:nosplit
func (self class) TextureGetFormat(texture gd.RID) gdclass.RDTextureFormat {
	var frame = callframe.New()
	callframe.Arg(frame, texture)
...
*/
//go:nosplit
func (self class) ShaderCompileSpirvFromSource(shader_source gdclass.RDShaderSource, allow_cache bool) gdclass.RDShaderSPIRV {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) ShaderCompileBinaryFromSpirv(spirv_data gdclass.RDShaderSPIRV, name gd.String) gd.PackedByteArray {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) CreateLocalDevice() gdclass.RenderingDevice {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
	...
	var ret = gdclass.RenderingDevice{classdb.RenderingDevice(gd.PointerWithOwnershipTransferredToGo(r_ret.Get()))}
	frame.Free()
	return ret
}
