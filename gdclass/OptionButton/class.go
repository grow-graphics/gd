...
*/
func (self Instance) SetItemIcon(idx int, texture gdclass.Texture2D) {
...
*/
func (self Instance) GetItemIcon(idx int) gdclass.Texture2D {
...
*/
func (self Instance) GetPopup() gdclass.PopupMenu {
...
func New() Instance {
	...
	return Instance{classdb.OptionButton(object)}
}
...
func init() {
	classdb.Register("OptionButton", func(ptr gd.Object) any { return classdb.OptionButton(ptr) })
}
