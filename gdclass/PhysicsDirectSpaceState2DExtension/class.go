...
func New() Go {
	...
	return Go{classdb.PhysicsDirectSpaceState2DExtension(object)}
}
...
func init() {classdb.Register("PhysicsDirectSpaceState2DExtension", func(ptr gd.Object) any { return classdb.PhysicsDirectSpaceState2DExtension(ptr) })}
