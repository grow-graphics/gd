...
*/
type Go [1]classdb.PhysicsDirectSpaceState2DExtension
func (Go) _intersect_ray(impl func(ptr unsafe.Pointer, from gd.Vector2, to gd.Vector2, collision_mask int, collide_with_bodies bool, collide_with_areas bool, hit_from_inside bool, result *classdb.PhysicsServer2DExtensionRayResult) bool, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
...
func (Go) _intersect_point(impl func(ptr unsafe.Pointer, position gd.Vector2, canvas_instance_id int, collision_mask int, collide_with_bodies bool, collide_with_areas bool, results *classdb.PhysicsServer2DExtensionShapeResult, max_results int) int, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		gc := gd.NewLifetime(api)
		class.SetTemporary(gc)
...
func (Go) _cast_motion(impl func(ptr unsafe.Pointer, shape_rid gd.RID, transform gd.Transform2D, motion gd.Vector2, margin float64, collision_mask int, collide_with_bodies bool, collide_with_areas bool, closest_safe *float64, closest_unsafe *float64) bool, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		gc := gd.NewLifetime(api)
		class.SetTemporary(gc)
		var shape_rid = gd.UnsafeGet[gd.RID](p_args,0)
...
func (Go) _collide_shape(impl func(ptr unsafe.Pointer, shape_rid gd.RID, transform gd.Transform2D, motion gd.Vector2, margin float64, collision_mask int, collide_with_bodies bool, collide_with_areas bool, results unsafe.Pointer, max_results int, result_count *int32) bool, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		gc := gd.NewLifetime(api)
		class.SetTemporary(gc)
		var shape_rid = gd.UnsafeGet[gd.RID](p_args,0)
...
func (Go) _rest_info(impl func(ptr unsafe.Pointer, shape_rid gd.RID, transform gd.Transform2D, motion gd.Vector2, margin float64, collision_mask int, collide_with_bodies bool, collide_with_areas bool, rest_info *classdb.PhysicsServer2DExtensionShapeRestInfo) bool, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		gc := gd.NewLifetime(api)
		class.SetTemporary(gc)
		var shape_rid = gd.UnsafeGet[gd.RID](p_args,0)
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("PhysicsDirectSpaceState2DExtension"))
...
func (self class) AsPhysicsDirectSpaceState2DExtension() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsPhysicsDirectSpaceState2DExtension() Go { return *((*Go)(unsafe.Pointer(&self))) }
func (self class) AsPhysicsDirectSpaceState2D() PhysicsDirectSpaceState2D.GD { return *((*PhysicsDirectSpaceState2D.GD)(unsafe.Pointer(&self))) }
func (self Go) AsPhysicsDirectSpaceState2D() PhysicsDirectSpaceState2D.Go { return *((*PhysicsDirectSpaceState2D.Go)(unsafe.Pointer(&self))) }
...
func (self class) Virtual(name string) reflect.Value {
	...
	default: return gd.VirtualByName(self.AsPhysicsDirectSpaceState2D(), name)
	}
}
...
func init() {classdb.Register("PhysicsDirectSpaceState2DExtension", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
