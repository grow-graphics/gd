...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeStep(object)}
}
...
func init() {classdb.Register("VisualShaderNodeStep", func(ptr gd.Object) any { return classdb.VisualShaderNodeStep(ptr) })}
