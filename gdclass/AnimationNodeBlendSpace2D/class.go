...
*/
func (self Instance) AddBlendPoint(node gdclass.AnimationRootNode, pos gd.Vector2) {
...
*/
func (self Instance) SetBlendPointNode(point int, node gdclass.AnimationRootNode) {
...
*/
func (self Instance) GetBlendPointNode(point int) gdclass.AnimationRootNode {
	return gdclass.AnimationRootNode(class(self).GetBlendPointNode(gd.Int(point)))
}
...
*/
//go:nosplit
func (self class) GetBlendPointNode(point gd.Int) gdclass.AnimationRootNode {
	var frame = callframe.New()
	callframe.Arg(frame, point)
