...
func New() Go {
	...
	return Go{classdb.AnimationNodeBlendSpace2D(object)}
}
...
func init() {classdb.Register("AnimationNodeBlendSpace2D", func(ptr gd.Object) any { return classdb.AnimationNodeBlendSpace2D(ptr) })}
