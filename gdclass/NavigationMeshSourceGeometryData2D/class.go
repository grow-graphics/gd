...
*/
func (self Go) AppendTraversableOutlines(traversable_outlines gd.Array) {
...
*/
func (self Go) AppendObstructionOutlines(obstruction_outlines gd.Array) {
...
func New() Go {
	...
	return Go{classdb.NavigationMeshSourceGeometryData2D(object)}
}

func (self Go) TraversableOutlines() gd.Array {
		return gd.Array(class(self).GetTraversableOutlines())
}

func (self Go) SetTraversableOutlines(value gd.Array) {
	class(self).SetTraversableOutlines(value)
}

func (self Go) ObstructionOutlines() gd.Array {
		return gd.Array(class(self).GetObstructionOutlines())
}

func (self Go) SetObstructionOutlines(value gd.Array) {
...
func (self class) SetTraversableOutlines(traversable_outlines gd.Array)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(traversable_outlines))
	var r_ret callframe.Nil
...
func (self class) SetObstructionOutlines(obstruction_outlines gd.Array)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(obstruction_outlines))
	var r_ret callframe.Nil
...
func (self class) AddTraversableOutline(shape_outline gd.PackedVector2Array)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(shape_outline))
	var r_ret callframe.Nil
...
func (self class) Merge(other_geometry gdclass.NavigationMeshSourceGeometryData2D)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(other_geometry[0])[0])
	var r_ret callframe.Nil
...
func (self class) SetProjectedObstructions(projected_obstructions gd.Array)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(projected_obstructions))
	var r_ret callframe.Nil
...
func init() {classdb.Register("NavigationMeshSourceGeometryData2D", func(ptr gd.Object) any { return classdb.NavigationMeshSourceGeometryData2D(ptr) })}
