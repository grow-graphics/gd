...
*/
func (self Instance) GetDevice(index int) gdclass.UPNPDevice {
...
*/
func (self Instance) AddDevice(device gdclass.UPNPDevice) {
...
*/
func (self Instance) SetDevice(index int, device gdclass.UPNPDevice) {
...
*/
func (self Instance) GetGateway() gdclass.UPNPDevice {
