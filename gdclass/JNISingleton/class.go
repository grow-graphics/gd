...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("JNISingleton"))
...
func init() {classdb.Register("JNISingleton", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
