...
func New() Go {
	...
	return Go{classdb.GLTFAccessor(object)}
}
...
func (self class) GetMin() gd.PackedFloat64Array {
	...
	var ret = discreet.New[gd.PackedFloat64Array](r_ret.Get())
	frame.Free()
	return ret
}
//go:nosplit
...
func init() {classdb.Register("GLTFAccessor", func(ptr gd.Object) any { return classdb.GLTFAccessor(ptr) })}
