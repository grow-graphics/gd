...
*/
func (self Instance) AddFocusable(control gdclass.Control) {
...
*/
func (self Instance) SetBottomEditor(editor gdclass.Control) {
...
func (self Instance) OnResourceSelected(cb func(path string, resource gdclass.Resource)) {
