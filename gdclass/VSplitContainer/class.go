...
*/
type Go [1]classdb.VSplitContainer
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VSplitContainer"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsVSplitContainer() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsVSplitContainer() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("VSplitContainer", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
