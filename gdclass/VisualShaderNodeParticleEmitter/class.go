...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeParticleEmitter(object)}
}
...
func init() {classdb.Register("VisualShaderNodeParticleEmitter", func(ptr gd.Object) any { return classdb.VisualShaderNodeParticleEmitter(ptr) })}
