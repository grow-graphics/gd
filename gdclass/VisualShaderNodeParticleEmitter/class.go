...
*/
type Go [1]classdb.VisualShaderNodeParticleEmitter
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeParticleEmitter"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self Go) Mode2d() bool {
	gc := gd.GarbageCollector(); _ = gc
		return bool(class(self).IsMode2d())
}

func (self Go) SetMode2d(value bool) {
	gc := gd.GarbageCollector(); _ = gc
...
func (self class) AsVisualShaderNodeParticleEmitter() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsVisualShaderNodeParticleEmitter() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("VisualShaderNodeParticleEmitter", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
