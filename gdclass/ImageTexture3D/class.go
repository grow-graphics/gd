...
*/
func (self Go) Create(format classdb.ImageFormat, width int, height int, depth int, use_mipmaps bool, data gd.ArrayOf[gdclass.Image]) gd.Error {
...
*/
func (self Go) Update(data gd.ArrayOf[gdclass.Image]) {
	gc := gd.GarbageCollector(); _ = gc
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ImageTexture3D"))
...
*/
//go:nosplit
func (self class) Create(format classdb.ImageFormat, width gd.Int, height gd.Int, depth gd.Int, use_mipmaps bool, data gd.ArrayOf[gdclass.Image]) int64 {
...
*/
//go:nosplit
func (self class) Update(data gd.ArrayOf[gdclass.Image])  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(data))
...
func init() {classdb.Register("ImageTexture3D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
