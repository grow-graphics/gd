...
*/
type Instance [1]classdb.AudioStreamPlayer3D
...
*/
func (self Instance) GetStreamPlayback() gdclass.AudioStreamPlayback {
...
func (self Instance) Stream() gdclass.AudioStream {
	return gdclass.AudioStream(class(self).GetStream())
}

func (self Instance) SetStream(value gdclass.AudioStream) {
	class(self).SetStream(value)
}

func (self Instance) AttenuationModel() classdb.AudioStreamPlayer3DAttenuationModel {
	return classdb.AudioStreamPlayer3DAttenuationModel(class(self).GetAttenuationModel())
}

func (self Instance) SetAttenuationModel(value classdb.AudioStreamPlayer3DAttenuationModel) {
...
func (self Instance) DopplerTracking() classdb.AudioStreamPlayer3DDopplerTracking {
	return classdb.AudioStreamPlayer3DDopplerTracking(class(self).GetDopplerTracking())
}

func (self Instance) SetDopplerTracking(value classdb.AudioStreamPlayer3DDopplerTracking) {
