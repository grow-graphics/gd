...
func New() Go {
	...
	return Go{classdb.NavigationMeshSourceGeometryData3D(object)}
}
...
func (self class) AddMeshArray(mesh_array gd.Array, xform gd.Transform3D)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(mesh_array))
	callframe.Arg(frame, xform)
	var r_ret callframe.Nil
...
func (self class) AddFaces(faces gd.PackedVector3Array, xform gd.Transform3D)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(faces))
	callframe.Arg(frame, xform)
	var r_ret callframe.Nil
...
func init() {classdb.Register("NavigationMeshSourceGeometryData3D", func(ptr gd.Object) any { return classdb.NavigationMeshSourceGeometryData3D(ptr) })}
