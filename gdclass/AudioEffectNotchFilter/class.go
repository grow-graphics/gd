...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("AudioEffectNotchFilter"))
...
func init() {classdb.Register("AudioEffectNotchFilter", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
