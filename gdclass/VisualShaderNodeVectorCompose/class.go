...
*/
type Go [1]classdb.VisualShaderNodeVectorCompose
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeVectorCompose"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsVisualShaderNodeVectorCompose() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsVisualShaderNodeVectorCompose() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("VisualShaderNodeVectorCompose", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
