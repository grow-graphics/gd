...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeVectorCompose(object)}
}
...
func init() {classdb.Register("VisualShaderNodeVectorCompose", func(ptr gd.Object) any { return classdb.VisualShaderNodeVectorCompose(ptr) })}
