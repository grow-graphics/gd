...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ResourceImporterTexture"))
...
func init() {classdb.Register("ResourceImporterTexture", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
