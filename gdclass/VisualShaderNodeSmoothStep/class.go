...
*/
type Go [1]classdb.VisualShaderNodeSmoothStep
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeSmoothStep"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self Go) OpType() classdb.VisualShaderNodeSmoothStepOpType {
	gc := gd.GarbageCollector(); _ = gc
		return classdb.VisualShaderNodeSmoothStepOpType(class(self).GetOpType())
}

func (self Go) SetOpType(value classdb.VisualShaderNodeSmoothStepOpType) {
	gc := gd.GarbageCollector(); _ = gc
...
func (self class) AsVisualShaderNodeSmoothStep() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsVisualShaderNodeSmoothStep() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("VisualShaderNodeSmoothStep", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
