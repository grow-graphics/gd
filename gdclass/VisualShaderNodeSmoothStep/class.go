...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeSmoothStep(object)}
}
...
func init() {classdb.Register("VisualShaderNodeSmoothStep", func(ptr gd.Object) any { return classdb.VisualShaderNodeSmoothStep(ptr) })}
