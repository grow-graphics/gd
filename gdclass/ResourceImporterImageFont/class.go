...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ResourceImporterImageFont"))
...
func init() {classdb.Register("ResourceImporterImageFont", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
