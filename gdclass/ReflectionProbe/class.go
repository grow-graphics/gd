...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ReflectionProbe"))
...
func init() {classdb.Register("ReflectionProbe", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
