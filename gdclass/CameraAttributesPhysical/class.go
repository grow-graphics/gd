...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("CameraAttributesPhysical"))
...
func init() {classdb.Register("CameraAttributesPhysical", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
