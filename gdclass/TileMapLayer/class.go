...
[b]Note:[/b] If the properties of [param tile_data] object should change over time, use [method notify_runtime_tile_data_update] to notify the [TileMapLayer] it needs an update.
*/
func (Instance) _tile_data_runtime_update(impl func(ptr unsafe.Pointer, coords gd.Vector2i, tile_data gdclass.TileData)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var coords = gd.UnsafeGet[gd.Vector2i](p_args, 0)
		var tile_data = gdclass.TileData{pointers.New[classdb.TileData]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
[/codeblock]
*/
func (self Instance) GetCellTileData(coords gd.Vector2i) gdclass.TileData {
...
*/
func (self Instance) GetPattern(coords_array gd.Array) gdclass.TileMapPattern {
...
*/
func (self Instance) SetPattern(position gd.Vector2i, pattern gdclass.TileMapPattern) {
...
*/
func (self Instance) MapPattern(position_in_tilemap gd.Vector2i, coords_in_pattern gd.Vector2i, pattern gdclass.TileMapPattern) gd.Vector2i {
...
func (self Instance) TileSet() gdclass.TileSet {
	return gdclass.TileSet(class(self).GetTileSet())
}

func (self Instance) SetTileSet(value gdclass.TileSet) {
...
[b]Note:[/b] If the properties of [param tile_data] object should change over time, use [method notify_runtime_tile_data_update] to notify the [TileMapLayer] it needs an update.
*/
func (class) _tile_data_runtime_update(impl func(ptr unsafe.Pointer, coords gd.Vector2i, tile_data gdclass.TileData)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var coords = gd.UnsafeGet[gd.Vector2i](p_args, 0)
		var tile_data = gdclass.TileData{pointers.New[classdb.TileData]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
		defer pointers.End(tile_data[0])
