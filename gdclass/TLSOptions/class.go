...
*/
func (self Instance) Client() gdclass.TLSOptions {
...
[b]Note:[/b] On the Web platform, TLS verification is always enforced against the CA list of the web browser. This is considered a security feature.
*/
func (self Instance) ClientUnsafe() gdclass.TLSOptions {
...
*/
func (self Instance) Server(key gdclass.CryptoKey, certificate gdclass.X509Certificate) gdclass.TLSOptions {
...
*/
func (self Instance) GetTrustedCaChain() gdclass.X509Certificate {
...
*/
func (self Instance) GetPrivateKey() gdclass.CryptoKey {
...
*/
func (self Instance) GetOwnCertificate() gdclass.X509Certificate {
