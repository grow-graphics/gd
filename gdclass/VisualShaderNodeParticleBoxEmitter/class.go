...
*/
type Go [1]classdb.VisualShaderNodeParticleBoxEmitter
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeParticleBoxEmitter"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsVisualShaderNodeParticleBoxEmitter() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsVisualShaderNodeParticleBoxEmitter() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("VisualShaderNodeParticleBoxEmitter", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
