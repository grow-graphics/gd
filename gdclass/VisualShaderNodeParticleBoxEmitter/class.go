...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeParticleBoxEmitter(object)}
}
...
func init() {classdb.Register("VisualShaderNodeParticleBoxEmitter", func(ptr gd.Object) any { return classdb.VisualShaderNodeParticleBoxEmitter(ptr) })}
