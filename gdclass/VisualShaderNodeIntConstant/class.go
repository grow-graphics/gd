...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeIntConstant"))
...
func init() {classdb.Register("VisualShaderNodeIntConstant", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
