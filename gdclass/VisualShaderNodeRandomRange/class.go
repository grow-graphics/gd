...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeRandomRange"))
...
func init() {classdb.Register("VisualShaderNodeRandomRange", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
