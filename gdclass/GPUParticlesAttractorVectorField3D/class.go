...
*/
type Instance [1]classdb.GPUParticlesAttractorVectorField3D
...
func New() Instance {
	...
	return Instance{classdb.GPUParticlesAttractorVectorField3D(object)}
}
...
func (self Instance) Texture() gdclass.Texture3D {
	return gdclass.Texture3D(class(self).GetTexture())
}

func (self Instance) SetTexture(value gdclass.Texture3D) {
...
func init() {
	classdb.Register("GPUParticlesAttractorVectorField3D", func(ptr gd.Object) any { return classdb.GPUParticlesAttractorVectorField3D(ptr) })
}
