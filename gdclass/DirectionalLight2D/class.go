...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("DirectionalLight2D"))
...
func init() {classdb.Register("DirectionalLight2D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
