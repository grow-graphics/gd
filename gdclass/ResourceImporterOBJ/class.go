...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ResourceImporterOBJ"))
...
func init() {classdb.Register("ResourceImporterOBJ", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
