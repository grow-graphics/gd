...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("QuadMesh"))
...
func init() {classdb.Register("QuadMesh", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
