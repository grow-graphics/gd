...
func (self Instance) DiffuseTexture() gdclass.Texture2D {
	return gdclass.Texture2D(class(self).GetDiffuseTexture())
}

func (self Instance) SetDiffuseTexture(value gdclass.Texture2D) {
...
func (self Instance) SpecularTexture() gdclass.Texture2D {
	return gdclass.Texture2D(class(self).GetSpecularTexture())
}

func (self Instance) SetSpecularTexture(value gdclass.Texture2D) {
