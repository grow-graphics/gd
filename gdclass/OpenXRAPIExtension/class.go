...
*/
func (self Instance) RegisterCompositionLayerProvider(extension gdclass.OpenXRExtensionWrapperExtension) {
...
*/
func (self Instance) UnregisterCompositionLayerProvider(extension gdclass.OpenXRExtensionWrapperExtension) {
