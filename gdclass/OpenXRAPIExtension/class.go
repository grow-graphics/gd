...
func New() Go {
	...
	return Go{classdb.OpenXRAPIExtension(object)}
}
...
func (self class) XrResult(result gd.Int, format gd.String, args gd.Array) bool {
	...
	callframe.Arg(frame, discreet.Get(format))
...
func (self class) RegisterCompositionLayerProvider(extension gdclass.OpenXRExtensionWrapperExtension)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(extension[0])[0])
...
func init() {classdb.Register("OpenXRAPIExtension", func(ptr gd.Object) any { return classdb.OpenXRAPIExtension(ptr) })}
