...
*/
func (self Instance) CreateFromImageAlpha(image gdclass.Image) {
...
*/
func (self Instance) ConvertToImage() gdclass.Image {
	return gdclass.Image(class(self).ConvertToImage())
}
...
func New() Instance {
	...
	return Instance{classdb.BitMap(object)}
}
...
*/
//go:nosplit
func (self class) ConvertToImage() gdclass.Image {
	var frame = callframe.New()
...
func init() { classdb.Register("BitMap", func(ptr gd.Object) any { return classdb.BitMap(ptr) }) }
