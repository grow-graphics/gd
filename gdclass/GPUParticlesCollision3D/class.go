...
func New() Go {
	...
	return Go{classdb.GPUParticlesCollision3D(object)}
}
...
func init() {classdb.Register("GPUParticlesCollision3D", func(ptr gd.Object) any { return classdb.GPUParticlesCollision3D(ptr) })}
