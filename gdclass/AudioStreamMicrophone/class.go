...
func New() Go {
	...
	return Go{classdb.AudioStreamMicrophone(object)}
}
...
func init() {classdb.Register("AudioStreamMicrophone", func(ptr gd.Object) any { return classdb.AudioStreamMicrophone(ptr) })}
