...
*/
type Go [1]classdb.AudioStreamMicrophone
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("AudioStreamMicrophone"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsAudioStreamMicrophone() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsAudioStreamMicrophone() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("AudioStreamMicrophone", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
