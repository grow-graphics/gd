...
*/
type Go [1]classdb.VisualShaderNodeIntOp
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeIntOp"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self Go) Operator() classdb.VisualShaderNodeIntOpOperator {
	gc := gd.GarbageCollector(); _ = gc
		return classdb.VisualShaderNodeIntOpOperator(class(self).GetOperator())
}

func (self Go) SetOperator(value classdb.VisualShaderNodeIntOpOperator) {
	gc := gd.GarbageCollector(); _ = gc
...
func (self class) AsVisualShaderNodeIntOp() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsVisualShaderNodeIntOp() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("VisualShaderNodeIntOp", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
