...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeIntOp(object)}
}
...
func init() {classdb.Register("VisualShaderNodeIntOp", func(ptr gd.Object) any { return classdb.VisualShaderNodeIntOp(ptr) })}
