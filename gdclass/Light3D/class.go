...
func (self Instance) LightProjector() gdclass.Texture2D {
	return gdclass.Texture2D(class(self).GetProjector())
}

func (self Instance) SetLightProjector(value gdclass.Texture2D) {
...
//go:nosplit
func (self class) GetProjector() gdclass.Texture2D {
	var frame = callframe.New()
