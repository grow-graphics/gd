...
[b]Note:[/b] Event position is relative to the control origin.
*/
func (Instance) _gui_input(impl func(ptr unsafe.Pointer, event gdclass.InputEvent)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
...
*/
func (self Instance) FindPrevValidFocus() gdclass.Control {
...
*/
func (self Instance) FindNextValidFocus() gdclass.Control {
...
*/
func (self Instance) FindValidFocusNeighbor(side gdconst.Side) gdclass.Control {
...
*/
func (self Instance) GetParentControl() gdclass.Control {
...
*/
func (self Instance) ForceDrag(data gd.Variant, preview gdclass.Control) {
...
[/codeblocks]
*/
func (self Instance) SetDragPreview(control gdclass.Control) {
...
func (self Instance) ShortcutContext() gdclass.Node {
	return gdclass.Node(class(self).GetShortcutContext())
}

func (self Instance) SetShortcutContext(value gdclass.Node) {
...
[b]Note:[/b] Event position is relative to the control origin.
*/
func (class) _gui_input(impl func(ptr unsafe.Pointer, event gdclass.InputEvent)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var event = gdclass.InputEvent{pointers.New[classdb.InputEvent]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(event[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
*/
//go:nosplit
func (self class) FindValidFocusNeighbor(side gdconst.Side) gdclass.Control {
	var frame = callframe.New()
	callframe.Arg(frame, side)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func (self Instance) OnGuiInput(cb func(event gdclass.InputEvent)) {
