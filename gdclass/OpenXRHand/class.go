...
func New() Go {
	...
	return Go{classdb.OpenXRHand(object)}
}
...
func (self class) SetHandSkeleton(hand_skeleton gd.NodePath)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(hand_skeleton))
	var r_ret callframe.Nil
...
func init() {classdb.Register("OpenXRHand", func(ptr gd.Object) any { return classdb.OpenXRHand(ptr) })}
