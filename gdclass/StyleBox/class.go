...
*/
func (self Instance) GetCurrentItemDrawn() gdclass.CanvasItem {
	return gdclass.CanvasItem(class(self).GetCurrentItemDrawn())
}
...
*/
//go:nosplit
func (self class) GetCurrentItemDrawn() gdclass.CanvasItem {
	var frame = callframe.New()
	...
	var ret = gdclass.CanvasItem{classdb.CanvasItem(gd.PointerMustAssertInstanceID(r_ret.Get()))}
	frame.Free()
	return ret
}
