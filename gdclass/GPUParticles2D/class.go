...
*/
func (self Instance) CaptureRect() gd.Rect2 {
...
*/
func (self Instance) EmitParticle(xform gd.Transform2D, velocity gd.Vector2, color gd.Color, custom gd.Color, flags int) {
...
func New() Instance {
	...
	return Instance{classdb.GPUParticles2D(object)}
}
...
func (self Instance) VisibilityRect() gd.Rect2 {
	return gd.Rect2(class(self).GetVisibilityRect())
}

func (self Instance) SetVisibilityRect(value gd.Rect2) {
