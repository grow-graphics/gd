...
*/
type Go [1]classdb.Texture2DArrayRD
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("Texture2DArrayRD"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsTexture2DArrayRD() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsTexture2DArrayRD() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("Texture2DArrayRD", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
