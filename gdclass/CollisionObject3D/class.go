...
[b]Note:[/b] [method _input_event] requires [member input_ray_pickable] to be [code]true[/code] and at least one [member collision_layer] bit to be set.
*/
func (Instance) _input_event(impl func(ptr unsafe.Pointer, camera gdclass.Camera3D, event gdclass.InputEvent, event_position gd.Vector3, normal gd.Vector3, shape_idx int)) (cb gd.ExtensionClassCallVirtualFunc) {
...
*/
func (self Instance) ShapeOwnerAddShape(owner_id int, shape gdclass.Shape3D) {
...
*/
func (self Instance) ShapeOwnerGetShape(owner_id int, shape_id int) gdclass.Shape3D {
	return gdclass.Shape3D(class(self).ShapeOwnerGetShape(gd.Int(owner_id), gd.Int(shape_id)))
}
...
[b]Note:[/b] [method _input_event] requires [member input_ray_pickable] to be [code]true[/code] and at least one [member collision_layer] bit to be set.
*/
func (class) _input_event(impl func(ptr unsafe.Pointer, camera gdclass.Camera3D, event gdclass.InputEvent, event_position gd.Vector3, normal gd.Vector3, shape_idx gd.Int)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var camera = gdclass.Camera3D{pointers.New[classdb.Camera3D]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(camera[0])
		var event = gdclass.InputEvent{pointers.New[classdb.InputEvent]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
*/
//go:nosplit
func (self class) ShapeOwnerGetShape(owner_id gd.Int, shape_id gd.Int) gdclass.Shape3D {
	var frame = callframe.New()
	callframe.Arg(frame, owner_id)
...
func (self Instance) OnInputEvent(cb func(camera gdclass.Node, event gdclass.InputEvent, event_position gd.Vector3, normal gd.Vector3, shape_idx int)) {
