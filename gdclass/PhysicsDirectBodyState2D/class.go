...
*/
func (self Instance) GetSpaceState() gdclass.PhysicsDirectSpaceState2D {
...
func init() {
	classdb.Register("PhysicsDirectBodyState2D", func(ptr gd.Object) any { return classdb.PhysicsDirectBodyState2D(ptr) })
}
