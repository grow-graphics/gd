...
func (self Go) GetSpaceState() gdclass.PhysicsDirectSpaceState2D {
	return gdclass.PhysicsDirectSpaceState2D(class(self).GetSpaceState())
}
...
func New() Go {
	...
	return Go{classdb.PhysicsDirectBodyState2D(object)}
}
...
*/
//go:nosplit
func (self class) GetSpaceState() gdclass.PhysicsDirectSpaceState2D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func init() {classdb.Register("PhysicsDirectBodyState2D", func(ptr gd.Object) any { return classdb.PhysicsDirectBodyState2D(ptr) })}
