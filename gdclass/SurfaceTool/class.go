...
*/
func (self Instance) SetMaterial(material gdclass.Material) {
...
*/
func (self Instance) CreateFrom(existing gdclass.Mesh, surface int) {
...
*/
func (self Instance) CreateFromBlendShape(existing gdclass.Mesh, surface int, blend_shape string) {
...
*/
func (self Instance) AppendFrom(existing gdclass.Mesh, surface int, transform gd.Transform3D) {
...
*/
func (self Instance) Commit() gdclass.ArrayMesh {
