...
*/
func (self Instance) SetDropcap(text string, font gdclass.Font, font_size int) bool {
...
*/
func (self Instance) AddString(text string, font gdclass.Font, font_size int) bool {
