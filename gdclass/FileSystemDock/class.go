...
*/
func (self Instance) AddResourceTooltipPlugin(plugin gdclass.EditorResourceTooltipPlugin) {
...
*/
func (self Instance) RemoveResourceTooltipPlugin(plugin gdclass.EditorResourceTooltipPlugin) {
...
func (self Instance) OnResourceRemoved(cb func(resource gdclass.Resource)) {
