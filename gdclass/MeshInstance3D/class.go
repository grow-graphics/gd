...
*/
func (self Instance) GetSkinReference() gdclass.SkinReference {
...
*/
func (self Instance) SetSurfaceOverrideMaterial(surface int, material gdclass.Material) {
...
*/
func (self Instance) GetSurfaceOverrideMaterial(surface int) gdclass.Material {
...
*/
func (self Instance) GetActiveMaterial(surface int) gdclass.Material {
...
*/
func (self Instance) BakeMeshFromCurrentBlendShapeMix() gdclass.ArrayMesh {
