...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeParticleRingEmitter"))
...
func init() {classdb.Register("VisualShaderNodeParticleRingEmitter", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
