...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeTextureParameterTriplanar"))
...
func init() {classdb.Register("VisualShaderNodeTextureParameterTriplanar", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
