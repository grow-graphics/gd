...
func GetFeed(index int) gdclass.CameraFeed {
	once.Do(singleton)
	return gdclass.CameraFeed(class(self).GetFeed(gd.Int(index)))
}
...
*/
//go:nosplit
func (self class) GetFeed(index gd.Int) gdclass.CameraFeed {
	...
	var ret = gdclass.CameraFeed{classdb.CameraFeed(gd.PointerWithOwnershipTransferredToGo(r_ret.Get()))}
	frame.Free()
	return ret
}
/*
...
func (self class) AddFeed(feed gdclass.CameraFeed)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(feed[0])[0])
...
func init() {classdb.Register("CameraServer", func(ptr gd.Object) any { return classdb.CameraServer(ptr) })}
