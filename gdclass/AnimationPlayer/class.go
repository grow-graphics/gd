...
func New() Go {
	...
	return Go{classdb.AnimationPlayer(object)}
}
...
func (self class) AnimationSetNext(animation_from gd.StringName, animation_to gd.StringName)  {
	...
	callframe.Arg(frame, discreet.Get(animation_from))
	callframe.Arg(frame, discreet.Get(animation_to))
...
func init() {classdb.Register("AnimationPlayer", func(ptr gd.Object) any { return classdb.AnimationPlayer(ptr) })}
