...
*/
func (self Instance) SetSlotCustomIconLeft(slot_index int, custom_icon gdclass.Texture2D) {
...
*/
func (self Instance) GetSlotCustomIconLeft(slot_index int) gdclass.Texture2D {
...
*/
func (self Instance) SetSlotCustomIconRight(slot_index int, custom_icon gdclass.Texture2D) {
...
*/
func (self Instance) GetSlotCustomIconRight(slot_index int) gdclass.Texture2D {
