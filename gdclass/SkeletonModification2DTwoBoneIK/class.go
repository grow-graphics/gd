...
func New() Go {
	...
	return Go{classdb.SkeletonModification2DTwoBoneIK(object)}
}
...
func (self class) SetJointOneBone2dNode(bone2d_node gd.NodePath)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(bone2d_node))
	var r_ret callframe.Nil
...
func init() {classdb.Register("SkeletonModification2DTwoBoneIK", func(ptr gd.Object) any { return classdb.SkeletonModification2DTwoBoneIK(ptr) })}
