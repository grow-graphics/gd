...
*/
func (self Instance) SetHeldModificationStack(held_modification_stack gdclass.SkeletonModificationStack2D) {
...
*/
func (self Instance) GetHeldModificationStack() gdclass.SkeletonModificationStack2D {
