...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeBooleanConstant"))
...
func init() {classdb.Register("VisualShaderNodeBooleanConstant", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
