...
*/
func (self Instance) AcceptStream(stream gdclass.StreamPeer, server_options gdclass.TLSOptions) gd.Error {
...
*/
func (self Instance) ConnectToStream(stream gdclass.StreamPeer, common_name string) gd.Error {
...
*/
func (self Instance) GetStream() gdclass.StreamPeer {
