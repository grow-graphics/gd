...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("HSlider"))
...
func init() {classdb.Register("HSlider", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
