...
func New() Go {
	...
	return Go{classdb.NavigationPathQueryParameters3D(object)}
}
...
func init() {classdb.Register("NavigationPathQueryParameters3D", func(ptr gd.Object) any { return classdb.NavigationPathQueryParameters3D(ptr) })}
