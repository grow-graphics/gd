...
*/
var self gdclass.PhysicsServer2DManager
var once sync.Once
func singleton() {
	gc := gd.Static
	obj := gc.API.Object.GetSingleton(gc, gc.API.Singletons.PhysicsServer2DManager)
	self = *(*gdclass.PhysicsServer2DManager)(unsafe.Pointer(&obj))
}
...
func init() {classdb.Register("PhysicsServer2DManager", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
