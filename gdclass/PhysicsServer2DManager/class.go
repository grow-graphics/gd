...
func (self class) RegisterServer(name gd.String, create_callback gd.Callable)  {
	...
	callframe.Arg(frame, discreet.Get(create_callback))
...
func init() {classdb.Register("PhysicsServer2DManager", func(ptr gd.Object) any { return classdb.PhysicsServer2DManager(ptr) })}
