...
*/
type Go [1]classdb.PlaceholderTexture2D
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("PlaceholderTexture2D"))
...
func (self class) AsPlaceholderTexture2D() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsPlaceholderTexture2D() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("PlaceholderTexture2D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
