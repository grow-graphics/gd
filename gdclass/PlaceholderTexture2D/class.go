...
func New() Go {
	...
	return Go{classdb.PlaceholderTexture2D(object)}
}
...
func init() {classdb.Register("PlaceholderTexture2D", func(ptr gd.Object) any { return classdb.PlaceholderTexture2D(ptr) })}
