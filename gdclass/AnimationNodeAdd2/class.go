...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("AnimationNodeAdd2"))
...
func init() {classdb.Register("AnimationNodeAdd2", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
