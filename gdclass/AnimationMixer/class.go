...
A virtual function for processing after getting a key during playback.
*/
func (Instance) _post_process_key_value(impl func(ptr unsafe.Pointer, animation gdclass.Animation, track int, value gd.Variant, object_id int, object_sub_idx int) gd.Variant) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var animation = gdclass.Animation{pointers.New[classdb.Animation]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
...
[/codeblocks]
*/
func (self Instance) AddAnimationLibrary(name string, library gdclass.AnimationLibrary) gd.Error {
...
*/
func (self Instance) GetAnimationLibrary(name string) gdclass.AnimationLibrary {
...
*/
func (self Instance) GetAnimation(name string) gdclass.Animation {
...
*/
func (self Instance) FindAnimation(animation gdclass.Animation) string {
...
*/
func (self Instance) FindAnimationLibrary(animation gdclass.Animation) string {
...
A virtual function for processing after getting a key during playback.
*/
func (class) _post_process_key_value(impl func(ptr unsafe.Pointer, animation gdclass.Animation, track gd.Int, value gd.Variant, object_id gd.Int, object_sub_idx gd.Int) gd.Variant) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var animation = gdclass.Animation{pointers.New[classdb.Animation]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(animation[0])
		var track = gd.UnsafeGet[gd.Int](p_args, 1)
