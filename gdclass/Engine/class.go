...
func GetMainLoop() gdclass.MainLoop {
	once.Do(singleton)
	return gdclass.MainLoop(class(self).GetMainLoop())
}
...
func GetScriptLanguage(index int) gdclass.ScriptLanguage {
	once.Do(singleton)
	return gdclass.ScriptLanguage(class(self).GetScriptLanguage(gd.Int(index)))
}
...
*/
//go:nosplit
func (self class) GetMainLoop() gdclass.MainLoop {
	var frame = callframe.New()
	...
	var ret = gdclass.MainLoop{classdb.MainLoop(gd.PointerLifetimeBoundTo(self.AsObject(), r_ret.Get()))}
	frame.Free()
	return ret
}
/*
...
*/
//go:nosplit
func (self class) GetScriptLanguage(index gd.Int) gdclass.ScriptLanguage {
	var frame = callframe.New()
	...
	var ret = gdclass.ScriptLanguage{classdb.ScriptLanguage(gd.PointerMustAssertInstanceID(r_ret.Get()))}
	frame.Free()
	return ret
}
/*
