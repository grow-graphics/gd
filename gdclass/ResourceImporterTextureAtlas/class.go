...
func New() Go {
	...
	return Go{classdb.ResourceImporterTextureAtlas(object)}
}
...
func init() {classdb.Register("ResourceImporterTextureAtlas", func(ptr gd.Object) any { return classdb.ResourceImporterTextureAtlas(ptr) })}
