...
*/
func ComputeConvexMeshPoints(planes gd.Array) []gd.Vector3 {
	once.Do(singleton)
	return []gd.Vector3(class(self).ComputeConvexMeshPoints(planes).AsSlice())
}
...
*/
func BuildBoxPlanes(extents gd.Vector3) gd.Array {
	once.Do(singleton)
	return gd.Array(class(self).BuildBoxPlanes(extents))
}
...
*/
func BuildCylinderPlanes(radius float64, height float64, sides int) gd.Array {
	once.Do(singleton)
...
*/
func BuildCapsulePlanes(radius float64, height float64, sides int, lats int) gd.Array {
	once.Do(singleton)
...
func GetClosestPointsBetweenSegments(p1 gd.Vector3, p2 gd.Vector3, q1 gd.Vector3, q2 gd.Vector3) []gd.Vector3 {
	once.Do(singleton)
	return []gd.Vector3(class(self).GetClosestPointsBetweenSegments(p1, p2, q1, q2).AsSlice())
}
...
func RayIntersectsTriangle(from gd.Vector3, dir gd.Vector3, a gd.Vector3, b gd.Vector3, c gd.Vector3) gd.Variant {
	once.Do(singleton)
	return gd.Variant(class(self).RayIntersectsTriangle(from, dir, a, b, c))
}
...
func SegmentIntersectsTriangle(from gd.Vector3, to gd.Vector3, a gd.Vector3, b gd.Vector3, c gd.Vector3) gd.Variant {
	once.Do(singleton)
	return gd.Variant(class(self).SegmentIntersectsTriangle(from, to, a, b, c))
}
...
func SegmentIntersectsSphere(from gd.Vector3, to gd.Vector3, sphere_position gd.Vector3, sphere_radius float64) []gd.Vector3 {
	once.Do(singleton)
	return []gd.Vector3(class(self).SegmentIntersectsSphere(from, to, sphere_position, gd.Float(sphere_radius)).AsSlice())
}
...
func SegmentIntersectsCylinder(from gd.Vector3, to gd.Vector3, height float64, radius float64) []gd.Vector3 {
	once.Do(singleton)
	return []gd.Vector3(class(self).SegmentIntersectsCylinder(from, to, gd.Float(height), gd.Float(radius)).AsSlice())
}
...
*/
func SegmentIntersectsConvex(from gd.Vector3, to gd.Vector3, planes gd.Array) []gd.Vector3 {
	once.Do(singleton)
	return []gd.Vector3(class(self).SegmentIntersectsConvex(from, to, planes).AsSlice())
}
...
func ClipPolygon(points []gd.Vector3, plane gd.Plane) []gd.Vector3 {
	once.Do(singleton)
	return []gd.Vector3(class(self).ClipPolygon(gd.NewPackedVector3Slice(points), plane).AsSlice())
}
...
func TetrahedralizeDelaunay(points []gd.Vector3) []int32 {
	once.Do(singleton)
	return []int32(class(self).TetrahedralizeDelaunay(gd.NewPackedVector3Slice(points)).AsSlice())
}
...
func (self class) ComputeConvexMeshPoints(planes gd.Array) gd.PackedVector3Array {
	...
	callframe.Arg(frame, discreet.Get(planes))
	var r_ret = callframe.Ret[[2]uintptr](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_compute_convex_mesh_points, self.AsObject(), frame.Array(0), r_ret.Uintptr())
...
func (self class) BuildBoxPlanes(extents gd.Vector3) gd.Array {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_build_box_planes, self.AsObject(), frame.Array(0), r_ret.Uintptr())
...
func (self class) BuildCylinderPlanes(radius gd.Float, height gd.Float, sides gd.Int, axis gd.Vector3Axis) gd.Array {
	...
	var r_ret = callframe.Ret[[1]uintptr](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_build_cylinder_planes, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = discreet.New[gd.Array](r_ret.Get())
	frame.Free()
	return ret
}
...
func (self class) BuildCapsulePlanes(radius gd.Float, height gd.Float, sides gd.Int, lats gd.Int, axis gd.Vector3Axis) gd.Array {
	...
	callframe.Arg(frame, axis)
	var r_ret = callframe.Ret[[1]uintptr](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_build_capsule_planes, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = discreet.New[gd.Array](r_ret.Get())
	frame.Free()
	return ret
}
...
func (self class) GetClosestPointsBetweenSegments(p1 gd.Vector3, p2 gd.Vector3, q1 gd.Vector3, q2 gd.Vector3) gd.PackedVector3Array {
	...
	var r_ret = callframe.Ret[[2]uintptr](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_get_closest_points_between_segments, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = discreet.New[gd.PackedVector3Array](r_ret.Get())
	frame.Free()
	return ret
}
...
func (self class) GetClosestPointToSegment(point gd.Vector3, s1 gd.Vector3, s2 gd.Vector3) gd.Vector3 {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_get_closest_point_to_segment, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
func (self class) GetClosestPointToSegmentUncapped(point gd.Vector3, s1 gd.Vector3, s2 gd.Vector3) gd.Vector3 {
	...
	callframe.Arg(frame, s2)
	var r_ret = callframe.Ret[gd.Vector3](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_get_closest_point_to_segment_uncapped, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
func (self class) GetTriangleBarycentricCoords(point gd.Vector3, a gd.Vector3, b gd.Vector3, c gd.Vector3) gd.Vector3 {
	...
	var r_ret = callframe.Ret[gd.Vector3](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_get_triangle_barycentric_coords, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
func (self class) RayIntersectsTriangle(from gd.Vector3, dir gd.Vector3, a gd.Vector3, b gd.Vector3, c gd.Vector3) gd.Variant {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_ray_intersects_triangle, self.AsObject(), frame.Array(0), r_ret.Uintptr())
...
func (self class) SegmentIntersectsTriangle(from gd.Vector3, to gd.Vector3, a gd.Vector3, b gd.Vector3, c gd.Vector3) gd.Variant {
	...
	callframe.Arg(frame, c)
	var r_ret = callframe.Ret[[3]uintptr](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_segment_intersects_triangle, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = discreet.New[gd.Variant](r_ret.Get())
	frame.Free()
	return ret
}
...
func (self class) SegmentIntersectsSphere(from gd.Vector3, to gd.Vector3, sphere_position gd.Vector3, sphere_radius gd.Float) gd.PackedVector3Array {
	...
	var r_ret = callframe.Ret[[2]uintptr](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_segment_intersects_sphere, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = discreet.New[gd.PackedVector3Array](r_ret.Get())
	frame.Free()
	return ret
}
...
func (self class) SegmentIntersectsCylinder(from gd.Vector3, to gd.Vector3, height gd.Float, radius gd.Float) gd.PackedVector3Array {
	...
	callframe.Arg(frame, radius)
	var r_ret = callframe.Ret[[2]uintptr](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_segment_intersects_cylinder, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = discreet.New[gd.PackedVector3Array](r_ret.Get())
	frame.Free()
	return ret
}
...
func (self class) SegmentIntersectsConvex(from gd.Vector3, to gd.Vector3, planes gd.Array) gd.PackedVector3Array {
	...
	callframe.Arg(frame, discreet.Get(planes))
	var r_ret = callframe.Ret[[2]uintptr](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_segment_intersects_convex, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = discreet.New[gd.PackedVector3Array](r_ret.Get())
	frame.Free()
	return ret
}
...
func (self class) ClipPolygon(points gd.PackedVector3Array, plane gd.Plane) gd.PackedVector3Array {
	...
	var r_ret = callframe.Ret[[2]uintptr](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_clip_polygon, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = discreet.New[gd.PackedVector3Array](r_ret.Get())
	frame.Free()
	return ret
}
...
func (self class) TetrahedralizeDelaunay(points gd.PackedVector3Array) gd.PackedInt32Array {
	...
	callframe.Arg(frame, discreet.Get(points))
	var r_ret = callframe.Ret[[2]uintptr](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.Geometry3D.Bind_tetrahedralize_delaunay, self.AsObject(), frame.Array(0), r_ret.Uintptr())
...
func init() {classdb.Register("Geometry3D", func(ptr gd.Object) any { return classdb.Geometry3D(ptr) })}
