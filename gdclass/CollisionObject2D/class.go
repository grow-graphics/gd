...
[b]Note:[/b] [method _input_event] requires [member input_pickable] to be [code]true[/code] and at least one [member collision_layer] bit to be set.
*/
func (Instance) _input_event(impl func(ptr unsafe.Pointer, viewport gdclass.Viewport, event gdclass.InputEvent, shape_idx int)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var viewport = gdclass.Viewport{pointers.New[classdb.Viewport]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
...
*/
func (self Instance) ShapeOwnerAddShape(owner_id int, shape gdclass.Shape2D) {
...
*/
func (self Instance) ShapeOwnerGetShape(owner_id int, shape_id int) gdclass.Shape2D {
	return gdclass.Shape2D(class(self).ShapeOwnerGetShape(gd.Int(owner_id), gd.Int(shape_id)))
}
...
[b]Note:[/b] [method _input_event] requires [member input_pickable] to be [code]true[/code] and at least one [member collision_layer] bit to be set.
*/
func (class) _input_event(impl func(ptr unsafe.Pointer, viewport gdclass.Viewport, event gdclass.InputEvent, shape_idx gd.Int)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var viewport = gdclass.Viewport{pointers.New[classdb.Viewport]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(viewport[0])
		var event = gdclass.InputEvent{pointers.New[classdb.InputEvent]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
*/
//go:nosplit
func (self class) ShapeOwnerGetShape(owner_id gd.Int, shape_id gd.Int) gdclass.Shape2D {
	var frame = callframe.New()
	callframe.Arg(frame, owner_id)
...
func (self Instance) OnInputEvent(cb func(viewport gdclass.Node, event gdclass.InputEvent, shape_idx int)) {
