...
func (Go) _input_event(impl func(ptr unsafe.Pointer, viewport gdclass.Viewport, event gdclass.InputEvent, shape_idx int) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var viewport = gdclass.Viewport{discreet.New[classdb.Viewport]([3]uintptr{gd.UnsafeGet[uintptr](p_args,0)})}
		defer discreet.End(viewport[0])
...
func New() Go {
	...
	return Go{classdb.CollisionObject2D(object)}
}
...
func init() {classdb.Register("CollisionObject2D", func(ptr gd.Object) any { return classdb.CollisionObject2D(ptr) })}
