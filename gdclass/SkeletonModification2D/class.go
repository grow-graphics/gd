...
Called when the modification is setup. This is where the modification performs initialization.
*/
func (Instance) _setup_modification(impl func(ptr unsafe.Pointer, modification_stack gdclass.SkeletonModificationStack2D)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var modification_stack = gdclass.SkeletonModificationStack2D{pointers.New[classdb.SkeletonModificationStack2D]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
...
*/
func (self Instance) GetModificationStack() gdclass.SkeletonModificationStack2D {
...
Called when the modification is setup. This is where the modification performs initialization.
*/
func (class) _setup_modification(impl func(ptr unsafe.Pointer, modification_stack gdclass.SkeletonModificationStack2D)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var modification_stack = gdclass.SkeletonModificationStack2D{pointers.New[classdb.SkeletonModificationStack2D]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(modification_stack[0])
		self := reflect.ValueOf(class).UnsafePointer()
