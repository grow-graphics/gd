...
func New() Go {
	...
	return Go{classdb.RenderSceneDataExtension(object)}
}
...
func init() {classdb.Register("RenderSceneDataExtension", func(ptr gd.Object) any { return classdb.RenderSceneDataExtension(ptr) })}
