...
[b]Note:[/b] If it was not possible to create the preview the [param receiver_func] will still be called, but the preview will be null.
*/
func (self Instance) QueueEditedResourcePreview(resource gdclass.Resource, receiver gd.Object, receiver_func string, userdata gd.Variant) {
...
*/
func (self Instance) AddPreviewGenerator(generator gdclass.EditorResourcePreviewGenerator) {
...
*/
func (self Instance) RemovePreviewGenerator(generator gdclass.EditorResourcePreviewGenerator) {
