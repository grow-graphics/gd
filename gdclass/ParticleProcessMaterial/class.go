...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ParticleProcessMaterial"))
...
func (self Go) EmissionPointTexture() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetEmissionPointTexture(gc))
}
...
func (self Go) EmissionNormalTexture() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetEmissionNormalTexture(gc))
}
...
func (self Go) EmissionColorTexture() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetEmissionColorTexture(gc))
}
...
func (self Go) AngleCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,7))
}
...
func (self Go) AngularVelocityCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,1))
}
...
func (self Go) DirectionalVelocityCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,16))
}
...
func (self Go) OrbitVelocityCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,2))
}
...
func (self Go) RadialVelocityCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,15))
}
...
func (self Go) VelocityLimitCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetVelocityLimitCurve(gc))
}
...
func (self Go) LinearAccelCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,3))
}
...
func (self Go) RadialAccelCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,4))
}
...
func (self Go) TangentialAccelCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,5))
}
...
func (self Go) DampingCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,6))
}
...
func (self Go) ScaleCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,8))
}
...
func (self Go) ScaleOverVelocityCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,17))
}
...
func (self Go) ColorRamp() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetColorRamp(gc))
}
...
func (self Go) ColorInitialRamp() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetColorInitialRamp(gc))
}
...
func (self Go) AlphaCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetAlphaCurve(gc))
}
...
func (self Go) EmissionCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetEmissionCurve(gc))
}
...
func (self Go) HueVariationCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,9))
}
...
func (self Go) AnimSpeedCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,10))
}
...
func (self Go) AnimOffsetCurve() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,11))
}
...
func (self Go) TurbulenceInfluenceOverLife() gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
		return gdclass.Texture2D(class(self).GetParamTexture(gc,12))
}
...
*/
//go:nosplit
func (self class) GetParamTexture(ctx gd.Lifetime, param classdb.ParticleProcessMaterialParameter) gdclass.Texture2D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, param)
...
//go:nosplit
func (self class) GetColorRamp(ctx gd.Lifetime) gdclass.Texture2D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
//go:nosplit
func (self class) GetAlphaCurve(ctx gd.Lifetime) gdclass.Texture2D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
//go:nosplit
func (self class) GetEmissionCurve(ctx gd.Lifetime) gdclass.Texture2D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
//go:nosplit
func (self class) GetColorInitialRamp(ctx gd.Lifetime) gdclass.Texture2D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
//go:nosplit
func (self class) GetVelocityLimitCurve(ctx gd.Lifetime) gdclass.Texture2D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
//go:nosplit
func (self class) GetEmissionPointTexture(ctx gd.Lifetime) gdclass.Texture2D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
//go:nosplit
func (self class) GetEmissionNormalTexture(ctx gd.Lifetime) gdclass.Texture2D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
//go:nosplit
func (self class) GetEmissionColorTexture(ctx gd.Lifetime) gdclass.Texture2D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
func init() {classdb.Register("ParticleProcessMaterial", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
