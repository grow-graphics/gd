...
*/
func (self Instance) GetElementFrame(element string) gdclass.GraphFrame {
...
*/
func (self Instance) GetMenuHbox() gdclass.HBoxContainer {
...
*/
func (self Instance) SetSelected(node gdclass.Node) {
...
func (self Instance) OnNodeSelected(cb func(node gdclass.Node)) {
	self[0].AsObject().Connect(gd.NewStringName("node_selected"), gd.NewCallable(cb), 0)
}

func (self Instance) OnNodeDeselected(cb func(node gdclass.Node)) {
	self[0].AsObject().Connect(gd.NewStringName("node_deselected"), gd.NewCallable(cb), 0)
}

func (self Instance) OnFrameRectChanged(cb func(frame_ gdclass.GraphFrame, new_rect gd.Vector2)) {
