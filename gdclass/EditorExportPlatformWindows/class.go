...
*/
type Go [1]classdb.EditorExportPlatformWindows
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("EditorExportPlatformWindows"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsEditorExportPlatformWindows() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsEditorExportPlatformWindows() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("EditorExportPlatformWindows", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
