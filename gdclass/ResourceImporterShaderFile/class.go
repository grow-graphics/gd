...
func New() Go {
	...
	return Go{classdb.ResourceImporterShaderFile(object)}
}
...
func init() {classdb.Register("ResourceImporterShaderFile", func(ptr gd.Object) any { return classdb.ResourceImporterShaderFile(ptr) })}
