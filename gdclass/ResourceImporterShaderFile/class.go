...
*/
type Go [1]classdb.ResourceImporterShaderFile
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ResourceImporterShaderFile"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsResourceImporterShaderFile() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsResourceImporterShaderFile() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("ResourceImporterShaderFile", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
