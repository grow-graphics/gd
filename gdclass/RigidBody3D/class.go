...
*/
type Instance [1]classdb.RigidBody3D

/*
Called during physics processing, allowing you to read and safely modify the simulation state for the object. By default, it is called before the standard force integration, but the [member custom_integrator] property allows you to disable the standard force integration and do fully custom force integration for a body.
*/
func (Instance) _integrate_forces(impl func(ptr unsafe.Pointer, state gdclass.PhysicsDirectBodyState3D)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = gdclass.PhysicsDirectBodyState3D{pointers.New[classdb.PhysicsDirectBodyState3D]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
...
func (self Instance) CenterOfMassMode() classdb.RigidBody3DCenterOfMassMode {
	return classdb.RigidBody3DCenterOfMassMode(class(self).GetCenterOfMassMode())
}

func (self Instance) SetCenterOfMassMode(value classdb.RigidBody3DCenterOfMassMode) {
...
func (self Instance) FreezeMode() classdb.RigidBody3DFreezeMode {
	return classdb.RigidBody3DFreezeMode(class(self).GetFreezeMode())
}

func (self Instance) SetFreezeMode(value classdb.RigidBody3DFreezeMode) {
...
func (self Instance) SetLinearDampMode(value classdb.RigidBody3DDampMode) {
...
func (self Instance) SetAngularDampMode(value classdb.RigidBody3DDampMode) {
...
Called during physics processing, allowing you to read and safely modify the simulation state for the object. By default, it is called before the standard force integration, but the [member custom_integrator] property allows you to disable the standard force integration and do fully custom force integration for a body.
*/
func (class) _integrate_forces(impl func(ptr unsafe.Pointer, state gdclass.PhysicsDirectBodyState3D)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = gdclass.PhysicsDirectBodyState3D{pointers.New[classdb.PhysicsDirectBodyState3D]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
func (self Instance) OnBodyShapeEntered(cb func(body_rid gd.RID, body gdclass.Node, body_shape_index int, local_shape_index int)) {
	self[0].AsObject().Connect(gd.NewStringName("body_shape_entered"), gd.NewCallable(cb), 0)
}

func (self Instance) OnBodyShapeExited(cb func(body_rid gd.RID, body gdclass.Node, body_shape_index int, local_shape_index int)) {
	self[0].AsObject().Connect(gd.NewStringName("body_shape_exited"), gd.NewCallable(cb), 0)
}

func (self Instance) OnBodyEntered(cb func(body gdclass.Node)) {
	self[0].AsObject().Connect(gd.NewStringName("body_entered"), gd.NewCallable(cb), 0)
}

func (self Instance) OnBodyExited(cb func(body gdclass.Node)) {
