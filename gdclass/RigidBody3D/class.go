...
*/
func (self Go) GetCollidingBodies() gd.ArrayOf[gdclass.Node3D] {
	gc := gd.GarbageCollector(); _ = gc
	return gd.ArrayOf[gdclass.Node3D](class(self).GetCollidingBodies(gc))
}
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("RigidBody3D"))
...
*/
//go:nosplit
func (self class) GetCollidingBodies(ctx gd.Lifetime) gd.ArrayOf[gdclass.Node3D] {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
func init() {classdb.Register("RigidBody3D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
