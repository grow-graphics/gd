...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("AudioEffectEQ6"))
...
func init() {classdb.Register("AudioEffectEQ6", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
