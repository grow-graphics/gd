...
func New() Go {
	...
	return Go{classdb.AudioEffectHighShelfFilter(object)}
}
...
func init() {classdb.Register("AudioEffectHighShelfFilter", func(ptr gd.Object) any { return classdb.AudioEffectHighShelfFilter(ptr) })}
