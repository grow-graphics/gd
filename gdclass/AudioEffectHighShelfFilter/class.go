...
*/
type Go [1]classdb.AudioEffectHighShelfFilter
// GD is a 1:1 low-level instance of the class, undocumented, for those who know what they are doing.
type GD = class
type class [1]classdb.AudioEffectHighShelfFilter
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("AudioEffectHighShelfFilter"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsAudioEffectHighShelfFilter() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsAudioEffectHighShelfFilter() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("AudioEffectHighShelfFilter", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
