...
func singleton() {
	gc := gd.Static
	obj := gc.API.Object.GetSingleton(gc, gc.API.Singletons.NativeMenu)
...
func GetSystemMenuName(menu_id classdb.NativeMenuSystemMenus) string {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return string(class(self).GetSystemMenuName(gc, menu_id).String())
}
...
func GetPopupOpenCallback(rid gd.RID) gd.Callable {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.Callable(class(self).GetPopupOpenCallback(gc, rid))
}
...
func GetPopupCloseCallback(rid gd.RID) gd.Callable {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.Callable(class(self).GetPopupCloseCallback(gc, rid))
}
...
func AddSubmenuItem(rid gd.RID, label string, submenu_rid gd.RID) int {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return int(int(class(self).AddSubmenuItem(rid, gc.String(label), submenu_rid, gc.Variant(([1]gd.Variant{}[0])), gd.Int(-1))))
}
...
func AddItem(rid gd.RID, label string) int {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return int(int(class(self).AddItem(rid, gc.String(label), ([1]gd.Callable{}[0]), ([1]gd.Callable{}[0]), gc.Variant(([1]gd.Variant{}[0])), 0, gd.Int(-1))))
}
...
func AddCheckItem(rid gd.RID, label string) int {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return int(int(class(self).AddCheckItem(rid, gc.String(label), ([1]gd.Callable{}[0]), ([1]gd.Callable{}[0]), gc.Variant(([1]gd.Variant{}[0])), 0, gd.Int(-1))))
}
...
func AddIconItem(rid gd.RID, icon gdclass.Texture2D, label string) int {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return int(int(class(self).AddIconItem(rid, icon, gc.String(label), ([1]gd.Callable{}[0]), ([1]gd.Callable{}[0]), gc.Variant(([1]gd.Variant{}[0])), 0, gd.Int(-1))))
}
...
func AddIconCheckItem(rid gd.RID, icon gdclass.Texture2D, label string) int {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return int(int(class(self).AddIconCheckItem(rid, icon, gc.String(label), ([1]gd.Callable{}[0]), ([1]gd.Callable{}[0]), gc.Variant(([1]gd.Variant{}[0])), 0, gd.Int(-1))))
}
...
func AddRadioCheckItem(rid gd.RID, label string) int {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return int(int(class(self).AddRadioCheckItem(rid, gc.String(label), ([1]gd.Callable{}[0]), ([1]gd.Callable{}[0]), gc.Variant(([1]gd.Variant{}[0])), 0, gd.Int(-1))))
}
...
func AddIconRadioCheckItem(rid gd.RID, icon gdclass.Texture2D, label string) int {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return int(int(class(self).AddIconRadioCheckItem(rid, icon, gc.String(label), ([1]gd.Callable{}[0]), ([1]gd.Callable{}[0]), gc.Variant(([1]gd.Variant{}[0])), 0, gd.Int(-1))))
}
...
func AddMultistateItem(rid gd.RID, label string, max_states int, default_state int) int {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return int(int(class(self).AddMultistateItem(rid, gc.String(label), gd.Int(max_states), gd.Int(default_state), ([1]gd.Callable{}[0]), ([1]gd.Callable{}[0]), gc.Variant(([1]gd.Variant{}[0])), 0, gd.Int(-1))))
}
...
func FindItemIndexWithText(rid gd.RID, text string) int {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return int(int(class(self).FindItemIndexWithText(rid, gc.String(text))))
}
...
func GetItemCallback(rid gd.RID, idx int) gd.Callable {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.Callable(class(self).GetItemCallback(gc, rid, gd.Int(idx)))
}
...
func GetItemKeyCallback(rid gd.RID, idx int) gd.Callable {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.Callable(class(self).GetItemKeyCallback(gc, rid, gd.Int(idx)))
}
...
func GetItemTag(rid gd.RID, idx int) gd.Variant {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gd.Variant(class(self).GetItemTag(gc, rid, gd.Int(idx)))
}
...
func GetItemText(rid gd.RID, idx int) string {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return string(class(self).GetItemText(gc, rid, gd.Int(idx)).String())
}
...
func GetItemTooltip(rid gd.RID, idx int) string {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return string(class(self).GetItemTooltip(gc, rid, gd.Int(idx)).String())
}
...
func GetItemIcon(rid gd.RID, idx int) gdclass.Texture2D {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	return gdclass.Texture2D(class(self).GetItemIcon(gc, rid, gd.Int(idx)))
}
...
func SetItemText(rid gd.RID, idx int, text string) {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	class(self).SetItemText(rid, gd.Int(idx), gc.String(text))
}
...
func SetItemTooltip(rid gd.RID, idx int, tooltip string) {
	gc := gd.GarbageCollector(); _ = gc
	once.Do(singleton)
	class(self).SetItemTooltip(rid, gd.Int(idx), gc.String(tooltip))
}
...
*/
//go:nosplit
func (self class) GetItemIcon(ctx gd.Lifetime, rid gd.RID, idx gd.Int) gdclass.Texture2D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, rid)
	callframe.Arg(frame, idx)
...
func init() {classdb.Register("NativeMenu", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
