...
func New() Go {
	...
	return Go{classdb.AudioEffectHighPassFilter(object)}
}
...
func init() {classdb.Register("AudioEffectHighPassFilter", func(ptr gd.Object) any { return classdb.AudioEffectHighPassFilter(ptr) })}
