...
func New() Go {
	...
	return Go{classdb.AudioEffectDistortion(object)}
}
...
func init() {classdb.Register("AudioEffectDistortion", func(ptr gd.Object) any { return classdb.AudioEffectDistortion(ptr) })}
