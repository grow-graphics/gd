...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VFlowContainer"))
...
func init() {classdb.Register("VFlowContainer", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
