...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("AudioSamplePlayback"))
...
func init() {classdb.Register("AudioSamplePlayback", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
