...
Gizmo that is used for providing custom visualization and editing (handles and subgizmos) for [Node3D] objects. Can be overridden to create custom gizmos, but for simple gizmos creating a [EditorNode3DGizmoPlugin] is usually recommended.
	...
	type EditorNode3DGizmo interface {
		...
		SubgizmosIntersectFrustum(camera gdclass.Camera3D, frustum gd.Array) []int32
...
The [param secondary] argument is [code]true[/code] when the edited handle is secondary (see [method add_handles] for more information).
*/
func (Instance) _set_handle(impl func(ptr unsafe.Pointer, id int, secondary bool, camera gdclass.Camera3D, point gd.Vector2)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var id = gd.UnsafeGet[gd.Int](p_args, 0)
		var secondary = gd.UnsafeGet[bool](p_args, 1)
		var camera = gdclass.Camera3D{pointers.New[classdb.Camera3D]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 2)})}
...
Override this method to allow selecting subgizmos using mouse clicks. Given a [param camera] and a [param point] in screen coordinates, this method should return which subgizmo should be selected. The returned value should be a unique subgizmo identifier, which can have any non-negative value and will be used in other virtual methods like [method _get_subgizmo_transform] or [method _commit_subgizmos].
*/
func (Instance) _subgizmos_intersect_ray(impl func(ptr unsafe.Pointer, camera gdclass.Camera3D, point gd.Vector2) int) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var camera = gdclass.Camera3D{pointers.New[classdb.Camera3D]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(camera[0])
...
Override this method to allow selecting subgizmos using mouse drag box selection. Given a [param camera] and a [param frustum], this method should return which subgizmos are contained within the frustum. The [param frustum] argument consists of an array with all the [Plane]s that make up the selection frustum. The returned value should contain a list of unique subgizmo identifiers, which can have any non-negative value and will be used in other virtual methods like [method _get_subgizmo_transform] or [method _commit_subgizmos].
*/
func (Instance) _subgizmos_intersect_frustum(impl func(ptr unsafe.Pointer, camera gdclass.Camera3D, frustum gd.Array) []int32) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var camera = gdclass.Camera3D{pointers.New[classdb.Camera3D]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(camera[0])
...
*/
func (self Instance) AddLines(lines []gd.Vector3, material gdclass.Material) {
...
*/
func (self Instance) AddMesh(mesh gdclass.Mesh) {
...
*/
func (self Instance) AddCollisionTriangles(triangles gdclass.TriangleMesh) {
...
*/
func (self Instance) AddUnscaledBillboard(material gdclass.Material) {
...
*/
func (self Instance) AddHandles(handles []gd.Vector3, material gdclass.Material, ids []int32) {
...
*/
func (self Instance) SetNode3d(node gdclass.Node) {
...
*/
func (self Instance) GetNode3d() gdclass.Node3D {
	return gdclass.Node3D(class(self).GetNode3d())
}
...
*/
func (self Instance) GetPlugin() gdclass.EditorNode3DGizmoPlugin {
	return gdclass.EditorNode3DGizmoPlugin(class(self).GetPlugin())
}
...
The [param secondary] argument is [code]true[/code] when the edited handle is secondary (see [method add_handles] for more information).
*/
func (class) _set_handle(impl func(ptr unsafe.Pointer, id gd.Int, secondary bool, camera gdclass.Camera3D, point gd.Vector2)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var id = gd.UnsafeGet[gd.Int](p_args, 0)
		var secondary = gd.UnsafeGet[bool](p_args, 1)
		var camera = gdclass.Camera3D{pointers.New[classdb.Camera3D]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 2)})}
...
Override this method to allow selecting subgizmos using mouse clicks. Given a [param camera] and a [param point] in screen coordinates, this method should return which subgizmo should be selected. The returned value should be a unique subgizmo identifier, which can have any non-negative value and will be used in other virtual methods like [method _get_subgizmo_transform] or [method _commit_subgizmos].
*/
func (class) _subgizmos_intersect_ray(impl func(ptr unsafe.Pointer, camera gdclass.Camera3D, point gd.Vector2) gd.Int) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var camera = gdclass.Camera3D{pointers.New[classdb.Camera3D]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(camera[0])
		var point = gd.UnsafeGet[gd.Vector2](p_args, 1)
...
Override this method to allow selecting subgizmos using mouse drag box selection. Given a [param camera] and a [param frustum], this method should return which subgizmos are contained within the frustum. The [param frustum] argument consists of an array with all the [Plane]s that make up the selection frustum. The returned value should contain a list of unique subgizmo identifiers, which can have any non-negative value and will be used in other virtual methods like [method _get_subgizmo_transform] or [method _commit_subgizmos].
*/
func (class) _subgizmos_intersect_frustum(impl func(ptr unsafe.Pointer, camera gdclass.Camera3D, frustum gd.Array) gd.PackedInt32Array) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var camera = gdclass.Camera3D{pointers.New[classdb.Camera3D]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(camera[0])
		var frustum = pointers.New[gd.Array](gd.UnsafeGet[[1]uintptr](p_args, 1))
...
*/
//go:nosplit
func (self class) GetNode3d() gdclass.Node3D {
	var frame = callframe.New()
	...
	var ret = gdclass.Node3D{classdb.Node3D(gd.PointerLifetimeBoundTo(self.AsObject(), r_ret.Get()))}
	frame.Free()
	return ret
}
...
*/
//go:nosplit
func (self class) GetPlugin() gdclass.EditorNode3DGizmoPlugin {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
	...
	var ret = gdclass.EditorNode3DGizmoPlugin{classdb.EditorNode3DGizmoPlugin(gd.PointerWithOwnershipTransferredToGo(r_ret.Get()))}
	frame.Free()
	return ret
}
