...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeVectorRefract(object)}
}
...
func init() {classdb.Register("VisualShaderNodeVectorRefract", func(ptr gd.Object) any { return classdb.VisualShaderNodeVectorRefract(ptr) })}
