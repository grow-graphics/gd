...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeColorParameter(object)}
}
...
func init() {classdb.Register("VisualShaderNodeColorParameter", func(ptr gd.Object) any { return classdb.VisualShaderNodeColorParameter(ptr) })}
