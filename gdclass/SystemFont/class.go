...
func New() Go {
	...
	return Go{classdb.SystemFont(object)}
}
...
func (self class) SetFontNames(names gd.PackedStringArray)  {
	var frame = callframe.New()
	callframe.Arg(frame, discreet.Get(names))
	var r_ret callframe.Nil
...
func init() {classdb.Register("SystemFont", func(ptr gd.Object) any { return classdb.SystemFont(ptr) })}
