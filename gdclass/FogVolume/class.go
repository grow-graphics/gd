...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("FogVolume"))
...
func init() {classdb.Register("FogVolume", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
