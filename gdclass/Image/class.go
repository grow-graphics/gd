...
*/
func (self Instance) Create(width int, height int, use_mipmaps bool, format classdb.ImageFormat) gdclass.Image {
...
Creates an empty image of given size and format. See [enum Format] constants. If [param use_mipmaps] is [code]true[/code], then generate mipmaps for this image. See the [method generate_mipmaps].
*/
func (self Instance) CreateEmpty(width int, height int, use_mipmaps bool, format classdb.ImageFormat) gdclass.Image {
...
*/
func (self Instance) CreateFromData(width int, height int, use_mipmaps bool, format classdb.ImageFormat, data []byte) gdclass.Image {
...
*/
func (self Instance) LoadFromFile(path string) gdclass.Image {
...
*/
func (self Instance) RgbeToSrgb() gdclass.Image {
...
*/
func (self Instance) ComputeImageMetrics(compared_image gdclass.Image, use_luma bool) gd.Dictionary {
...
*/
func (self Instance) BlitRect(src gdclass.Image, src_rect gd.Rect2i, dst gd.Vector2i) {
...
*/
func (self Instance) BlitRectMask(src gdclass.Image, mask gdclass.Image, src_rect gd.Rect2i, dst gd.Vector2i) {
...
*/
func (self Instance) BlendRect(src gdclass.Image, src_rect gd.Rect2i, dst gd.Vector2i) {
...
*/
func (self Instance) BlendRectMask(src gdclass.Image, mask gdclass.Image, src_rect gd.Rect2i, dst gd.Vector2i) {
...
*/
func (self Instance) GetRegion(region gd.Rect2i) gdclass.Image {
...
*/
func (self Instance) CopyFrom(src gdclass.Image) {
