...
*/
func (self Instance) CreateItem() gdclass.TreeItem {
...
*/
func (self Instance) GetRoot() gdclass.TreeItem {
...
*/
func (self Instance) GetNextSelected(from gdclass.TreeItem) gdclass.TreeItem {
...
*/
func (self Instance) GetSelected() gdclass.TreeItem {
...
*/
func (self Instance) SetSelected(item gdclass.TreeItem, column int) {
...
[/codeblocks]
*/
func (self Instance) GetEdited() gdclass.TreeItem {
...
*/
func (self Instance) GetItemAreaRect(item gdclass.TreeItem) gd.Rect2 {
...
*/
func (self Instance) GetItemAtPosition(position gd.Vector2) gdclass.TreeItem {
...
*/
func (self Instance) ScrollToItem(item gdclass.TreeItem) {
...
func (self Instance) OnMultiSelected(cb func(item gdclass.TreeItem, column int, selected bool)) {
...
func (self Instance) OnItemCollapsed(cb func(item gdclass.TreeItem)) {
	self[0].AsObject().Connect(gd.NewStringName("item_collapsed"), gd.NewCallable(cb), 0)
}

func (self Instance) OnCheckPropagatedToItem(cb func(item gdclass.TreeItem, column int)) {
	self[0].AsObject().Connect(gd.NewStringName("check_propagated_to_item"), gd.NewCallable(cb), 0)
}

func (self Instance) OnButtonClicked(cb func(item gdclass.TreeItem, column int, id int, mouse_button_index int)) {
