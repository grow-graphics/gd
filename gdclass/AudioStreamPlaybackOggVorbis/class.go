...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("AudioStreamPlaybackOggVorbis"))
...
func init() {classdb.Register("AudioStreamPlaybackOggVorbis", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
