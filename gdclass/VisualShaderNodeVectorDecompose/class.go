...
*/
type Go [1]classdb.VisualShaderNodeVectorDecompose
// GD is a 1:1 low-level instance of the class, undocumented, for those who know what they are doing.
type GD = class
type class [1]classdb.VisualShaderNodeVectorDecompose
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeVectorDecompose"))
	return *(*Go)(unsafe.Pointer(&object))
}

func (self class) AsVisualShaderNodeVectorDecompose() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsVisualShaderNodeVectorDecompose() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("VisualShaderNodeVectorDecompose", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
