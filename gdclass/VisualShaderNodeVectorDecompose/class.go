...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeVectorDecompose(object)}
}
...
func init() {classdb.Register("VisualShaderNodeVectorDecompose", func(ptr gd.Object) any { return classdb.VisualShaderNodeVectorDecompose(ptr) })}
