...
*/
func (self Instance) GetTilesToBeRemovedOnChange(texture gdclass.Texture2D, margins gd.Vector2i, separation gd.Vector2i, texture_region_size gd.Vector2i) []gd.Vector2 {
...
*/
func (self Instance) GetTileData(atlas_coords gd.Vector2i, alternative_tile int) gdclass.TileData {
...
*/
func (self Instance) GetRuntimeTexture() gdclass.Texture2D {
