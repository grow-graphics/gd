...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeUIntConstant"))
...
func init() {classdb.Register("VisualShaderNodeUIntConstant", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
