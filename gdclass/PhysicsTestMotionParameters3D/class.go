...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("PhysicsTestMotionParameters3D"))
...
func init() {classdb.Register("PhysicsTestMotionParameters3D", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
