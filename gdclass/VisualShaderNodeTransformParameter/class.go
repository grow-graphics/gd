...
*/
type Go [1]classdb.VisualShaderNodeTransformParameter
...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("VisualShaderNodeTransformParameter"))
...
func (self Go) DefaultValue() gd.Transform3D {
	gc := gd.GarbageCollector(); _ = gc
		return gd.Transform3D(class(self).GetDefaultValue())
}

func (self Go) SetDefaultValue(value gd.Transform3D) {
	gc := gd.GarbageCollector(); _ = gc
...
func (self class) AsVisualShaderNodeTransformParameter() GD { return *((*GD)(unsafe.Pointer(&self))) }
func (self Go) AsVisualShaderNodeTransformParameter() Go { return *((*Go)(unsafe.Pointer(&self))) }
...
func init() {classdb.Register("VisualShaderNodeTransformParameter", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
