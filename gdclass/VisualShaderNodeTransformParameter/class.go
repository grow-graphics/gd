...
func New() Go {
	...
	return Go{classdb.VisualShaderNodeTransformParameter(object)}
}
...
func init() {classdb.Register("VisualShaderNodeTransformParameter", func(ptr gd.Object) any { return classdb.VisualShaderNodeTransformParameter(ptr) })}
