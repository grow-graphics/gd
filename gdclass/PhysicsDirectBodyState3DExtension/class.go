...
func New() Go {
	...
	return Go{classdb.PhysicsDirectBodyState3DExtension(object)}
}
...
func init() {classdb.Register("PhysicsDirectBodyState3DExtension", func(ptr gd.Object) any { return classdb.PhysicsDirectBodyState3DExtension(ptr) })}
