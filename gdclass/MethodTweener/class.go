...
*/
func (self Instance) SetDelay(delay float64) gdclass.MethodTweener {
...
*/
func (self Instance) SetTrans(trans classdb.TweenTransitionType) gdclass.MethodTweener {
...
*/
func (self Instance) SetEase(ease classdb.TweenEaseType) gdclass.MethodTweener {
