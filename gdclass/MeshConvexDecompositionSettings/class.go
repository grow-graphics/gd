...
func New() Go {
	...
	return Go{classdb.MeshConvexDecompositionSettings(object)}
}
...
func init() {classdb.Register("MeshConvexDecompositionSettings", func(ptr gd.Object) any { return classdb.MeshConvexDecompositionSettings(ptr) })}
