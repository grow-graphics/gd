...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("EditorExportPlatformAndroid"))
...
func init() {classdb.Register("EditorExportPlatformAndroid", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
