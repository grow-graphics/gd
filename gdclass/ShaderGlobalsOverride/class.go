...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ShaderGlobalsOverride"))
...
func init() {classdb.Register("ShaderGlobalsOverride", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
