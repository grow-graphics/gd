...
*/
func (self Instance) AddResource(name string, resource gdclass.Resource) {
...
*/
func (self Instance) GetResource(name string) gdclass.Resource {
	return gdclass.Resource(class(self).GetResource(gd.NewStringName(name)))
}
...
*/
//go:nosplit
func (self class) GetResource(name gd.StringName) gdclass.Resource {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(name))
