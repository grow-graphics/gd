...
func New() Go {
	...
	object := gc.API.ClassDB.ConstructObject(gc, gc.StringName("ParallaxBackground"))
...
func init() {classdb.Register("ParallaxBackground", func(ptr gd.Pointer) any {var class class; class[0].SetPointer(ptr); return class })}
