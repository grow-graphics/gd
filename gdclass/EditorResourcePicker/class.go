...
func (self Instance) EditedResource() gdclass.Resource {
	return gdclass.Resource(class(self).GetEditedResource())
}

func (self Instance) SetEditedResource(value gdclass.Resource) {
...
func (self Instance) OnResourceSelected(cb func(resource gdclass.Resource, inspect bool)) {
	self[0].AsObject().Connect(gd.NewStringName("resource_selected"), gd.NewCallable(cb), 0)
}

func (self Instance) OnResourceChanged(cb func(resource gdclass.Resource)) {
