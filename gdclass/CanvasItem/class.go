...
*/
//go:nosplit
func (self class) GetCanvasLayerNode() gdclass.CanvasLayer {
	var frame = callframe.New()
	...
	var ret = gdclass.CanvasLayer{classdb.CanvasLayer(gd.PointerWithOwnershipTransferredToGo(r_ret.Get()))}
	frame.Free()
	return ret
}
