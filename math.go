...
// from returning NaN.
func Acos[T ~float32 | ~float64](x T) Radians { return xy.Acos(x) }
...
func Acosh[T ~float32 | ~float64](x T) Radians { return xy.Acosh(x) }
...
func Asin[T ~float32 | ~float64](x T) Radians { return xy.Asin(x) }
...
func Asinh[T ~float32 | ~float64](x T) Radians { return xy.Asinh(x) }
...
// have both y and x.
func Atan[T ~float32 | ~float64](x T) Radians { return xy.Atan(x) }
...
func Atan2[T ~float32 | ~float64](y, x T) Radians { return xy.Atan2(y, x) }
...
func Atanh[T ~float32 | ~float64](x T) Radians { return xy.Atanh(x) }
...
func NearestPowerOfTwo(x Int) Int { return Int(xy.NearestPowerOfTwo(x)) }
...
func StepDecimals[T ~float32 | ~float64](x T) Int { return Int(xy.StepDecimals(x)) }
