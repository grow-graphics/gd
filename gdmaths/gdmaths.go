...
func Abs[T xy.ComponentWise[T]](x T) T { return xy.Abs(x) }

// Absf returns the absolute value of the float parameter x (i.e. non-negative value).
func Absf[T ~float32 | ~float64](x T) T { return xy.Absf(x) }

// Absi returns the absolute value of the integer parameter x (i.e. non-negative value).
func Absi[T ~int8 | ~int16 | ~int32 | ~int64 | ~int](x T) T { return xy.Absi(x) }
...
// from returning NaN.
func Acos[T ~float32 | ~float64](x T) gd.Radians { return xy.Acos(x) }
...
func Acosh[T ~float32 | ~float64](x T) gd.Radians { return xy.Acosh(x) }
...
func AngleDifference[T ~float32 | ~float64](from, to T) T { return xy.AngleDifference(from, to) }
...
func Asin[T ~float32 | ~float64](x T) gd.Radians { return xy.Asin(x) }
...
func Asinh[T ~float32 | ~float64](x T) gd.Radians { return xy.Asinh(x) }
...
// have both y and x.
func Atan[T ~float32 | ~float64](x T) gd.Radians { return xy.Atan(x) }
...
func Atan2[T ~float32 | ~float64](y, x T) gd.Radians { return xy.Atan2(y, x) }
...
func Atanh[T ~float32 | ~float64](x T) gd.Radians { return xy.Atanh(x) }
...
func BezierDerivative[T ~float32 | ~float64](start, control_1, control_2, end, t T) T {
	return xy.BezierDerivative(start, control_1, control_2, end, t)
}
...
func Clamp[T ordered](value, min, max T) T { return xy.Clamp(value, min, max) }

// Clampf clamps the value, returning a float not less than min and not more than max.
func Clampf[T ~float32 | ~float64](value, min, max T) T { return xy.Clampf(value, min, max) }
...
func Clampi[T ~int8 | ~int16 | ~int32 | ~int64 | ~int](value, min, max T) T {
	return xy.Clampi(value, min, max)
}

// Cos returns the cosine of angle x in radians.
func Cos[T ~float32 | ~float64](x T) T { return xy.Cos(x) }

// Cosh returns the hyperbolic cosine of x in radians.
func Cosh[T ~float32 | ~float64](x T) T { return xy.Cosh(x) }
...
func CubicInterpolate[T ~float32 | ~float64](from, to, pre, post, weight T) T {
	return xy.CubicInterpolate(from, to, pre, post, weight)
}
...
func CubicInterpolateAngle[T ~float32 | ~float64](from, to, pre, post, weight T) T {
	return xy.CubicInterpolateAngle(from, to, pre, post, weight)
}
...
func CubicInterpolateAngleInTime[T ~float32 | ~float64](from, to, pre, post, weight, to_t, pre_t, post_t T) T {
	return xy.CubicInterpolateAngleInTime(from, to, pre, post, weight, to_t, pre_t, post_t)
}
...
func CubicInterpolateInTime[T ~float32 | ~float64](from, to, pre, post, weight, to_t, pre_t, post_t T) T {
	return xy.CubicInterpolateInTime(from, to, pre, post, weight, to_t, pre_t, post_t)
}

// DecibelsToLinear converts from decibels to linear energy (audio).
func DecibelsToLinear[T ~float32 | ~float64](db T) T { return xy.DecibelsToLinear(db) }
...
func Ease[T ~float32 | ~float64](x, curve T) T { return xy.Ease(x, curve) }
...
func Fmod[T ~float32 | ~float64](x, y T) T { return xy.Fmod(x, y) }

// Fposmod returns the floating-point modulus of x divided by y, wrapping equally in positive and negative.
func Fposmod[T ~float32 | ~float64](x, y T) T { return xy.Fposmod(x, y) }
...
func IsApproximatelyEqual[T ~float32 | ~float64](a, b T) bool {
	return xy.IsApproximatelyEqual(a, b)
}

// IsFinite returns whether x is a finite value, i.e. it is not NaN, +INF, or -INF.
func IsFinite[T ~float32 | ~float64](x T) bool { return xy.IsFinite(x) }

// IsInfinity returns whether x is an infinite value, i.e. it is +INF or -INF.
func IsInfinity[T ~float32 | ~float64](x T) bool { return xy.IsInfinity(x) }

// IsNaN returns whether x is NaN (not a number).
func IsNaN[T ~float32 | ~float64](x T) bool { return xy.IsNaN(x) }
...
func IsApproximatelyZero[T ~float32 | ~float64](x T) bool { return xy.IsApproximatelyZero(x) }
...
func Lerp[T xy.Lerpable[T]](from, to T, weight gd.Float) T {
	return xy.Lerp(from, to, weight)
}
...
func LerpAngle[T ~float32 | ~float64](from, to, weight T) T {
	return xy.LerpAngle(from, to, weight)
}
...
func Lerpf[T ~float32 | ~float64](from, to, weight T) T { return xy.Lerpf(from, to, weight) }

// LinearToDecibels converts from linear energy (audio) to decibels.
func LinearToDecibels[T ~float32 | ~float64](energy T) T { return xy.LinearToDecibels(energy) }
...
func Log[T ~float32 | ~float64](x T) T { return xy.Log(x) }
...
func MoveToward[T ~float32 | ~float64](from, to, delta T) T {
	return xy.MoveToward(from, to, delta)
}
...
func NearestPowerOfTwo(x gd.Int) gd.Int { return gd.Int(xy.NearestPowerOfTwo(x)) }
...
func PingPong[T ~float32 | ~float64](value, length T) T { return xy.PingPong(value, length) }

// Posmod returns the integer modulus of x divided by y that wraps equally in positive and negative.
func Posmod[T ~int8 | ~int16 | ~int32 | ~int64 | ~int](x, y T) T { return xy.Posmod(x, y) }

// Pow returns the result of base raised to the power of exp.
func Pow[T ~float32 | ~float64](base, exp T) T { return xy.Pow(base, exp) }
...
func Remap[T ~float32 | ~float64](value, istart, istop, ostart, ostop T) T {
	return xy.Remap(value, istart, istop, ostart, ostop)
}
...
func Smoothstep[T ~float32 | ~float64](from, to, x T) T { return xy.Smoothstep(from, to, x) }
...
func Snapped[T xy.ComponentWise[T]](x, step T) T { return xy.Snapped(x, step) }
...
func Sqrt[T ~float32 | ~float64](x T) T { return xy.Sqrt(x) }
...
func StepDecimals[T ~float32 | ~float64](x T) gd.Int { return gd.Int(xy.StepDecimals(x)) }

// Tan returns the tangent of angle x in radians.
func Tan[T ~float32 | ~float64](x T) T { return xy.Tan(x) }

// Tanh returns the hyperbolic tangent of x in radians.
func Tanh[T ~float32 | ~float64](x T) T { return xy.Tanh(x) }
...
func Wrapi[T ~int8 | ~int16 | ~int32 | ~int64 | ~int](value, min, max T) T {
	return xy.Wrapi(value, min, max)
}

// Wrapf value between min and max. Can be used for creating loop-alike behavior or infinite surfaces.
func Wrapf[T ~float32 | ~float64](value, min, max T) T { return xy.Wrapf(value, min, max) }
