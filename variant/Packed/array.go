...
func (array *Array[T]) Append(value T) { (*GenericArray.Contains[T])(array).Append(value) }
...
func (array Array[T]) Clear() { GenericArray.Clear((GenericArray.Contains[T])(array)) }
...
func (array Array[T]) Fill(value T) { GenericArray.Fill((GenericArray.Contains[T])(array), value) }
...
func (array Array[T]) IsEmpty() bool { return GenericArray.IsEmpty((GenericArray.Contains[T])(array)) }
...
func (array *Array[T]) Resize(size int) { (*GenericArray.Contains[T])(array).Resize(size) }

// Reverse reverses the order of the elements in the array.
func (array Array[T]) Reverse() { GenericArray.Reverse((GenericArray.Contains[T])(array)) }
...
func (array Array[T]) Len() int { return (GenericArray.Contains[T])(array).Len() }

// Slice returns a slice of the array from the given begin index to the given end index.
func (array Array[T]) Slice(begin, end int) Array[T] { //gd:Packed_T.
