...
func TestAll(t *testing.T) {
	...
	gdtests.Print(t, "true", Array.New(6, 10, 6).All(greater_than_5))  // Prints true (3/3 elements evaluate to true).
	gdtests.Print(t, "false", Array.New(4, 10, 4).All(greater_than_5)) // Prints false (1/3 elements evaluate to true).
	gdtests.Print(t, "false", Array.New(4, 4, 4).All(greater_than_5))  // Prints false (0/3 elements evaluate to true).
	gdtests.Print(t, "true", Array.New[int]().All(greater_than_5))     // Prints true (0/0 elements evaluate to true).
}
...
func TestBinarySearchFunc(t *testing.T) {
	...
	Array.Insert(my_items, my_items.BinarySearchFunc(sort_by_amount, apple, true), apple)

	var banana = [2]any{"Banana", 5}
	// "Banana" is inserted after "Kiwi".
	Array.Insert(my_items, my_items.BinarySearchFunc(sort_by_amount, banana, false), banana)
