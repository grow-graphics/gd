...
<Aside>On Linux and MacOS, the `gd` command line tool will automatically download and use the correct version of `godot` for you if it's not already installed.</Aside>
