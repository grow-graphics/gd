...
var Distinctions = map[string][][3]string{
	...
	"CanvasItem":                     {{"rotation", "float", "Angle.Radians"}, {"angle ", "float", "Angle.Radians"}},
	"CanvasLayer":                    {{"rotation", "float", "Angle.Radians"}},
	...
	"SkeletonModification2D":         {{"angle", "float", "Angle.Radians"}, {"clamp_angle min", "float", "Angle.Radians"}, {"clamp_angle max", "float", "Angle.Radians"}},
