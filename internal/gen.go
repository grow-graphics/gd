...
func generate() error {
	...
	fmt.Fprintln(core, `package internal`)
	fmt.Fprintln(core)
	...
	fmt.Fprintln(all, `package classdb`)
	fmt.Fprintln(all)
	...
	fmt.Fprintln(enums, `import "grow.graphics/gd/internal/classdb"`)
	fmt.Fprintln(enums)
	...
	fmt.Fprintln(classdb, `import "grow.graphics/gd/internal/classdb"`)
	fmt.Fprintln(classdb)
