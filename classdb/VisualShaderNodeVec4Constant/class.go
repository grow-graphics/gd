...
func (self class) SetConstant(constant Quaternion.IJKX) { //gd:VisualShaderNodeVec4Constant.set_constant
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.VisualShaderNodeVec4Constant.Bind_set_constant, 0|(gdextension.SizeQuaternion<<4), unsafe.Pointer(&struct{ constant Quaternion.IJKX }{constant}))
}

//go:nosplit
func (self class) GetConstant() Quaternion.IJKX { //gd:VisualShaderNodeVec4Constant.get_constant
	var r_ret = gdunsafe.Call[Quaternion.IJKX](self.AsObject(), gd.Global.Methods.VisualShaderNodeVec4Constant.Bind_get_constant, gdextension.SizeQuaternion, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
