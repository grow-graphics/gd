...
func New() Instance {
	...
	return Instance{*(*gdclass.EditorUndoRedoManager)(unsafe.Pointer(&object))}
}
...
*/
//go:nosplit
func (self class) CreateAction(name gd.String, merge_mode gdclass.UndoRedoMergeMode, custom_context gd.Object, backward_undo_ops bool) {
