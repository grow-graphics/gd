...
func (self class) GetCanvas() RID.Any { //gd:World2D.get_canvas
	var r_ret = gdunsafe.Call[RID.Any](self.AsObject(), gd.Global.Methods.World2D.Bind_get_canvas, gdextension.SizeRID, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetSpace() RID.Any { //gd:World2D.get_space
	var r_ret = gdunsafe.Call[RID.Any](self.AsObject(), gd.Global.Methods.World2D.Bind_get_space, gdextension.SizeRID, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetNavigationMap() RID.Any { //gd:World2D.get_navigation_map
	var r_ret = gdunsafe.Call[RID.Any](self.AsObject(), gd.Global.Methods.World2D.Bind_get_navigation_map, gdextension.SizeRID, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetDirectSpaceState() [1]gdclass.PhysicsDirectSpaceState2D { //gd:World2D.get_direct_space_state
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.World2D.Bind_get_direct_space_state, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
