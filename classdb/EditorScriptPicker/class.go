...
func (self class) SetScriptOwner(owner_node [1]gdclass.Node) { //gd:EditorScriptPicker.set_script_owner
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.EditorScriptPicker.Bind_set_script_owner, 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ owner_node gdextension.Object }{gdextension.Object(gd.PointerWithOwnershipTransferredToGodot(owner_node[0].AsObject()[0]))}))
}

//go:nosplit
func (self class) GetScriptOwner() [1]gdclass.Node { //gd:EditorScriptPicker.get_script_owner
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.EditorScriptPicker.Bind_get_script_owner, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
