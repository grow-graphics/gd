...
func (self class) SetShader(shader [1]gdclass.Shader) { //gd:ShaderMaterial.set_shader
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_shader, 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ shader gdextension.Object }{gdextension.Object(gd.CallerIncrements(shader[0].AsObject()))}))
}
