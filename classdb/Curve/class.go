...
func New() Instance {
	...
	return Instance{*(*gdclass.Curve)(unsafe.Pointer(&object))}
}
...
*/
//go:nosplit
func (self class) AddPoint(position gd.Vector2, left_tangent gd.Float, right_tangent gd.Float, left_mode gdclass.CurveTangentMode, right_mode gdclass.CurveTangentMode) gd.Int {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetPointLeftMode(index gd.Int) gdclass.CurveTangentMode {
	var frame = callframe.New()
	callframe.Arg(frame, index)
...
*/
//go:nosplit
func (self class) GetPointRightMode(index gd.Int) gdclass.CurveTangentMode {
	var frame = callframe.New()
	callframe.Arg(frame, index)
	var r_ret = callframe.Ret[gdclass.CurveTangentMode](frame)
...
*/
//go:nosplit
func (self class) SetPointLeftMode(index gd.Int, mode gdclass.CurveTangentMode) {
	var frame = callframe.New()
	callframe.Arg(frame, index)
...
*/
//go:nosplit
func (self class) SetPointRightMode(index gd.Int, mode gdclass.CurveTangentMode) {
	var frame = callframe.New()
	callframe.Arg(frame, index)
	callframe.Arg(frame, mode)
	var r_ret callframe.Nil
...
type TangentMode = gdclass.CurveTangentMode
