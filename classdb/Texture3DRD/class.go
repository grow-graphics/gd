...
func New() Instance {
	object := [1]gd.Object{pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(pointers.Get(gd.NewStringName("Texture3DRD"))))})}
...
func (self class) SetTextureRdRid(texture_rd_rid RID.Any) { //gd:Texture3DRD.set_texture_rd_rid
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Texture3DRD.Bind_set_texture_rd_rid), 0|(gdextension.SizeRID<<4), unsafe.Pointer(&struct{ texture_rd_rid RID.Any }{texture_rd_rid}))
}

//go:nosplit
func (self class) GetTextureRdRid() RID.Any { //gd:Texture3DRD.get_texture_rd_rid
	var r_ret = gdextension.Call[RID.Any](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Texture3DRD.Bind_get_texture_rd_rid), gdextension.SizeRID, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
