...
//go:nosplit
func (self class) SetTextureRdRid(texture_rd_rid gd.RID) { //gd:TextureLayeredRD.set_texture_rd_rid
...
//go:nosplit
func (self class) GetTextureRdRid() gd.RID { //gd:TextureLayeredRD.get_texture_rd_rid
	var frame = callframe.New()
