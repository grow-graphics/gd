...
func New() Instance {
	object := [1]gd.Object{pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(pointers.Get(gd.NewStringName("PointLight2D"))))})}
...
func (self class) GetTexture() [1]gdclass.Texture2D { //gd:PointLight2D.get_texture
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.PointLight2D.Bind_get_texture), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
