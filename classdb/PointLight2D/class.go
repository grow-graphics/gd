...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = *(*gdclass.PointLight2D)(unsafe.Pointer(&obj))
		return true
	}
	return false
}
...
func (self class) SetTextureScale(texture_scale float64) { //gd:PointLight2D.set_texture_scale
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_texture_scale, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ texture_scale float64 }{texture_scale}))
}

//go:nosplit
func (self class) GetTextureScale() float64 { //gd:PointLight2D.get_texture_scale
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_texture_scale, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func init() {
	gdclass.Register("PointLight2D", func(ptr gd.Object) any { return *(*Instance)(unsafe.Pointer(&ptr)) })
}
