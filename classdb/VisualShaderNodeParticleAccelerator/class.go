...
func (self class) SetMode(mode Mode) { //gd:VisualShaderNodeParticleAccelerator.set_mode
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.VisualShaderNodeParticleAccelerator.Bind_set_mode, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ mode Mode }{mode}))
}

//go:nosplit
func (self class) GetMode() Mode { //gd:VisualShaderNodeParticleAccelerator.get_mode
	var r_ret = gdunsafe.Call[Mode](self.AsObject(), gd.Global.Methods.VisualShaderNodeParticleAccelerator.Bind_get_mode, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
