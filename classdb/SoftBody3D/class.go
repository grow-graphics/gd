...
func New() Instance {
	...
	return Instance{*(*gdclass.SoftBody3D)(unsafe.Pointer(&object))}
}
...
//go:nosplit
func (self class) SetDisableMode(mode gdclass.SoftBody3DDisableMode) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetDisableMode() gdclass.SoftBody3DDisableMode {
	var frame = callframe.New()
...
type DisableMode = gdclass.SoftBody3DDisableMode
