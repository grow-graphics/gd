...
func (self class) GetPointCount() int64 { //gd:Curve3D.get_point_count
	var r_ret = gdextension.Call[int64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_get_point_count), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetPointCount(count int64) { //gd:Curve3D.set_point_count
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_set_point_count), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ count int64 }{count}))
}
...
func (self class) AddPoint(position Vector3.XYZ, in Vector3.XYZ, out Vector3.XYZ, index int64) { //gd:Curve3D.add_point
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_add_point), 0|(gdextension.SizeVector3<<4)|(gdextension.SizeVector3<<8)|(gdextension.SizeVector3<<12)|(gdextension.SizeInt<<16), unsafe.Pointer(&struct {
...
func (self class) SetPointPosition(idx int64, position Vector3.XYZ) { //gd:Curve3D.set_point_position
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_set_point_position), 0|(gdextension.SizeInt<<4)|(gdextension.SizeVector3<<8), unsafe.Pointer(&struct {
		idx      int64
		position Vector3.XYZ
	}{idx, position}))
}
...
func (self class) GetPointPosition(idx int64) Vector3.XYZ { //gd:Curve3D.get_point_position
	var r_ret = gdextension.Call[Vector3.XYZ](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_get_point_position), gdextension.SizeVector3|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ idx int64 }{idx}))
	var ret = r_ret
	return ret
}
...
func (self class) SetPointTilt(idx int64, tilt float64) { //gd:Curve3D.set_point_tilt
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_set_point_tilt), 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), unsafe.Pointer(&struct {
		idx  int64
		tilt float64
	}{idx, tilt}))
}
...
func (self class) GetPointTilt(idx int64) float64 { //gd:Curve3D.get_point_tilt
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_get_point_tilt), gdextension.SizeFloat|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ idx int64 }{idx}))
	var ret = r_ret
	return ret
}
...
func (self class) SetPointIn(idx int64, position Vector3.XYZ) { //gd:Curve3D.set_point_in
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_set_point_in), 0|(gdextension.SizeInt<<4)|(gdextension.SizeVector3<<8), unsafe.Pointer(&struct {
		idx      int64
		position Vector3.XYZ
	}{idx, position}))
}
...
func (self class) GetPointIn(idx int64) Vector3.XYZ { //gd:Curve3D.get_point_in
	var r_ret = gdextension.Call[Vector3.XYZ](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_get_point_in), gdextension.SizeVector3|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ idx int64 }{idx}))
	var ret = r_ret
	return ret
}
...
func (self class) SetPointOut(idx int64, position Vector3.XYZ) { //gd:Curve3D.set_point_out
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_set_point_out), 0|(gdextension.SizeInt<<4)|(gdextension.SizeVector3<<8), unsafe.Pointer(&struct {
		idx      int64
		position Vector3.XYZ
	}{idx, position}))
}
...
func (self class) GetPointOut(idx int64) Vector3.XYZ { //gd:Curve3D.get_point_out
	var r_ret = gdextension.Call[Vector3.XYZ](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_get_point_out), gdextension.SizeVector3|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ idx int64 }{idx}))
	var ret = r_ret
	return ret
}
...
func (self class) RemovePoint(idx int64) { //gd:Curve3D.remove_point
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_remove_point), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ idx int64 }{idx}))
}
...
func (self class) ClearPoints() { //gd:Curve3D.clear_points
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_clear_points), 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) Sample(idx int64, t float64) Vector3.XYZ { //gd:Curve3D.sample
	var r_ret = gdextension.Call[Vector3.XYZ](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_sample), gdextension.SizeVector3|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), unsafe.Pointer(&struct {
		idx int64
		t   float64
	}{idx, t}))
	var ret = r_ret
...
func (self class) Samplef(fofs float64) Vector3.XYZ { //gd:Curve3D.samplef
	var r_ret = gdextension.Call[Vector3.XYZ](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_samplef), gdextension.SizeVector3|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ fofs float64 }{fofs}))
	var ret = r_ret
	return ret
}
...
func (self class) SetClosed(closed bool) { //gd:Curve3D.set_closed
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_set_closed), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ closed bool }{closed}))
}

//go:nosplit
func (self class) IsClosed() bool { //gd:Curve3D.is_closed
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_is_closed), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetBakeInterval(distance float64) { //gd:Curve3D.set_bake_interval
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_set_bake_interval), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ distance float64 }{distance}))
}

//go:nosplit
func (self class) GetBakeInterval() float64 { //gd:Curve3D.get_bake_interval
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_get_bake_interval), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetUpVectorEnabled(enable bool) { //gd:Curve3D.set_up_vector_enabled
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_set_up_vector_enabled), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) IsUpVectorEnabled() bool { //gd:Curve3D.is_up_vector_enabled
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_is_up_vector_enabled), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetBakedLength() float64 { //gd:Curve3D.get_baked_length
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_get_baked_length), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SampleBaked(offset float64, cubic bool) Vector3.XYZ { //gd:Curve3D.sample_baked
	var r_ret = gdextension.Call[Vector3.XYZ](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_sample_baked), gdextension.SizeVector3|(gdextension.SizeFloat<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		offset float64
		cubic  bool
	}{offset, cubic}))
	var ret = r_ret
...
func (self class) SampleBakedWithRotation(offset float64, cubic bool, apply_tilt bool) Transform3D.BasisOrigin { //gd:Curve3D.sample_baked_with_rotation
	var r_ret = gdextension.Call[Transform3D.BasisOrigin](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_sample_baked_with_rotation), gdextension.SizeTransform3D|(gdextension.SizeFloat<<4)|(gdextension.SizeBool<<8)|(gdextension.SizeBool<<12), unsafe.Pointer(&struct {
		offset     float64
		cubic      bool
		apply_tilt bool
...
func (self class) SampleBakedUpVector(offset float64, apply_tilt bool) Vector3.XYZ { //gd:Curve3D.sample_baked_up_vector
	var r_ret = gdextension.Call[Vector3.XYZ](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_sample_baked_up_vector), gdextension.SizeVector3|(gdextension.SizeFloat<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		offset     float64
		apply_tilt bool
	}{offset, apply_tilt}))
	var ret = r_ret
...
func (self class) GetBakedPoints() Packed.Array[Vector3.XYZ] { //gd:Curve3D.get_baked_points
	var r_ret = gdextension.Call[gd.PackedPointers](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_get_baked_points), gdextension.SizePackedArray, unsafe.Pointer(&struct{}{}))
...
func (self class) GetBakedTilts() Packed.Array[float32] { //gd:Curve3D.get_baked_tilts
	var r_ret = gdextension.Call[gd.PackedPointers](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_get_baked_tilts), gdextension.SizePackedArray, unsafe.Pointer(&struct{}{}))
...
func (self class) GetBakedUpVectors() Packed.Array[Vector3.XYZ] { //gd:Curve3D.get_baked_up_vectors
	var r_ret = gdextension.Call[gd.PackedPointers](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_get_baked_up_vectors), gdextension.SizePackedArray, unsafe.Pointer(&struct{}{}))
	var ret = Packed.Array[Vector3.XYZ](Array.Through(gd.PackedProxy[gd.PackedVector3Array, Vector3.XYZ]{}, pointers.Pack(pointers.Let[gd.PackedStringArray](r_ret))))
	return ret
}
...
func (self class) GetClosestPoint(to_point Vector3.XYZ) Vector3.XYZ { //gd:Curve3D.get_closest_point
	var r_ret = gdextension.Call[Vector3.XYZ](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_get_closest_point), gdextension.SizeVector3|(gdextension.SizeVector3<<4), unsafe.Pointer(&struct{ to_point Vector3.XYZ }{to_point}))
	var ret = r_ret
	return ret
}
...
func (self class) GetClosestOffset(to_point Vector3.XYZ) float64 { //gd:Curve3D.get_closest_offset
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_get_closest_offset), gdextension.SizeFloat|(gdextension.SizeVector3<<4), unsafe.Pointer(&struct{ to_point Vector3.XYZ }{to_point}))
	var ret = r_ret
	return ret
}
...
func (self class) Tessellate(max_stages int64, tolerance_degrees float64) Packed.Array[Vector3.XYZ] { //gd:Curve3D.tessellate
	var r_ret = gdextension.Call[gd.PackedPointers](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_tessellate), gdextension.SizePackedArray|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), unsafe.Pointer(&struct {
		max_stages        int64
...
func (self class) TessellateEvenLength(max_stages int64, tolerance_length float64) Packed.Array[Vector3.XYZ] { //gd:Curve3D.tessellate_even_length
	var r_ret = gdextension.Call[gd.PackedPointers](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Curve3D.Bind_tessellate_even_length), gdextension.SizePackedArray|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), unsafe.Pointer(&struct {
		max_stages       int64
