...
func (self class) SetLength(length float64) { //gd:SeparationRayShape3D.set_length
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SeparationRayShape3D.Bind_set_length, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ length float64 }{length}))
}

//go:nosplit
func (self class) GetLength() float64 { //gd:SeparationRayShape3D.get_length
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.SeparationRayShape3D.Bind_get_length, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetSlideOnSlope(active bool) { //gd:SeparationRayShape3D.set_slide_on_slope
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SeparationRayShape3D.Bind_set_slide_on_slope, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ active bool }{active}))
}

//go:nosplit
func (self class) GetSlideOnSlope() bool { //gd:SeparationRayShape3D.get_slide_on_slope
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SeparationRayShape3D.Bind_get_slide_on_slope, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
