...
func (self class) SetTargetTransform(target Transform3D.BasisOrigin) { //gd:SkeletonIK3D.set_target_transform
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_set_target_transform), 0|(gdextension.SizeTransform3D<<4), unsafe.Pointer(&struct{ target Transform3D.BasisOrigin }{gd.Transposed(target)}))
}

//go:nosplit
func (self class) GetTargetTransform() Transform3D.BasisOrigin { //gd:SkeletonIK3D.get_target_transform
	var r_ret = gdextension.Call[Transform3D.BasisOrigin](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_get_target_transform), gdextension.SizeTransform3D, unsafe.Pointer(&struct{}{}))
...
func (self class) SetOverrideTipBasis(override bool) { //gd:SkeletonIK3D.set_override_tip_basis
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_set_override_tip_basis), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ override bool }{override}))
}

//go:nosplit
func (self class) IsOverrideTipBasis() bool { //gd:SkeletonIK3D.is_override_tip_basis
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_is_override_tip_basis), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetUseMagnet(use bool) { //gd:SkeletonIK3D.set_use_magnet
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_set_use_magnet), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ use bool }{use}))
}

//go:nosplit
func (self class) IsUsingMagnet() bool { //gd:SkeletonIK3D.is_using_magnet
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_is_using_magnet), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetMagnetPosition(local_position Vector3.XYZ) { //gd:SkeletonIK3D.set_magnet_position
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_set_magnet_position), 0|(gdextension.SizeVector3<<4), unsafe.Pointer(&struct{ local_position Vector3.XYZ }{local_position}))
}

//go:nosplit
func (self class) GetMagnetPosition() Vector3.XYZ { //gd:SkeletonIK3D.get_magnet_position
	var r_ret = gdextension.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_get_magnet_position), gdextension.SizeVector3, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) IsRunning() bool { //gd:SkeletonIK3D.is_running
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_is_running), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetMinDistance(min_distance float64) { //gd:SkeletonIK3D.set_min_distance
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_set_min_distance), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ min_distance float64 }{min_distance}))
}

//go:nosplit
func (self class) GetMinDistance() float64 { //gd:SkeletonIK3D.get_min_distance
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_get_min_distance), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetMaxIterations(iterations int64) { //gd:SkeletonIK3D.set_max_iterations
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_set_max_iterations), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ iterations int64 }{iterations}))
}

//go:nosplit
func (self class) GetMaxIterations() int64 { //gd:SkeletonIK3D.get_max_iterations
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_get_max_iterations), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) Start(one_time bool) { //gd:SkeletonIK3D.start
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_start), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ one_time bool }{one_time}))
}
...
func (self class) Stop() { //gd:SkeletonIK3D.stop
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_stop), 0, unsafe.Pointer(&struct{}{}))
}

//go:nosplit
func (self class) SetInterpolation(interpolation float64) { //gd:SkeletonIK3D.set_interpolation
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_set_interpolation), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ interpolation float64 }{interpolation}))
}

//go:nosplit
func (self class) GetInterpolation() float64 { //gd:SkeletonIK3D.get_interpolation
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.SkeletonIK3D.Bind_get_interpolation), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
