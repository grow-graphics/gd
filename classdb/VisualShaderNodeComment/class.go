...
func New() Instance {
	object := [1]gd.Object{pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(pointers.Get(gd.NewStringName("VisualShaderNodeComment"))))})}
...
func (self class) SetDescription(description String.Readable) { //gd:VisualShaderNodeComment.set_description
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.VisualShaderNodeComment.Bind_set_description), 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ description gdextension.String }{pointers.Get(gd.InternalString(description))}))
}

//go:nosplit
func (self class) GetDescription() String.Readable { //gd:VisualShaderNodeComment.get_description
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.VisualShaderNodeComment.Bind_get_description), gdextension.SizeString, unsafe.Pointer(&struct{}{}))
