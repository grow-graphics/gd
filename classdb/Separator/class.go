...
func New() Instance {
	...
	return Instance{*(*gdclass.Separator)(unsafe.Pointer(&object))}
}
...
func init() {
	gdclass.Register("Separator", func(ptr gd.Object) any { return [1]gdclass.Separator{*(*gdclass.Separator)(unsafe.Pointer(&ptr))} })
}
