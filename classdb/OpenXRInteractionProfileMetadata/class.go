...
func New() Instance {
	...
	return Instance{*(*gdclass.OpenXRInteractionProfileMetadata)(unsafe.Pointer(&object))}
}
...
*/
//go:nosplit
func (self class) RegisterIoPath(interaction_profile gd.String, display_name gd.String, toplevel_path gd.String, openxr_path gd.String, openxr_extension_name gd.String, action_type gdclass.OpenXRActionActionType) {
	var frame = callframe.New()
