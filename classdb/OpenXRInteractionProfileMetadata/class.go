...
*/
//go:nosplit
func (self class) RegisterProfileRename(old_name gd.String, new_name gd.String) { //gd:OpenXRInteractionProfileMetadata.register_profile_rename
...
*/
//go:nosplit
func (self class) RegisterTopLevelPath(display_name gd.String, openxr_path gd.String, openxr_extension_name gd.String) { //gd:OpenXRInteractionProfileMetadata.register_top_level_path
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) RegisterInteractionProfile(display_name gd.String, openxr_path gd.String, openxr_extension_name gd.String) { //gd:OpenXRInteractionProfileMetadata.register_interaction_profile
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(display_name))
	callframe.Arg(frame, pointers.Get(openxr_path))
	callframe.Arg(frame, pointers.Get(openxr_extension_name))
...
*/
//go:nosplit
func (self class) RegisterIoPath(interaction_profile gd.String, display_name gd.String, toplevel_path gd.String, openxr_path gd.String, openxr_extension_name gd.String, action_type gdclass.OpenXRActionActionType) { //gd:OpenXRInteractionProfileMetadata.register_io_path
	var frame = callframe.New()
