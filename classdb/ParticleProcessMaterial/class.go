...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = *(*gdclass.ParticleProcessMaterial)(unsafe.Pointer(&obj))
		return true
	}
	return false
}
...
func (self class) SetDirection(degrees Vector3.XYZ) { //gd:ParticleProcessMaterial.set_direction
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_direction, 0|(gdextension.SizeVector3<<4), unsafe.Pointer(&struct{ degrees Vector3.XYZ }{degrees}))
}
...
func (self class) SetInheritVelocityRatio(ratio float64) { //gd:ParticleProcessMaterial.set_inherit_velocity_ratio
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_inherit_velocity_ratio, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ ratio float64 }{ratio}))
}

//go:nosplit
func (self class) GetInheritVelocityRatio() float64 { //gd:ParticleProcessMaterial.get_inherit_velocity_ratio
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_inherit_velocity_ratio, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetParam(param Parameter, value Vector2.XY) { //gd:ParticleProcessMaterial.set_param
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_param, 0|(gdextension.SizeInt<<4)|(gdextension.SizeVector2<<8), unsafe.Pointer(&struct {
		param Parameter
		value Vector2.XY
	}{param, value}))
}
...
func (self class) GetParam(param Parameter) Vector2.XY { //gd:ParticleProcessMaterial.get_param
	var r_ret = gdextension.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_param, gdextension.SizeVector2|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ param Parameter }{param}))
	var ret = r_ret
	return ret
}
...
func (self class) GetParamTexture(param Parameter) [1]gdclass.Texture2D { //gd:ParticleProcessMaterial.get_param_texture
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_param_texture, gdextension.SizeObject|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ param Parameter }{param}))
...
func (self class) GetAlphaCurve() [1]gdclass.Texture2D { //gd:ParticleProcessMaterial.get_alpha_curve
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_alpha_curve, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
	var ret = [1]gdclass.Texture2D{gd.PointerWithOwnershipTransferredToGo[gdclass.Texture2D](r_ret)}
	return ret
}
...
func (self class) GetEmissionCurve() [1]gdclass.Texture2D { //gd:ParticleProcessMaterial.get_emission_curve
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_emission_curve, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
	var ret = [1]gdclass.Texture2D{gd.PointerWithOwnershipTransferredToGo[gdclass.Texture2D](r_ret)}
	return ret
}
...
func (self class) GetVelocityLimitCurve() [1]gdclass.Texture2D { //gd:ParticleProcessMaterial.get_velocity_limit_curve
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_velocity_limit_curve, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
	var ret = [1]gdclass.Texture2D{gd.PointerWithOwnershipTransferredToGo[gdclass.Texture2D](r_ret)}
	return ret
}
...
func (self class) SetVelocityPivot(pivot Vector3.XYZ) { //gd:ParticleProcessMaterial.set_velocity_pivot
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_velocity_pivot, 0|(gdextension.SizeVector3<<4), unsafe.Pointer(&struct{ pivot Vector3.XYZ }{pivot}))
}

//go:nosplit
func (self class) GetVelocityPivot() Vector3.XYZ { //gd:ParticleProcessMaterial.get_velocity_pivot
	var r_ret = gdextension.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_velocity_pivot, gdextension.SizeVector3, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetEmissionPointTexture() [1]gdclass.Texture2D { //gd:ParticleProcessMaterial.get_emission_point_texture
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_emission_point_texture, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
	var ret = [1]gdclass.Texture2D{gd.PointerWithOwnershipTransferredToGo[gdclass.Texture2D](r_ret)}
	return ret
}
...
func (self class) GetEmissionNormalTexture() [1]gdclass.Texture2D { //gd:ParticleProcessMaterial.get_emission_normal_texture
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_emission_normal_texture, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
	var ret = [1]gdclass.Texture2D{gd.PointerWithOwnershipTransferredToGo[gdclass.Texture2D](r_ret)}
	return ret
}
...
func (self class) GetEmissionColorTexture() [1]gdclass.Texture2D { //gd:ParticleProcessMaterial.get_emission_color_texture
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_emission_color_texture, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
	var ret = [1]gdclass.Texture2D{gd.PointerWithOwnershipTransferredToGo[gdclass.Texture2D](r_ret)}
	return ret
}
...
func (self class) SetEmissionPointCount(point_count int64) { //gd:ParticleProcessMaterial.set_emission_point_count
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_emission_point_count, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ point_count int64 }{point_count}))
}

//go:nosplit
func (self class) GetEmissionPointCount() int64 { //gd:ParticleProcessMaterial.get_emission_point_count
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_emission_point_count, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetEmissionShapeOffset(emission_shape_offset Vector3.XYZ) { //gd:ParticleProcessMaterial.set_emission_shape_offset
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_emission_shape_offset, 0|(gdextension.SizeVector3<<4), unsafe.Pointer(&struct{ emission_shape_offset Vector3.XYZ }{emission_shape_offset}))
}

//go:nosplit
func (self class) GetEmissionShapeOffset() Vector3.XYZ { //gd:ParticleProcessMaterial.get_emission_shape_offset
	var r_ret = gdextension.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_emission_shape_offset, gdextension.SizeVector3, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetEmissionShapeScale(emission_shape_scale Vector3.XYZ) { //gd:ParticleProcessMaterial.set_emission_shape_scale
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_emission_shape_scale, 0|(gdextension.SizeVector3<<4), unsafe.Pointer(&struct{ emission_shape_scale Vector3.XYZ }{emission_shape_scale}))
}

//go:nosplit
func (self class) GetEmissionShapeScale() Vector3.XYZ { //gd:ParticleProcessMaterial.get_emission_shape_scale
	var r_ret = gdextension.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_emission_shape_scale, gdextension.SizeVector3, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetTurbulenceEnabled() bool { //gd:ParticleProcessMaterial.get_turbulence_enabled
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_turbulence_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetTurbulenceEnabled(turbulence_enabled bool) { //gd:ParticleProcessMaterial.set_turbulence_enabled
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_turbulence_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ turbulence_enabled bool }{turbulence_enabled}))
}

//go:nosplit
func (self class) GetTurbulenceNoiseStrength() float64 { //gd:ParticleProcessMaterial.get_turbulence_noise_strength
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_turbulence_noise_strength, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetTurbulenceNoiseStrength(turbulence_noise_strength float64) { //gd:ParticleProcessMaterial.set_turbulence_noise_strength
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_turbulence_noise_strength, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ turbulence_noise_strength float64 }{turbulence_noise_strength}))
}

//go:nosplit
func (self class) GetTurbulenceNoiseScale() float64 { //gd:ParticleProcessMaterial.get_turbulence_noise_scale
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_turbulence_noise_scale, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetTurbulenceNoiseScale(turbulence_noise_scale float64) { //gd:ParticleProcessMaterial.set_turbulence_noise_scale
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_turbulence_noise_scale, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ turbulence_noise_scale float64 }{turbulence_noise_scale}))
}

//go:nosplit
func (self class) GetTurbulenceNoiseSpeedRandom() float64 { //gd:ParticleProcessMaterial.get_turbulence_noise_speed_random
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_turbulence_noise_speed_random, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetTurbulenceNoiseSpeedRandom(turbulence_noise_speed_random float64) { //gd:ParticleProcessMaterial.set_turbulence_noise_speed_random
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_turbulence_noise_speed_random, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ turbulence_noise_speed_random float64 }{turbulence_noise_speed_random}))
}

//go:nosplit
func (self class) GetTurbulenceNoiseSpeed() Vector3.XYZ { //gd:ParticleProcessMaterial.get_turbulence_noise_speed
	var r_ret = gdextension.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_turbulence_noise_speed, gdextension.SizeVector3, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetTurbulenceNoiseSpeed(turbulence_noise_speed Vector3.XYZ) { //gd:ParticleProcessMaterial.set_turbulence_noise_speed
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_turbulence_noise_speed, 0|(gdextension.SizeVector3<<4), unsafe.Pointer(&struct{ turbulence_noise_speed Vector3.XYZ }{turbulence_noise_speed}))
}
...
func (self class) SetLifetimeRandomness(randomness float64) { //gd:ParticleProcessMaterial.set_lifetime_randomness
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_lifetime_randomness, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ randomness float64 }{randomness}))
}
...
func (self class) GetSubEmitterMode() SubEmitterMode { //gd:ParticleProcessMaterial.get_sub_emitter_mode
	var r_ret = gdextension.Call[SubEmitterMode](gd.ObjectChecked(self.AsObject()), methods.get_sub_emitter_mode, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetSubEmitterMode(mode SubEmitterMode) { //gd:ParticleProcessMaterial.set_sub_emitter_mode
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_sub_emitter_mode, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ mode SubEmitterMode }{mode}))
}

//go:nosplit
func (self class) GetSubEmitterFrequency() float64 { //gd:ParticleProcessMaterial.get_sub_emitter_frequency
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_sub_emitter_frequency, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetSubEmitterFrequency(hz float64) { //gd:ParticleProcessMaterial.set_sub_emitter_frequency
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_sub_emitter_frequency, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ hz float64 }{hz}))
}

//go:nosplit
func (self class) GetSubEmitterAmountAtEnd() int64 { //gd:ParticleProcessMaterial.get_sub_emitter_amount_at_end
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_sub_emitter_amount_at_end, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetSubEmitterAmountAtEnd(amount int64) { //gd:ParticleProcessMaterial.set_sub_emitter_amount_at_end
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_sub_emitter_amount_at_end, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ amount int64 }{amount}))
}

//go:nosplit
func (self class) GetSubEmitterAmountAtCollision() int64 { //gd:ParticleProcessMaterial.get_sub_emitter_amount_at_collision
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_sub_emitter_amount_at_collision, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetSubEmitterAmountAtCollision(amount int64) { //gd:ParticleProcessMaterial.set_sub_emitter_amount_at_collision
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_sub_emitter_amount_at_collision, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ amount int64 }{amount}))
}

//go:nosplit
func (self class) GetSubEmitterAmountAtStart() int64 { //gd:ParticleProcessMaterial.get_sub_emitter_amount_at_start
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_sub_emitter_amount_at_start, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetSubEmitterAmountAtStart(amount int64) { //gd:ParticleProcessMaterial.set_sub_emitter_amount_at_start
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_sub_emitter_amount_at_start, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ amount int64 }{amount}))
}

//go:nosplit
func (self class) GetSubEmitterKeepVelocity() bool { //gd:ParticleProcessMaterial.get_sub_emitter_keep_velocity
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_sub_emitter_keep_velocity, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetSubEmitterKeepVelocity(enable bool) { //gd:ParticleProcessMaterial.set_sub_emitter_keep_velocity
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_sub_emitter_keep_velocity, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) SetAttractorInteractionEnabled(enabled bool) { //gd:ParticleProcessMaterial.set_attractor_interaction_enabled
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_attractor_interaction_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsAttractorInteractionEnabled() bool { //gd:ParticleProcessMaterial.is_attractor_interaction_enabled
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_attractor_interaction_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetCollisionMode(mode CollisionMode) { //gd:ParticleProcessMaterial.set_collision_mode
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_collision_mode, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ mode CollisionMode }{mode}))
}

//go:nosplit
func (self class) GetCollisionMode() CollisionMode { //gd:ParticleProcessMaterial.get_collision_mode
	var r_ret = gdextension.Call[CollisionMode](gd.ObjectChecked(self.AsObject()), methods.get_collision_mode, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetCollisionUseScale(radius bool) { //gd:ParticleProcessMaterial.set_collision_use_scale
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_collision_use_scale, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ radius bool }{radius}))
}

//go:nosplit
func (self class) IsCollisionUsingScale() bool { //gd:ParticleProcessMaterial.is_collision_using_scale
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_collision_using_scale, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetCollisionFriction(friction float64) { //gd:ParticleProcessMaterial.set_collision_friction
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_collision_friction, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ friction float64 }{friction}))
}

//go:nosplit
func (self class) GetCollisionFriction() float64 { //gd:ParticleProcessMaterial.get_collision_friction
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_collision_friction, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetCollisionBounce(bounce float64) { //gd:ParticleProcessMaterial.set_collision_bounce
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_collision_bounce, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ bounce float64 }{bounce}))
}

//go:nosplit
func (self class) GetCollisionBounce() float64 { //gd:ParticleProcessMaterial.get_collision_bounce
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_collision_bounce, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func init() {
	gdclass.Register("ParticleProcessMaterial", func(ptr gd.Object) any { return *(*Instance)(unsafe.Pointer(&ptr)) })
}
