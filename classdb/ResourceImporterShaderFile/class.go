...
func New() Instance {
	...
	return Instance{*(*gdclass.ResourceImporterShaderFile)(unsafe.Pointer(&object))}
}
...
func init() {
	gdclass.Register("ResourceImporterShaderFile", func(ptr gd.Object) any {
		return [1]gdclass.ResourceImporterShaderFile{*(*gdclass.ResourceImporterShaderFile)(unsafe.Pointer(&ptr))}
	})
}
