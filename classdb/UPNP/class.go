...
*/
func (self Instance) GetDevice(index int) [1]gdclass.UPNPDevice {
...
*/
func (self Instance) AddDevice(device [1]gdclass.UPNPDevice) {
...
*/
func (self Instance) SetDevice(index int, device [1]gdclass.UPNPDevice) {
...
*/
func (self Instance) GetGateway() [1]gdclass.UPNPDevice {
...
func New() Instance {
	...
	return Instance{*(*gdclass.UPNP)(unsafe.Pointer(&object))}
}
...
*/
//go:nosplit
func (self class) SetDevice(index gd.Int, device [1]gdclass.UPNPDevice) {
	var frame = callframe.New()
	callframe.Arg(frame, index)
	callframe.Arg(frame, pointers.Get(device[0])[0])
	var r_ret callframe.Nil
...
func init() {
	gdclass.Register("UPNP", func(ptr gd.Object) any { return [1]gdclass.UPNP{*(*gdclass.UPNP)(unsafe.Pointer(&ptr))} })
}

type UPNPResult = gdclass.UPNPUPNPResult
