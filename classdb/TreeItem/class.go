...
func New() Instance {
	...
	return Instance{*(*gdclass.TreeItem)(unsafe.Pointer(&object))}
}
...
*/
//go:nosplit
func (self class) SetCellMode(column gd.Int, mode gdclass.TreeItemTreeCellMode) {
...
*/
//go:nosplit
func (self class) GetCellMode(column gd.Int) gdclass.TreeItemTreeCellMode {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) SetTextDirection(column gd.Int, direction gdclass.ControlTextDirection) {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) GetTextDirection(column gd.Int) gdclass.ControlTextDirection {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) SetAutowrapMode(column gd.Int, autowrap_mode gdclass.TextServerAutowrapMode) {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) GetAutowrapMode(column gd.Int) gdclass.TextServerAutowrapMode {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) SetTextOverrunBehavior(column gd.Int, overrun_behavior gdclass.TextServerOverrunBehavior) {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) GetTextOverrunBehavior(column gd.Int) gdclass.TextServerOverrunBehavior {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) SetStructuredTextBidiOverride(column gd.Int, parser gdclass.TextServerStructuredTextParser) {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) GetStructuredTextBidiOverride(column gd.Int) gdclass.TextServerStructuredTextParser {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) SetIcon(column gd.Int, texture [1]gdclass.Texture2D) {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) SetCustomFont(column gd.Int, font [1]gdclass.Font) {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) AddButton(column gd.Int, button [1]gdclass.Texture2D, id gd.Int, disabled bool, tooltip_text gd.String) {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) GetButton(column gd.Int, button_index gd.Int) [1]gdclass.Texture2D {
	var frame = callframe.New()
	callframe.Arg(frame, column)
	callframe.Arg(frame, button_index)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) SetButton(column gd.Int, button_index gd.Int, button [1]gdclass.Texture2D) {
	var frame = callframe.New()
	callframe.Arg(frame, column)
	callframe.Arg(frame, button_index)
	callframe.Arg(frame, pointers.Get(button[0])[0])
...
*/
//go:nosplit
func (self class) RemoveChild(child [1]gdclass.TreeItem) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) MoveBefore(item [1]gdclass.TreeItem) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) MoveAfter(item [1]gdclass.TreeItem) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(item[0])[0])
	var r_ret callframe.Nil
...
type TreeCellMode = gdclass.TreeItemTreeCellMode
