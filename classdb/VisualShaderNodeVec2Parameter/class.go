...
func (self class) SetDefaultValue(value Vector2.XY) { //gd:VisualShaderNodeVec2Parameter.set_default_value
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_default_value, 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ value Vector2.XY }{value}))
}

//go:nosplit
func (self class) GetDefaultValue() Vector2.XY { //gd:VisualShaderNodeVec2Parameter.get_default_value
	var r_ret = gdextension.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
