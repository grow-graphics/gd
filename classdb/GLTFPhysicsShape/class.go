...
func (self class) FromNode(shape_node [1]gdclass.CollisionShape3D) [1]gdclass.GLTFPhysicsShape { //gd:GLTFPhysicsShape.from_node
	var r_ret = gdextension.CallStatic[gdextension.Object](methods.from_node, gdextension.SizeObject|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ shape_node gdextension.Object }{gdextension.Object(gd.ObjectChecked(shape_node[0].AsObject()))}))
...
func (self class) ToNode(cache_shapes bool) [1]gdclass.CollisionShape3D { //gd:GLTFPhysicsShape.to_node
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.to_node, gdextension.SizeObject|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ cache_shapes bool }{cache_shapes}))
...
func (self class) ToResource(cache_shapes bool) [1]gdclass.Shape3D { //gd:GLTFPhysicsShape.to_resource
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.to_resource, gdextension.SizeObject|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ cache_shapes bool }{cache_shapes}))
...
func (self class) FromDictionary(dictionary Dictionary.Any) [1]gdclass.GLTFPhysicsShape { //gd:GLTFPhysicsShape.from_dictionary
	var r_ret = gdextension.CallStatic[gdextension.Object](methods.from_dictionary, gdextension.SizeObject|(gdextension.SizeDictionary<<4), unsafe.Pointer(&struct{ dictionary gdextension.Dictionary }{pointers.Get(gd.InternalDictionary(dictionary))}))
	var ret = [1]gdclass.GLTFPhysicsShape{gd.PointerWithOwnershipTransferredToGo[gdclass.GLTFPhysicsShape](r_ret)}
	return ret
}
...
func (self class) ToDictionary() Dictionary.Any { //gd:GLTFPhysicsShape.to_dictionary
	var r_ret = gdextension.Call[gdextension.Dictionary](gd.ObjectChecked(self.AsObject()), methods.to_dictionary, gdextension.SizeDictionary, unsafe.Pointer(&struct{}{}))
...
func (self class) GetShapeType() String.Readable { //gd:GLTFPhysicsShape.get_shape_type
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_shape_type, gdextension.SizeString, unsafe.Pointer(&struct{}{}))
...
func (self class) SetShapeType(shape_type String.Readable) { //gd:GLTFPhysicsShape.set_shape_type
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_shape_type, 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ shape_type gdextension.String }{pointers.Get(gd.InternalString(shape_type))}))
}
...
func (self class) GetIsTrigger() bool { //gd:GLTFPhysicsShape.get_is_trigger
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_is_trigger, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetIsTrigger(is_trigger bool) { //gd:GLTFPhysicsShape.set_is_trigger
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_is_trigger, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ is_trigger bool }{is_trigger}))
}

//go:nosplit
func (self class) GetMeshIndex() int64 { //gd:GLTFPhysicsShape.get_mesh_index
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_mesh_index, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetMeshIndex(mesh_index int64) { //gd:GLTFPhysicsShape.set_mesh_index
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_mesh_index, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ mesh_index int64 }{mesh_index}))
}

//go:nosplit
func (self class) GetImporterMesh() [1]gdclass.ImporterMesh { //gd:GLTFPhysicsShape.get_importer_mesh
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_importer_mesh, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
