...
//go:nosplit
func (self class) SetRadius(radius gd.Float) { //gd:GPUParticlesCollisionSphere3D.set_radius
...
//go:nosplit
func (self class) GetRadius() gd.Float { //gd:GPUParticlesCollisionSphere3D.get_radius
	var frame = callframe.New()
