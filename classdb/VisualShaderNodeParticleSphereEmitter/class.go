...
func New() Instance {
	...
	casted := Instance{*(*gdclass.VisualShaderNodeParticleSphereEmitter)(unsafe.Pointer(&object))}
...
func init() {
	gdclass.Register("VisualShaderNodeParticleSphereEmitter", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeParticleSphereEmitter{*(*gdclass.VisualShaderNodeParticleSphereEmitter)(unsafe.Pointer(&ptr))}
	})
}
