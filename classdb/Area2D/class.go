...
*/
func (self Instance) GetOverlappingBodies() [][1]gdclass.Node2D {
	return [][1]gdclass.Node2D(gd.ArrayAs[[][1]gdclass.Node2D](class(self).GetOverlappingBodies()))
}
...
For performance reasons (collisions are all processed at the same time) this list is modified once during the physics step, not immediately after objects are moved. Consider using signals instead.
*/
func (self Instance) GetOverlappingAreas() [][1]gdclass.Area2D {
	return [][1]gdclass.Area2D(gd.ArrayAs[[][1]gdclass.Area2D](class(self).GetOverlappingAreas()))
}
...
//go:nosplit
func (self class) SetGravitySpaceOverrideMode(space_override_mode gdclass.Area2DSpaceOverride) {
...
//go:nosplit
func (self class) GetGravitySpaceOverrideMode() gdclass.Area2DSpaceOverride {
	var frame = callframe.New()
...
//go:nosplit
func (self class) SetLinearDampSpaceOverrideMode(space_override_mode gdclass.Area2DSpaceOverride) {
	var frame = callframe.New()
	callframe.Arg(frame, space_override_mode)
	var r_ret = callframe.Nil
...
//go:nosplit
func (self class) GetLinearDampSpaceOverrideMode() gdclass.Area2DSpaceOverride {
	var frame = callframe.New()
	var r_ret = callframe.Ret[gdclass.Area2DSpaceOverride](frame)
...
//go:nosplit
func (self class) SetAngularDampSpaceOverrideMode(space_override_mode gdclass.Area2DSpaceOverride) {
	var frame = callframe.New()
	callframe.Arg(frame, space_override_mode)
	var r_ret = callframe.Nil
...
//go:nosplit
func (self class) GetAngularDampSpaceOverrideMode() gdclass.Area2DSpaceOverride {
	var frame = callframe.New()
	var r_ret = callframe.Ret[gdclass.Area2DSpaceOverride](frame)
...
*/
//go:nosplit
func (self class) OverlapsBody(body [1]gdclass.Node) bool {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) OverlapsArea(area [1]gdclass.Node) bool {
	var frame = callframe.New()
...
func (self Instance) OnBodyShapeEntered(cb func(body_rid Resource.ID, body [1]gdclass.Node2D, body_shape_index int, local_shape_index int)) {
	self[0].AsObject()[0].Connect(gd.NewStringName("body_shape_entered"), gd.NewCallable(cb), 0)
}

func (self Instance) OnBodyShapeExited(cb func(body_rid Resource.ID, body [1]gdclass.Node2D, body_shape_index int, local_shape_index int)) {
...
func (self Instance) OnAreaShapeEntered(cb func(area_rid Resource.ID, area [1]gdclass.Area2D, area_shape_index int, local_shape_index int)) {
	self[0].AsObject()[0].Connect(gd.NewStringName("area_shape_entered"), gd.NewCallable(cb), 0)
}

func (self Instance) OnAreaShapeExited(cb func(area_rid Resource.ID, area [1]gdclass.Area2D, area_shape_index int, local_shape_index int)) {
...
type SpaceOverride = gdclass.Area2DSpaceOverride
