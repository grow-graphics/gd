...
func (self class) GetExcludeBodies() Array.Contains[RID.Any] { //gd:PhysicsTestMotionParameters3D.get_exclude_bodies
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.PhysicsTestMotionParameters3D.Bind_get_exclude_bodies), gdextension.SizeArray, unsafe.Pointer(&struct{}{}))
...
func (self class) SetExcludeBodies(exclude_list Array.Contains[RID.Any]) { //gd:PhysicsTestMotionParameters3D.set_exclude_bodies
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.PhysicsTestMotionParameters3D.Bind_set_exclude_bodies), 0|(gdextension.SizeArray<<4), unsafe.Pointer(&struct{ exclude_list gdextension.Array }{gdextension.Array(pointers.Get(gd.InternalArray(exclude_list))[0])}))
}

//go:nosplit
func (self class) GetExcludeObjects() Array.Contains[int64] { //gd:PhysicsTestMotionParameters3D.get_exclude_objects
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.PhysicsTestMotionParameters3D.Bind_get_exclude_objects), gdextension.SizeArray, unsafe.Pointer(&struct{}{}))
...
func (self class) SetExcludeObjects(exclude_list Array.Contains[int64]) { //gd:PhysicsTestMotionParameters3D.set_exclude_objects
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.PhysicsTestMotionParameters3D.Bind_set_exclude_objects), 0|(gdextension.SizeArray<<4), unsafe.Pointer(&struct{ exclude_list gdextension.Array }{gdextension.Array(pointers.Get(gd.InternalArray(exclude_list))[0])}))
}
