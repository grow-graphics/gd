...
func (self class) SetPosition(position Vector2.XY) { //gd:Node2D.set_position
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_set_position), 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ position Vector2.XY }{position}))
}

//go:nosplit
func (self class) SetRotation(radians float64) { //gd:Node2D.set_rotation
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_set_rotation), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ radians float64 }{radians}))
}

//go:nosplit
func (self class) SetRotationDegrees(degrees float64) { //gd:Node2D.set_rotation_degrees
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_set_rotation_degrees), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ degrees float64 }{degrees}))
}

//go:nosplit
func (self class) SetSkew(radians float64) { //gd:Node2D.set_skew
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_set_skew), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ radians float64 }{radians}))
}

//go:nosplit
func (self class) SetScale(scale Vector2.XY) { //gd:Node2D.set_scale
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_set_scale), 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ scale Vector2.XY }{scale}))
}

//go:nosplit
func (self class) GetPosition() Vector2.XY { //gd:Node2D.get_position
	var r_ret = gdextension.Call[Vector2.XY](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_get_position), gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetRotation() float64 { //gd:Node2D.get_rotation
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_get_rotation), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetRotationDegrees() float64 { //gd:Node2D.get_rotation_degrees
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_get_rotation_degrees), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetSkew() float64 { //gd:Node2D.get_skew
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_get_skew), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetScale() Vector2.XY { //gd:Node2D.get_scale
	var r_ret = gdextension.Call[Vector2.XY](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_get_scale), gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) Rotate(radians float64) { //gd:Node2D.rotate
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_rotate), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ radians float64 }{radians}))
}
...
func (self class) MoveLocalX(delta float64, scaled bool) { //gd:Node2D.move_local_x
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_move_local_x), 0|(gdextension.SizeFloat<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		delta  float64
		scaled bool
	}{delta, scaled}))
}
...
func (self class) MoveLocalY(delta float64, scaled bool) { //gd:Node2D.move_local_y
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_move_local_y), 0|(gdextension.SizeFloat<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		delta  float64
		scaled bool
	}{delta, scaled}))
}
...
func (self class) Translate(offset Vector2.XY) { //gd:Node2D.translate
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_translate), 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ offset Vector2.XY }{offset}))
}
...
func (self class) GlobalTranslate(offset Vector2.XY) { //gd:Node2D.global_translate
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_global_translate), 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ offset Vector2.XY }{offset}))
}
...
func (self class) ApplyScale(ratio Vector2.XY) { //gd:Node2D.apply_scale
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_apply_scale), 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ ratio Vector2.XY }{ratio}))
}

//go:nosplit
func (self class) SetGlobalPosition(position Vector2.XY) { //gd:Node2D.set_global_position
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_set_global_position), 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ position Vector2.XY }{position}))
}

//go:nosplit
func (self class) GetGlobalPosition() Vector2.XY { //gd:Node2D.get_global_position
	var r_ret = gdextension.Call[Vector2.XY](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_get_global_position), gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetGlobalRotation(radians float64) { //gd:Node2D.set_global_rotation
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_set_global_rotation), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ radians float64 }{radians}))
}

//go:nosplit
func (self class) SetGlobalRotationDegrees(degrees float64) { //gd:Node2D.set_global_rotation_degrees
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_set_global_rotation_degrees), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ degrees float64 }{degrees}))
}

//go:nosplit
func (self class) GetGlobalRotation() float64 { //gd:Node2D.get_global_rotation
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_get_global_rotation), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetGlobalRotationDegrees() float64 { //gd:Node2D.get_global_rotation_degrees
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_get_global_rotation_degrees), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetGlobalSkew(radians float64) { //gd:Node2D.set_global_skew
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_set_global_skew), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ radians float64 }{radians}))
}

//go:nosplit
func (self class) GetGlobalSkew() float64 { //gd:Node2D.get_global_skew
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_get_global_skew), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetGlobalScale(scale Vector2.XY) { //gd:Node2D.set_global_scale
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_set_global_scale), 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ scale Vector2.XY }{scale}))
}

//go:nosplit
func (self class) GetGlobalScale() Vector2.XY { //gd:Node2D.get_global_scale
	var r_ret = gdextension.Call[Vector2.XY](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_get_global_scale), gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetTransform(xform Transform2D.OriginXY) { //gd:Node2D.set_transform
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_set_transform), 0|(gdextension.SizeTransform2D<<4), unsafe.Pointer(&struct{ xform Transform2D.OriginXY }{xform}))
}

//go:nosplit
func (self class) SetGlobalTransform(xform Transform2D.OriginXY) { //gd:Node2D.set_global_transform
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_set_global_transform), 0|(gdextension.SizeTransform2D<<4), unsafe.Pointer(&struct{ xform Transform2D.OriginXY }{xform}))
}
...
func (self class) LookAt(point Vector2.XY) { //gd:Node2D.look_at
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_look_at), 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ point Vector2.XY }{point}))
}
...
func (self class) GetAngleTo(point Vector2.XY) float64 { //gd:Node2D.get_angle_to
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_get_angle_to), gdextension.SizeFloat|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ point Vector2.XY }{point}))
	var ret = r_ret
	return ret
}
...
func (self class) ToLocal(global_point Vector2.XY) Vector2.XY { //gd:Node2D.to_local
	var r_ret = gdextension.Call[Vector2.XY](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_to_local), gdextension.SizeVector2|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ global_point Vector2.XY }{global_point}))
	var ret = r_ret
	return ret
}
...
func (self class) ToGlobal(local_point Vector2.XY) Vector2.XY { //gd:Node2D.to_global
	var r_ret = gdextension.Call[Vector2.XY](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_to_global), gdextension.SizeVector2|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ local_point Vector2.XY }{local_point}))
	var ret = r_ret
	return ret
}
...
func (self class) GetRelativeTransformToParent(parent [1]gdclass.Node) Transform2D.OriginXY { //gd:Node2D.get_relative_transform_to_parent
	var r_ret = gdextension.Call[Transform2D.OriginXY](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node2D.Bind_get_relative_transform_to_parent), gdextension.SizeTransform2D|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ parent gdextension.Object }{gdextension.Object(gd.ObjectChecked(parent[0].AsObject()))}))
	var ret = r_ret
	return ret
}
