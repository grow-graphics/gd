...
func New() Instance {
	object := [1]gd.Object{pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(pointers.Get(gd.NewStringName("VisualShaderNodeCurveTexture"))))})}
...
func (self class) GetTexture() [1]gdclass.CurveTexture { //gd:VisualShaderNodeCurveTexture.get_texture
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.VisualShaderNodeCurveTexture.Bind_get_texture), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
