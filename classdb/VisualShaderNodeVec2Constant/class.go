...
//go:nosplit
func (self class) SetConstant(constant gd.Vector2) { //gd:VisualShaderNodeVec2Constant.set_constant
...
//go:nosplit
func (self class) GetConstant() gd.Vector2 { //gd:VisualShaderNodeVec2Constant.get_constant
	var frame = callframe.New()
