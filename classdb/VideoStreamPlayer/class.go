...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = *(*gdclass.VideoStreamPlayer)(unsafe.Pointer(&obj))
		return true
	}
	return false
}
...
func (self class) SetVolume(volume float64) { //gd:VideoStreamPlayer.set_volume
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_volume, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ volume float64 }{volume}))
}

//go:nosplit
func (self class) GetVolume() float64 { //gd:VideoStreamPlayer.get_volume
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_volume, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetVolumeDb(db float64) { //gd:VideoStreamPlayer.set_volume_db
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_volume_db, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ db float64 }{db}))
}
...
func (self class) SetAudioTrack(track int64) { //gd:VideoStreamPlayer.set_audio_track
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_audio_track, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ track int64 }{track}))
}

//go:nosplit
func (self class) GetAudioTrack() int64 { //gd:VideoStreamPlayer.get_audio_track
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_audio_track, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetStreamName() String.Readable { //gd:VideoStreamPlayer.get_stream_name
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_stream_name, gdextension.SizeString, unsafe.Pointer(&struct{}{}))
...
func (self class) GetStreamLength() float64 { //gd:VideoStreamPlayer.get_stream_length
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_stream_length, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetStreamPosition(position float64) { //gd:VideoStreamPlayer.set_stream_position
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_stream_position, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ position float64 }{position}))
}

//go:nosplit
func (self class) GetStreamPosition() float64 { //gd:VideoStreamPlayer.get_stream_position
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_stream_position, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetAutoplay(enabled bool) { //gd:VideoStreamPlayer.set_autoplay
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_autoplay, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) HasAutoplay() bool { //gd:VideoStreamPlayer.has_autoplay
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.has_autoplay, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetExpand(enable bool) { //gd:VideoStreamPlayer.set_expand
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_expand, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) HasExpand() bool { //gd:VideoStreamPlayer.has_expand
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.has_expand, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetBufferingMsec(msec int64) { //gd:VideoStreamPlayer.set_buffering_msec
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_buffering_msec, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ msec int64 }{msec}))
}

//go:nosplit
func (self class) GetBufferingMsec() int64 { //gd:VideoStreamPlayer.get_buffering_msec
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_buffering_msec, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetVideoTexture() [1]gdclass.Texture2D { //gd:VideoStreamPlayer.get_video_texture
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_video_texture, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func init() {
	gdclass.Register("VideoStreamPlayer", func(ptr gd.Object) any { return *(*Instance)(unsafe.Pointer(&ptr)) })
}
