...
func New() Instance {
	...
	casted := Instance{*(*gdclass.VisualShaderNodeScreenNormalWorldSpace)(unsafe.Pointer(&object))}
...
func init() {
	gdclass.Register("VisualShaderNodeScreenNormalWorldSpace", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeScreenNormalWorldSpace{*(*gdclass.VisualShaderNodeScreenNormalWorldSpace)(unsafe.Pointer(&ptr))}
	})
}
