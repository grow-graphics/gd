...
//go:nosplit
func (self class) SetOpType(op_type gdclass.VisualShaderNodeStepOpType) {
...
//go:nosplit
func (self class) GetOpType() gdclass.VisualShaderNodeStepOpType {
	var frame = callframe.New()
...
type OpType = gdclass.VisualShaderNodeStepOpType
