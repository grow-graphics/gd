...
*/
//go:nosplit
func (self class) GetTabCount() gd.Int { //gd:TabContainer.get_tab_count
...
//go:nosplit
func (self class) SetCurrentTab(tab_idx gd.Int) { //gd:TabContainer.set_current_tab
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetCurrentTab() gd.Int { //gd:TabContainer.get_current_tab
	var frame = callframe.New()
	var r_ret = callframe.Ret[gd.Int](frame)
...
*/
//go:nosplit
func (self class) GetPreviousTab() gd.Int { //gd:TabContainer.get_previous_tab
	var frame = callframe.New()
	var r_ret = callframe.Ret[gd.Int](frame)
...
*/
//go:nosplit
func (self class) GetTabControl(tab_idx gd.Int) [1]gdclass.Control { //gd:TabContainer.get_tab_control
	var frame = callframe.New()
	callframe.Arg(frame, tab_idx)
	var r_ret = callframe.Ret[gd.EnginePointer](frame)
...
*/
//go:nosplit
func (self class) SetTabIcon(tab_idx gd.Int, icon [1]gdclass.Texture2D) { //gd:TabContainer.set_tab_icon
	var frame = callframe.New()
	callframe.Arg(frame, tab_idx)
...
*/
//go:nosplit
func (self class) GetTabIcon(tab_idx gd.Int) [1]gdclass.Texture2D { //gd:TabContainer.get_tab_icon
	var frame = callframe.New()
	callframe.Arg(frame, tab_idx)
	var r_ret = callframe.Ret[gd.EnginePointer](frame)
...
*/
//go:nosplit
func (self class) SetTabIconMaxWidth(tab_idx gd.Int, width gd.Int) { //gd:TabContainer.set_tab_icon_max_width
	var frame = callframe.New()
	callframe.Arg(frame, tab_idx)
...
*/
//go:nosplit
func (self class) GetTabIconMaxWidth(tab_idx gd.Int) gd.Int { //gd:TabContainer.get_tab_icon_max_width
	var frame = callframe.New()
	callframe.Arg(frame, tab_idx)
	var r_ret = callframe.Ret[gd.Int](frame)
...
*/
//go:nosplit
func (self class) SetTabDisabled(tab_idx gd.Int, disabled bool) { //gd:TabContainer.set_tab_disabled
	var frame = callframe.New()
	callframe.Arg(frame, tab_idx)
...
*/
//go:nosplit
func (self class) IsTabDisabled(tab_idx gd.Int) bool { //gd:TabContainer.is_tab_disabled
	var frame = callframe.New()
	callframe.Arg(frame, tab_idx)
	var r_ret = callframe.Ret[bool](frame)
...
*/
//go:nosplit
func (self class) SetTabHidden(tab_idx gd.Int, hidden bool) { //gd:TabContainer.set_tab_hidden
	var frame = callframe.New()
	callframe.Arg(frame, tab_idx)
...
*/
//go:nosplit
func (self class) IsTabHidden(tab_idx gd.Int) bool { //gd:TabContainer.is_tab_hidden
	var frame = callframe.New()
	callframe.Arg(frame, tab_idx)
	var r_ret = callframe.Ret[bool](frame)
...
*/
//go:nosplit
func (self class) SetTabMetadata(tab_idx gd.Int, metadata gd.Variant) { //gd:TabContainer.set_tab_metadata
	var frame = callframe.New()
	callframe.Arg(frame, tab_idx)
...
*/
//go:nosplit
func (self class) GetTabMetadata(tab_idx gd.Int) gd.Variant { //gd:TabContainer.get_tab_metadata
	var frame = callframe.New()
	callframe.Arg(frame, tab_idx)
...
*/
//go:nosplit
func (self class) SetTabButtonIcon(tab_idx gd.Int, icon [1]gdclass.Texture2D) { //gd:TabContainer.set_tab_button_icon
	var frame = callframe.New()
	callframe.Arg(frame, tab_idx)
	callframe.Arg(frame, pointers.Get(icon[0])[0])
	var r_ret = callframe.Nil
...
*/
//go:nosplit
func (self class) GetTabButtonIcon(tab_idx gd.Int) [1]gdclass.Texture2D { //gd:TabContainer.get_tab_button_icon
	var frame = callframe.New()
	callframe.Arg(frame, tab_idx)
	var r_ret = callframe.Ret[gd.EnginePointer](frame)
...
*/
//go:nosplit
func (self class) GetTabIdxAtPoint(point gd.Vector2) gd.Int { //gd:TabContainer.get_tab_idx_at_point
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetTabIdxFromControl(control [1]gdclass.Control) gd.Int { //gd:TabContainer.get_tab_idx_from_control
	var frame = callframe.New()
...
//go:nosplit
func (self class) SetTabsRearrangeGroup(group_id gd.Int) { //gd:TabContainer.set_tabs_rearrange_group
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetTabsRearrangeGroup() gd.Int { //gd:TabContainer.get_tabs_rearrange_group
	var frame = callframe.New()
	var r_ret = callframe.Ret[gd.Int](frame)
