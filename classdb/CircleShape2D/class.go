...
func (self class) SetRadius(radius float64) { //gd:CircleShape2D.set_radius
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.CircleShape2D.Bind_set_radius, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ radius float64 }{radius}))
}

//go:nosplit
func (self class) GetRadius() float64 { //gd:CircleShape2D.get_radius
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.CircleShape2D.Bind_get_radius, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
