...
func (self class) GetProfile() [1]gdclass.SkeletonProfile { //gd:RetargetModifier3D.get_profile
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.RetargetModifier3D.Bind_get_profile), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
