...
func (self class) SetCubeMap(value [1]gdclass.TextureLayered) { //gd:VisualShaderNodeCubemap.set_cube_map
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.VisualShaderNodeCubemap.Bind_set_cube_map, 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ value gdextension.Object }{gdextension.Object(gd.ObjectChecked(value[0].AsObject()))}))
}
