...
func (self class) GetProbeData() [1]gdclass.VoxelGIData { //gd:VoxelGI.get_probe_data
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.VoxelGI.Bind_get_probe_data), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) GetCameraAttributes() [1]gdclass.CameraAttributes { //gd:VoxelGI.get_camera_attributes
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.VoxelGI.Bind_get_camera_attributes), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
