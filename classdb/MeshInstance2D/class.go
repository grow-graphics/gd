...
func (self class) GetMesh() [1]gdclass.Mesh { //gd:MeshInstance2D.get_mesh
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.MeshInstance2D.Bind_get_mesh), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) GetTexture() [1]gdclass.Texture2D { //gd:MeshInstance2D.get_texture
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.MeshInstance2D.Bind_get_texture), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
