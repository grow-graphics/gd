...
func (self class) GetCurrentGridMap() [1]gdclass.GridMap { //gd:GridMapEditorPlugin.get_current_grid_map
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.GridMapEditorPlugin.Bind_get_current_grid_map), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) GetSelectedCells() Array.Any { //gd:GridMapEditorPlugin.get_selected_cells
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.GridMapEditorPlugin.Bind_get_selected_cells), gdextension.SizeArray, unsafe.Pointer(&struct{}{}))
