...
func (self class) CreatePlaceholder() [1]gdclass.Resource { //gd:CubemapArray.create_placeholder
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.CubemapArray.Bind_create_placeholder, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
