...
func (self class) SetNightSky(night_sky [1]gdclass.Texture2D) { //gd:PhysicalSkyMaterial.set_night_sky
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_night_sky, 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ night_sky gdextension.Object }{gdextension.Object(gd.CallerIncrements(night_sky[0].AsObject()))}))
}
