...
func New() Instance {
	...
	return Instance{*(*gdclass.OggPacketSequencePlayback)(unsafe.Pointer(&object))}
}
...
func init() {
	gdclass.Register("OggPacketSequencePlayback", func(ptr gd.Object) any {
		return [1]gdclass.OggPacketSequencePlayback{*(*gdclass.OggPacketSequencePlayback)(unsafe.Pointer(&ptr))}
	})
}
