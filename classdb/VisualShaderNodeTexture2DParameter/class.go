...
func New() Instance {
	...
	casted := Instance{*(*gdclass.VisualShaderNodeTexture2DParameter)(unsafe.Pointer(&object))}
...
func init() {
	gdclass.Register("VisualShaderNodeTexture2DParameter", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeTexture2DParameter{*(*gdclass.VisualShaderNodeTexture2DParameter)(unsafe.Pointer(&ptr))}
	})
}
