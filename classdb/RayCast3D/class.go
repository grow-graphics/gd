...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = *(*gdclass.RayCast3D)(unsafe.Pointer(&obj))
		return true
	}
	return false
}
...
func (self class) GetCollisionPoint() Vector3.XYZ { //gd:RayCast3D.get_collision_point
	var r_ret = gdextension.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_collision_point, gdextension.SizeVector3, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetCollisionNormal() Vector3.XYZ { //gd:RayCast3D.get_collision_normal
	var r_ret = gdextension.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_collision_normal, gdextension.SizeVector3, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetCollisionFaceIndex() int64 { //gd:RayCast3D.get_collision_face_index
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_collision_face_index, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDebugShapeThickness(debug_shape_thickness int64) { //gd:RayCast3D.set_debug_shape_thickness
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_debug_shape_thickness, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ debug_shape_thickness int64 }{debug_shape_thickness}))
}

//go:nosplit
func (self class) GetDebugShapeThickness() int64 { //gd:RayCast3D.get_debug_shape_thickness
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_debug_shape_thickness, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func init() {
	gdclass.Register("RayCast3D", func(ptr gd.Object) any { return *(*Instance)(unsafe.Pointer(&ptr)) })
}
