...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = *(*gdclass.VisualShaderNodeTexture2DArray)(unsafe.Pointer(&obj))
		return true
	}
	return false
}
...
func (self class) SetTextureArray(value [1]gdclass.TextureLayered) { //gd:VisualShaderNodeTexture2DArray.set_texture_array
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_texture_array, 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ value gdextension.Object }{gdextension.Object(gd.CallerIncrements(value[0].AsObject()))}))
}
...
func init() {
	gdclass.Register("VisualShaderNodeTexture2DArray", func(ptr gd.Object) any { return *(*Instance)(unsafe.Pointer(&ptr)) })
}
