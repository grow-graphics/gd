...
func New() Instance {
	...
	return Instance{*(*gdclass.CompressedTexture2D)(unsafe.Pointer(&object))}
}
...
func (self class) Load(path gd.String) error {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.CompressedTexture2D.Bind_load, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
func (self class) GetLoadPath() gd.String {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.CompressedTexture2D.Bind_get_load_path, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = pointers.New[gd.String](r_ret.Get())
	frame.Free()
	return ret
}
func (self class) AsCompressedTexture2D() Advanced    { return *((*Advanced)(unsafe.Pointer(&self))) }
func (self Instance) AsCompressedTexture2D() Instance { return *((*Instance)(unsafe.Pointer(&self))) }
...
func init() {
	gdclass.Register("CompressedTexture2D", func(ptr gd.Object) any {
		return [1]gdclass.CompressedTexture2D{*(*gdclass.CompressedTexture2D)(unsafe.Pointer(&ptr))}
	})
}
