...
func (self class) SetMixRate(hz float64) { //gd:AudioStreamGenerator.set_mix_rate
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.AudioStreamGenerator.Bind_set_mix_rate), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ hz float64 }{hz}))
}

//go:nosplit
func (self class) GetMixRate() float64 { //gd:AudioStreamGenerator.get_mix_rate
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.AudioStreamGenerator.Bind_get_mix_rate), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetMixRateMode(mode AudioStreamGeneratorMixRate) { //gd:AudioStreamGenerator.set_mix_rate_mode
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.AudioStreamGenerator.Bind_set_mix_rate_mode), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ mode AudioStreamGeneratorMixRate }{mode}))
}

//go:nosplit
func (self class) GetMixRateMode() AudioStreamGeneratorMixRate { //gd:AudioStreamGenerator.get_mix_rate_mode
	var r_ret = gdextension.Call[AudioStreamGeneratorMixRate](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.AudioStreamGenerator.Bind_get_mix_rate_mode), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetBufferLength(seconds float64) { //gd:AudioStreamGenerator.set_buffer_length
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.AudioStreamGenerator.Bind_set_buffer_length), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ seconds float64 }{seconds}))
}

//go:nosplit
func (self class) GetBufferLength() float64 { //gd:AudioStreamGenerator.get_buffer_length
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.AudioStreamGenerator.Bind_get_buffer_length), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
