...
func (self class) SetPath(path String.Readable) { //gd:Resource.set_path
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Resource.Bind_set_path, 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ path gdextension.String }{gdextension.String(pointers.Get(gd.InternalString(path))[0])}))
}
...
func (self class) TakeOverPath(path String.Readable) { //gd:Resource.take_over_path
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Resource.Bind_take_over_path, 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ path gdextension.String }{gdextension.String(pointers.Get(gd.InternalString(path))[0])}))
}

//go:nosplit
func (self class) GetPath() String.Readable { //gd:Resource.get_path
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.Resource.Bind_get_path, gdextension.SizeString, unsafe.Pointer(&struct{}{}))
...
func (self class) SetPathCache(path String.Readable) { //gd:Resource.set_path_cache
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Resource.Bind_set_path_cache, 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ path gdextension.String }{gdextension.String(pointers.Get(gd.InternalString(path))[0])}))
}

//go:nosplit
func (self class) SetName(name String.Readable) { //gd:Resource.set_name
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Resource.Bind_set_name, 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ name gdextension.String }{gdextension.String(pointers.Get(gd.InternalString(name))[0])}))
}

//go:nosplit
func (self class) GetName() String.Readable { //gd:Resource.get_name
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.Resource.Bind_get_name, gdextension.SizeString, unsafe.Pointer(&struct{}{}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) GetRid() RID.Any { //gd:Resource.get_rid
	var r_ret = gdunsafe.Call[RID.Any](self.AsObject(), gd.Global.Methods.Resource.Bind_get_rid, gdextension.SizeRID, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetLocalToScene(enable bool) { //gd:Resource.set_local_to_scene
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Resource.Bind_set_local_to_scene, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) IsLocalToScene() bool { //gd:Resource.is_local_to_scene
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.Resource.Bind_is_local_to_scene, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetLocalScene() [1]gdclass.Node { //gd:Resource.get_local_scene
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.Resource.Bind_get_local_scene, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) SetupLocalToScene() { //gd:Resource.setup_local_to_scene
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Resource.Bind_setup_local_to_scene, 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) ResetState() { //gd:Resource.reset_state
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Resource.Bind_reset_state, 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) SetIdForPath(path String.Readable, id String.Readable) { //gd:Resource.set_id_for_path
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Resource.Bind_set_id_for_path, 0|(gdextension.SizeString<<4)|(gdextension.SizeString<<8), unsafe.Pointer(&struct {
...
func (self class) GetIdForPath(path String.Readable) String.Readable { //gd:Resource.get_id_for_path
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.Resource.Bind_get_id_for_path, gdextension.SizeString|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ path gdextension.String }{gdextension.String(pointers.Get(gd.InternalString(path))[0])}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) IsBuiltIn() bool { //gd:Resource.is_built_in
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.Resource.Bind_is_built_in, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GenerateSceneUniqueId() String.Readable { //gd:Resource.generate_scene_unique_id
	var r_ret = gdunsafe.CallStatic[[1]gd.EnginePointer](gd.Global.Methods.Resource.Bind_generate_scene_unique_id, gdextension.SizeString, unsafe.Pointer(&struct{}{}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) SetSceneUniqueId(id String.Readable) { //gd:Resource.set_scene_unique_id
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Resource.Bind_set_scene_unique_id, 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ id gdextension.String }{gdextension.String(pointers.Get(gd.InternalString(id))[0])}))
}

//go:nosplit
func (self class) GetSceneUniqueId() String.Readable { //gd:Resource.get_scene_unique_id
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.Resource.Bind_get_scene_unique_id, gdextension.SizeString, unsafe.Pointer(&struct{}{}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) EmitChanged() { //gd:Resource.emit_changed
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Resource.Bind_emit_changed, 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) Duplicate(subresources bool) [1]gdclass.Resource { //gd:Resource.duplicate
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.Resource.Bind_duplicate, gdextension.SizeObject|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ subresources bool }{subresources}))
