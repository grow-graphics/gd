...
func (self class) SetRadius(radius float64) { //gd:CapsuleShape3D.set_radius
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.CapsuleShape3D.Bind_set_radius, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ radius float64 }{radius}))
}

//go:nosplit
func (self class) GetRadius() float64 { //gd:CapsuleShape3D.get_radius
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.CapsuleShape3D.Bind_get_radius, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetHeight(height float64) { //gd:CapsuleShape3D.set_height
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.CapsuleShape3D.Bind_set_height, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ height float64 }{height}))
}

//go:nosplit
func (self class) GetHeight() float64 { //gd:CapsuleShape3D.get_height
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.CapsuleShape3D.Bind_get_height, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
