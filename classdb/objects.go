...
type BlaziumClient = [1]gdclass.BlaziumClient
...
type ColorButton = [1]gdclass.ColorButton
...
type DiscordEmbeddedAppClient = [1]gdclass.DiscordEmbeddedAppClient
type DiscordEmbeddedAppResponse = [1]gdclass.DiscordEmbeddedAppResponse
type DiscordEmbeddedAppResult = [1]gdclass.DiscordEmbeddedAppResult
type DisplayServer = [1]gdclass.DisplayServer
type ENV = [1]gdclass.ENV
...
type EditorHScrollBox = [1]gdclass.EditorHScrollBox
...
type EditorScrollBox = [1]gdclass.EditorScrollBox
...
type EditorVScrollBox = [1]gdclass.EditorVScrollBox
...
type FoldableContainer = [1]gdclass.FoldableContainer
type FoldableGroup = [1]gdclass.FoldableGroup
...
type GameServerInfo = [1]gdclass.GameServerInfo
...
type LobbyClient = [1]gdclass.LobbyClient
type LobbyInfo = [1]gdclass.LobbyInfo
type LobbyPeer = [1]gdclass.LobbyPeer
type LobbyResponse = [1]gdclass.LobbyResponse
type LobbyResult = [1]gdclass.LobbyResult
type LoginAccessTokenResponse = [1]gdclass.LoginAccessTokenResponse
type LoginAccessTokenResult = [1]gdclass.LoginAccessTokenResult
type LoginClient = [1]gdclass.LoginClient
type LoginConnectResponse = [1]gdclass.LoginConnectResponse
type LoginConnectResult = [1]gdclass.LoginConnectResult
type LoginIDResponse = [1]gdclass.LoginIDResponse
type LoginIDResult = [1]gdclass.LoginIDResult
type LoginRefreshTokenResponse = [1]gdclass.LoginRefreshTokenResponse
type LoginRefreshTokenResult = [1]gdclass.LoginRefreshTokenResult
type LoginURLResponse = [1]gdclass.LoginURLResponse
type LoginURLResult = [1]gdclass.LoginURLResult
type LoginVerifyTokenResponse = [1]gdclass.LoginVerifyTokenResponse
type LoginVerifyTokenResult = [1]gdclass.LoginVerifyTokenResult
...
type MasterServerClient = [1]gdclass.MasterServerClient
type MasterServerListResponse = [1]gdclass.MasterServerListResponse
type MasterServerListResult = [1]gdclass.MasterServerListResult
type MasterServerResponse = [1]gdclass.MasterServerResponse
type MasterServerResult = [1]gdclass.MasterServerResult
...
type POGRClient = [1]gdclass.POGRClient
type POGRResponse = [1]gdclass.POGRResponse
type POGRResult = [1]gdclass.POGRResult
...
type ResourceImporterCSV = [1]gdclass.ResourceImporterCSV
...
type SQLite = [1]gdclass.SQLite
type SQLiteAccess = [1]gdclass.SQLiteAccess
type SQLiteColumnSchema = [1]gdclass.SQLiteColumnSchema
type SQLiteDatabase = [1]gdclass.SQLiteDatabase
type SQLiteQuery = [1]gdclass.SQLiteQuery
type SQLiteQueryResult = [1]gdclass.SQLiteQueryResult
...
type ScriptedLobbyClient = [1]gdclass.ScriptedLobbyClient
type ScriptedLobbyResponse = [1]gdclass.ScriptedLobbyResponse
type ScriptedLobbyResult = [1]gdclass.ScriptedLobbyResult
...
type SixWayLightingMaterial = [1]gdclass.SixWayLightingMaterial
...
type ThirdPartyClient = [1]gdclass.ThirdPartyClient
...
type ViewLobbyResponse = [1]gdclass.ViewLobbyResponse
type ViewLobbyResult = [1]gdclass.ViewLobbyResult
...
type YoutubePlayablesClient = [1]gdclass.YoutubePlayablesClient
type YoutubePlayablesResponse = [1]gdclass.YoutubePlayablesResponse
type YoutubePlayablesResult = [1]gdclass.YoutubePlayablesResult
