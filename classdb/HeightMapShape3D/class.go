...
func New() Instance {
	...
	return Instance{*(*gdclass.HeightMapShape3D)(unsafe.Pointer(&object))}
}
...
*/
//go:nosplit
func (self class) UpdateMapDataFromImage(image [1]gdclass.Image, height_min gd.Float, height_max gd.Float) {
	var frame = callframe.New()
