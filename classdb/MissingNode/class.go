...
func New() Instance {
	object := [1]gd.Object{pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(pointers.Get(gd.NewStringName("MissingNode"))))})}
...
func (self class) SetOriginalClass(name String.Readable) { //gd:MissingNode.set_original_class
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.MissingNode.Bind_set_original_class), 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ name gdextension.String }{pointers.Get(gd.InternalString(name))}))
}

//go:nosplit
func (self class) GetOriginalClass() String.Readable { //gd:MissingNode.get_original_class
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.MissingNode.Bind_get_original_class), gdextension.SizeString, unsafe.Pointer(&struct{}{}))
...
func (self class) SetOriginalScene(name String.Readable) { //gd:MissingNode.set_original_scene
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.MissingNode.Bind_set_original_scene), 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ name gdextension.String }{pointers.Get(gd.InternalString(name))}))
}

//go:nosplit
func (self class) GetOriginalScene() String.Readable { //gd:MissingNode.get_original_scene
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.MissingNode.Bind_get_original_scene), gdextension.SizeString, unsafe.Pointer(&struct{}{}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) SetRecordingProperties(enable bool) { //gd:MissingNode.set_recording_properties
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.MissingNode.Bind_set_recording_properties), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) IsRecordingProperties() bool { //gd:MissingNode.is_recording_properties
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.MissingNode.Bind_is_recording_properties), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
