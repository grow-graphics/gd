...
func (self class) SetFont(font [1]gdclass.Font) { //gd:LabelSettings.set_font
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.LabelSettings.Bind_set_font, 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ font gdextension.Object }{gdextension.Object(gd.ObjectChecked(font[0].AsObject()))}))
}
