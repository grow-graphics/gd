...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = *(*gdclass.VisualShaderNodeVaryingGetter)(unsafe.Pointer(&obj))
		return true
	}
	return false
}
...
func init() {
	gdclass.Register("VisualShaderNodeVaryingGetter", func(ptr gd.Object) any { return *(*Instance)(unsafe.Pointer(&ptr)) })
}
