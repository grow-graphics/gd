...
func New() Instance {
	...
	casted := Instance{*(*gdclass.VisualShaderNodeOuterProduct)(unsafe.Pointer(&object))}
...
func init() {
	gdclass.Register("VisualShaderNodeOuterProduct", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeOuterProduct{*(*gdclass.VisualShaderNodeOuterProduct)(unsafe.Pointer(&ptr))}
	})
}
