...
func (self class) GetTexture() [1]gdclass.CurveXYZTexture { //gd:VisualShaderNodeCurveXYZTexture.get_texture
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.VisualShaderNodeCurveXYZTexture.Bind_get_texture, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
