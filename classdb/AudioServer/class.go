...
func (self class) SetBusCount(amount int64) { //gd:AudioServer.set_bus_count
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_set_bus_count), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ amount int64 }{amount}))
}

//go:nosplit
func (self class) GetBusCount() int64 { //gd:AudioServer.get_bus_count
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_bus_count), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) RemoveBus(index int64) { //gd:AudioServer.remove_bus
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_remove_bus), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ index int64 }{index}))
}
...
func (self class) AddBus(at_position int64) { //gd:AudioServer.add_bus
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_add_bus), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ at_position int64 }{at_position}))
}
...
func (self class) MoveBus(index int64, to_index int64) { //gd:AudioServer.move_bus
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_move_bus), 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		index    int64
		to_index int64
	}{index, to_index}))
}
...
func (self class) GetBusChannels(bus_idx int64) int64 { //gd:AudioServer.get_bus_channels
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_bus_channels), gdextension.SizeInt|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ bus_idx int64 }{bus_idx}))
	var ret = r_ret
	return ret
}
...
func (self class) SetBusVolumeDb(bus_idx int64, volume_db float64) { //gd:AudioServer.set_bus_volume_db
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_set_bus_volume_db), 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), unsafe.Pointer(&struct {
		bus_idx   int64
		volume_db float64
	}{bus_idx, volume_db}))
}
...
func (self class) GetBusVolumeDb(bus_idx int64) float64 { //gd:AudioServer.get_bus_volume_db
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_bus_volume_db), gdextension.SizeFloat|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ bus_idx int64 }{bus_idx}))
	var ret = r_ret
	return ret
}
...
func (self class) SetBusVolumeLinear(bus_idx int64, volume_linear float64) { //gd:AudioServer.set_bus_volume_linear
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_set_bus_volume_linear), 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), unsafe.Pointer(&struct {
		bus_idx       int64
...
func (self class) GetBusVolumeLinear(bus_idx int64) float64 { //gd:AudioServer.get_bus_volume_linear
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_bus_volume_linear), gdextension.SizeFloat|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ bus_idx int64 }{bus_idx}))
	var ret = r_ret
	return ret
}
...
func (self class) SetBusSolo(bus_idx int64, enable bool) { //gd:AudioServer.set_bus_solo
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_set_bus_solo), 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		bus_idx int64
		enable  bool
	}{bus_idx, enable}))
}
...
func (self class) IsBusSolo(bus_idx int64) bool { //gd:AudioServer.is_bus_solo
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_is_bus_solo), gdextension.SizeBool|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ bus_idx int64 }{bus_idx}))
	var ret = r_ret
	return ret
}
...
func (self class) SetBusMute(bus_idx int64, enable bool) { //gd:AudioServer.set_bus_mute
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_set_bus_mute), 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		bus_idx int64
		enable  bool
	}{bus_idx, enable}))
}
...
func (self class) IsBusMute(bus_idx int64) bool { //gd:AudioServer.is_bus_mute
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_is_bus_mute), gdextension.SizeBool|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ bus_idx int64 }{bus_idx}))
	var ret = r_ret
	return ret
}
...
func (self class) SetBusBypassEffects(bus_idx int64, enable bool) { //gd:AudioServer.set_bus_bypass_effects
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_set_bus_bypass_effects), 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		bus_idx int64
		enable  bool
	}{bus_idx, enable}))
}
...
func (self class) IsBusBypassingEffects(bus_idx int64) bool { //gd:AudioServer.is_bus_bypassing_effects
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_is_bus_bypassing_effects), gdextension.SizeBool|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ bus_idx int64 }{bus_idx}))
	var ret = r_ret
	return ret
}
...
func (self class) AddBusEffect(bus_idx int64, effect [1]gdclass.AudioEffect, at_position int64) { //gd:AudioServer.add_bus_effect
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_add_bus_effect), 0|(gdextension.SizeInt<<4)|(gdextension.SizeObject<<8)|(gdextension.SizeInt<<12), unsafe.Pointer(&struct {
		bus_idx     int64
...
func (self class) RemoveBusEffect(bus_idx int64, effect_idx int64) { //gd:AudioServer.remove_bus_effect
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_remove_bus_effect), 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		bus_idx    int64
		effect_idx int64
	}{bus_idx, effect_idx}))
}
...
func (self class) GetBusEffectCount(bus_idx int64) int64 { //gd:AudioServer.get_bus_effect_count
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_bus_effect_count), gdextension.SizeInt|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ bus_idx int64 }{bus_idx}))
	var ret = r_ret
	return ret
}
...
func (self class) SwapBusEffects(bus_idx int64, effect_idx int64, by_effect_idx int64) { //gd:AudioServer.swap_bus_effects
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_swap_bus_effects), 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeInt<<12), unsafe.Pointer(&struct {
		bus_idx       int64
		effect_idx    int64
		by_effect_idx int64
...
func (self class) SetBusEffectEnabled(bus_idx int64, effect_idx int64, enabled bool) { //gd:AudioServer.set_bus_effect_enabled
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_set_bus_effect_enabled), 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeBool<<12), unsafe.Pointer(&struct {
		bus_idx    int64
		effect_idx int64
		enabled    bool
...
func (self class) IsBusEffectEnabled(bus_idx int64, effect_idx int64) bool { //gd:AudioServer.is_bus_effect_enabled
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_is_bus_effect_enabled), gdextension.SizeBool|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		bus_idx    int64
		effect_idx int64
	}{bus_idx, effect_idx}))
	var ret = r_ret
...
func (self class) GetBusPeakVolumeLeftDb(bus_idx int64, channel int64) float64 { //gd:AudioServer.get_bus_peak_volume_left_db
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_bus_peak_volume_left_db), gdextension.SizeFloat|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		bus_idx int64
		channel int64
	}{bus_idx, channel}))
	var ret = r_ret
...
func (self class) GetBusPeakVolumeRightDb(bus_idx int64, channel int64) float64 { //gd:AudioServer.get_bus_peak_volume_right_db
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_bus_peak_volume_right_db), gdextension.SizeFloat|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		bus_idx int64
		channel int64
	}{bus_idx, channel}))
	var ret = r_ret
...
func (self class) SetPlaybackSpeedScale(scale float64) { //gd:AudioServer.set_playback_speed_scale
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_set_playback_speed_scale), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ scale float64 }{scale}))
}

//go:nosplit
func (self class) GetPlaybackSpeedScale() float64 { //gd:AudioServer.get_playback_speed_scale
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_playback_speed_scale), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) Lock() { //gd:AudioServer.lock
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_lock), 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) Unlock() { //gd:AudioServer.unlock
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_unlock), 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) GetSpeakerMode() SpeakerMode { //gd:AudioServer.get_speaker_mode
	var r_ret = gdextension.Call[SpeakerMode](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_speaker_mode), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetMixRate() float64 { //gd:AudioServer.get_mix_rate
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_mix_rate), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetInputMixRate() float64 { //gd:AudioServer.get_input_mix_rate
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_input_mix_rate), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetOutputDeviceList() Packed.Strings { //gd:AudioServer.get_output_device_list
	var r_ret = gdextension.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_output_device_list), gdextension.SizePackedArray, unsafe.Pointer(&struct{}{}))
...
func (self class) GetTimeToNextMix() float64 { //gd:AudioServer.get_time_to_next_mix
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_time_to_next_mix), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetTimeSinceLastMix() float64 { //gd:AudioServer.get_time_since_last_mix
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_time_since_last_mix), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetOutputLatency() float64 { //gd:AudioServer.get_output_latency
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_output_latency), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetInputDeviceList() Packed.Strings { //gd:AudioServer.get_input_device_list
	var r_ret = gdextension.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_get_input_device_list), gdextension.SizePackedArray, unsafe.Pointer(&struct{}{}))
	var ret = Packed.Strings(Array.Through(gd.PackedStringArrayProxy{}, pointers.Pack(pointers.Let[gd.PackedStringArray](r_ret))))
	return ret
}
...
func (self class) SetBusLayout(bus_layout [1]gdclass.AudioBusLayout) { //gd:AudioServer.set_bus_layout
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_set_bus_layout), 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ bus_layout gdextension.Object }{gdextension.Object(gd.ObjectChecked(bus_layout[0].AsObject()))}))
}
...
func (self class) SetEnableTaggingUsedAudioStreams(enable bool) { //gd:AudioServer.set_enable_tagging_used_audio_streams
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_set_enable_tagging_used_audio_streams), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}
...
func (self class) IsStreamRegisteredAsSample(stream [1]gdclass.AudioStream) bool { //gd:AudioServer.is_stream_registered_as_sample
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_is_stream_registered_as_sample), gdextension.SizeBool|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ stream gdextension.Object }{gdextension.Object(gd.ObjectChecked(stream[0].AsObject()))}))
	var ret = r_ret
	return ret
}
...
func (self class) RegisterStreamAsSample(stream [1]gdclass.AudioStream) { //gd:AudioServer.register_stream_as_sample
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioServer.Bind_register_stream_as_sample), 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ stream gdextension.Object }{gdextension.Object(gd.ObjectChecked(stream[0].AsObject()))}))
}
