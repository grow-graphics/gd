...
func New() Instance {
	...
	return Instance{*(*gdclass.CompressedTexture2DArray)(unsafe.Pointer(&object))}
}
...
func init() {
	gdclass.Register("CompressedTexture2DArray", func(ptr gd.Object) any {
		return [1]gdclass.CompressedTexture2DArray{*(*gdclass.CompressedTexture2DArray)(unsafe.Pointer(&ptr))}
	})
}
