...
func New() Instance {
	object := [1]gd.Object{pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(pointers.Get(gd.NewStringName("EditorFileDialog"))))})}
...
func (self class) SetFilters(filters Packed.Strings) { //gd:EditorFileDialog.set_filters
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.EditorFileDialog.Bind_set_filters), 0|(gdextension.SizePackedArray<<4), unsafe.Pointer(&struct {
...
func (self class) GetOptionName(option int64) String.Readable { //gd:EditorFileDialog.get_option_name
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.EditorFileDialog.Bind_get_option_name), gdextension.SizeString|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ option int64 }{option}))
...
func (self class) GetSelectedOptions() Dictionary.Any { //gd:EditorFileDialog.get_selected_options
	var r_ret = gdextension.Call[gdextension.Dictionary](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.EditorFileDialog.Bind_get_selected_options), gdextension.SizeDictionary, unsafe.Pointer(&struct{}{}))
...
func (self class) SetFilenameFilter(filter String.Readable) { //gd:EditorFileDialog.set_filename_filter
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.EditorFileDialog.Bind_set_filename_filter), 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ filter gdextension.String }{pointers.Get(gd.InternalString(filter))}))
}
...
func (self class) GetFilenameFilter() String.Readable { //gd:EditorFileDialog.get_filename_filter
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.EditorFileDialog.Bind_get_filename_filter), gdextension.SizeString, unsafe.Pointer(&struct{}{}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) GetCurrentDir() String.Readable { //gd:EditorFileDialog.get_current_dir
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.EditorFileDialog.Bind_get_current_dir), gdextension.SizeString, unsafe.Pointer(&struct{}{}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) GetCurrentFile() String.Readable { //gd:EditorFileDialog.get_current_file
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.EditorFileDialog.Bind_get_current_file), gdextension.SizeString, unsafe.Pointer(&struct{}{}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) GetCurrentPath() String.Readable { //gd:EditorFileDialog.get_current_path
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.EditorFileDialog.Bind_get_current_path), gdextension.SizeString, unsafe.Pointer(&struct{}{}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) SetCurrentDir(dir String.Readable) { //gd:EditorFileDialog.set_current_dir
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.EditorFileDialog.Bind_set_current_dir), 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ dir gdextension.String }{pointers.Get(gd.InternalString(dir))}))
}

//go:nosplit
func (self class) SetCurrentFile(file String.Readable) { //gd:EditorFileDialog.set_current_file
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.EditorFileDialog.Bind_set_current_file), 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ file gdextension.String }{pointers.Get(gd.InternalString(file))}))
}

//go:nosplit
func (self class) SetCurrentPath(path String.Readable) { //gd:EditorFileDialog.set_current_path
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.EditorFileDialog.Bind_set_current_path), 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ path gdextension.String }{pointers.Get(gd.InternalString(path))}))
}
...
func (self class) GetVbox() [1]gdclass.VBoxContainer { //gd:EditorFileDialog.get_vbox
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.EditorFileDialog.Bind_get_vbox), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) GetLineEdit() [1]gdclass.LineEdit { //gd:EditorFileDialog.get_line_edit
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.EditorFileDialog.Bind_get_line_edit), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
