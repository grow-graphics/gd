...
func (self class) GetCustomViewport() [1]gdclass.Node { //gd:Camera2D.get_custom_viewport
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Camera2D.Bind_get_custom_viewport), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
