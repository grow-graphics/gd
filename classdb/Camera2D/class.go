...
func (self class) SetOffset(offset Vector2.XY) { //gd:Camera2D.set_offset
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_offset, 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ offset Vector2.XY }{offset}))
}

//go:nosplit
func (self class) GetOffset() Vector2.XY { //gd:Camera2D.get_offset
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.Camera2D.Bind_get_offset, gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetAnchorMode(anchor_mode AnchorMode) { //gd:Camera2D.set_anchor_mode
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_anchor_mode, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ anchor_mode AnchorMode }{anchor_mode}))
}

//go:nosplit
func (self class) GetAnchorMode() AnchorMode { //gd:Camera2D.get_anchor_mode
	var r_ret = gdunsafe.Call[AnchorMode](self.AsObject(), gd.Global.Methods.Camera2D.Bind_get_anchor_mode, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetIgnoreRotation(ignore bool) { //gd:Camera2D.set_ignore_rotation
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_ignore_rotation, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ ignore bool }{ignore}))
}

//go:nosplit
func (self class) IsIgnoringRotation() bool { //gd:Camera2D.is_ignoring_rotation
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.Camera2D.Bind_is_ignoring_rotation, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetProcessCallback(mode Camera2DProcessCallback) { //gd:Camera2D.set_process_callback
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_process_callback, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ mode Camera2DProcessCallback }{mode}))
}

//go:nosplit
func (self class) GetProcessCallback() Camera2DProcessCallback { //gd:Camera2D.get_process_callback
	var r_ret = gdunsafe.Call[Camera2DProcessCallback](self.AsObject(), gd.Global.Methods.Camera2D.Bind_get_process_callback, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetEnabled(enabled bool) { //gd:Camera2D.set_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsEnabled() bool { //gd:Camera2D.is_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.Camera2D.Bind_is_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) MakeCurrent() { //gd:Camera2D.make_current
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_make_current, 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) IsCurrent() bool { //gd:Camera2D.is_current
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.Camera2D.Bind_is_current, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetLimit(margin Rect2.Side, limit int64) { //gd:Camera2D.set_limit
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_limit, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		margin Rect2.Side
		limit  int64
	}{margin, limit}))
}
...
func (self class) GetLimit(margin Rect2.Side) int64 { //gd:Camera2D.get_limit
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.Camera2D.Bind_get_limit, gdextension.SizeInt|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ margin Rect2.Side }{margin}))
	var ret = r_ret
	return ret
}
...
func (self class) SetLimitSmoothingEnabled(limit_smoothing_enabled bool) { //gd:Camera2D.set_limit_smoothing_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_limit_smoothing_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ limit_smoothing_enabled bool }{limit_smoothing_enabled}))
}

//go:nosplit
func (self class) IsLimitSmoothingEnabled() bool { //gd:Camera2D.is_limit_smoothing_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.Camera2D.Bind_is_limit_smoothing_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDragVerticalEnabled(enabled bool) { //gd:Camera2D.set_drag_vertical_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_drag_vertical_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsDragVerticalEnabled() bool { //gd:Camera2D.is_drag_vertical_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.Camera2D.Bind_is_drag_vertical_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDragHorizontalEnabled(enabled bool) { //gd:Camera2D.set_drag_horizontal_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_drag_horizontal_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsDragHorizontalEnabled() bool { //gd:Camera2D.is_drag_horizontal_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.Camera2D.Bind_is_drag_horizontal_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDragVerticalOffset(offset float64) { //gd:Camera2D.set_drag_vertical_offset
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_drag_vertical_offset, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ offset float64 }{offset}))
}

//go:nosplit
func (self class) GetDragVerticalOffset() float64 { //gd:Camera2D.get_drag_vertical_offset
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.Camera2D.Bind_get_drag_vertical_offset, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDragHorizontalOffset(offset float64) { //gd:Camera2D.set_drag_horizontal_offset
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_drag_horizontal_offset, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ offset float64 }{offset}))
}

//go:nosplit
func (self class) GetDragHorizontalOffset() float64 { //gd:Camera2D.get_drag_horizontal_offset
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.Camera2D.Bind_get_drag_horizontal_offset, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDragMargin(margin Rect2.Side, drag_margin float64) { //gd:Camera2D.set_drag_margin
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_drag_margin, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), unsafe.Pointer(&struct {
		margin      Rect2.Side
		drag_margin float64
	}{margin, drag_margin}))
}
...
func (self class) GetDragMargin(margin Rect2.Side) float64 { //gd:Camera2D.get_drag_margin
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.Camera2D.Bind_get_drag_margin, gdextension.SizeFloat|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ margin Rect2.Side }{margin}))
	var ret = r_ret
	return ret
}
...
func (self class) GetTargetPosition() Vector2.XY { //gd:Camera2D.get_target_position
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.Camera2D.Bind_get_target_position, gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetScreenCenterPosition() Vector2.XY { //gd:Camera2D.get_screen_center_position
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.Camera2D.Bind_get_screen_center_position, gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetZoom(zoom Vector2.XY) { //gd:Camera2D.set_zoom
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_zoom, 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ zoom Vector2.XY }{zoom}))
}

//go:nosplit
func (self class) GetZoom() Vector2.XY { //gd:Camera2D.get_zoom
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.Camera2D.Bind_get_zoom, gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetCustomViewport() [1]gdclass.Node { //gd:Camera2D.get_custom_viewport
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.Camera2D.Bind_get_custom_viewport, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) SetPositionSmoothingSpeed(position_smoothing_speed float64) { //gd:Camera2D.set_position_smoothing_speed
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_position_smoothing_speed, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ position_smoothing_speed float64 }{position_smoothing_speed}))
}

//go:nosplit
func (self class) GetPositionSmoothingSpeed() float64 { //gd:Camera2D.get_position_smoothing_speed
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.Camera2D.Bind_get_position_smoothing_speed, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetPositionSmoothingEnabled(position_smoothing_speed bool) { //gd:Camera2D.set_position_smoothing_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_position_smoothing_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ position_smoothing_speed bool }{position_smoothing_speed}))
}

//go:nosplit
func (self class) IsPositionSmoothingEnabled() bool { //gd:Camera2D.is_position_smoothing_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.Camera2D.Bind_is_position_smoothing_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetRotationSmoothingEnabled(enabled bool) { //gd:Camera2D.set_rotation_smoothing_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_rotation_smoothing_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsRotationSmoothingEnabled() bool { //gd:Camera2D.is_rotation_smoothing_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.Camera2D.Bind_is_rotation_smoothing_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetRotationSmoothingSpeed(speed float64) { //gd:Camera2D.set_rotation_smoothing_speed
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_rotation_smoothing_speed, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ speed float64 }{speed}))
}

//go:nosplit
func (self class) GetRotationSmoothingSpeed() float64 { //gd:Camera2D.get_rotation_smoothing_speed
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.Camera2D.Bind_get_rotation_smoothing_speed, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) ForceUpdateScroll() { //gd:Camera2D.force_update_scroll
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_force_update_scroll, 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) ResetSmoothing() { //gd:Camera2D.reset_smoothing
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_reset_smoothing, 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) Align() { //gd:Camera2D.align
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_align, 0, unsafe.Pointer(&struct{}{}))
}

//go:nosplit
func (self class) SetScreenDrawingEnabled(screen_drawing_enabled bool) { //gd:Camera2D.set_screen_drawing_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_screen_drawing_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ screen_drawing_enabled bool }{screen_drawing_enabled}))
}

//go:nosplit
func (self class) IsScreenDrawingEnabled() bool { //gd:Camera2D.is_screen_drawing_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.Camera2D.Bind_is_screen_drawing_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetLimitDrawingEnabled(limit_drawing_enabled bool) { //gd:Camera2D.set_limit_drawing_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_limit_drawing_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ limit_drawing_enabled bool }{limit_drawing_enabled}))
}

//go:nosplit
func (self class) IsLimitDrawingEnabled() bool { //gd:Camera2D.is_limit_drawing_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.Camera2D.Bind_is_limit_drawing_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetMarginDrawingEnabled(margin_drawing_enabled bool) { //gd:Camera2D.set_margin_drawing_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Camera2D.Bind_set_margin_drawing_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ margin_drawing_enabled bool }{margin_drawing_enabled}))
}

//go:nosplit
func (self class) IsMarginDrawingEnabled() bool { //gd:Camera2D.is_margin_drawing_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.Camera2D.Bind_is_margin_drawing_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
