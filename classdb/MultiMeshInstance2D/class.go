...
func (self class) GetMultimesh() [1]gdclass.MultiMesh { //gd:MultiMeshInstance2D.get_multimesh
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.MultiMeshInstance2D.Bind_get_multimesh), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) GetTexture() [1]gdclass.Texture2D { //gd:MultiMeshInstance2D.get_texture
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.MultiMeshInstance2D.Bind_get_texture), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
