...
func (self class) SetGizmoExtents(extents float64) { //gd:Marker3D.set_gizmo_extents
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Marker3D.Bind_set_gizmo_extents), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ extents float64 }{extents}))
}

//go:nosplit
func (self class) GetGizmoExtents() float64 { //gd:Marker3D.get_gizmo_extents
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Marker3D.Bind_get_gizmo_extents), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
