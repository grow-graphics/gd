...
func New() Instance {
	...
	casted := Instance{*(*gdclass.AnimationNodeOutput)(unsafe.Pointer(&object))}
...
func init() {
	gdclass.Register("AnimationNodeOutput", func(ptr gd.Object) any {
		return [1]gdclass.AnimationNodeOutput{*(*gdclass.AnimationNodeOutput)(unsafe.Pointer(&ptr))}
	})
}
