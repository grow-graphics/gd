...
func (self class) GetOccluder() [1]gdclass.Occluder3D { //gd:OccluderInstance3D.get_occluder
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.OccluderInstance3D.Bind_get_occluder), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
