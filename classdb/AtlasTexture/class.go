...
func (self class) GetAtlas() [1]gdclass.Texture2D { //gd:AtlasTexture.get_atlas
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AtlasTexture.Bind_get_atlas), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
