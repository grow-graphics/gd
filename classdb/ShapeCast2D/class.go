...
func (self class) SetEnabled(enabled bool) { //gd:ShapeCast2D.set_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_set_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsEnabled() bool { //gd:ShapeCast2D.is_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_is_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetShape() [1]gdclass.Shape2D { //gd:ShapeCast2D.get_shape
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_shape, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) SetTargetPosition(local_point Vector2.XY) { //gd:ShapeCast2D.set_target_position
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_set_target_position, 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ local_point Vector2.XY }{local_point}))
}

//go:nosplit
func (self class) GetTargetPosition() Vector2.XY { //gd:ShapeCast2D.get_target_position
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_target_position, gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetMargin(margin float64) { //gd:ShapeCast2D.set_margin
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_set_margin, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ margin float64 }{margin}))
}

//go:nosplit
func (self class) GetMargin() float64 { //gd:ShapeCast2D.get_margin
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_margin, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetMaxResults(max_results int64) { //gd:ShapeCast2D.set_max_results
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_set_max_results, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ max_results int64 }{max_results}))
}

//go:nosplit
func (self class) GetMaxResults() int64 { //gd:ShapeCast2D.get_max_results
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_max_results, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) IsColliding() bool { //gd:ShapeCast2D.is_colliding
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_is_colliding, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetCollisionCount() int64 { //gd:ShapeCast2D.get_collision_count
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_collision_count, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) ForceShapecastUpdate() { //gd:ShapeCast2D.force_shapecast_update
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_force_shapecast_update, 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) GetCollider(index int64) [1]gd.Object { //gd:ShapeCast2D.get_collider
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_collider, gdextension.SizeObject|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ index int64 }{index}))
...
func (self class) GetColliderRid(index int64) RID.Any { //gd:ShapeCast2D.get_collider_rid
	var r_ret = gdunsafe.Call[RID.Any](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_collider_rid, gdextension.SizeRID|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ index int64 }{index}))
	var ret = r_ret
	return ret
}
...
func (self class) GetColliderShape(index int64) int64 { //gd:ShapeCast2D.get_collider_shape
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_collider_shape, gdextension.SizeInt|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ index int64 }{index}))
	var ret = r_ret
	return ret
}
...
func (self class) GetCollisionPoint(index int64) Vector2.XY { //gd:ShapeCast2D.get_collision_point
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_collision_point, gdextension.SizeVector2|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ index int64 }{index}))
	var ret = r_ret
	return ret
}
...
func (self class) GetCollisionNormal(index int64) Vector2.XY { //gd:ShapeCast2D.get_collision_normal
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_collision_normal, gdextension.SizeVector2|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ index int64 }{index}))
	var ret = r_ret
	return ret
}
...
func (self class) GetClosestCollisionSafeFraction() float64 { //gd:ShapeCast2D.get_closest_collision_safe_fraction
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_closest_collision_safe_fraction, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetClosestCollisionUnsafeFraction() float64 { //gd:ShapeCast2D.get_closest_collision_unsafe_fraction
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_closest_collision_unsafe_fraction, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) AddExceptionRid(rid RID.Any) { //gd:ShapeCast2D.add_exception_rid
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_add_exception_rid, 0|(gdextension.SizeRID<<4), unsafe.Pointer(&struct{ rid RID.Any }{rid}))
}
...
func (self class) AddException(node [1]gdclass.CollisionObject2D) { //gd:ShapeCast2D.add_exception
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_add_exception, 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ node gdextension.Object }{gdextension.Object(gd.PointerWithOwnershipTransferredToGodot(node[0].AsObject()[0]))}))
}
...
func (self class) RemoveExceptionRid(rid RID.Any) { //gd:ShapeCast2D.remove_exception_rid
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_remove_exception_rid, 0|(gdextension.SizeRID<<4), unsafe.Pointer(&struct{ rid RID.Any }{rid}))
}
...
func (self class) ClearExceptions() { //gd:ShapeCast2D.clear_exceptions
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_clear_exceptions, 0, unsafe.Pointer(&struct{}{}))
}

//go:nosplit
func (self class) SetCollisionMask(mask int64) { //gd:ShapeCast2D.set_collision_mask
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_set_collision_mask, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ mask int64 }{mask}))
}

//go:nosplit
func (self class) GetCollisionMask() int64 { //gd:ShapeCast2D.get_collision_mask
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_collision_mask, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetCollisionMaskValue(layer_number int64, value bool) { //gd:ShapeCast2D.set_collision_mask_value
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_set_collision_mask_value, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		layer_number int64
		value        bool
	}{layer_number, value}))
}
...
func (self class) GetCollisionMaskValue(layer_number int64) bool { //gd:ShapeCast2D.get_collision_mask_value
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_collision_mask_value, gdextension.SizeBool|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ layer_number int64 }{layer_number}))
	var ret = r_ret
	return ret
}
...
func (self class) SetExcludeParentBody(mask bool) { //gd:ShapeCast2D.set_exclude_parent_body
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_set_exclude_parent_body, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ mask bool }{mask}))
}

//go:nosplit
func (self class) GetExcludeParentBody() bool { //gd:ShapeCast2D.get_exclude_parent_body
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_exclude_parent_body, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetCollideWithAreas(enable bool) { //gd:ShapeCast2D.set_collide_with_areas
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_set_collide_with_areas, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) IsCollideWithAreasEnabled() bool { //gd:ShapeCast2D.is_collide_with_areas_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_is_collide_with_areas_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetCollideWithBodies(enable bool) { //gd:ShapeCast2D.set_collide_with_bodies
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_set_collide_with_bodies, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) IsCollideWithBodiesEnabled() bool { //gd:ShapeCast2D.is_collide_with_bodies_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_is_collide_with_bodies_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetCollisionResult() Array.Any { //gd:ShapeCast2D.get_collision_result
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.ShapeCast2D.Bind_get_collision_result, gdextension.SizeArray, unsafe.Pointer(&struct{}{}))
