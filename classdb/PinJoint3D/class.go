...
func (self class) SetParam(param Param, value float64) { //gd:PinJoint3D.set_param
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.PinJoint3D.Bind_set_param, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), unsafe.Pointer(&struct {
		param Param
		value float64
	}{param, value}))
}
...
func (self class) GetParam(param Param) float64 { //gd:PinJoint3D.get_param
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.PinJoint3D.Bind_get_param, gdextension.SizeFloat|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ param Param }{param}))
	var ret = r_ret
	return ret
}
