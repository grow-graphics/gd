...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = *(*gdclass.Font)(unsafe.Pointer(&obj))
		return true
	}
	return false
}
...
func (self class) SetFallbacks(fallbacks Array.Contains[[1]gdclass.Font]) { //gd:Font.set_fallbacks
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_fallbacks, 0|(gdextension.SizeArray<<4), unsafe.Pointer(&struct{ fallbacks gdextension.Array }{pointers.Get(gd.InternalArray(fallbacks))}))
}

//go:nosplit
func (self class) GetFallbacks() Array.Contains[[1]gdclass.Font] { //gd:Font.get_fallbacks
	var r_ret = gdextension.Call[gdextension.Array](gd.ObjectChecked(self.AsObject()), methods.get_fallbacks, gdextension.SizeArray, unsafe.Pointer(&struct{}{}))
...
func (self class) GetRids() Array.Contains[RID.Any] { //gd:Font.get_rids
	var r_ret = gdextension.Call[gdextension.Array](gd.ObjectChecked(self.AsObject()), methods.get_rids, gdextension.SizeArray, unsafe.Pointer(&struct{}{}))
...
func (self class) GetHeight(font_size int64) float64 { //gd:Font.get_height
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_height, gdextension.SizeFloat|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ font_size int64 }{font_size}))
	var ret = r_ret
	return ret
}
...
func (self class) GetAscent(font_size int64) float64 { //gd:Font.get_ascent
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_ascent, gdextension.SizeFloat|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ font_size int64 }{font_size}))
	var ret = r_ret
	return ret
}
...
func (self class) GetDescent(font_size int64) float64 { //gd:Font.get_descent
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_descent, gdextension.SizeFloat|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ font_size int64 }{font_size}))
	var ret = r_ret
	return ret
}
...
func (self class) GetUnderlinePosition(font_size int64) float64 { //gd:Font.get_underline_position
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_underline_position, gdextension.SizeFloat|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ font_size int64 }{font_size}))
	var ret = r_ret
	return ret
}
...
func (self class) GetUnderlineThickness(font_size int64) float64 { //gd:Font.get_underline_thickness
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_underline_thickness, gdextension.SizeFloat|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ font_size int64 }{font_size}))
	var ret = r_ret
	return ret
}
...
func (self class) GetFontName() String.Readable { //gd:Font.get_font_name
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_font_name, gdextension.SizeString, unsafe.Pointer(&struct{}{}))
...
func (self class) GetFontStyleName() String.Readable { //gd:Font.get_font_style_name
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_font_style_name, gdextension.SizeString, unsafe.Pointer(&struct{}{}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) GetOtNameStrings() Dictionary.Any { //gd:Font.get_ot_name_strings
	var r_ret = gdextension.Call[gdextension.Dictionary](gd.ObjectChecked(self.AsObject()), methods.get_ot_name_strings, gdextension.SizeDictionary, unsafe.Pointer(&struct{}{}))
...
func (self class) GetFontStyle() TextServer.FontStyle { //gd:Font.get_font_style
	var r_ret = gdextension.Call[TextServer.FontStyle](gd.ObjectChecked(self.AsObject()), methods.get_font_style, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetFontWeight() int64 { //gd:Font.get_font_weight
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_font_weight, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetFontStretch() int64 { //gd:Font.get_font_stretch
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_font_stretch, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetSpacing(spacing TextServer.SpacingType) int64 { //gd:Font.get_spacing
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_spacing, gdextension.SizeInt|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ spacing TextServer.SpacingType }{spacing}))
	var ret = r_ret
	return ret
}
...
func (self class) GetOpentypeFeatures() Dictionary.Any { //gd:Font.get_opentype_features
	var r_ret = gdextension.Call[gdextension.Dictionary](gd.ObjectChecked(self.AsObject()), methods.get_opentype_features, gdextension.SizeDictionary, unsafe.Pointer(&struct{}{}))
	var ret = Dictionary.Through(gd.DictionaryProxy[variant.Any, variant.Any]{}, pointers.Pack(pointers.New[gd.Dictionary](r_ret)))
	return ret
}
...
func (self class) SetCacheCapacity(single_line int64, multi_line int64) { //gd:Font.set_cache_capacity
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_cache_capacity, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		single_line int64
		multi_line  int64
...
func (self class) GetStringSize(text String.Readable, alignment GUI.HorizontalAlignment, width float64, font_size int64, justification_flags TextServer.JustificationFlag, direction TextServer.Direction, orientation TextServer.Orientation) Vector2.XY { //gd:Font.get_string_size
	var r_ret = gdextension.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_string_size, gdextension.SizeVector2|(gdextension.SizeString<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeFloat<<12)|(gdextension.SizeInt<<16)|(gdextension.SizeInt<<20)|(gdextension.SizeInt<<24)|(gdextension.SizeInt<<28), unsafe.Pointer(&struct {
...
func (self class) GetCharSize(char int64, font_size int64) Vector2.XY { //gd:Font.get_char_size
	var r_ret = gdextension.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_char_size, gdextension.SizeVector2|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		char      int64
		font_size int64
	}{char, font_size}))
	var ret = r_ret
...
func (self class) DrawChar(canvas_item RID.Any, pos Vector2.XY, char int64, font_size int64, modulate Color.RGBA) float64 { //gd:Font.draw_char
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.draw_char, gdextension.SizeFloat|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeInt<<16)|(gdextension.SizeColor<<20), unsafe.Pointer(&struct {
		canvas_item RID.Any
		pos         Vector2.XY
		char        int64
		font_size   int64
...
func (self class) DrawCharOutline(canvas_item RID.Any, pos Vector2.XY, char int64, font_size int64, size int64, modulate Color.RGBA) float64 { //gd:Font.draw_char_outline
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.draw_char_outline, gdextension.SizeFloat|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeInt<<16)|(gdextension.SizeInt<<20)|(gdextension.SizeColor<<24), unsafe.Pointer(&struct {
		canvas_item RID.Any
		pos         Vector2.XY
		char        int64
		font_size   int64
...
func (self class) HasChar(char int64) bool { //gd:Font.has_char
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.has_char, gdextension.SizeBool|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ char int64 }{char}))
	var ret = r_ret
	return ret
}
...
func (self class) GetSupportedChars() String.Readable { //gd:Font.get_supported_chars
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_supported_chars, gdextension.SizeString, unsafe.Pointer(&struct{}{}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) IsLanguageSupported(language String.Readable) bool { //gd:Font.is_language_supported
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_language_supported, gdextension.SizeBool|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ language gdextension.String }{pointers.Get(gd.InternalString(language))}))
	var ret = r_ret
	return ret
}
...
func (self class) IsScriptSupported(script String.Readable) bool { //gd:Font.is_script_supported
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_script_supported, gdextension.SizeBool|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ script gdextension.String }{pointers.Get(gd.InternalString(script))}))
	var ret = r_ret
	return ret
}
...
func (self class) GetSupportedFeatureList() Dictionary.Any { //gd:Font.get_supported_feature_list
	var r_ret = gdextension.Call[gdextension.Dictionary](gd.ObjectChecked(self.AsObject()), methods.get_supported_feature_list, gdextension.SizeDictionary, unsafe.Pointer(&struct{}{}))
	var ret = Dictionary.Through(gd.DictionaryProxy[variant.Any, variant.Any]{}, pointers.Pack(pointers.New[gd.Dictionary](r_ret)))
	return ret
}
...
func (self class) GetSupportedVariationList() Dictionary.Any { //gd:Font.get_supported_variation_list
	var r_ret = gdextension.Call[gdextension.Dictionary](gd.ObjectChecked(self.AsObject()), methods.get_supported_variation_list, gdextension.SizeDictionary, unsafe.Pointer(&struct{}{}))
	var ret = Dictionary.Through(gd.DictionaryProxy[variant.Any, variant.Any]{}, pointers.Pack(pointers.New[gd.Dictionary](r_ret)))
	return ret
}
...
func init() {
	gdclass.Register("Font", func(ptr gd.Object) any { return *(*Instance)(unsafe.Pointer(&ptr)) })
}
