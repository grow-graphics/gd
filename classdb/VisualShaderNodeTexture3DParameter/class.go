...
func New() Instance {
	...
	casted := Instance{*(*gdclass.VisualShaderNodeTexture3DParameter)(unsafe.Pointer(&object))}
...
func init() {
	gdclass.Register("VisualShaderNodeTexture3DParameter", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeTexture3DParameter{*(*gdclass.VisualShaderNodeTexture3DParameter)(unsafe.Pointer(&ptr))}
	})
}
