...
func New() Instance {
	...
	casted := Instance{*(*gdclass.VisualShaderNodeVaryingSetter)(unsafe.Pointer(&object))}
...
func init() {
	gdclass.Register("VisualShaderNodeVaryingSetter", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeVaryingSetter{*(*gdclass.VisualShaderNodeVaryingSetter)(unsafe.Pointer(&ptr))}
	})
}
