...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = *(*gdclass.NavigationAgent2D)(unsafe.Pointer(&obj))
		return true
	}
	return false
}
...
func (self class) GetPathfindingAlgorithm() NavigationPathQueryParameters2D.PathfindingAlgorithm { //gd:NavigationAgent2D.get_pathfinding_algorithm
	var r_ret = gdextension.Call[NavigationPathQueryParameters2D.PathfindingAlgorithm](gd.ObjectChecked(self.AsObject()), methods.get_pathfinding_algorithm, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetPathPostprocessing() NavigationPathQueryParameters2D.PathPostProcessing { //gd:NavigationAgent2D.get_path_postprocessing
	var r_ret = gdextension.Call[NavigationPathQueryParameters2D.PathPostProcessing](gd.ObjectChecked(self.AsObject()), methods.get_path_postprocessing, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetPathMetadataFlags() NavigationPathQueryParameters2D.PathMetadataFlags { //gd:NavigationAgent2D.get_path_metadata_flags
	var r_ret = gdextension.Call[NavigationPathQueryParameters2D.PathMetadataFlags](gd.ObjectChecked(self.AsObject()), methods.get_path_metadata_flags, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetTargetPosition(position Vector2.XY) { //gd:NavigationAgent2D.set_target_position
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_target_position, 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ position Vector2.XY }{position}))
}
...
func (self class) GetNextPathPosition() Vector2.XY { //gd:NavigationAgent2D.get_next_path_position
	var r_ret = gdextension.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_next_path_position, gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetVelocityForced(velocity Vector2.XY) { //gd:NavigationAgent2D.set_velocity_forced
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_velocity_forced, 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ velocity Vector2.XY }{velocity}))
}
...
func (self class) GetFinalPosition() Vector2.XY { //gd:NavigationAgent2D.get_final_position
	var r_ret = gdextension.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_final_position, gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDebugPathCustomLineWidth(line_width float64) { //gd:NavigationAgent2D.set_debug_path_custom_line_width
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_debug_path_custom_line_width, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ line_width float64 }{line_width}))
}

//go:nosplit
func (self class) GetDebugPathCustomLineWidth() float64 { //gd:NavigationAgent2D.get_debug_path_custom_line_width
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_debug_path_custom_line_width, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func init() {
	gdclass.Register("NavigationAgent2D", func(ptr gd.Object) any { return *(*Instance)(unsafe.Pointer(&ptr)) })
}
