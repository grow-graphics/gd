...
func (self class) GetCurrentNavigationResult() [1]gdclass.NavigationPathQueryResult2D { //gd:NavigationAgent2D.get_current_navigation_result
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.NavigationAgent2D.Bind_get_current_navigation_result), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
