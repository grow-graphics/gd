...
//go:nosplit
func (self class) SetSize(size gd.Vector3) { //gd:GPUParticlesCollisionBox3D.set_size
...
//go:nosplit
func (self class) GetSize() gd.Vector3 { //gd:GPUParticlesCollisionBox3D.get_size
	var frame = callframe.New()
