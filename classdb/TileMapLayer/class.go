...
func (self class) SetCell(coords Vector2i.XY, source_id int64, atlas_coords Vector2i.XY, alternative_tile int64) { //gd:TileMapLayer.set_cell
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_cell, 0|(gdextension.SizeVector2i<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeVector2i<<12)|(gdextension.SizeInt<<16), unsafe.Pointer(&struct {
		coords           Vector2i.XY
		source_id        int64
...
func (self class) EraseCell(coords Vector2i.XY) { //gd:TileMapLayer.erase_cell
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_erase_cell, 0|(gdextension.SizeVector2i<<4), unsafe.Pointer(&struct{ coords Vector2i.XY }{coords}))
}
...
func (self class) FixInvalidTiles() { //gd:TileMapLayer.fix_invalid_tiles
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_fix_invalid_tiles, 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) Clear() { //gd:TileMapLayer.clear
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_clear, 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) GetCellSourceId(coords Vector2i.XY) int64 { //gd:TileMapLayer.get_cell_source_id
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_cell_source_id, gdextension.SizeInt|(gdextension.SizeVector2i<<4), unsafe.Pointer(&struct{ coords Vector2i.XY }{coords}))
	var ret = r_ret
	return ret
}
...
func (self class) GetCellAtlasCoords(coords Vector2i.XY) Vector2i.XY { //gd:TileMapLayer.get_cell_atlas_coords
	var r_ret = gdunsafe.Call[Vector2i.XY](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_cell_atlas_coords, gdextension.SizeVector2i|(gdextension.SizeVector2i<<4), unsafe.Pointer(&struct{ coords Vector2i.XY }{coords}))
	var ret = r_ret
	return ret
}
...
func (self class) GetCellAlternativeTile(coords Vector2i.XY) int64 { //gd:TileMapLayer.get_cell_alternative_tile
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_cell_alternative_tile, gdextension.SizeInt|(gdextension.SizeVector2i<<4), unsafe.Pointer(&struct{ coords Vector2i.XY }{coords}))
	var ret = r_ret
	return ret
}
...
func (self class) GetCellTileData(coords Vector2i.XY) [1]gdclass.TileData { //gd:TileMapLayer.get_cell_tile_data
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_cell_tile_data, gdextension.SizeObject|(gdextension.SizeVector2i<<4), unsafe.Pointer(&struct{ coords Vector2i.XY }{coords}))
...
func (self class) IsCellFlippedH(coords Vector2i.XY) bool { //gd:TileMapLayer.is_cell_flipped_h
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_is_cell_flipped_h, gdextension.SizeBool|(gdextension.SizeVector2i<<4), unsafe.Pointer(&struct{ coords Vector2i.XY }{coords}))
	var ret = r_ret
	return ret
}
...
func (self class) IsCellFlippedV(coords Vector2i.XY) bool { //gd:TileMapLayer.is_cell_flipped_v
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_is_cell_flipped_v, gdextension.SizeBool|(gdextension.SizeVector2i<<4), unsafe.Pointer(&struct{ coords Vector2i.XY }{coords}))
	var ret = r_ret
	return ret
}
...
func (self class) IsCellTransposed(coords Vector2i.XY) bool { //gd:TileMapLayer.is_cell_transposed
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_is_cell_transposed, gdextension.SizeBool|(gdextension.SizeVector2i<<4), unsafe.Pointer(&struct{ coords Vector2i.XY }{coords}))
	var ret = r_ret
	return ret
}
...
func (self class) GetUsedCells() Array.Contains[Vector2i.XY] { //gd:TileMapLayer.get_used_cells
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_used_cells, gdextension.SizeArray, unsafe.Pointer(&struct{}{}))
...
func (self class) GetUsedCellsById(source_id int64, atlas_coords Vector2i.XY, alternative_tile int64) Array.Contains[Vector2i.XY] { //gd:TileMapLayer.get_used_cells_by_id
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_used_cells_by_id, gdextension.SizeArray|(gdextension.SizeInt<<4)|(gdextension.SizeVector2i<<8)|(gdextension.SizeInt<<12), unsafe.Pointer(&struct {
		source_id        int64
		atlas_coords     Vector2i.XY
		alternative_tile int64
...
func (self class) GetUsedRect() Rect2i.PositionSize { //gd:TileMapLayer.get_used_rect
	var r_ret = gdunsafe.Call[Rect2i.PositionSize](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_used_rect, gdextension.SizeRect2i, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetPattern(coords_array Array.Contains[Vector2i.XY]) [1]gdclass.TileMapPattern { //gd:TileMapLayer.get_pattern
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_pattern, gdextension.SizeObject|(gdextension.SizeArray<<4), unsafe.Pointer(&struct{ coords_array gdextension.Array }{gdextension.Array(pointers.Get(gd.InternalArray(coords_array))[0])}))
...
func (self class) SetCellsTerrainConnect(cells Array.Contains[Vector2i.XY], terrain_set int64, terrain int64, ignore_empty_terrains bool) { //gd:TileMapLayer.set_cells_terrain_connect
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_cells_terrain_connect, 0|(gdextension.SizeArray<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeBool<<16), unsafe.Pointer(&struct {
...
func (self class) SetCellsTerrainPath(path Array.Contains[Vector2i.XY], terrain_set int64, terrain int64, ignore_empty_terrains bool) { //gd:TileMapLayer.set_cells_terrain_path
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_cells_terrain_path, 0|(gdextension.SizeArray<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeBool<<16), unsafe.Pointer(&struct {
...
func (self class) HasBodyRid(body RID.Any) bool { //gd:TileMapLayer.has_body_rid
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_has_body_rid, gdextension.SizeBool|(gdextension.SizeRID<<4), unsafe.Pointer(&struct{ body RID.Any }{body}))
	var ret = r_ret
	return ret
}
...
func (self class) GetCoordsForBodyRid(body RID.Any) Vector2i.XY { //gd:TileMapLayer.get_coords_for_body_rid
	var r_ret = gdunsafe.Call[Vector2i.XY](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_coords_for_body_rid, gdextension.SizeVector2i|(gdextension.SizeRID<<4), unsafe.Pointer(&struct{ body RID.Any }{body}))
	var ret = r_ret
	return ret
}
...
func (self class) UpdateInternals() { //gd:TileMapLayer.update_internals
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_update_internals, 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) NotifyRuntimeTileDataUpdate() { //gd:TileMapLayer.notify_runtime_tile_data_update
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_notify_runtime_tile_data_update, 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) MapPattern(position_in_tilemap Vector2i.XY, coords_in_pattern Vector2i.XY, pattern [1]gdclass.TileMapPattern) Vector2i.XY { //gd:TileMapLayer.map_pattern
	var r_ret = gdunsafe.Call[Vector2i.XY](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_map_pattern, gdextension.SizeVector2i|(gdextension.SizeVector2i<<4)|(gdextension.SizeVector2i<<8)|(gdextension.SizeObject<<12), unsafe.Pointer(&struct {
...
func (self class) GetSurroundingCells(coords Vector2i.XY) Array.Contains[Vector2i.XY] { //gd:TileMapLayer.get_surrounding_cells
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_surrounding_cells, gdextension.SizeArray|(gdextension.SizeVector2i<<4), unsafe.Pointer(&struct{ coords Vector2i.XY }{coords}))
	var ret = Array.Through(gd.ArrayProxy[Vector2i.XY]{}, pointers.Pack(pointers.New[gd.Array](r_ret)))
	return ret
}
...
func (self class) GetNeighborCell(coords Vector2i.XY, neighbor TileSet.CellNeighbor) Vector2i.XY { //gd:TileMapLayer.get_neighbor_cell
	var r_ret = gdunsafe.Call[Vector2i.XY](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_neighbor_cell, gdextension.SizeVector2i|(gdextension.SizeVector2i<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		coords   Vector2i.XY
...
func (self class) MapToLocal(map_position Vector2i.XY) Vector2.XY { //gd:TileMapLayer.map_to_local
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_map_to_local, gdextension.SizeVector2|(gdextension.SizeVector2i<<4), unsafe.Pointer(&struct{ map_position Vector2i.XY }{map_position}))
	var ret = r_ret
	return ret
}
...
func (self class) LocalToMap(local_position Vector2.XY) Vector2i.XY { //gd:TileMapLayer.local_to_map
	var r_ret = gdunsafe.Call[Vector2i.XY](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_local_to_map, gdextension.SizeVector2i|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ local_position Vector2.XY }{local_position}))
	var ret = r_ret
	return ret
}
...
func (self class) SetTileMapDataFromArray(tile_map_layer_data Packed.Bytes) { //gd:TileMapLayer.set_tile_map_data_from_array
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_tile_map_data_from_array, 0|(gdextension.SizePackedArray<<4), unsafe.Pointer(&struct{ tile_map_layer_data gdextension.PackedArray }{gdextension.ToPackedArray(pointers.Get(gd.InternalPacked[gd.PackedByteArray, byte](Packed.Array[byte](tile_map_layer_data))))}))
}

//go:nosplit
func (self class) GetTileMapDataAsArray() Packed.Bytes { //gd:TileMapLayer.get_tile_map_data_as_array
	var r_ret = gdunsafe.Call[gd.PackedPointers](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_tile_map_data_as_array, gdextension.SizePackedArray, unsafe.Pointer(&struct{}{}))
...
func (self class) SetEnabled(enabled bool) { //gd:TileMapLayer.set_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsEnabled() bool { //gd:TileMapLayer.is_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_is_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetTileSet() [1]gdclass.TileSet { //gd:TileMapLayer.get_tile_set
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_tile_set, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) SetYSortOrigin(y_sort_origin int64) { //gd:TileMapLayer.set_y_sort_origin
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_y_sort_origin, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ y_sort_origin int64 }{y_sort_origin}))
}

//go:nosplit
func (self class) GetYSortOrigin() int64 { //gd:TileMapLayer.get_y_sort_origin
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_y_sort_origin, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetXDrawOrderReversed(x_draw_order_reversed bool) { //gd:TileMapLayer.set_x_draw_order_reversed
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_x_draw_order_reversed, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ x_draw_order_reversed bool }{x_draw_order_reversed}))
}

//go:nosplit
func (self class) IsXDrawOrderReversed() bool { //gd:TileMapLayer.is_x_draw_order_reversed
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_is_x_draw_order_reversed, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetRenderingQuadrantSize(size int64) { //gd:TileMapLayer.set_rendering_quadrant_size
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_rendering_quadrant_size, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ size int64 }{size}))
}

//go:nosplit
func (self class) GetRenderingQuadrantSize() int64 { //gd:TileMapLayer.get_rendering_quadrant_size
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_rendering_quadrant_size, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetCollisionEnabled(enabled bool) { //gd:TileMapLayer.set_collision_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_collision_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsCollisionEnabled() bool { //gd:TileMapLayer.is_collision_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_is_collision_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetUseKinematicBodies(use_kinematic_bodies bool) { //gd:TileMapLayer.set_use_kinematic_bodies
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_use_kinematic_bodies, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ use_kinematic_bodies bool }{use_kinematic_bodies}))
}

//go:nosplit
func (self class) IsUsingKinematicBodies() bool { //gd:TileMapLayer.is_using_kinematic_bodies
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_is_using_kinematic_bodies, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetCollisionVisibilityMode(visibility_mode DebugVisibilityMode) { //gd:TileMapLayer.set_collision_visibility_mode
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_collision_visibility_mode, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ visibility_mode DebugVisibilityMode }{visibility_mode}))
}

//go:nosplit
func (self class) GetCollisionVisibilityMode() DebugVisibilityMode { //gd:TileMapLayer.get_collision_visibility_mode
	var r_ret = gdunsafe.Call[DebugVisibilityMode](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_collision_visibility_mode, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetOcclusionEnabled(enabled bool) { //gd:TileMapLayer.set_occlusion_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_occlusion_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsOcclusionEnabled() bool { //gd:TileMapLayer.is_occlusion_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_is_occlusion_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetNavigationEnabled(enabled bool) { //gd:TileMapLayer.set_navigation_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_navigation_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsNavigationEnabled() bool { //gd:TileMapLayer.is_navigation_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_is_navigation_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetNavigationMap(mapping RID.Any) { //gd:TileMapLayer.set_navigation_map
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_navigation_map, 0|(gdextension.SizeRID<<4), unsafe.Pointer(&struct{ mapping RID.Any }{mapping}))
}
...
func (self class) GetNavigationMap() RID.Any { //gd:TileMapLayer.get_navigation_map
	var r_ret = gdunsafe.Call[RID.Any](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_navigation_map, gdextension.SizeRID, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetNavigationVisibilityMode(show_navigation DebugVisibilityMode) { //gd:TileMapLayer.set_navigation_visibility_mode
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_set_navigation_visibility_mode, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ show_navigation DebugVisibilityMode }{show_navigation}))
}

//go:nosplit
func (self class) GetNavigationVisibilityMode() DebugVisibilityMode { //gd:TileMapLayer.get_navigation_visibility_mode
	var r_ret = gdunsafe.Call[DebugVisibilityMode](self.AsObject(), gd.Global.Methods.TileMapLayer.Bind_get_navigation_visibility_mode, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
