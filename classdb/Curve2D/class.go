...
func (self class) GetPointCount() int64 { //gd:Curve2D.get_point_count
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.Curve2D.Bind_get_point_count, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetPointCount(count int64) { //gd:Curve2D.set_point_count
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Curve2D.Bind_set_point_count, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ count int64 }{count}))
}
...
func (self class) AddPoint(position Vector2.XY, in Vector2.XY, out Vector2.XY, index int64) { //gd:Curve2D.add_point
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Curve2D.Bind_add_point, 0|(gdextension.SizeVector2<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeVector2<<12)|(gdextension.SizeInt<<16), unsafe.Pointer(&struct {
		position Vector2.XY
		in       Vector2.XY
		out      Vector2.XY
		index    int64
...
func (self class) SetPointPosition(idx int64, position Vector2.XY) { //gd:Curve2D.set_point_position
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Curve2D.Bind_set_point_position, 0|(gdextension.SizeInt<<4)|(gdextension.SizeVector2<<8), unsafe.Pointer(&struct {
		idx      int64
		position Vector2.XY
	}{idx, position}))
}
...
func (self class) GetPointPosition(idx int64) Vector2.XY { //gd:Curve2D.get_point_position
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.Curve2D.Bind_get_point_position, gdextension.SizeVector2|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ idx int64 }{idx}))
	var ret = r_ret
	return ret
}
...
func (self class) SetPointIn(idx int64, position Vector2.XY) { //gd:Curve2D.set_point_in
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Curve2D.Bind_set_point_in, 0|(gdextension.SizeInt<<4)|(gdextension.SizeVector2<<8), unsafe.Pointer(&struct {
		idx      int64
		position Vector2.XY
	}{idx, position}))
}
...
func (self class) GetPointIn(idx int64) Vector2.XY { //gd:Curve2D.get_point_in
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.Curve2D.Bind_get_point_in, gdextension.SizeVector2|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ idx int64 }{idx}))
	var ret = r_ret
	return ret
}
...
func (self class) SetPointOut(idx int64, position Vector2.XY) { //gd:Curve2D.set_point_out
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Curve2D.Bind_set_point_out, 0|(gdextension.SizeInt<<4)|(gdextension.SizeVector2<<8), unsafe.Pointer(&struct {
		idx      int64
		position Vector2.XY
	}{idx, position}))
}
...
func (self class) GetPointOut(idx int64) Vector2.XY { //gd:Curve2D.get_point_out
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.Curve2D.Bind_get_point_out, gdextension.SizeVector2|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ idx int64 }{idx}))
	var ret = r_ret
	return ret
}
...
func (self class) RemovePoint(idx int64) { //gd:Curve2D.remove_point
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Curve2D.Bind_remove_point, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ idx int64 }{idx}))
}
...
func (self class) ClearPoints() { //gd:Curve2D.clear_points
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Curve2D.Bind_clear_points, 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) Sample(idx int64, t float64) Vector2.XY { //gd:Curve2D.sample
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.Curve2D.Bind_sample, gdextension.SizeVector2|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), unsafe.Pointer(&struct {
		idx int64
		t   float64
	}{idx, t}))
	var ret = r_ret
...
func (self class) Samplef(fofs float64) Vector2.XY { //gd:Curve2D.samplef
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.Curve2D.Bind_samplef, gdextension.SizeVector2|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ fofs float64 }{fofs}))
	var ret = r_ret
	return ret
}
...
func (self class) SetBakeInterval(distance float64) { //gd:Curve2D.set_bake_interval
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Curve2D.Bind_set_bake_interval, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ distance float64 }{distance}))
}

//go:nosplit
func (self class) GetBakeInterval() float64 { //gd:Curve2D.get_bake_interval
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.Curve2D.Bind_get_bake_interval, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetBakedLength() float64 { //gd:Curve2D.get_baked_length
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.Curve2D.Bind_get_baked_length, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SampleBaked(offset float64, cubic bool) Vector2.XY { //gd:Curve2D.sample_baked
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.Curve2D.Bind_sample_baked, gdextension.SizeVector2|(gdextension.SizeFloat<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		offset float64
		cubic  bool
	}{offset, cubic}))
	var ret = r_ret
...
func (self class) SampleBakedWithRotation(offset float64, cubic bool) Transform2D.OriginXY { //gd:Curve2D.sample_baked_with_rotation
	var r_ret = gdunsafe.Call[Transform2D.OriginXY](self.AsObject(), gd.Global.Methods.Curve2D.Bind_sample_baked_with_rotation, gdextension.SizeTransform2D|(gdextension.SizeFloat<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		offset float64
		cubic  bool
	}{offset, cubic}))
	var ret = r_ret
...
func (self class) GetBakedPoints() Packed.Array[Vector2.XY] { //gd:Curve2D.get_baked_points
	var r_ret = gdunsafe.Call[gd.PackedPointers](self.AsObject(), gd.Global.Methods.Curve2D.Bind_get_baked_points, gdextension.SizePackedArray, unsafe.Pointer(&struct{}{}))
...
func (self class) GetClosestPoint(to_point Vector2.XY) Vector2.XY { //gd:Curve2D.get_closest_point
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.Curve2D.Bind_get_closest_point, gdextension.SizeVector2|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ to_point Vector2.XY }{to_point}))
	var ret = r_ret
	return ret
}
...
func (self class) GetClosestOffset(to_point Vector2.XY) float64 { //gd:Curve2D.get_closest_offset
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.Curve2D.Bind_get_closest_offset, gdextension.SizeFloat|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ to_point Vector2.XY }{to_point}))
	var ret = r_ret
	return ret
}
...
func (self class) Tessellate(max_stages int64, tolerance_degrees float64) Packed.Array[Vector2.XY] { //gd:Curve2D.tessellate
	var r_ret = gdunsafe.Call[gd.PackedPointers](self.AsObject(), gd.Global.Methods.Curve2D.Bind_tessellate, gdextension.SizePackedArray|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), unsafe.Pointer(&struct {
		max_stages        int64
...
func (self class) TessellateEvenLength(max_stages int64, tolerance_length float64) Packed.Array[Vector2.XY] { //gd:Curve2D.tessellate_even_length
	var r_ret = gdunsafe.Call[gd.PackedPointers](self.AsObject(), gd.Global.Methods.Curve2D.Bind_tessellate_even_length, gdextension.SizePackedArray|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), unsafe.Pointer(&struct {
		max_stages       int64
