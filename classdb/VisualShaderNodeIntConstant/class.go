...
func New() Instance {
	...
	casted := Instance{*(*gdclass.VisualShaderNodeIntConstant)(unsafe.Pointer(&object))}
...
//go:nosplit
func (self class) SetConstant(constant gd.Int) { //gd:VisualShaderNodeIntConstant.set_constant
	var frame = callframe.New()
	callframe.Arg(frame, constant)
	var r_ret = callframe.Nil
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.VisualShaderNodeIntConstant.Bind_set_constant, self.AsObject(), frame.Array(0), r_ret.Addr())
	frame.Free()
}

//go:nosplit
func (self class) GetConstant() gd.Int { //gd:VisualShaderNodeIntConstant.get_constant
	var frame = callframe.New()
	var r_ret = callframe.Ret[gd.Int](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.VisualShaderNodeIntConstant.Bind_get_constant, self.AsObject(), frame.Array(0), r_ret.Addr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
func init() {
	gdclass.Register("VisualShaderNodeIntConstant", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeIntConstant{*(*gdclass.VisualShaderNodeIntConstant)(unsafe.Pointer(&ptr))}
	})
}
