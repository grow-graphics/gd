...
func New() Instance {
	...
	casted := Instance{*(*gdclass.VisualShaderNodeWorldPositionFromDepth)(unsafe.Pointer(&object))}
...
func init() {
	gdclass.Register("VisualShaderNodeWorldPositionFromDepth", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeWorldPositionFromDepth{*(*gdclass.VisualShaderNodeWorldPositionFromDepth)(unsafe.Pointer(&ptr))}
	})
}
