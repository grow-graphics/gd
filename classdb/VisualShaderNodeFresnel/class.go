...
func New() Instance {
	...
	casted := Instance{*(*gdclass.VisualShaderNodeFresnel)(unsafe.Pointer(&object))}
...
func init() {
	gdclass.Register("VisualShaderNodeFresnel", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeFresnel{*(*gdclass.VisualShaderNodeFresnel)(unsafe.Pointer(&ptr))}
	})
}
