...
func New() Instance {
	...
	casted := Instance{*(*gdclass.VBoxContainer)(unsafe.Pointer(&object))}
	return casted
}
...
func init() {
	gdclass.Register("VBoxContainer", func(ptr gd.Object) any {
		return [1]gdclass.VBoxContainer{*(*gdclass.VBoxContainer)(unsafe.Pointer(&ptr))}
	})
}
