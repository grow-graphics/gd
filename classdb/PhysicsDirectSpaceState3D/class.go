...
func (self class) IntersectRay(parameters [1]gdclass.PhysicsRayQueryParameters3D) Dictionary.Any { //gd:PhysicsDirectSpaceState3D.intersect_ray
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.PhysicsDirectSpaceState3D.Bind_intersect_ray, gdextension.SizeDictionary|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ parameters gdextension.Object }{gdextension.Object(gd.ObjectChecked(parameters[0].AsObject()))}))
...
func (self class) CastMotion(parameters [1]gdclass.PhysicsShapeQueryParameters3D) Packed.Array[float32] { //gd:PhysicsDirectSpaceState3D.cast_motion
	var r_ret = gdunsafe.Call[gd.PackedPointers](self.AsObject(), gd.Global.Methods.PhysicsDirectSpaceState3D.Bind_cast_motion, gdextension.SizePackedArray|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ parameters gdextension.Object }{gdextension.Object(gd.ObjectChecked(parameters[0].AsObject()))}))
...
func (self class) GetRestInfo(parameters [1]gdclass.PhysicsShapeQueryParameters3D) Dictionary.Any { //gd:PhysicsDirectSpaceState3D.get_rest_info
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.PhysicsDirectSpaceState3D.Bind_get_rest_info, gdextension.SizeDictionary|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ parameters gdextension.Object }{gdextension.Object(gd.ObjectChecked(parameters[0].AsObject()))}))
	var ret = Dictionary.Through(gd.DictionaryProxy[variant.Any, variant.Any]{}, pointers.Pack(pointers.New[gd.Dictionary](r_ret)))
	return ret
}
