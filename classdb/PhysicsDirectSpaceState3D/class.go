...
func (self class) IntersectPoint(parameters [1]gdclass.PhysicsPointQueryParameters3D, max_results int64) Array.Contains[Dictionary.Any] { //gd:PhysicsDirectSpaceState3D.intersect_point
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.PhysicsDirectSpaceState3D.Bind_intersect_point, gdextension.SizeArray|(gdextension.SizeObject<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
...
func (self class) IntersectRay(parameters [1]gdclass.PhysicsRayQueryParameters3D) Dictionary.Any { //gd:PhysicsDirectSpaceState3D.intersect_ray
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.PhysicsDirectSpaceState3D.Bind_intersect_ray, gdextension.SizeDictionary|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ parameters gdextension.Object }{gdextension.Object(pointers.Get(parameters[0])[0])}))
...
func (self class) IntersectShape(parameters [1]gdclass.PhysicsShapeQueryParameters3D, max_results int64) Array.Contains[Dictionary.Any] { //gd:PhysicsDirectSpaceState3D.intersect_shape
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.PhysicsDirectSpaceState3D.Bind_intersect_shape, gdextension.SizeArray|(gdextension.SizeObject<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		parameters  gdextension.Object
		max_results int64
	}{gdextension.Object(pointers.Get(parameters[0])[0]), max_results}))
	var ret = Array.Through(gd.ArrayProxy[Dictionary.Any]{}, pointers.Pack(pointers.New[gd.Array](r_ret)))
...
func (self class) CastMotion(parameters [1]gdclass.PhysicsShapeQueryParameters3D) Packed.Array[float32] { //gd:PhysicsDirectSpaceState3D.cast_motion
	var r_ret = gdunsafe.Call[gd.PackedPointers](self.AsObject(), gd.Global.Methods.PhysicsDirectSpaceState3D.Bind_cast_motion, gdextension.SizePackedArray|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ parameters gdextension.Object }{gdextension.Object(pointers.Get(parameters[0])[0])}))
...
func (self class) CollideShape(parameters [1]gdclass.PhysicsShapeQueryParameters3D, max_results int64) Array.Contains[Vector3.XYZ] { //gd:PhysicsDirectSpaceState3D.collide_shape
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.PhysicsDirectSpaceState3D.Bind_collide_shape, gdextension.SizeArray|(gdextension.SizeObject<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		parameters  gdextension.Object
		max_results int64
	}{gdextension.Object(pointers.Get(parameters[0])[0]), max_results}))
...
func (self class) GetRestInfo(parameters [1]gdclass.PhysicsShapeQueryParameters3D) Dictionary.Any { //gd:PhysicsDirectSpaceState3D.get_rest_info
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.PhysicsDirectSpaceState3D.Bind_get_rest_info, gdextension.SizeDictionary|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ parameters gdextension.Object }{gdextension.Object(pointers.Get(parameters[0])[0])}))
	var ret = Dictionary.Through(gd.DictionaryProxy[variant.Any, variant.Any]{}, pointers.Pack(pointers.New[gd.Dictionary](r_ret)))
	return ret
}
