...
func New() Instance {
	...
	casted := Instance{*(*gdclass.AudioBusLayout)(unsafe.Pointer(&object))}
...
func init() {
	gdclass.Register("AudioBusLayout", func(ptr gd.Object) any {
		return [1]gdclass.AudioBusLayout{*(*gdclass.AudioBusLayout)(unsafe.Pointer(&ptr))}
	})
}
