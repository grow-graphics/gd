...
func (self class) SetFunction(fn Function) { //gd:VisualShaderNodeUIntFunc.set_function
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.VisualShaderNodeUIntFunc.Bind_set_function, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ fn Function }{fn}))
}

//go:nosplit
func (self class) GetFunction() Function { //gd:VisualShaderNodeUIntFunc.get_function
	var r_ret = gdunsafe.Call[Function](self.AsObject(), gd.Global.Methods.VisualShaderNodeUIntFunc.Bind_get_function, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
