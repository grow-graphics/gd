...
func (self class) PrintOrphanNodes() { //gd:Node.print_orphan_nodes
	gdextension.CallStatic[struct{}](gdextension.MethodForClass(gd.Global.Methods.Node.Bind_print_orphan_nodes), 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) AddSibling(sibling [1]gdclass.Node, force_readable_name bool) { //gd:Node.add_sibling
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_add_sibling), 0|(gdextension.SizeObject<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
...
func (self class) SetName(name String.Readable) { //gd:Node.set_name
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_name), 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ name gdextension.String }{gdextension.String(pointers.Get(gd.InternalString(name))[0])}))
}

//go:nosplit
func (self class) GetName() String.Name { //gd:Node.get_name
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_name), gdextension.SizeStringName, unsafe.Pointer(&struct{}{}))
...
func (self class) AddChild(node [1]gdclass.Node, force_readable_name bool, internal_ InternalMode) { //gd:Node.add_child
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_add_child), 0|(gdextension.SizeObject<<4)|(gdextension.SizeBool<<8)|(gdextension.SizeInt<<12), unsafe.Pointer(&struct {
...
func (self class) RemoveChild(node [1]gdclass.Node) { //gd:Node.remove_child
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_remove_child), 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ node gdextension.Object }{gdextension.Object(gd.ObjectChecked(node[0].AsObject()))}))
}
...
func (self class) Reparent(new_parent [1]gdclass.Node, keep_global_transform bool) { //gd:Node.reparent
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_reparent), 0|(gdextension.SizeObject<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
...
func (self class) GetChildCount(include_internal bool) int64 { //gd:Node.get_child_count
	var r_ret = gdextension.Call[int64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_child_count), gdextension.SizeInt|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ include_internal bool }{include_internal}))
	var ret = r_ret
	return ret
}
...
func (self class) GetChildren(include_internal bool) Array.Contains[[1]gdclass.Node] { //gd:Node.get_children
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_children), gdextension.SizeArray|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ include_internal bool }{include_internal}))
...
func (self class) GetChild(idx int64, include_internal bool) [1]gdclass.Node { //gd:Node.get_child
	var r_ret = gdextension.Call[gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_child), gdextension.SizeObject|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		idx              int64
...
func (self class) HasNode(path Path.ToNode) bool { //gd:Node.has_node
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_has_node), gdextension.SizeBool|(gdextension.SizeNodePath<<4), unsafe.Pointer(&struct{ path gdextension.NodePath }{gdextension.NodePath(pointers.Get(gd.InternalNodePath(path))[0])}))
	var ret = r_ret
	return ret
}
...
func (self class) GetNode(path Path.ToNode) [1]gdclass.Node { //gd:Node.get_node
	var r_ret = gdextension.Call[gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_node), gdextension.SizeObject|(gdextension.SizeNodePath<<4), unsafe.Pointer(&struct{ path gdextension.NodePath }{gdextension.NodePath(pointers.Get(gd.InternalNodePath(path))[0])}))
	var ret = [1]gdclass.Node{gd.PointerMustAssertInstanceID[gdclass.Node](r_ret)}
	return ret
}
...
func (self class) GetNodeOrNull(path Path.ToNode) [1]gdclass.Node { //gd:Node.get_node_or_null
	var r_ret = gdextension.Call[gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_node_or_null), gdextension.SizeObject|(gdextension.SizeNodePath<<4), unsafe.Pointer(&struct{ path gdextension.NodePath }{gdextension.NodePath(pointers.Get(gd.InternalNodePath(path))[0])}))
	var ret = [1]gdclass.Node{gd.PointerMustAssertInstanceID[gdclass.Node](r_ret)}
	return ret
}
...
func (self class) GetParent() [1]gdclass.Node { //gd:Node.get_parent
	var r_ret = gdextension.Call[gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_parent), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
	var ret = [1]gdclass.Node{gd.PointerMustAssertInstanceID[gdclass.Node](r_ret)}
	return ret
}
...
func (self class) FindChild(pattern String.Readable, recursive bool, owned bool) [1]gdclass.Node { //gd:Node.find_child
	var r_ret = gdextension.Call[gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_find_child), gdextension.SizeObject|(gdextension.SizeString<<4)|(gdextension.SizeBool<<8)|(gdextension.SizeBool<<12), unsafe.Pointer(&struct {
...
func (self class) FindChildren(pattern String.Readable, atype String.Readable, recursive bool, owned bool) Array.Contains[[1]gdclass.Node] { //gd:Node.find_children
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_find_children), gdextension.SizeArray|(gdextension.SizeString<<4)|(gdextension.SizeString<<8)|(gdextension.SizeBool<<12)|(gdextension.SizeBool<<16), unsafe.Pointer(&struct {
		pattern   gdextension.String
...
func (self class) FindParent(pattern String.Readable) [1]gdclass.Node { //gd:Node.find_parent
	var r_ret = gdextension.Call[gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_find_parent), gdextension.SizeObject|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ pattern gdextension.String }{gdextension.String(pointers.Get(gd.InternalString(pattern))[0])}))
	var ret = [1]gdclass.Node{gd.PointerMustAssertInstanceID[gdclass.Node](r_ret)}
	return ret
}
...
func (self class) HasNodeAndResource(path Path.ToNode) bool { //gd:Node.has_node_and_resource
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_has_node_and_resource), gdextension.SizeBool|(gdextension.SizeNodePath<<4), unsafe.Pointer(&struct{ path gdextension.NodePath }{gdextension.NodePath(pointers.Get(gd.InternalNodePath(path))[0])}))
	var ret = r_ret
	return ret
}
...
func (self class) GetNodeAndResource(path Path.ToNode) Array.Any { //gd:Node.get_node_and_resource
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_node_and_resource), gdextension.SizeArray|(gdextension.SizeNodePath<<4), unsafe.Pointer(&struct{ path gdextension.NodePath }{gdextension.NodePath(pointers.Get(gd.InternalNodePath(path))[0])}))
...
func (self class) IsInsideTree() bool { //gd:Node.is_inside_tree
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_inside_tree), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) IsPartOfEditedScene() bool { //gd:Node.is_part_of_edited_scene
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_part_of_edited_scene), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) IsAncestorOf(node [1]gdclass.Node) bool { //gd:Node.is_ancestor_of
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_ancestor_of), gdextension.SizeBool|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ node gdextension.Object }{gdextension.Object(gd.ObjectChecked(node[0].AsObject()))}))
	var ret = r_ret
	return ret
}
...
func (self class) IsGreaterThan(node [1]gdclass.Node) bool { //gd:Node.is_greater_than
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_greater_than), gdextension.SizeBool|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ node gdextension.Object }{gdextension.Object(gd.ObjectChecked(node[0].AsObject()))}))
	var ret = r_ret
	return ret
}
...
func (self class) GetPath() Path.ToNode { //gd:Node.get_path
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_path), gdextension.SizeNodePath, unsafe.Pointer(&struct{}{}))
...
func (self class) GetPathTo(node [1]gdclass.Node, use_unique_path bool) Path.ToNode { //gd:Node.get_path_to
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_path_to), gdextension.SizeNodePath|(gdextension.SizeObject<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		node            gdextension.Object
...
func (self class) AddToGroup(group String.Name, persistent bool) { //gd:Node.add_to_group
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_add_to_group), 0|(gdextension.SizeStringName<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
...
func (self class) RemoveFromGroup(group String.Name) { //gd:Node.remove_from_group
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_remove_from_group), 0|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ group gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(group))[0])}))
}
...
func (self class) IsInGroup(group String.Name) bool { //gd:Node.is_in_group
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_in_group), gdextension.SizeBool|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ group gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(group))[0])}))
	var ret = r_ret
	return ret
}
...
func (self class) MoveChild(child_node [1]gdclass.Node, to_index int64) { //gd:Node.move_child
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_move_child), 0|(gdextension.SizeObject<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
...
func (self class) GetGroups() Array.Contains[String.Name] { //gd:Node.get_groups
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_groups), gdextension.SizeArray, unsafe.Pointer(&struct{}{}))
...
func (self class) SetOwner(owner [1]gdclass.Node) { //gd:Node.set_owner
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_owner), 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ owner gdextension.Object }{gdextension.Object(gd.ObjectChecked(owner[0].AsObject()))}))
}

//go:nosplit
func (self class) GetOwner() [1]gdclass.Node { //gd:Node.get_owner
	var r_ret = gdextension.Call[gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_owner), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
	var ret = [1]gdclass.Node{gd.PointerMustAssertInstanceID[gdclass.Node](r_ret)}
	return ret
}
...
func (self class) GetIndex(include_internal bool) int64 { //gd:Node.get_index
	var r_ret = gdextension.Call[int64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_index), gdextension.SizeInt|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ include_internal bool }{include_internal}))
	var ret = r_ret
	return ret
}
...
func (self class) PrintTree() { //gd:Node.print_tree
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_print_tree), 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) PrintTreePretty() { //gd:Node.print_tree_pretty
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_print_tree_pretty), 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) GetTreeString() String.Readable { //gd:Node.get_tree_string
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_tree_string), gdextension.SizeString, unsafe.Pointer(&struct{}{}))
...
func (self class) GetTreeStringPretty() String.Readable { //gd:Node.get_tree_string_pretty
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_tree_string_pretty), gdextension.SizeString, unsafe.Pointer(&struct{}{}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) SetSceneFilePath(scene_file_path String.Readable) { //gd:Node.set_scene_file_path
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_scene_file_path), 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ scene_file_path gdextension.String }{gdextension.String(pointers.Get(gd.InternalString(scene_file_path))[0])}))
}

//go:nosplit
func (self class) GetSceneFilePath() String.Readable { //gd:Node.get_scene_file_path
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_scene_file_path), gdextension.SizeString, unsafe.Pointer(&struct{}{}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) PropagateNotification(what int64) { //gd:Node.propagate_notification
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_propagate_notification), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ what int64 }{what}))
}
...
func (self class) PropagateCall(method String.Name, args Array.Any, parent_first bool) { //gd:Node.propagate_call
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_propagate_call), 0|(gdextension.SizeStringName<<4)|(gdextension.SizeArray<<8)|(gdextension.SizeBool<<12), unsafe.Pointer(&struct {
...
func (self class) SetPhysicsProcess(enable bool) { //gd:Node.set_physics_process
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_physics_process), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}
...
func (self class) GetPhysicsProcessDeltaTime() float64 { //gd:Node.get_physics_process_delta_time
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_physics_process_delta_time), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) IsPhysicsProcessing() bool { //gd:Node.is_physics_processing
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_physics_processing), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetProcessDeltaTime() float64 { //gd:Node.get_process_delta_time
	var r_ret = gdextension.Call[float64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_process_delta_time), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetProcess(enable bool) { //gd:Node.set_process
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_process), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) SetProcessPriority(priority int64) { //gd:Node.set_process_priority
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_process_priority), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ priority int64 }{priority}))
}

//go:nosplit
func (self class) GetProcessPriority() int64 { //gd:Node.get_process_priority
	var r_ret = gdextension.Call[int64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_process_priority), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetPhysicsProcessPriority(priority int64) { //gd:Node.set_physics_process_priority
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_physics_process_priority), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ priority int64 }{priority}))
}

//go:nosplit
func (self class) GetPhysicsProcessPriority() int64 { //gd:Node.get_physics_process_priority
	var r_ret = gdextension.Call[int64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_physics_process_priority), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) IsProcessing() bool { //gd:Node.is_processing
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_processing), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetProcessInput(enable bool) { //gd:Node.set_process_input
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_process_input), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}
...
func (self class) IsProcessingInput() bool { //gd:Node.is_processing_input
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_processing_input), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetProcessShortcutInput(enable bool) { //gd:Node.set_process_shortcut_input
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_process_shortcut_input), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}
...
func (self class) IsProcessingShortcutInput() bool { //gd:Node.is_processing_shortcut_input
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_processing_shortcut_input), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetProcessUnhandledInput(enable bool) { //gd:Node.set_process_unhandled_input
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_process_unhandled_input), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}
...
func (self class) IsProcessingUnhandledInput() bool { //gd:Node.is_processing_unhandled_input
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_processing_unhandled_input), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetProcessUnhandledKeyInput(enable bool) { //gd:Node.set_process_unhandled_key_input
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_process_unhandled_key_input), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}
...
func (self class) IsProcessingUnhandledKeyInput() bool { //gd:Node.is_processing_unhandled_key_input
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_processing_unhandled_key_input), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetProcessMode(mode ProcessMode) { //gd:Node.set_process_mode
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_process_mode), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ mode ProcessMode }{mode}))
}

//go:nosplit
func (self class) GetProcessMode() ProcessMode { //gd:Node.get_process_mode
	var r_ret = gdextension.Call[ProcessMode](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_process_mode), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) CanProcess() bool { //gd:Node.can_process
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_can_process), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetProcessThreadGroup(mode ProcessThreadGroup) { //gd:Node.set_process_thread_group
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_process_thread_group), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ mode ProcessThreadGroup }{mode}))
}

//go:nosplit
func (self class) GetProcessThreadGroup() ProcessThreadGroup { //gd:Node.get_process_thread_group
	var r_ret = gdextension.Call[ProcessThreadGroup](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_process_thread_group), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetProcessThreadMessages(flags ProcessThreadMessages) { //gd:Node.set_process_thread_messages
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_process_thread_messages), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ flags ProcessThreadMessages }{flags}))
}

//go:nosplit
func (self class) GetProcessThreadMessages() ProcessThreadMessages { //gd:Node.get_process_thread_messages
	var r_ret = gdextension.Call[ProcessThreadMessages](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_process_thread_messages), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetProcessThreadGroupOrder(order int64) { //gd:Node.set_process_thread_group_order
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_process_thread_group_order), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ order int64 }{order}))
}

//go:nosplit
func (self class) GetProcessThreadGroupOrder() int64 { //gd:Node.get_process_thread_group_order
	var r_ret = gdextension.Call[int64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_process_thread_group_order), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDisplayFolded(fold bool) { //gd:Node.set_display_folded
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_display_folded), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ fold bool }{fold}))
}
...
func (self class) IsDisplayedFolded() bool { //gd:Node.is_displayed_folded
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_displayed_folded), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetProcessInternal(enable bool) { //gd:Node.set_process_internal
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_process_internal), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}
...
func (self class) IsProcessingInternal() bool { //gd:Node.is_processing_internal
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_processing_internal), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetPhysicsProcessInternal(enable bool) { //gd:Node.set_physics_process_internal
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_physics_process_internal), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}
...
func (self class) IsPhysicsProcessingInternal() bool { //gd:Node.is_physics_processing_internal
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_physics_processing_internal), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetPhysicsInterpolationMode(mode PhysicsInterpolationMode) { //gd:Node.set_physics_interpolation_mode
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_physics_interpolation_mode), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ mode PhysicsInterpolationMode }{mode}))
}

//go:nosplit
func (self class) GetPhysicsInterpolationMode() PhysicsInterpolationMode { //gd:Node.get_physics_interpolation_mode
	var r_ret = gdextension.Call[PhysicsInterpolationMode](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_physics_interpolation_mode), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) IsPhysicsInterpolated() bool { //gd:Node.is_physics_interpolated
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_physics_interpolated), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) IsPhysicsInterpolatedAndEnabled() bool { //gd:Node.is_physics_interpolated_and_enabled
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_physics_interpolated_and_enabled), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) ResetPhysicsInterpolation() { //gd:Node.reset_physics_interpolation
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_reset_physics_interpolation), 0, unsafe.Pointer(&struct{}{}))
}

//go:nosplit
func (self class) SetAutoTranslateMode(mode AutoTranslateMode) { //gd:Node.set_auto_translate_mode
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_auto_translate_mode), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ mode AutoTranslateMode }{mode}))
}

//go:nosplit
func (self class) GetAutoTranslateMode() AutoTranslateMode { //gd:Node.get_auto_translate_mode
	var r_ret = gdextension.Call[AutoTranslateMode](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_auto_translate_mode), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetTranslationDomainInherited() { //gd:Node.set_translation_domain_inherited
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_translation_domain_inherited), 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) GetWindow() [1]gdclass.Window { //gd:Node.get_window
	var r_ret = gdextension.Call[gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_window), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) GetLastExclusiveWindow() [1]gdclass.Window { //gd:Node.get_last_exclusive_window
	var r_ret = gdextension.Call[gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_last_exclusive_window), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
	var ret = [1]gdclass.Window{gd.PointerMustAssertInstanceID[gdclass.Window](r_ret)}
	return ret
}
...
func (self class) GetTree() [1]gdclass.SceneTree { //gd:Node.get_tree
	var r_ret = gdextension.Call[gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_tree), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) CreateTween() [1]gdclass.Tween { //gd:Node.create_tween
	var r_ret = gdextension.Call[gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_create_tween), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) Duplicate(flags int64) [1]gdclass.Node { //gd:Node.duplicate
	var r_ret = gdextension.Call[gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_duplicate), gdextension.SizeObject|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ flags int64 }{flags}))
...
func (self class) ReplaceBy(node [1]gdclass.Node, keep_groups bool) { //gd:Node.replace_by
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_replace_by), 0|(gdextension.SizeObject<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		node        gdextension.Object
		keep_groups bool
...
func (self class) SetSceneInstanceLoadPlaceholder(load_placeholder bool) { //gd:Node.set_scene_instance_load_placeholder
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_scene_instance_load_placeholder), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ load_placeholder bool }{load_placeholder}))
}
...
func (self class) GetSceneInstanceLoadPlaceholder() bool { //gd:Node.get_scene_instance_load_placeholder
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_scene_instance_load_placeholder), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetEditableInstance(node [1]gdclass.Node, is_editable bool) { //gd:Node.set_editable_instance
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_editable_instance), 0|(gdextension.SizeObject<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		node        gdextension.Object
		is_editable bool
...
func (self class) IsEditableInstance(node [1]gdclass.Node) bool { //gd:Node.is_editable_instance
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_editable_instance), gdextension.SizeBool|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ node gdextension.Object }{gdextension.Object(gd.ObjectChecked(node[0].AsObject()))}))
	var ret = r_ret
	return ret
}
...
func (self class) GetViewport() [1]gdclass.Viewport { //gd:Node.get_viewport
	var r_ret = gdextension.Call[gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_viewport), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) QueueFree() { //gd:Node.queue_free
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_queue_free), 0, unsafe.Pointer(&struct{}{}))
...
func (self class) RequestReady() { //gd:Node.request_ready
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_request_ready), 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) IsNodeReady() bool { //gd:Node.is_node_ready
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_node_ready), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetMultiplayerAuthority(id int64, recursive bool) { //gd:Node.set_multiplayer_authority
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_multiplayer_authority), 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		id        int64
		recursive bool
	}{id, recursive}))
}
...
func (self class) GetMultiplayerAuthority() int64 { //gd:Node.get_multiplayer_authority
	var r_ret = gdextension.Call[int64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_multiplayer_authority), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) IsMultiplayerAuthority() bool { //gd:Node.is_multiplayer_authority
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_multiplayer_authority), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetMultiplayer() [1]gdclass.MultiplayerAPI { //gd:Node.get_multiplayer
	var r_ret = gdextension.Call[gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_multiplayer), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) RpcConfig(method String.Name, config variant.Any) { //gd:Node.rpc_config
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_rpc_config), 0|(gdextension.SizeStringName<<4)|(gdextension.SizeVariant<<8), unsafe.Pointer(&struct {
		method gdextension.StringName
...
func (self class) GetRpcConfig() variant.Any { //gd:Node.get_rpc_config
	var r_ret = gdextension.Call[[3]uint64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_rpc_config), gdextension.SizeVariant, unsafe.Pointer(&struct{}{}))
...
func (self class) SetEditorDescription(editor_description String.Readable) { //gd:Node.set_editor_description
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_editor_description), 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ editor_description gdextension.String }{gdextension.String(pointers.Get(gd.InternalString(editor_description))[0])}))
}

//go:nosplit
func (self class) GetEditorDescription() String.Readable { //gd:Node.get_editor_description
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_get_editor_description), gdextension.SizeString, unsafe.Pointer(&struct{}{}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) SetUniqueNameInOwner(enable bool) { //gd:Node.set_unique_name_in_owner
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_unique_name_in_owner), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) IsUniqueNameInOwner() bool { //gd:Node.is_unique_name_in_owner
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_is_unique_name_in_owner), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) Atr(message String.Readable, context String.Name) String.Readable { //gd:Node.atr
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_atr), gdextension.SizeString|(gdextension.SizeString<<4)|(gdextension.SizeStringName<<8), unsafe.Pointer(&struct {
...
func (self class) AtrN(message String.Readable, plural_message String.Name, n int64, context String.Name) String.Readable { //gd:Node.atr_n
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_atr_n), gdextension.SizeString|(gdextension.SizeString<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeStringName<<16), unsafe.Pointer(&struct {
		message        gdextension.String
...
func (self class) Rpc(method String.Name, args ...gd.Variant) Error.Code { //gd:Node.rpc
	...
	ret, err := gdextension.MethodForClass(gd.Global.Methods.Node.Bind_rpc).Call(gdextension.Object(gd.ObjectChecked(self.AsObject())), fixed[:]...)
	if err != nil {
		panic(err)
	}
...
func (self class) RpcId(peer_id int64, method String.Name, args ...gd.Variant) Error.Code { //gd:Node.rpc_id
	...
	ret, err := gdextension.MethodForClass(gd.Global.Methods.Node.Bind_rpc_id).Call(gdextension.Object(gd.ObjectChecked(self.AsObject())), fixed[:]...)
	if err != nil {
		panic(err)
	}
	return gd.VariantAs[Error.Code](pointers.New[gd.Variant]([3]uint64(ret)))
...
func (self class) UpdateConfigurationWarnings() { //gd:Node.update_configuration_warnings
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_update_configuration_warnings), 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) CallDeferredThreadGroup(method String.Name, args ...gd.Variant) variant.Any { //gd:Node.call_deferred_thread_group
	var fixed = [...]gdextension.Variant{gdextension.Variant(pointers.Get(gd.NewVariant(method)))}
	ret, err := gdextension.MethodForClass(gd.Global.Methods.Node.Bind_call_deferred_thread_group).Call(gdextension.Object(gd.ObjectChecked(self.AsObject())), fixed[:]...)
	if err != nil {
		panic(err)
	}
...
func (self class) SetDeferredThreadGroup(property String.Name, value variant.Any) { //gd:Node.set_deferred_thread_group
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_deferred_thread_group), 0|(gdextension.SizeStringName<<4)|(gdextension.SizeVariant<<8), unsafe.Pointer(&struct {
...
func (self class) NotifyDeferredThreadGroup(what int64) { //gd:Node.notify_deferred_thread_group
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_notify_deferred_thread_group), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ what int64 }{what}))
}
...
func (self class) CallThreadSafe(method String.Name, args ...gd.Variant) variant.Any { //gd:Node.call_thread_safe
	var fixed = [...]gdextension.Variant{gdextension.Variant(pointers.Get(gd.NewVariant(method)))}
	ret, err := gdextension.MethodForClass(gd.Global.Methods.Node.Bind_call_thread_safe).Call(gdextension.Object(gd.ObjectChecked(self.AsObject())), fixed[:]...)
	if err != nil {
		panic(err)
	}
	return gd.VariantAs[variant.Any](pointers.New[gd.Variant]([3]uint64(ret)))
...
func (self class) SetThreadSafe(property String.Name, value variant.Any) { //gd:Node.set_thread_safe
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_set_thread_safe), 0|(gdextension.SizeStringName<<4)|(gdextension.SizeVariant<<8), unsafe.Pointer(&struct {
		property gdextension.StringName
		value    gdextension.Variant
	}{gdextension.StringName(pointers.Get(gd.InternalStringName(property))[0]), gdextension.Variant(pointers.Get(gd.InternalVariant(value)))}))
}
...
func (self class) NotifyThreadSafe(what int64) { //gd:Node.notify_thread_safe
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.Node.Bind_notify_thread_safe), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ what int64 }{what}))
}
