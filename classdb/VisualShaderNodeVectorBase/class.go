...
func (self class) SetOpType(atype OpType) { //gd:VisualShaderNodeVectorBase.set_op_type
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.VisualShaderNodeVectorBase.Bind_set_op_type), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ atype OpType }{atype}))
}

//go:nosplit
func (self class) GetOpType() OpType { //gd:VisualShaderNodeVectorBase.get_op_type
	var r_ret = gdextension.Call[OpType](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.VisualShaderNodeVectorBase.Bind_get_op_type), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
