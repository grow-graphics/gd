...
[/codeblock]
*/
func CreateOptions(from Vector2.XY, to Vector2.XY, collision_mask int, exclude [][]RID.Body2D) [1]gdclass.PhysicsRayQueryParameters2D { //gd:PhysicsRayQueryParameters2D.create
	self := Instance{}
