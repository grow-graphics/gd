...
func (self class) SetGizmoExtents(extents float64) { //gd:Marker2D.set_gizmo_extents
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Marker2D.Bind_set_gizmo_extents, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ extents float64 }{extents}))
}

//go:nosplit
func (self class) GetGizmoExtents() float64 { //gd:Marker2D.get_gizmo_extents
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.Marker2D.Bind_get_gizmo_extents, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
