...
func (self class) SetSize(size gd.Vector2) { //gd:VisualShaderNodeResizableBase.set_size
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.VisualShaderNodeResizableBase.Bind_set_size, self.AsObject(), frame.Array(0), r_ret.Addr())
	frame.Free()
}
...
func init() {
	gdclass.Register("VisualShaderNodeResizableBase", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeResizableBase{*(*gdclass.VisualShaderNodeResizableBase)(unsafe.Pointer(&ptr))}
	})
}
