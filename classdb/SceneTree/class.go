...
func (self class) GetRoot() [1]gdclass.Window { //gd:SceneTree.get_root
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.SceneTree.Bind_get_root, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) HasGroup(name String.Name) bool { //gd:SceneTree.has_group
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SceneTree.Bind_has_group, gdextension.SizeBool|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ name gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(name))[0])}))
	var ret = r_ret
	return ret
}
...
func (self class) IsAutoAcceptQuit() bool { //gd:SceneTree.is_auto_accept_quit
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SceneTree.Bind_is_auto_accept_quit, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetAutoAcceptQuit(enabled bool) { //gd:SceneTree.set_auto_accept_quit
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_set_auto_accept_quit, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsQuitOnGoBack() bool { //gd:SceneTree.is_quit_on_go_back
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SceneTree.Bind_is_quit_on_go_back, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetQuitOnGoBack(enabled bool) { //gd:SceneTree.set_quit_on_go_back
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_set_quit_on_go_back, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) SetDebugCollisionsHint(enable bool) { //gd:SceneTree.set_debug_collisions_hint
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_set_debug_collisions_hint, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) IsDebuggingCollisionsHint() bool { //gd:SceneTree.is_debugging_collisions_hint
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SceneTree.Bind_is_debugging_collisions_hint, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDebugPathsHint(enable bool) { //gd:SceneTree.set_debug_paths_hint
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_set_debug_paths_hint, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) IsDebuggingPathsHint() bool { //gd:SceneTree.is_debugging_paths_hint
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SceneTree.Bind_is_debugging_paths_hint, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDebugNavigationHint(enable bool) { //gd:SceneTree.set_debug_navigation_hint
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_set_debug_navigation_hint, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) IsDebuggingNavigationHint() bool { //gd:SceneTree.is_debugging_navigation_hint
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SceneTree.Bind_is_debugging_navigation_hint, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetEditedSceneRoot(scene [1]gdclass.Node) { //gd:SceneTree.set_edited_scene_root
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_set_edited_scene_root, 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ scene gdextension.Object }{gdextension.Object(gd.PointerWithOwnershipTransferredToGodot(scene[0].AsObject()[0]))}))
}

//go:nosplit
func (self class) GetEditedSceneRoot() [1]gdclass.Node { //gd:SceneTree.get_edited_scene_root
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.SceneTree.Bind_get_edited_scene_root, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) SetPause(enable bool) { //gd:SceneTree.set_pause
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_set_pause, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) IsPaused() bool { //gd:SceneTree.is_paused
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SceneTree.Bind_is_paused, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) CreateTimer(time_sec float64, process_always bool, process_in_physics bool, ignore_time_scale bool) [1]gdclass.SceneTreeTimer { //gd:SceneTree.create_timer
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.SceneTree.Bind_create_timer, gdextension.SizeObject|(gdextension.SizeFloat<<4)|(gdextension.SizeBool<<8)|(gdextension.SizeBool<<12)|(gdextension.SizeBool<<16), unsafe.Pointer(&struct {
		time_sec           float64
		process_always     bool
...
func (self class) CreateTween() [1]gdclass.Tween { //gd:SceneTree.create_tween
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.SceneTree.Bind_create_tween, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) GetProcessedTweens() Array.Contains[[1]gdclass.Tween] { //gd:SceneTree.get_processed_tweens
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.SceneTree.Bind_get_processed_tweens, gdextension.SizeArray, unsafe.Pointer(&struct{}{}))
...
func (self class) GetNodeCount() int64 { //gd:SceneTree.get_node_count
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.SceneTree.Bind_get_node_count, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetFrame() int64 { //gd:SceneTree.get_frame
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.SceneTree.Bind_get_frame, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) Quit(exit_code int64) { //gd:SceneTree.quit
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_quit, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ exit_code int64 }{exit_code}))
}

//go:nosplit
func (self class) SetPhysicsInterpolationEnabled(enabled bool) { //gd:SceneTree.set_physics_interpolation_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_set_physics_interpolation_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsPhysicsInterpolationEnabled() bool { //gd:SceneTree.is_physics_interpolation_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SceneTree.Bind_is_physics_interpolation_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) QueueDelete(obj [1]gd.Object) { //gd:SceneTree.queue_delete
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_queue_delete, 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ obj gdextension.Object }{gdextension.Object(gd.PointerWithOwnershipTransferredToGodot(obj[0].AsObject()[0]))}))
}
...
func (self class) NotifyGroupFlags(call_flags int64, group String.Name, notification int64) { //gd:SceneTree.notify_group_flags
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_notify_group_flags, 0|(gdextension.SizeInt<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeInt<<12), unsafe.Pointer(&struct {
		call_flags   int64
...
func (self class) SetGroupFlags(call_flags int64, group String.Name, property String.Readable, value variant.Any) { //gd:SceneTree.set_group_flags
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_set_group_flags, 0|(gdextension.SizeInt<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeString<<12)|(gdextension.SizeVariant<<16), unsafe.Pointer(&struct {
		call_flags int64
		group      gdextension.StringName
...
func (self class) NotifyGroup(group String.Name, notification int64) { //gd:SceneTree.notify_group
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_notify_group, 0|(gdextension.SizeStringName<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		group        gdextension.StringName
		notification int64
...
func (self class) SetGroup(group String.Name, property String.Readable, value variant.Any) { //gd:SceneTree.set_group
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_set_group, 0|(gdextension.SizeStringName<<4)|(gdextension.SizeString<<8)|(gdextension.SizeVariant<<12), unsafe.Pointer(&struct {
		group    gdextension.StringName
		property gdextension.String
		value    gdextension.Variant
...
func (self class) GetNodesInGroup(group String.Name) Array.Contains[[1]gdclass.Node] { //gd:SceneTree.get_nodes_in_group
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.SceneTree.Bind_get_nodes_in_group, gdextension.SizeArray|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ group gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(group))[0])}))
...
func (self class) GetFirstNodeInGroup(group String.Name) [1]gdclass.Node { //gd:SceneTree.get_first_node_in_group
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.SceneTree.Bind_get_first_node_in_group, gdextension.SizeObject|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ group gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(group))[0])}))
	var ret = [1]gdclass.Node{gd.PointerMustAssertInstanceID[gdclass.Node](r_ret)}
	return ret
}
...
func (self class) GetNodeCountInGroup(group String.Name) int64 { //gd:SceneTree.get_node_count_in_group
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.SceneTree.Bind_get_node_count_in_group, gdextension.SizeInt|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ group gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(group))[0])}))
	var ret = r_ret
	return ret
}
...
func (self class) SetCurrentScene(child_node [1]gdclass.Node) { //gd:SceneTree.set_current_scene
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_set_current_scene, 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ child_node gdextension.Object }{gdextension.Object(gd.PointerWithOwnershipTransferredToGodot(child_node[0].AsObject()[0]))}))
}

//go:nosplit
func (self class) GetCurrentScene() [1]gdclass.Node { //gd:SceneTree.get_current_scene
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.SceneTree.Bind_get_current_scene, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
	var ret = [1]gdclass.Node{gd.PointerMustAssertInstanceID[gdclass.Node](r_ret)}
	return ret
}
...
func (self class) ChangeSceneToFile(path String.Readable) Error.Code { //gd:SceneTree.change_scene_to_file
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.SceneTree.Bind_change_scene_to_file, gdextension.SizeInt|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ path gdextension.String }{gdextension.String(pointers.Get(gd.InternalString(path))[0])}))
...
func (self class) ReloadCurrentScene() Error.Code { //gd:SceneTree.reload_current_scene
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.SceneTree.Bind_reload_current_scene, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = Error.Code(r_ret)
	return ret
}
...
func (self class) UnloadCurrentScene() { //gd:SceneTree.unload_current_scene
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_unload_current_scene, 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) GetMultiplayer(for_path Path.ToNode) [1]gdclass.MultiplayerAPI { //gd:SceneTree.get_multiplayer
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.SceneTree.Bind_get_multiplayer, gdextension.SizeObject|(gdextension.SizeNodePath<<4), unsafe.Pointer(&struct{ for_path gdextension.NodePath }{gdextension.NodePath(pointers.Get(gd.InternalNodePath(for_path))[0])}))
...
func (self class) SetMultiplayerPollEnabled(enabled bool) { //gd:SceneTree.set_multiplayer_poll_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SceneTree.Bind_set_multiplayer_poll_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsMultiplayerPollEnabled() bool { //gd:SceneTree.is_multiplayer_poll_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SceneTree.Bind_is_multiplayer_poll_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
