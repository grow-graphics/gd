...
func New() Instance {
	...
	return Instance{*(*gdclass.SceneTree)(unsafe.Pointer(&object))}
}
...
//go:nosplit
func (self class) GetRoot() [1]gdclass.Window {
...
*/
//go:nosplit
func (self class) CreateTimer(time_sec gd.Float, process_always bool, process_in_physics bool, ignore_time_scale bool) [1]gdclass.SceneTreeTimer {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetFirstNodeInGroup(group gd.StringName) [1]gdclass.Node {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(group))
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
//go:nosplit
func (self class) GetCurrentScene() [1]gdclass.Node {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) SetMultiplayer(multiplayer [1]gdclass.MultiplayerAPI, root_path gd.NodePath) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetMultiplayer(for_path gd.NodePath) [1]gdclass.MultiplayerAPI {
	var frame = callframe.New()
...
type GroupCallFlags = gdclass.SceneTreeGroupCallFlags
