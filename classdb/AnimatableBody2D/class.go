...
func (self class) SetSyncToPhysics(enable bool) { //gd:AnimatableBody2D.set_sync_to_physics
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.AnimatableBody2D.Bind_set_sync_to_physics, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) IsSyncToPhysicsEnabled() bool { //gd:AnimatableBody2D.is_sync_to_physics_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.AnimatableBody2D.Bind_is_sync_to_physics_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
