...
func (self class) GetPolygon() Packed.Array[Vector2.XY] { //gd:Polygon2D.get_polygon
	var r_ret = gdextension.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_get_polygon), gdextension.SizePackedArray, unsafe.Pointer(&struct{}{}))
...
func (self class) GetUv() Packed.Array[Vector2.XY] { //gd:Polygon2D.get_uv
	var r_ret = gdextension.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_get_uv), gdextension.SizePackedArray, unsafe.Pointer(&struct{}{}))
	var ret = Packed.Array[Vector2.XY](Array.Through(gd.PackedProxy[gd.PackedVector2Array, Vector2.XY]{}, pointers.Pack(pointers.Let[gd.PackedStringArray](r_ret))))
	return ret
}
...
func (self class) SetColor(color Color.RGBA) { //gd:Polygon2D.set_color
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_set_color), 0|(gdextension.SizeColor<<4), unsafe.Pointer(&struct{ color Color.RGBA }{color}))
}

//go:nosplit
func (self class) GetColor() Color.RGBA { //gd:Polygon2D.get_color
	var r_ret = gdextension.Call[Color.RGBA](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_get_color), gdextension.SizeColor, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetVertexColors() Packed.Array[Color.RGBA] { //gd:Polygon2D.get_vertex_colors
	var r_ret = gdextension.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_get_vertex_colors), gdextension.SizePackedArray, unsafe.Pointer(&struct{}{}))
...
func (self class) SetTexture(texture [1]gdclass.Texture2D) { //gd:Polygon2D.set_texture
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_set_texture), 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ texture gdextension.Object }{gdextension.Object(gd.ObjectChecked(texture[0].AsObject()))}))
}
...
func (self class) SetTextureOffset(texture_offset Vector2.XY) { //gd:Polygon2D.set_texture_offset
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_set_texture_offset), 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ texture_offset Vector2.XY }{texture_offset}))
}

//go:nosplit
func (self class) GetTextureOffset() Vector2.XY { //gd:Polygon2D.get_texture_offset
	var r_ret = gdextension.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_get_texture_offset), gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetTextureRotation(texture_rotation float64) { //gd:Polygon2D.set_texture_rotation
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_set_texture_rotation), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ texture_rotation float64 }{texture_rotation}))
}

//go:nosplit
func (self class) GetTextureRotation() float64 { //gd:Polygon2D.get_texture_rotation
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_get_texture_rotation), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetTextureScale(texture_scale Vector2.XY) { //gd:Polygon2D.set_texture_scale
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_set_texture_scale), 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ texture_scale Vector2.XY }{texture_scale}))
}

//go:nosplit
func (self class) GetTextureScale() Vector2.XY { //gd:Polygon2D.get_texture_scale
	var r_ret = gdextension.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_get_texture_scale), gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetInvertEnabled(invert bool) { //gd:Polygon2D.set_invert_enabled
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_set_invert_enabled), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ invert bool }{invert}))
}

//go:nosplit
func (self class) GetInvertEnabled() bool { //gd:Polygon2D.get_invert_enabled
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_get_invert_enabled), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetAntialiased(antialiased bool) { //gd:Polygon2D.set_antialiased
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_set_antialiased), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ antialiased bool }{antialiased}))
}

//go:nosplit
func (self class) GetAntialiased() bool { //gd:Polygon2D.get_antialiased
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_get_antialiased), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetInvertBorder(invert_border float64) { //gd:Polygon2D.set_invert_border
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_set_invert_border), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ invert_border float64 }{invert_border}))
}

//go:nosplit
func (self class) GetInvertBorder() float64 { //gd:Polygon2D.get_invert_border
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_get_invert_border), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetOffset(offset Vector2.XY) { //gd:Polygon2D.set_offset
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_set_offset), 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ offset Vector2.XY }{offset}))
}

//go:nosplit
func (self class) GetOffset() Vector2.XY { //gd:Polygon2D.get_offset
	var r_ret = gdextension.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_get_offset), gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetBoneCount() int64 { //gd:Polygon2D.get_bone_count
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_get_bone_count), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetBoneWeights(index int64) Packed.Array[float32] { //gd:Polygon2D.get_bone_weights
	var r_ret = gdextension.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_get_bone_weights), gdextension.SizePackedArray|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ index int64 }{index}))
...
func (self class) EraseBone(index int64) { //gd:Polygon2D.erase_bone
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_erase_bone), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ index int64 }{index}))
}
...
func (self class) ClearBones() { //gd:Polygon2D.clear_bones
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_clear_bones), 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) SetInternalVertexCount(internal_vertex_count int64) { //gd:Polygon2D.set_internal_vertex_count
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_set_internal_vertex_count), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ internal_vertex_count int64 }{internal_vertex_count}))
}

//go:nosplit
func (self class) GetInternalVertexCount() int64 { //gd:Polygon2D.get_internal_vertex_count
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Polygon2D.Bind_get_internal_vertex_count), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
