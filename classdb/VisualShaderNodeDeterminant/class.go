...
func New() Instance {
	...
	casted := Instance{*(*gdclass.VisualShaderNodeDeterminant)(unsafe.Pointer(&object))}
...
func init() {
	gdclass.Register("VisualShaderNodeDeterminant", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeDeterminant{*(*gdclass.VisualShaderNodeDeterminant)(unsafe.Pointer(&ptr))}
	})
}
