...
func (self class) SetDefaultValue(value Color.RGBA) { //gd:VisualShaderNodeColorParameter.set_default_value
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_default_value, 0|(gdextension.SizeColor<<4), unsafe.Pointer(&struct{ value Color.RGBA }{value}))
}

//go:nosplit
func (self class) GetDefaultValue() Color.RGBA { //gd:VisualShaderNodeColorParameter.get_default_value
	var r_ret = gdextension.Call[Color.RGBA](gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeColor, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
