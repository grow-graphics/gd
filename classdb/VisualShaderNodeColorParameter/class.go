...
func (self class) SetDefaultValueEnabled(enabled bool) { //gd:VisualShaderNodeColorParameter.set_default_value_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.VisualShaderNodeColorParameter.Bind_set_default_value_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsDefaultValueEnabled() bool { //gd:VisualShaderNodeColorParameter.is_default_value_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.VisualShaderNodeColorParameter.Bind_is_default_value_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDefaultValue(value Color.RGBA) { //gd:VisualShaderNodeColorParameter.set_default_value
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.VisualShaderNodeColorParameter.Bind_set_default_value, 0|(gdextension.SizeColor<<4), unsafe.Pointer(&struct{ value Color.RGBA }{value}))
}

//go:nosplit
func (self class) GetDefaultValue() Color.RGBA { //gd:VisualShaderNodeColorParameter.get_default_value
	var r_ret = gdunsafe.Call[Color.RGBA](self.AsObject(), gd.Global.Methods.VisualShaderNodeColorParameter.Bind_get_default_value, gdextension.SizeColor, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
