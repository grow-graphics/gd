...
func (self class) SetTexture(texture [1]gdclass.Texture2D) { //gd:Sprite2D.set_texture
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.Sprite2D.Bind_set_texture, 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ texture gdextension.Object }{gdextension.Object(gd.ObjectChecked(texture[0].AsObject()))}))
}
