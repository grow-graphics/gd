...
func (self class) SetLightData(data [1]gdclass.LightmapGIData) { //gd:LightmapGI.set_light_data
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_light_data), 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ data gdextension.Object }{gdextension.Object(gd.ObjectChecked(data[0].AsObject()))}))
}
...
func (self class) SetBakeQuality(bake_quality BakeQuality) { //gd:LightmapGI.set_bake_quality
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_bake_quality), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ bake_quality BakeQuality }{bake_quality}))
}

//go:nosplit
func (self class) GetBakeQuality() BakeQuality { //gd:LightmapGI.get_bake_quality
	var r_ret = gdextension.Call[BakeQuality](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_get_bake_quality), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetBounces(bounces int64) { //gd:LightmapGI.set_bounces
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_bounces), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ bounces int64 }{bounces}))
}

//go:nosplit
func (self class) GetBounces() int64 { //gd:LightmapGI.get_bounces
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_get_bounces), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetBounceIndirectEnergy(bounce_indirect_energy float64) { //gd:LightmapGI.set_bounce_indirect_energy
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_bounce_indirect_energy), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ bounce_indirect_energy float64 }{bounce_indirect_energy}))
}

//go:nosplit
func (self class) GetBounceIndirectEnergy() float64 { //gd:LightmapGI.get_bounce_indirect_energy
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_get_bounce_indirect_energy), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetGenerateProbes(subdivision GenerateProbes) { //gd:LightmapGI.set_generate_probes
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_generate_probes), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ subdivision GenerateProbes }{subdivision}))
}

//go:nosplit
func (self class) GetGenerateProbes() GenerateProbes { //gd:LightmapGI.get_generate_probes
	var r_ret = gdextension.Call[GenerateProbes](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_get_generate_probes), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetBias(bias float64) { //gd:LightmapGI.set_bias
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_bias), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ bias float64 }{bias}))
}

//go:nosplit
func (self class) GetBias() float64 { //gd:LightmapGI.get_bias
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_get_bias), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetEnvironmentMode(mode EnvironmentMode) { //gd:LightmapGI.set_environment_mode
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_environment_mode), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ mode EnvironmentMode }{mode}))
}

//go:nosplit
func (self class) GetEnvironmentMode() EnvironmentMode { //gd:LightmapGI.get_environment_mode
	var r_ret = gdextension.Call[EnvironmentMode](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_get_environment_mode), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetEnvironmentCustomSky(sky [1]gdclass.Sky) { //gd:LightmapGI.set_environment_custom_sky
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_environment_custom_sky), 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ sky gdextension.Object }{gdextension.Object(gd.ObjectChecked(sky[0].AsObject()))}))
}
...
func (self class) SetEnvironmentCustomColor(color Color.RGBA) { //gd:LightmapGI.set_environment_custom_color
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_environment_custom_color), 0|(gdextension.SizeColor<<4), unsafe.Pointer(&struct{ color Color.RGBA }{color}))
}

//go:nosplit
func (self class) GetEnvironmentCustomColor() Color.RGBA { //gd:LightmapGI.get_environment_custom_color
	var r_ret = gdextension.Call[Color.RGBA](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_get_environment_custom_color), gdextension.SizeColor, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetEnvironmentCustomEnergy(energy float64) { //gd:LightmapGI.set_environment_custom_energy
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_environment_custom_energy), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ energy float64 }{energy}))
}

//go:nosplit
func (self class) GetEnvironmentCustomEnergy() float64 { //gd:LightmapGI.get_environment_custom_energy
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_get_environment_custom_energy), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetTexelScale(texel_scale float64) { //gd:LightmapGI.set_texel_scale
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_texel_scale), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ texel_scale float64 }{texel_scale}))
}

//go:nosplit
func (self class) GetTexelScale() float64 { //gd:LightmapGI.get_texel_scale
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_get_texel_scale), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetMaxTextureSize(max_texture_size int64) { //gd:LightmapGI.set_max_texture_size
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_max_texture_size), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ max_texture_size int64 }{max_texture_size}))
}

//go:nosplit
func (self class) GetMaxTextureSize() int64 { //gd:LightmapGI.get_max_texture_size
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_get_max_texture_size), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetSupersamplingEnabled(enable bool) { //gd:LightmapGI.set_supersampling_enabled
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_supersampling_enabled), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) IsSupersamplingEnabled() bool { //gd:LightmapGI.is_supersampling_enabled
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_is_supersampling_enabled), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetSupersamplingFactor(factor float64) { //gd:LightmapGI.set_supersampling_factor
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_supersampling_factor), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ factor float64 }{factor}))
}

//go:nosplit
func (self class) GetSupersamplingFactor() float64 { //gd:LightmapGI.get_supersampling_factor
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_get_supersampling_factor), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetUseDenoiser(use_denoiser bool) { //gd:LightmapGI.set_use_denoiser
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_use_denoiser), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ use_denoiser bool }{use_denoiser}))
}

//go:nosplit
func (self class) IsUsingDenoiser() bool { //gd:LightmapGI.is_using_denoiser
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_is_using_denoiser), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDenoiserStrength(denoiser_strength float64) { //gd:LightmapGI.set_denoiser_strength
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_denoiser_strength), 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ denoiser_strength float64 }{denoiser_strength}))
}

//go:nosplit
func (self class) GetDenoiserStrength() float64 { //gd:LightmapGI.get_denoiser_strength
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_get_denoiser_strength), gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDenoiserRange(denoiser_range int64) { //gd:LightmapGI.set_denoiser_range
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_denoiser_range), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ denoiser_range int64 }{denoiser_range}))
}

//go:nosplit
func (self class) GetDenoiserRange() int64 { //gd:LightmapGI.get_denoiser_range
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_get_denoiser_range), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetInterior(enable bool) { //gd:LightmapGI.set_interior
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_interior), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enable bool }{enable}))
}

//go:nosplit
func (self class) IsInterior() bool { //gd:LightmapGI.is_interior
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_is_interior), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDirectional(directional bool) { //gd:LightmapGI.set_directional
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_directional), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ directional bool }{directional}))
}

//go:nosplit
func (self class) IsDirectional() bool { //gd:LightmapGI.is_directional
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_is_directional), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetShadowmaskMode(mode LightmapGIData.ShadowmaskMode) { //gd:LightmapGI.set_shadowmask_mode
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_shadowmask_mode), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ mode LightmapGIData.ShadowmaskMode }{mode}))
}

//go:nosplit
func (self class) GetShadowmaskMode() LightmapGIData.ShadowmaskMode { //gd:LightmapGI.get_shadowmask_mode
	var r_ret = gdextension.Call[LightmapGIData.ShadowmaskMode](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_get_shadowmask_mode), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetUseTextureForBounces(use_texture_for_bounces bool) { //gd:LightmapGI.set_use_texture_for_bounces
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_use_texture_for_bounces), 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ use_texture_for_bounces bool }{use_texture_for_bounces}))
}

//go:nosplit
func (self class) IsUsingTextureForBounces() bool { //gd:LightmapGI.is_using_texture_for_bounces
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_is_using_texture_for_bounces), gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetCameraAttributes(camera_attributes [1]gdclass.CameraAttributes) { //gd:LightmapGI.set_camera_attributes
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.LightmapGI.Bind_set_camera_attributes), 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ camera_attributes gdextension.Object }{gdextension.Object(gd.ObjectChecked(camera_attributes[0].AsObject()))}))
}
