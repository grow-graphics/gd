...
func (self class) SetOpType(atype OpType) { //gd:VisualShaderNodeParticleRandomness.set_op_type
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.VisualShaderNodeParticleRandomness.Bind_set_op_type), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ atype OpType }{atype}))
}

//go:nosplit
func (self class) GetOpType() OpType { //gd:VisualShaderNodeParticleRandomness.get_op_type
	var r_ret = gdextension.Call[OpType](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.VisualShaderNodeParticleRandomness.Bind_get_op_type), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
