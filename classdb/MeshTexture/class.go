...
func New() Instance {
	object := [1]gd.Object{pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(pointers.Get(gd.NewStringName("MeshTexture"))))})}
...
func (self class) GetMesh() [1]gdclass.Mesh { //gd:MeshTexture.get_mesh
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.MeshTexture.Bind_get_mesh), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) GetBaseTexture() [1]gdclass.Texture2D { //gd:MeshTexture.get_base_texture
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.MeshTexture.Bind_get_base_texture), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
