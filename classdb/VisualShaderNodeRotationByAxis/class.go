...
func New() Instance {
	...
	casted := Instance{*(*gdclass.VisualShaderNodeRotationByAxis)(unsafe.Pointer(&object))}
...
func init() {
	gdclass.Register("VisualShaderNodeRotationByAxis", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeRotationByAxis{*(*gdclass.VisualShaderNodeRotationByAxis)(unsafe.Pointer(&ptr))}
	})
}
