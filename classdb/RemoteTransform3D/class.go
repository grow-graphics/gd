...
//go:nosplit
func (self class) SetRemoteNode(path gd.NodePath) { //gd:RemoteTransform3D.set_remote_node
...
//go:nosplit
func (self class) GetRemoteNode() gd.NodePath { //gd:RemoteTransform3D.get_remote_node
	var frame = callframe.New()
