...
*/
//go:nosplit
func (self class) GetAdditionalData(extension_name String.Name) gd.Variant { //gd:GLTFAnimation.get_additional_data
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetAdditionalData(extension_name String.Name, additional_data gd.Variant) { //gd:GLTFAnimation.set_additional_data
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(gd.InternalStringName(extension_name)))
