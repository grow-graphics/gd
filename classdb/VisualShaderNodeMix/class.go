...
func (self class) SetOpType(op_type OpType) { //gd:VisualShaderNodeMix.set_op_type
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.VisualShaderNodeMix.Bind_set_op_type, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ op_type OpType }{op_type}))
}

//go:nosplit
func (self class) GetOpType() OpType { //gd:VisualShaderNodeMix.get_op_type
	var r_ret = gdunsafe.Call[OpType](self.AsObject(), gd.Global.Methods.VisualShaderNodeMix.Bind_get_op_type, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
