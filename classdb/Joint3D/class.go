...
func New() Instance {
	object := [1]gd.Object{pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(pointers.Get(gd.NewStringName("Joint3D"))))})}
...
func (self class) SetNodeA(node Path.ToNode) { //gd:Joint3D.set_node_a
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Joint3D.Bind_set_node_a), 0|(gdextension.SizeNodePath<<4), unsafe.Pointer(&struct{ node gdextension.NodePath }{pointers.Get(gd.InternalNodePath(node))}))
}

//go:nosplit
func (self class) GetNodeA() Path.ToNode { //gd:Joint3D.get_node_a
	var r_ret = gdextension.Call[gdextension.NodePath](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Joint3D.Bind_get_node_a), gdextension.SizeNodePath, unsafe.Pointer(&struct{}{}))
...
func (self class) SetNodeB(node Path.ToNode) { //gd:Joint3D.set_node_b
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Joint3D.Bind_set_node_b), 0|(gdextension.SizeNodePath<<4), unsafe.Pointer(&struct{ node gdextension.NodePath }{pointers.Get(gd.InternalNodePath(node))}))
}

//go:nosplit
func (self class) GetNodeB() Path.ToNode { //gd:Joint3D.get_node_b
	var r_ret = gdextension.Call[gdextension.NodePath](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.Joint3D.Bind_get_node_b), gdextension.SizeNodePath, unsafe.Pointer(&struct{}{}))
	var ret = Path.ToNode(String.Via(gd.NodePathProxy{}, pointers.Pack(pointers.New[gd.NodePath](r_ret))))
	return ret
}
