...
func New() Instance {
	object := [1]gd.Object{pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(pointers.Get(gd.NewStringName("NavigationPathQueryResult2D"))))})}
...
func (self class) SetPath(path Packed.Array[Vector2.XY]) { //gd:NavigationPathQueryResult2D.set_path
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.NavigationPathQueryResult2D.Bind_set_path), 0|(gdextension.SizePackedArray<<4), unsafe.Pointer(&struct {
...
func (self class) SetPathTypes(path_types Packed.Array[int32]) { //gd:NavigationPathQueryResult2D.set_path_types
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.NavigationPathQueryResult2D.Bind_set_path_types), 0|(gdextension.SizePackedArray<<4), unsafe.Pointer(&struct {
...
func (self class) SetPathRids(path_rids Array.Contains[RID.Any]) { //gd:NavigationPathQueryResult2D.set_path_rids
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.NavigationPathQueryResult2D.Bind_set_path_rids), 0|(gdextension.SizeArray<<4), unsafe.Pointer(&struct{ path_rids gdextension.Array }{pointers.Get(gd.InternalArray(path_rids))}))
}

//go:nosplit
func (self class) GetPathRids() Array.Contains[RID.Any] { //gd:NavigationPathQueryResult2D.get_path_rids
	var r_ret = gdextension.Call[gdextension.Array](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.NavigationPathQueryResult2D.Bind_get_path_rids), gdextension.SizeArray, unsafe.Pointer(&struct{}{}))
...
func (self class) SetPathOwnerIds(path_owner_ids Packed.Array[int64]) { //gd:NavigationPathQueryResult2D.set_path_owner_ids
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.NavigationPathQueryResult2D.Bind_set_path_owner_ids), 0|(gdextension.SizePackedArray<<4), unsafe.Pointer(&struct {
