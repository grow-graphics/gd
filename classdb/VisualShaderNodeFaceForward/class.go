...
func New() Instance {
	...
	casted := Instance{*(*gdclass.VisualShaderNodeFaceForward)(unsafe.Pointer(&object))}
...
func init() {
	gdclass.Register("VisualShaderNodeFaceForward", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeFaceForward{*(*gdclass.VisualShaderNodeFaceForward)(unsafe.Pointer(&ptr))}
	})
}
