...
func (self class) GetBlendShape(blend_shape BlendShapeEntry) float64 { //gd:XRFaceTracker.get_blend_shape
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.XRFaceTracker.Bind_get_blend_shape, gdextension.SizeFloat|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ blend_shape BlendShapeEntry }{blend_shape}))
	var ret = r_ret
	return ret
}
...
func (self class) SetBlendShape(blend_shape BlendShapeEntry, weight float64) { //gd:XRFaceTracker.set_blend_shape
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.XRFaceTracker.Bind_set_blend_shape, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), unsafe.Pointer(&struct {
...
func (self class) GetBlendShapes() Packed.Array[float32] { //gd:XRFaceTracker.get_blend_shapes
	var r_ret = gdunsafe.Call[gd.PackedPointers](self.AsObject(), gd.Global.Methods.XRFaceTracker.Bind_get_blend_shapes, gdextension.SizePackedArray, unsafe.Pointer(&struct{}{}))
...
func (self class) SetBlendShapes(weights Packed.Array[float32]) { //gd:XRFaceTracker.set_blend_shapes
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.XRFaceTracker.Bind_set_blend_shapes, 0|(gdextension.SizePackedArray<<4), unsafe.Pointer(&struct{ weights gdextension.PackedArray }{gdextension.ToPackedArray(pointers.Get(gd.InternalPacked[gd.PackedFloat32Array, float32](weights)))}))
}
