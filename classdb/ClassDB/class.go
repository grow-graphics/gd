...
func (self class) GetClassList() Packed.Strings { //gd:ClassDB.get_class_list
	var r_ret = gdextension.Call[gd.PackedPointers](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_get_class_list), gdextension.SizePackedArray, unsafe.Pointer(&struct{}{}))
...
func (self class) GetInheritersFromClass(class_ String.Name) Packed.Strings { //gd:ClassDB.get_inheriters_from_class
	var r_ret = gdextension.Call[gd.PackedPointers](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_get_inheriters_from_class), gdextension.SizePackedArray|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ class_ gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0])}))
	var ret = Packed.Strings(Array.Through(gd.PackedStringArrayProxy{}, pointers.Pack(pointers.Let[gd.PackedStringArray](r_ret))))
	return ret
}
...
func (self class) GetParentClass(class_ String.Name) String.Name { //gd:ClassDB.get_parent_class
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_get_parent_class), gdextension.SizeStringName|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ class_ gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0])}))
...
func (self class) ClassExists(class_ String.Name) bool { //gd:ClassDB.class_exists
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_exists), gdextension.SizeBool|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ class_ gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0])}))
	var ret = r_ret
	return ret
}
...
func (self class) IsParentClass(class_ String.Name, inherits String.Name) bool { //gd:ClassDB.is_parent_class
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_is_parent_class), gdextension.SizeBool|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8), unsafe.Pointer(&struct {
...
func (self class) CanInstantiate(class_ String.Name) bool { //gd:ClassDB.can_instantiate
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_can_instantiate), gdextension.SizeBool|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ class_ gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0])}))
	var ret = r_ret
	return ret
}
...
func (self class) Instantiate(class_ String.Name) variant.Any { //gd:ClassDB.instantiate
	var r_ret = gdextension.Call[[3]uint64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_instantiate), gdextension.SizeVariant|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ class_ gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0])}))
...
func (self class) ClassGetApiType(class_ String.Name) APIType { //gd:ClassDB.class_get_api_type
	var r_ret = gdextension.Call[APIType](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_api_type), gdextension.SizeInt|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ class_ gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0])}))
	var ret = r_ret
	return ret
}
...
func (self class) ClassHasSignal(class_ String.Name, signal String.Name) bool { //gd:ClassDB.class_has_signal
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_has_signal), gdextension.SizeBool|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8), unsafe.Pointer(&struct {
		class_ gdextension.StringName
...
func (self class) ClassGetSignal(class_ String.Name, signal String.Name) Dictionary.Any { //gd:ClassDB.class_get_signal
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_signal), gdextension.SizeDictionary|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8), unsafe.Pointer(&struct {
		class_ gdextension.StringName
		signal gdextension.StringName
	}{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0]), gdextension.StringName(pointers.Get(gd.InternalStringName(signal))[0])}))
...
func (self class) ClassGetSignalList(class_ String.Name, no_inheritance bool) Array.Contains[Dictionary.Any] { //gd:ClassDB.class_get_signal_list
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_signal_list), gdextension.SizeArray|(gdextension.SizeStringName<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		class_         gdextension.StringName
		no_inheritance bool
...
func (self class) ClassGetPropertyList(class_ String.Name, no_inheritance bool) Array.Contains[Dictionary.Any] { //gd:ClassDB.class_get_property_list
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_property_list), gdextension.SizeArray|(gdextension.SizeStringName<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		class_         gdextension.StringName
		no_inheritance bool
	}{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0]), no_inheritance}))
	var ret = Array.Through(gd.ArrayProxy[Dictionary.Any]{}, pointers.Pack(pointers.New[gd.Array](r_ret)))
...
func (self class) ClassGetPropertyGetter(class_ String.Name, property String.Name) String.Name { //gd:ClassDB.class_get_property_getter
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_property_getter), gdextension.SizeStringName|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8), unsafe.Pointer(&struct {
		class_   gdextension.StringName
...
func (self class) ClassGetPropertySetter(class_ String.Name, property String.Name) String.Name { //gd:ClassDB.class_get_property_setter
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_property_setter), gdextension.SizeStringName|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8), unsafe.Pointer(&struct {
		class_   gdextension.StringName
		property gdextension.StringName
	}{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0]), gdextension.StringName(pointers.Get(gd.InternalStringName(property))[0])}))
	var ret = String.Name(String.Via(gd.StringNameProxy{}, pointers.Pack(pointers.New[gd.StringName](r_ret))))
...
func (self class) ClassGetProperty(obj [1]gd.Object, property String.Name) variant.Any { //gd:ClassDB.class_get_property
	var r_ret = gdextension.Call[[3]uint64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_property), gdextension.SizeVariant|(gdextension.SizeObject<<4)|(gdextension.SizeStringName<<8), unsafe.Pointer(&struct {
...
func (self class) ClassSetProperty(obj [1]gd.Object, property String.Name, value variant.Any) Error.Code { //gd:ClassDB.class_set_property
	var r_ret = gdextension.Call[int64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_set_property), gdextension.SizeInt|(gdextension.SizeObject<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeVariant<<12), unsafe.Pointer(&struct {
		obj      gdextension.Object
		property gdextension.StringName
...
func (self class) ClassGetPropertyDefaultValue(class_ String.Name, property String.Name) variant.Any { //gd:ClassDB.class_get_property_default_value
	var r_ret = gdextension.Call[[3]uint64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_property_default_value), gdextension.SizeVariant|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8), unsafe.Pointer(&struct {
		class_   gdextension.StringName
		property gdextension.StringName
	}{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0]), gdextension.StringName(pointers.Get(gd.InternalStringName(property))[0])}))
	var ret = variant.Implementation(gd.VariantProxy{}, pointers.Pack(pointers.New[gd.Variant](r_ret)))
...
func (self class) ClassHasMethod(class_ String.Name, method String.Name, no_inheritance bool) bool { //gd:ClassDB.class_has_method
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_has_method), gdextension.SizeBool|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeBool<<12), unsafe.Pointer(&struct {
		class_         gdextension.StringName
...
func (self class) ClassGetMethodArgumentCount(class_ String.Name, method String.Name, no_inheritance bool) int64 { //gd:ClassDB.class_get_method_argument_count
	var r_ret = gdextension.Call[int64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_method_argument_count), gdextension.SizeInt|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeBool<<12), unsafe.Pointer(&struct {
		class_         gdextension.StringName
		method         gdextension.StringName
		no_inheritance bool
	}{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0]), gdextension.StringName(pointers.Get(gd.InternalStringName(method))[0]), no_inheritance}))
...
func (self class) ClassGetMethodList(class_ String.Name, no_inheritance bool) Array.Contains[Dictionary.Any] { //gd:ClassDB.class_get_method_list
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_method_list), gdextension.SizeArray|(gdextension.SizeStringName<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		class_         gdextension.StringName
		no_inheritance bool
	}{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0]), no_inheritance}))
	var ret = Array.Through(gd.ArrayProxy[Dictionary.Any]{}, pointers.Pack(pointers.New[gd.Array](r_ret)))
...
func (self class) ClassCallStatic(class_ String.Name, method String.Name, args ...gd.Variant) variant.Any { //gd:ClassDB.class_call_static
	...
	ret, err := gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_call_static).Call(gdextension.Object(gd.ObjectChecked(self.AsObject())), fixed[:]...)
	if err != nil {
		panic(err)
	}
...
func (self class) ClassGetIntegerConstantList(class_ String.Name, no_inheritance bool) Packed.Strings { //gd:ClassDB.class_get_integer_constant_list
	var r_ret = gdextension.Call[gd.PackedPointers](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_integer_constant_list), gdextension.SizePackedArray|(gdextension.SizeStringName<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		class_         gdextension.StringName
		no_inheritance bool
	}{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0]), no_inheritance}))
	var ret = Packed.Strings(Array.Through(gd.PackedStringArrayProxy{}, pointers.Pack(pointers.Let[gd.PackedStringArray](r_ret))))
...
func (self class) ClassHasIntegerConstant(class_ String.Name, name String.Name) bool { //gd:ClassDB.class_has_integer_constant
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_has_integer_constant), gdextension.SizeBool|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8), unsafe.Pointer(&struct {
		class_ gdextension.StringName
...
func (self class) ClassGetIntegerConstant(class_ String.Name, name String.Name) int64 { //gd:ClassDB.class_get_integer_constant
	var r_ret = gdextension.Call[int64](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_integer_constant), gdextension.SizeInt|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8), unsafe.Pointer(&struct {
		class_ gdextension.StringName
		name   gdextension.StringName
	}{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0]), gdextension.StringName(pointers.Get(gd.InternalStringName(name))[0])}))
	var ret = r_ret
...
func (self class) ClassHasEnum(class_ String.Name, name String.Name, no_inheritance bool) bool { //gd:ClassDB.class_has_enum
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_has_enum), gdextension.SizeBool|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeBool<<12), unsafe.Pointer(&struct {
		class_         gdextension.StringName
		name           gdextension.StringName
		no_inheritance bool
...
func (self class) ClassGetEnumList(class_ String.Name, no_inheritance bool) Packed.Strings { //gd:ClassDB.class_get_enum_list
	var r_ret = gdextension.Call[gd.PackedPointers](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_enum_list), gdextension.SizePackedArray|(gdextension.SizeStringName<<4)|(gdextension.SizeBool<<8), unsafe.Pointer(&struct {
		class_         gdextension.StringName
		no_inheritance bool
	}{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0]), no_inheritance}))
	var ret = Packed.Strings(Array.Through(gd.PackedStringArrayProxy{}, pointers.Pack(pointers.Let[gd.PackedStringArray](r_ret))))
...
func (self class) ClassGetEnumConstants(class_ String.Name, enum String.Name, no_inheritance bool) Packed.Strings { //gd:ClassDB.class_get_enum_constants
	var r_ret = gdextension.Call[gd.PackedPointers](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_enum_constants), gdextension.SizePackedArray|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeBool<<12), unsafe.Pointer(&struct {
		class_         gdextension.StringName
...
func (self class) ClassGetIntegerConstantEnum(class_ String.Name, name String.Name, no_inheritance bool) String.Name { //gd:ClassDB.class_get_integer_constant_enum
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_class_get_integer_constant_enum), gdextension.SizeStringName|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeBool<<12), unsafe.Pointer(&struct {
		class_         gdextension.StringName
		name           gdextension.StringName
		no_inheritance bool
	}{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0]), gdextension.StringName(pointers.Get(gd.InternalStringName(name))[0]), no_inheritance}))
...
func (self class) IsClassEnumBitfield(class_ String.Name, enum String.Name, no_inheritance bool) bool { //gd:ClassDB.is_class_enum_bitfield
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_is_class_enum_bitfield), gdextension.SizeBool|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeBool<<12), unsafe.Pointer(&struct {
		class_         gdextension.StringName
		enum           gdextension.StringName
		no_inheritance bool
	}{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0]), gdextension.StringName(pointers.Get(gd.InternalStringName(enum))[0]), no_inheritance}))
...
func (self class) IsClassEnabled(class_ String.Name) bool { //gd:ClassDB.is_class_enabled
	var r_ret = gdextension.Call[bool](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.ClassDB.Bind_is_class_enabled), gdextension.SizeBool|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ class_ gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(class_))[0])}))
	var ret = r_ret
	return ret
}
