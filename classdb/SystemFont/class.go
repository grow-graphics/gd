...
func (self class) SetAntialiasing(antialiasing TextServer.FontAntialiasing) { //gd:SystemFont.set_antialiasing
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_antialiasing, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ antialiasing TextServer.FontAntialiasing }{antialiasing}))
}

//go:nosplit
func (self class) GetAntialiasing() TextServer.FontAntialiasing { //gd:SystemFont.get_antialiasing
	var r_ret = gdunsafe.Call[TextServer.FontAntialiasing](self.AsObject(), gd.Global.Methods.SystemFont.Bind_get_antialiasing, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDisableEmbeddedBitmaps(disable_embedded_bitmaps bool) { //gd:SystemFont.set_disable_embedded_bitmaps
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_disable_embedded_bitmaps, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ disable_embedded_bitmaps bool }{disable_embedded_bitmaps}))
}

//go:nosplit
func (self class) GetDisableEmbeddedBitmaps() bool { //gd:SystemFont.get_disable_embedded_bitmaps
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SystemFont.Bind_get_disable_embedded_bitmaps, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetGenerateMipmaps(generate_mipmaps bool) { //gd:SystemFont.set_generate_mipmaps
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_generate_mipmaps, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ generate_mipmaps bool }{generate_mipmaps}))
}

//go:nosplit
func (self class) GetGenerateMipmaps() bool { //gd:SystemFont.get_generate_mipmaps
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SystemFont.Bind_get_generate_mipmaps, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetAllowSystemFallback(allow_system_fallback bool) { //gd:SystemFont.set_allow_system_fallback
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_allow_system_fallback, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ allow_system_fallback bool }{allow_system_fallback}))
}

//go:nosplit
func (self class) IsAllowSystemFallback() bool { //gd:SystemFont.is_allow_system_fallback
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SystemFont.Bind_is_allow_system_fallback, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetForceAutohinter(force_autohinter bool) { //gd:SystemFont.set_force_autohinter
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_force_autohinter, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ force_autohinter bool }{force_autohinter}))
}

//go:nosplit
func (self class) IsForceAutohinter() bool { //gd:SystemFont.is_force_autohinter
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SystemFont.Bind_is_force_autohinter, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetHinting(hinting TextServer.Hinting) { //gd:SystemFont.set_hinting
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_hinting, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ hinting TextServer.Hinting }{hinting}))
}

//go:nosplit
func (self class) GetHinting() TextServer.Hinting { //gd:SystemFont.get_hinting
	var r_ret = gdunsafe.Call[TextServer.Hinting](self.AsObject(), gd.Global.Methods.SystemFont.Bind_get_hinting, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetSubpixelPositioning(subpixel_positioning TextServer.SubpixelPositioning) { //gd:SystemFont.set_subpixel_positioning
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_subpixel_positioning, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct {
...
func (self class) GetSubpixelPositioning() TextServer.SubpixelPositioning { //gd:SystemFont.get_subpixel_positioning
	var r_ret = gdunsafe.Call[TextServer.SubpixelPositioning](self.AsObject(), gd.Global.Methods.SystemFont.Bind_get_subpixel_positioning, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetKeepRoundingRemainders(keep_rounding_remainders bool) { //gd:SystemFont.set_keep_rounding_remainders
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_keep_rounding_remainders, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ keep_rounding_remainders bool }{keep_rounding_remainders}))
}

//go:nosplit
func (self class) GetKeepRoundingRemainders() bool { //gd:SystemFont.get_keep_rounding_remainders
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SystemFont.Bind_get_keep_rounding_remainders, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetMultichannelSignedDistanceField(msdf bool) { //gd:SystemFont.set_multichannel_signed_distance_field
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_multichannel_signed_distance_field, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ msdf bool }{msdf}))
}

//go:nosplit
func (self class) IsMultichannelSignedDistanceField() bool { //gd:SystemFont.is_multichannel_signed_distance_field
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SystemFont.Bind_is_multichannel_signed_distance_field, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetMsdfPixelRange(msdf_pixel_range int64) { //gd:SystemFont.set_msdf_pixel_range
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_msdf_pixel_range, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ msdf_pixel_range int64 }{msdf_pixel_range}))
}

//go:nosplit
func (self class) GetMsdfPixelRange() int64 { //gd:SystemFont.get_msdf_pixel_range
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.SystemFont.Bind_get_msdf_pixel_range, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetMsdfSize(msdf_size int64) { //gd:SystemFont.set_msdf_size
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_msdf_size, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ msdf_size int64 }{msdf_size}))
}

//go:nosplit
func (self class) GetMsdfSize() int64 { //gd:SystemFont.get_msdf_size
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.SystemFont.Bind_get_msdf_size, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetOversampling(oversampling float64) { //gd:SystemFont.set_oversampling
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_oversampling, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ oversampling float64 }{oversampling}))
}

//go:nosplit
func (self class) GetOversampling() float64 { //gd:SystemFont.get_oversampling
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.SystemFont.Bind_get_oversampling, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetFontNames() Packed.Strings { //gd:SystemFont.get_font_names
	var r_ret = gdunsafe.Call[gd.PackedPointers](self.AsObject(), gd.Global.Methods.SystemFont.Bind_get_font_names, gdextension.SizePackedArray, unsafe.Pointer(&struct{}{}))
...
func (self class) SetFontNames(names Packed.Strings) { //gd:SystemFont.set_font_names
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_font_names, 0|(gdextension.SizePackedArray<<4), unsafe.Pointer(&struct{ names gdextension.PackedArray }{gdextension.ToPackedArray(pointers.Get(gd.InternalPackedStrings(names)))}))
}

//go:nosplit
func (self class) GetFontItalic() bool { //gd:SystemFont.get_font_italic
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SystemFont.Bind_get_font_italic, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetFontItalic(italic bool) { //gd:SystemFont.set_font_italic
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_font_italic, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ italic bool }{italic}))
}

//go:nosplit
func (self class) SetFontWeight(weight int64) { //gd:SystemFont.set_font_weight
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_font_weight, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ weight int64 }{weight}))
}

//go:nosplit
func (self class) SetFontStretch(stretch int64) { //gd:SystemFont.set_font_stretch
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SystemFont.Bind_set_font_stretch, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ stretch int64 }{stretch}))
}
