...
func (self class) SetOperator(op Operator) { //gd:VisualShaderNodeFloatOp.set_operator
	gdextension.Call[struct{}](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.VisualShaderNodeFloatOp.Bind_set_operator), 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ op Operator }{op}))
}

//go:nosplit
func (self class) GetOperator() Operator { //gd:VisualShaderNodeFloatOp.get_operator
	var r_ret = gdextension.Call[Operator](gdextension.Object(gd.ObjectChecked(self.AsObject())), gdextension.MethodForClass(gd.Global.Methods.VisualShaderNodeFloatOp.Bind_get_operator), gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
