...
func (self class) SetConstant(constant gd.Int) {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.VisualShaderNodeUIntConstant.Bind_set_constant, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	frame.Free()
}
...
func (self class) GetConstant() gd.Int {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.VisualShaderNodeUIntConstant.Bind_get_constant, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
