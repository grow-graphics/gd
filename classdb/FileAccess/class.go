...
*/
func Open(path string, flags gdclass.FileAccessModeFlags) [1]gdclass.FileAccess {
	self := Instance{}
...
Returns [code]null[/code] if opening the file failed. You can use [method get_open_error] to check the error that occurred.
*/
func OpenEncrypted(path string, mode_flags gdclass.FileAccessModeFlags, key []byte) [1]gdclass.FileAccess {
	self := Instance{}
...
Returns [code]null[/code] if opening the file failed. You can use [method get_open_error] to check the error that occurred.
*/
func OpenEncryptedWithPass(path string, mode_flags gdclass.FileAccessModeFlags, pass string) [1]gdclass.FileAccess {
	self := Instance{}
...
Returns [code]null[/code] if opening the file failed. You can use [method get_open_error] to check the error that occurred.
*/
func OpenCompressed(path string, mode_flags gdclass.FileAccessModeFlags) [1]gdclass.FileAccess {
	self := Instance{}
...
*/
func GetUnixPermissions(file string) gdclass.FileAccessUnixPermissionFlags {
	self := Instance{}
...
func New() Instance {
	...
	return Instance{*(*gdclass.FileAccess)(unsafe.Pointer(&object))}
}
...
*/
//go:nosplit
func (self class) Open(path gd.String, flags gdclass.FileAccessModeFlags) [1]gdclass.FileAccess {
...
*/
//go:nosplit
func (self class) OpenEncrypted(path gd.String, mode_flags gdclass.FileAccessModeFlags, key gd.PackedByteArray) [1]gdclass.FileAccess {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(path))
...
*/
//go:nosplit
func (self class) OpenEncryptedWithPass(path gd.String, mode_flags gdclass.FileAccessModeFlags, pass gd.String) [1]gdclass.FileAccess {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(path))
	callframe.Arg(frame, mode_flags)
...
*/
//go:nosplit
func (self class) OpenCompressed(path gd.String, mode_flags gdclass.FileAccessModeFlags, compression_mode gdclass.FileAccessCompressionMode) [1]gdclass.FileAccess {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(path))
	callframe.Arg(frame, mode_flags)
...
*/
//go:nosplit
func (self class) GetUnixPermissions(file gd.String) gdclass.FileAccessUnixPermissionFlags {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(file))
...
type ModeFlags = gdclass.FileAccessModeFlags
...
type CompressionMode = gdclass.FileAccessCompressionMode
...
type UnixPermissionFlags = gdclass.FileAccessUnixPermissionFlags
