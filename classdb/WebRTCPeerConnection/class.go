...
*/
func (self Instance) GetConnectionState() gdclass.WebRTCPeerConnectionConnectionState {
...
*/
func (self Instance) GetGatheringState() gdclass.WebRTCPeerConnectionGatheringState {
...
*/
func (self Instance) GetSignalingState() gdclass.WebRTCPeerConnectionSignalingState {
...
*/
//go:nosplit
func (self class) Initialize(configuration gd.Dictionary) gd.Error {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) CreateDataChannel(label gd.String, options gd.Dictionary) [1]gdclass.WebRTCDataChannel {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) CreateOffer() gd.Error {
	var frame = callframe.New()
	var r_ret = callframe.Ret[gd.Error](frame)
...
*/
//go:nosplit
func (self class) SetLocalDescription(atype gd.String, sdp gd.String) gd.Error {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetRemoteDescription(atype gd.String, sdp gd.String) gd.Error {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(atype))
	callframe.Arg(frame, pointers.Get(sdp))
	var r_ret = callframe.Ret[gd.Error](frame)
...
*/
//go:nosplit
func (self class) AddIceCandidate(media gd.String, index gd.Int, name gd.String) gd.Error {
	var frame = callframe.New()
...
type ConnectionState = gdclass.WebRTCPeerConnectionConnectionState
...
type GatheringState = gdclass.WebRTCPeerConnectionGatheringState
...
type SignalingState = gdclass.WebRTCPeerConnectionSignalingState
