...
func (self class) SetFunction(fn Function) { //gd:VisualShaderNodeColorFunc.set_function
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.VisualShaderNodeColorFunc.Bind_set_function, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ fn Function }{fn}))
}

//go:nosplit
func (self class) GetFunction() Function { //gd:VisualShaderNodeColorFunc.get_function
	var r_ret = gdunsafe.Call[Function](self.AsObject(), gd.Global.Methods.VisualShaderNodeColorFunc.Bind_get_function, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
