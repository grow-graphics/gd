...
func (self class) SetBodyTracker(tracker_name String.Name) { //gd:XRBodyModifier3D.set_body_tracker
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.XRBodyModifier3D.Bind_set_body_tracker), 0|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ tracker_name gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(tracker_name))[0])}))
}

//go:nosplit
func (self class) GetBodyTracker() String.Name { //gd:XRBodyModifier3D.get_body_tracker
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.XRBodyModifier3D.Bind_get_body_tracker), gdextension.SizeStringName, unsafe.Pointer(&struct{}{}))
