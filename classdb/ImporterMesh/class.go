...
func (self class) AddBlendShape(name String.Readable) { //gd:ImporterMesh.add_blend_shape
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_add_blend_shape, 0|(gdextension.SizeString<<4), unsafe.Pointer(&struct{ name gdextension.String }{gdextension.String(pointers.Get(gd.InternalString(name))[0])}))
}
...
func (self class) GetBlendShapeCount() int64 { //gd:ImporterMesh.get_blend_shape_count
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_blend_shape_count, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetBlendShapeName(blend_shape_idx int64) String.Readable { //gd:ImporterMesh.get_blend_shape_name
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_blend_shape_name, gdextension.SizeString|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ blend_shape_idx int64 }{blend_shape_idx}))
...
func (self class) SetBlendShapeMode(mode Mesh.BlendShapeMode) { //gd:ImporterMesh.set_blend_shape_mode
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_set_blend_shape_mode, 0|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ mode Mesh.BlendShapeMode }{mode}))
}
...
func (self class) GetBlendShapeMode() Mesh.BlendShapeMode { //gd:ImporterMesh.get_blend_shape_mode
	var r_ret = gdunsafe.Call[Mesh.BlendShapeMode](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_blend_shape_mode, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) AddSurface(primitive Mesh.PrimitiveType, arrays Array.Any, blend_shapes Array.Contains[Array.Any], lods Dictionary.Any, material [1]gdclass.Material, name String.Readable, flags int64) { //gd:ImporterMesh.add_surface
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_add_surface, 0|(gdextension.SizeInt<<4)|(gdextension.SizeArray<<8)|(gdextension.SizeArray<<12)|(gdextension.SizeDictionary<<16)|(gdextension.SizeObject<<20)|(gdextension.SizeString<<24)|(gdextension.SizeInt<<28), unsafe.Pointer(&struct {
...
func (self class) GetSurfaceCount() int64 { //gd:ImporterMesh.get_surface_count
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_surface_count, gdextension.SizeInt, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetSurfacePrimitiveType(surface_idx int64) Mesh.PrimitiveType { //gd:ImporterMesh.get_surface_primitive_type
	var r_ret = gdunsafe.Call[Mesh.PrimitiveType](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_surface_primitive_type, gdextension.SizeInt|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ surface_idx int64 }{surface_idx}))
	var ret = r_ret
	return ret
}
...
func (self class) GetSurfaceName(surface_idx int64) String.Readable { //gd:ImporterMesh.get_surface_name
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_surface_name, gdextension.SizeString|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ surface_idx int64 }{surface_idx}))
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) GetSurfaceArrays(surface_idx int64) Array.Any { //gd:ImporterMesh.get_surface_arrays
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_surface_arrays, gdextension.SizeArray|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ surface_idx int64 }{surface_idx}))
...
func (self class) GetSurfaceBlendShapeArrays(surface_idx int64, blend_shape_idx int64) Array.Any { //gd:ImporterMesh.get_surface_blend_shape_arrays
	var r_ret = gdunsafe.Call[[1]gd.EnginePointer](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_surface_blend_shape_arrays, gdextension.SizeArray|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		surface_idx     int64
...
func (self class) GetSurfaceLodCount(surface_idx int64) int64 { //gd:ImporterMesh.get_surface_lod_count
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_surface_lod_count, gdextension.SizeInt|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ surface_idx int64 }{surface_idx}))
	var ret = r_ret
	return ret
}
...
func (self class) GetSurfaceLodSize(surface_idx int64, lod_idx int64) float64 { //gd:ImporterMesh.get_surface_lod_size
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_surface_lod_size, gdextension.SizeFloat|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		surface_idx int64
		lod_idx     int64
	}{surface_idx, lod_idx}))
	var ret = r_ret
...
func (self class) GetSurfaceLodIndices(surface_idx int64, lod_idx int64) Packed.Array[int32] { //gd:ImporterMesh.get_surface_lod_indices
	var r_ret = gdunsafe.Call[gd.PackedPointers](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_surface_lod_indices, gdextension.SizePackedArray|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), unsafe.Pointer(&struct {
		surface_idx int64
		lod_idx     int64
	}{surface_idx, lod_idx}))
...
func (self class) GetSurfaceMaterial(surface_idx int64) [1]gdclass.Material { //gd:ImporterMesh.get_surface_material
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_surface_material, gdextension.SizeObject|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ surface_idx int64 }{surface_idx}))
...
func (self class) GetSurfaceFormat(surface_idx int64) int64 { //gd:ImporterMesh.get_surface_format
	var r_ret = gdunsafe.Call[int64](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_surface_format, gdextension.SizeInt|(gdextension.SizeInt<<4), unsafe.Pointer(&struct{ surface_idx int64 }{surface_idx}))
	var ret = r_ret
	return ret
}
...
func (self class) SetSurfaceName(surface_idx int64, name String.Readable) { //gd:ImporterMesh.set_surface_name
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_set_surface_name, 0|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8), unsafe.Pointer(&struct {
		surface_idx int64
		name        gdextension.String
...
func (self class) SetSurfaceMaterial(surface_idx int64, material [1]gdclass.Material) { //gd:ImporterMesh.set_surface_material
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_set_surface_material, 0|(gdextension.SizeInt<<4)|(gdextension.SizeObject<<8), unsafe.Pointer(&struct {
		surface_idx int64
		material    gdextension.Object
	}{surface_idx, gdextension.Object(pointers.Get(material[0])[0])}))
}
...
func (self class) GenerateLods(normal_merge_angle float64, normal_split_angle float64, bone_transform_array Array.Any) { //gd:ImporterMesh.generate_lods
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_generate_lods, 0|(gdextension.SizeFloat<<4)|(gdextension.SizeFloat<<8)|(gdextension.SizeArray<<12), unsafe.Pointer(&struct {
...
func (self class) GetMesh(base_mesh [1]gdclass.ArrayMesh) [1]gdclass.ArrayMesh { //gd:ImporterMesh.get_mesh
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_mesh, gdextension.SizeObject|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ base_mesh gdextension.Object }{gdextension.Object(pointers.Get(base_mesh[0])[0])}))
...
func (self class) Clear() { //gd:ImporterMesh.clear
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_clear, 0, unsafe.Pointer(&struct{}{}))
}
...
func (self class) SetLightmapSizeHint(size Vector2i.XY) { //gd:ImporterMesh.set_lightmap_size_hint
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_set_lightmap_size_hint, 0|(gdextension.SizeVector2i<<4), unsafe.Pointer(&struct{ size Vector2i.XY }{size}))
}
...
func (self class) GetLightmapSizeHint() Vector2i.XY { //gd:ImporterMesh.get_lightmap_size_hint
	var r_ret = gdunsafe.Call[Vector2i.XY](self.AsObject(), gd.Global.Methods.ImporterMesh.Bind_get_lightmap_size_hint, gdextension.SizeVector2i, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
