...
func (self class) SetConstantLinearVelocity(vel Vector2.XY) { //gd:StaticBody2D.set_constant_linear_velocity
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.StaticBody2D.Bind_set_constant_linear_velocity, 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ vel Vector2.XY }{vel}))
}

//go:nosplit
func (self class) SetConstantAngularVelocity(vel float64) { //gd:StaticBody2D.set_constant_angular_velocity
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.StaticBody2D.Bind_set_constant_angular_velocity, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ vel float64 }{vel}))
}

//go:nosplit
func (self class) GetConstantLinearVelocity() Vector2.XY { //gd:StaticBody2D.get_constant_linear_velocity
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.StaticBody2D.Bind_get_constant_linear_velocity, gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) GetConstantAngularVelocity() float64 { //gd:StaticBody2D.get_constant_angular_velocity
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.StaticBody2D.Bind_get_constant_angular_velocity, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetPhysicsMaterialOverride(physics_material_override [1]gdclass.PhysicsMaterial) { //gd:StaticBody2D.set_physics_material_override
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.StaticBody2D.Bind_set_physics_material_override, 0|(gdextension.SizeObject<<4), unsafe.Pointer(&struct{ physics_material_override gdextension.Object }{gdextension.Object(gd.ObjectChecked(physics_material_override[0].AsObject()))}))
}

//go:nosplit
func (self class) GetPhysicsMaterialOverride() [1]gdclass.PhysicsMaterial { //gd:StaticBody2D.get_physics_material_override
	var r_ret = gdunsafe.Call[gd.EnginePointer](self.AsObject(), gd.Global.Methods.StaticBody2D.Bind_get_physics_material_override, gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
