...
func (self class) GetStream() [1]gdclass.AudioStream { //gd:AudioStreamPlayer2D.get_stream
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioStreamPlayer2D.Bind_get_stream), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
...
func (self class) SetBus(bus String.Name) { //gd:AudioStreamPlayer2D.set_bus
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioStreamPlayer2D.Bind_set_bus), 0|(gdextension.SizeStringName<<4), unsafe.Pointer(&struct{ bus gdextension.StringName }{gdextension.StringName(pointers.Get(gd.InternalStringName(bus))[0])}))
}

//go:nosplit
func (self class) GetBus() String.Name { //gd:AudioStreamPlayer2D.get_bus
	var r_ret = gdextension.Call[[1]gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioStreamPlayer2D.Bind_get_bus), gdextension.SizeStringName, unsafe.Pointer(&struct{}{}))
...
func (self class) GetStreamPlayback() [1]gdclass.AudioStreamPlayback { //gd:AudioStreamPlayer2D.get_stream_playback
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.AudioStreamPlayer2D.Bind_get_stream_playback), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
