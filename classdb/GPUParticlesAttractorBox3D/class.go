...
func (self class) SetSize(size Vector3.XYZ) { //gd:GPUParticlesAttractorBox3D.set_size
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.GPUParticlesAttractorBox3D.Bind_set_size, 0|(gdextension.SizeVector3<<4), unsafe.Pointer(&struct{ size Vector3.XYZ }{size}))
}

//go:nosplit
func (self class) GetSize() Vector3.XYZ { //gd:GPUParticlesAttractorBox3D.get_size
	var r_ret = gdunsafe.Call[Vector3.XYZ](self.AsObject(), gd.Global.Methods.GPUParticlesAttractorBox3D.Bind_get_size, gdextension.SizeVector3, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
