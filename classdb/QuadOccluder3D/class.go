...
func (self class) SetSize(size Vector2.XY) { //gd:QuadOccluder3D.set_size
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.QuadOccluder3D.Bind_set_size, 0|(gdextension.SizeVector2<<4), unsafe.Pointer(&struct{ size Vector2.XY }{size}))
}

//go:nosplit
func (self class) GetSize() Vector2.XY { //gd:QuadOccluder3D.get_size
	var r_ret = gdunsafe.Call[Vector2.XY](self.AsObject(), gd.Global.Methods.QuadOccluder3D.Bind_get_size, gdextension.SizeVector2, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
