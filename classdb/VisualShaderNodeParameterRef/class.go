...
func New() Instance {
	...
	return Instance{*(*gdclass.VisualShaderNodeParameterRef)(unsafe.Pointer(&object))}
}
...
func init() {
	gdclass.Register("VisualShaderNodeParameterRef", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeParameterRef{*(*gdclass.VisualShaderNodeParameterRef)(unsafe.Pointer(&ptr))}
	})
}
