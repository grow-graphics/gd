...
func (self class) SetVolumeDb(volume float64) { //gd:AudioEffectAmplify.set_volume_db
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.AudioEffectAmplify.Bind_set_volume_db, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ volume float64 }{volume}))
}

//go:nosplit
func (self class) GetVolumeDb() float64 { //gd:AudioEffectAmplify.get_volume_db
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.AudioEffectAmplify.Bind_get_volume_db, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetVolumeLinear(volume float64) { //gd:AudioEffectAmplify.set_volume_linear
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.AudioEffectAmplify.Bind_set_volume_linear, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ volume float64 }{volume}))
}

//go:nosplit
func (self class) GetVolumeLinear() float64 { //gd:AudioEffectAmplify.get_volume_linear
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.AudioEffectAmplify.Bind_get_volume_linear, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
