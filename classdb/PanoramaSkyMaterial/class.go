...
func (self class) GetPanorama() [1]gdclass.Texture2D { //gd:PanoramaSkyMaterial.get_panorama
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.PanoramaSkyMaterial.Bind_get_panorama), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
