...
func New() Instance {
	...
	return Instance{*(*gdclass.FontFile)(unsafe.Pointer(&object))}
}
...
//go:nosplit
func (self class) SetFontStyle(style gdclass.TextServerFontStyle) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) SetFixedSizeScaleMode(fixed_size_scale_mode gdclass.TextServerFixedSizeScaleMode) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetFixedSizeScaleMode() gdclass.TextServerFixedSizeScaleMode {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetExtraSpacing(cache_index gd.Int, spacing gdclass.TextServerSpacingType, value gd.Int) {
	var frame = callframe.New()
	callframe.Arg(frame, cache_index)
...
*/
//go:nosplit
func (self class) GetExtraSpacing(cache_index gd.Int, spacing gdclass.TextServerSpacingType) gd.Int {
	var frame = callframe.New()
	callframe.Arg(frame, cache_index)
	callframe.Arg(frame, spacing)
	var r_ret = callframe.Ret[gd.Int](frame)
...
*/
//go:nosplit
func (self class) SetTextureImage(cache_index gd.Int, size gd.Vector2i, texture_index gd.Int, image [1]gdclass.Image) {
	var frame = callframe.New()
	callframe.Arg(frame, cache_index)
	callframe.Arg(frame, size)
	callframe.Arg(frame, texture_index)
...
*/
//go:nosplit
func (self class) GetTextureImage(cache_index gd.Int, size gd.Vector2i, texture_index gd.Int) [1]gdclass.Image {
	var frame = callframe.New()
	callframe.Arg(frame, cache_index)
	callframe.Arg(frame, size)
	callframe.Arg(frame, texture_index)
