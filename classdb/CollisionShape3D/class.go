...
func (self class) GetShape() [1]gdclass.Shape3D { //gd:CollisionShape3D.get_shape
	var r_ret = gdextension.Call[gd.EnginePointer](gd.ObjectChecked(self.AsObject()), gdextension.MethodForClass(gd.Global.Methods.CollisionShape3D.Bind_get_shape), gdextension.SizeObject, unsafe.Pointer(&struct{}{}))
