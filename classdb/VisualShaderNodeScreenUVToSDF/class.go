...
func New() Instance {
	...
	casted := Instance{*(*gdclass.VisualShaderNodeScreenUVToSDF)(unsafe.Pointer(&object))}
...
func init() {
	gdclass.Register("VisualShaderNodeScreenUVToSDF", func(ptr gd.Object) any {
		return [1]gdclass.VisualShaderNodeScreenUVToSDF{*(*gdclass.VisualShaderNodeScreenUVToSDF)(unsafe.Pointer(&ptr))}
	})
}
