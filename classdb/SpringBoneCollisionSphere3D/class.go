...
func (self class) SetRadius(radius float64) { //gd:SpringBoneCollisionSphere3D.set_radius
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SpringBoneCollisionSphere3D.Bind_set_radius, 0|(gdextension.SizeFloat<<4), unsafe.Pointer(&struct{ radius float64 }{radius}))
}

//go:nosplit
func (self class) GetRadius() float64 { //gd:SpringBoneCollisionSphere3D.get_radius
	var r_ret = gdunsafe.Call[float64](self.AsObject(), gd.Global.Methods.SpringBoneCollisionSphere3D.Bind_get_radius, gdextension.SizeFloat, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetInside(enabled bool) { //gd:SpringBoneCollisionSphere3D.set_inside
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.SpringBoneCollisionSphere3D.Bind_set_inside, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsInside() bool { //gd:SpringBoneCollisionSphere3D.is_inside
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.SpringBoneCollisionSphere3D.Bind_is_inside, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
