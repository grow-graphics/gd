...
func (self class) SetDefaultValueEnabled(enabled bool) { //gd:VisualShaderNodeTransformParameter.set_default_value_enabled
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.VisualShaderNodeTransformParameter.Bind_set_default_value_enabled, 0|(gdextension.SizeBool<<4), unsafe.Pointer(&struct{ enabled bool }{enabled}))
}

//go:nosplit
func (self class) IsDefaultValueEnabled() bool { //gd:VisualShaderNodeTransformParameter.is_default_value_enabled
	var r_ret = gdunsafe.Call[bool](self.AsObject(), gd.Global.Methods.VisualShaderNodeTransformParameter.Bind_is_default_value_enabled, gdextension.SizeBool, unsafe.Pointer(&struct{}{}))
	var ret = r_ret
	return ret
}
...
func (self class) SetDefaultValue(value Transform3D.BasisOrigin) { //gd:VisualShaderNodeTransformParameter.set_default_value
	gdunsafe.Call[struct{}](self.AsObject(), gd.Global.Methods.VisualShaderNodeTransformParameter.Bind_set_default_value, 0|(gdextension.SizeTransform3D<<4), unsafe.Pointer(&struct{ value Transform3D.BasisOrigin }{gd.Transposed(value)}))
}

//go:nosplit
func (self class) GetDefaultValue() Transform3D.BasisOrigin { //gd:VisualShaderNodeTransformParameter.get_default_value
	var r_ret = gdunsafe.Call[Transform3D.BasisOrigin](self.AsObject(), gd.Global.Methods.VisualShaderNodeTransformParameter.Bind_get_default_value, gdextension.SizeTransform3D, unsafe.Pointer(&struct{}{}))
