...
*/
type Simple [1]classdb.VisualShaderNodeTextureParameterTriplanar
...
//go:nosplit
func (self class) AsVisualShaderNodeTextureParameterTriplanar() Expert { return self[0].AsVisualShaderNodeTextureParameterTriplanar() }


//go:nosplit
func (self Simple) AsVisualShaderNodeTextureParameterTriplanar() Simple { return self[0].AsVisualShaderNodeTextureParameterTriplanar() }
...
func init() {classdb.Register("VisualShaderNodeTextureParameterTriplanar", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
