...
*/
type Simple [1]classdb.AnimationNodeOutput
...
//go:nosplit
func (self class) AsAnimationNodeOutput() Expert { return self[0].AsAnimationNodeOutput() }


//go:nosplit
func (self Simple) AsAnimationNodeOutput() Simple { return self[0].AsAnimationNodeOutput() }
...
func init() {classdb.Register("AnimationNodeOutput", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
