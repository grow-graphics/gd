...
*/
type Simple [1]classdb.VisualShaderNodeDeterminant
...
//go:nosplit
func (self class) AsVisualShaderNodeDeterminant() Expert { return self[0].AsVisualShaderNodeDeterminant() }


//go:nosplit
func (self Simple) AsVisualShaderNodeDeterminant() Simple { return self[0].AsVisualShaderNodeDeterminant() }
...
func init() {classdb.Register("VisualShaderNodeDeterminant", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
