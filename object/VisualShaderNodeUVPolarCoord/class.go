...
*/
type Simple [1]classdb.VisualShaderNodeUVPolarCoord
...
//go:nosplit
func (self class) AsVisualShaderNodeUVPolarCoord() Expert { return self[0].AsVisualShaderNodeUVPolarCoord() }


//go:nosplit
func (self Simple) AsVisualShaderNodeUVPolarCoord() Simple { return self[0].AsVisualShaderNodeUVPolarCoord() }
...
func init() {classdb.Register("VisualShaderNodeUVPolarCoord", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
