...
*/
type Simple [1]classdb.CompressedCubemapArray
...
//go:nosplit
func (self class) AsCompressedCubemapArray() Expert { return self[0].AsCompressedCubemapArray() }


//go:nosplit
func (self Simple) AsCompressedCubemapArray() Simple { return self[0].AsCompressedCubemapArray() }
...
func init() {classdb.Register("CompressedCubemapArray", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
