...
func (self Simple) RegisterExtensionWrapper() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).RegisterExtensionWrapper()
}
...
*/
//go:nosplit
func (self class) GetOpenxrApi(ctx gd.Lifetime) object.OpenXRAPIExtension {
	...
	var ret object.OpenXRAPIExtension
...
//go:nosplit
func (self class) AsOpenXRExtensionWrapperExtension() Expert { return self[0].AsOpenXRExtensionWrapperExtension() }
...
func init() {classdb.Register("OpenXRExtensionWrapperExtension", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
