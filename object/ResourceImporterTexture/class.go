...
*/
type Simple [1]classdb.ResourceImporterTexture
...
//go:nosplit
func (self class) AsResourceImporterTexture() Expert { return self[0].AsResourceImporterTexture() }


//go:nosplit
func (self Simple) AsResourceImporterTexture() Simple { return self[0].AsResourceImporterTexture() }
...
func init() {classdb.Register("ResourceImporterTexture", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
