...
*/
type Simple [1]classdb.AnimatedSprite3D
...
//go:nosplit
func (self class) AsAnimatedSprite3D() Expert { return self[0].AsAnimatedSprite3D() }


//go:nosplit
func (self Simple) AsAnimatedSprite3D() Simple { return self[0].AsAnimatedSprite3D() }
...
func init() {classdb.Register("AnimatedSprite3D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
