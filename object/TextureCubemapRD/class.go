...
*/
type Simple [1]classdb.TextureCubemapRD
...
//go:nosplit
func (self class) AsTextureCubemapRD() Expert { return self[0].AsTextureCubemapRD() }


//go:nosplit
func (self Simple) AsTextureCubemapRD() Simple { return self[0].AsTextureCubemapRD() }
...
func init() {classdb.Register("TextureCubemapRD", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
