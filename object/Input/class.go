...
*/
type Simple [1]classdb.Input
func (self Simple) IsAnythingPressed() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsAnythingPressed())
}
func (self Simple) IsKeyPressed(keycode gd.Key) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsKeyPressed(keycode))
}
func (self Simple) IsPhysicalKeyPressed(keycode gd.Key) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsPhysicalKeyPressed(keycode))
}
func (self Simple) IsKeyLabelPressed(keycode gd.Key) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsKeyLabelPressed(keycode))
}
func (self Simple) IsMouseButtonPressed(button gd.MouseButton) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsMouseButtonPressed(button))
}
func (self Simple) IsJoyButtonPressed(device int, button gd.JoyButton) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsJoyButtonPressed(gd.Int(device), button))
}
func (self Simple) IsActionPressed(action string, exact_match bool) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsActionPressed(gc.StringName(action), exact_match))
}
func (self Simple) IsActionJustPressed(action string, exact_match bool) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsActionJustPressed(gc.StringName(action), exact_match))
}
func (self Simple) IsActionJustReleased(action string, exact_match bool) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsActionJustReleased(gc.StringName(action), exact_match))
}
...
func (self Simple) GetActionRawStrength(action string, exact_match bool) float64 {
	gc := gd.GarbageCollector(); _ = gc
	return float64(float64(Expert(self).GetActionRawStrength(gc.StringName(action), exact_match)))
}
func (self Simple) GetAxis(negative_action string, positive_action string) float64 {
	gc := gd.GarbageCollector(); _ = gc
	return float64(float64(Expert(self).GetAxis(gc.StringName(negative_action), gc.StringName(positive_action))))
}
func (self Simple) GetVector(negative_x string, positive_x string, negative_y string, positive_y string, deadzone float64) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).GetVector(gc.StringName(negative_x), gc.StringName(positive_x), gc.StringName(negative_y), gc.StringName(positive_y), gd.Float(deadzone)))
}
func (self Simple) AddJoyMapping(mapping string, update_existing bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).AddJoyMapping(gc.String(mapping), update_existing)
}
func (self Simple) RemoveJoyMapping(guid string) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).RemoveJoyMapping(gc.String(guid))
}
func (self Simple) IsJoyKnown(device int) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsJoyKnown(gd.Int(device)))
}
func (self Simple) GetJoyAxis(device int, axis gd.JoyAxis) float64 {
	gc := gd.GarbageCollector(); _ = gc
	return float64(float64(Expert(self).GetJoyAxis(gd.Int(device), axis)))
}
func (self Simple) GetJoyName(device int) string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetJoyName(gc, gd.Int(device)).String())
}
func (self Simple) GetJoyGuid(device int) string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetJoyGuid(gc, gd.Int(device)).String())
}
func (self Simple) GetJoyInfo(device int) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(Expert(self).GetJoyInfo(gc, gd.Int(device)))
}
func (self Simple) ShouldIgnoreDevice(vendor_id int, product_id int) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).ShouldIgnoreDevice(gd.Int(vendor_id), gd.Int(product_id)))
}
func (self Simple) GetConnectedJoypads() gd.ArrayOf[gd.Int] {
	gc := gd.GarbageCollector(); _ = gc
	return gd.ArrayOf[gd.Int](Expert(self).GetConnectedJoypads(gc))
}
func (self Simple) GetJoyVibrationStrength(device int) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).GetJoyVibrationStrength(gd.Int(device)))
}
func (self Simple) GetJoyVibrationDuration(device int) float64 {
	gc := gd.GarbageCollector(); _ = gc
	return float64(float64(Expert(self).GetJoyVibrationDuration(gd.Int(device))))
}
func (self Simple) StartJoyVibration(device int, weak_magnitude float64, strong_magnitude float64, duration float64) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).StartJoyVibration(gd.Int(device), gd.Float(weak_magnitude), gd.Float(strong_magnitude), gd.Float(duration))
}
func (self Simple) StopJoyVibration(device int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).StopJoyVibration(gd.Int(device))
}
func (self Simple) VibrateHandheld(duration_ms int, amplitude float64) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).VibrateHandheld(gd.Int(duration_ms), gd.Float(amplitude))
}
func (self Simple) GetGravity() gd.Vector3 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector3(Expert(self).GetGravity())
}
func (self Simple) GetAccelerometer() gd.Vector3 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector3(Expert(self).GetAccelerometer())
}
func (self Simple) GetMagnetometer() gd.Vector3 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector3(Expert(self).GetMagnetometer())
}
func (self Simple) GetGyroscope() gd.Vector3 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector3(Expert(self).GetGyroscope())
}
func (self Simple) SetGravity(value gd.Vector3) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetGravity(value)
}
func (self Simple) SetAccelerometer(value gd.Vector3) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetAccelerometer(value)
}
func (self Simple) SetMagnetometer(value gd.Vector3) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetMagnetometer(value)
}
func (self Simple) SetGyroscope(value gd.Vector3) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetGyroscope(value)
}
func (self Simple) GetLastMouseVelocity() gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).GetLastMouseVelocity())
}
func (self Simple) GetLastMouseScreenVelocity() gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).GetLastMouseScreenVelocity())
}
func (self Simple) GetMouseButtonMask() gd.MouseButtonMask {
	gc := gd.GarbageCollector(); _ = gc
	return gd.MouseButtonMask(Expert(self).GetMouseButtonMask())
}
func (self Simple) SetMouseMode(mode classdb.InputMouseMode) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetMouseMode(mode)
}
func (self Simple) GetMouseMode() classdb.InputMouseMode {
	gc := gd.GarbageCollector(); _ = gc
	return classdb.InputMouseMode(Expert(self).GetMouseMode())
}
func (self Simple) WarpMouse(position gd.Vector2) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).WarpMouse(position)
}
func (self Simple) ActionPress(action string, strength float64) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ActionPress(gc.StringName(action), gd.Float(strength))
}
func (self Simple) ActionRelease(action string) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ActionRelease(gc.StringName(action))
}
func (self Simple) SetDefaultCursorShape(shape classdb.InputCursorShape) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetDefaultCursorShape(shape)
}
func (self Simple) GetCurrentCursorShape() classdb.InputCursorShape {
	gc := gd.GarbageCollector(); _ = gc
	return classdb.InputCursorShape(Expert(self).GetCurrentCursorShape())
}
func (self Simple) SetCustomMouseCursor(image [1]classdb.Resource, shape classdb.InputCursorShape, hotspot gd.Vector2) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetCustomMouseCursor(image, shape, hotspot)
}
func (self Simple) ParseInputEvent(event [1]classdb.InputEvent) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ParseInputEvent(event)
}
func (self Simple) SetUseAccumulatedInput(enable bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetUseAccumulatedInput(enable)
}
func (self Simple) IsUsingAccumulatedInput() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsUsingAccumulatedInput())
}
func (self Simple) FlushBufferedEvents() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).FlushBufferedEvents()
}
func (self Simple) SetEmulateMouseFromTouch(enable bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetEmulateMouseFromTouch(enable)
}
func (self Simple) IsEmulatingMouseFromTouch() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsEmulatingMouseFromTouch())
}
func (self Simple) SetEmulateTouchFromMouse(enable bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetEmulateTouchFromMouse(enable)
}
func (self Simple) IsEmulatingTouchFromMouse() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsEmulatingTouchFromMouse())
}
...
*/
//go:nosplit
func (self class) SetCustomMouseCursor(image object.Resource, shape classdb.InputCursorShape, hotspot gd.Vector2)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) ParseInputEvent(event object.InputEvent)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
//go:nosplit
func (self class) AsInput() Expert { return self[0].AsInput() }


//go:nosplit
func (self Simple) AsInput() Simple { return self[0].AsInput() }
...
func init() {classdb.Register("Input", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
type MouseMode = classdb.InputMouseMode
