...
*/
type Simple [1]classdb.AudioEffectHighShelfFilter
...
//go:nosplit
func (self class) AsAudioEffectHighShelfFilter() Expert { return self[0].AsAudioEffectHighShelfFilter() }


//go:nosplit
func (self Simple) AsAudioEffectHighShelfFilter() Simple { return self[0].AsAudioEffectHighShelfFilter() }
...
func init() {classdb.Register("AudioEffectHighShelfFilter", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
