...
*/
type Simple [1]classdb.HBoxContainer
...
//go:nosplit
func (self class) AsHBoxContainer() Expert { return self[0].AsHBoxContainer() }


//go:nosplit
func (self Simple) AsHBoxContainer() Simple { return self[0].AsHBoxContainer() }
...
func init() {classdb.Register("HBoxContainer", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
