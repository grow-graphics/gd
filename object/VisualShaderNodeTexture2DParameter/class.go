...
*/
type Simple [1]classdb.VisualShaderNodeTexture2DParameter
...
//go:nosplit
func (self class) AsVisualShaderNodeTexture2DParameter() Expert { return self[0].AsVisualShaderNodeTexture2DParameter() }


//go:nosplit
func (self Simple) AsVisualShaderNodeTexture2DParameter() Simple { return self[0].AsVisualShaderNodeTexture2DParameter() }
...
func init() {classdb.Register("VisualShaderNodeTexture2DParameter", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
