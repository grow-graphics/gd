...
*/
type Simple [1]classdb.VisualShaderNodeVec4Constant
func (self Simple) SetConstant(constant gd.Quaternion) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetConstant(constant)
}
func (self Simple) GetConstant() gd.Quaternion {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Quaternion(Expert(self).GetConstant())
}
...
//go:nosplit
func (self class) AsVisualShaderNodeVec4Constant() Expert { return self[0].AsVisualShaderNodeVec4Constant() }


//go:nosplit
func (self Simple) AsVisualShaderNodeVec4Constant() Simple { return self[0].AsVisualShaderNodeVec4Constant() }
...
func init() {classdb.Register("VisualShaderNodeVec4Constant", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
