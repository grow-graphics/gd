...
*/
type Simple [1]classdb.BoxShape3D
...
func (self class) SetSize(size gd.Vector3)  {
	...
	mmm.API(selfPtr).Object.MethodBindPointerCall(mmm.API(selfPtr).Methods.BoxShape3D.Bind_set_size, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	frame.Free()
}
//go:nosplit
func (self class) GetSize() gd.Vector3 {
	...
	mmm.API(selfPtr).Object.MethodBindPointerCall(mmm.API(selfPtr).Methods.BoxShape3D.Bind_get_size, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
//go:nosplit
func (self class) AsBoxShape3D() Expert { return self[0].AsBoxShape3D() }


//go:nosplit
func (self Simple) AsBoxShape3D() Simple { return self[0].AsBoxShape3D() }
...
func init() {classdb.Register("BoxShape3D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
