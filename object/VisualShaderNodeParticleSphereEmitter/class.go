...
*/
type Simple [1]classdb.VisualShaderNodeParticleSphereEmitter
...
//go:nosplit
func (self class) AsVisualShaderNodeParticleSphereEmitter() Expert { return self[0].AsVisualShaderNodeParticleSphereEmitter() }


//go:nosplit
func (self Simple) AsVisualShaderNodeParticleSphereEmitter() Simple { return self[0].AsVisualShaderNodeParticleSphereEmitter() }
...
func init() {classdb.Register("VisualShaderNodeParticleSphereEmitter", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
