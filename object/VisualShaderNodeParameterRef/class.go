...
*/
type Simple [1]classdb.VisualShaderNodeParameterRef
...
//go:nosplit
func (self class) AsVisualShaderNodeParameterRef() Expert { return self[0].AsVisualShaderNodeParameterRef() }


//go:nosplit
func (self Simple) AsVisualShaderNodeParameterRef() Simple { return self[0].AsVisualShaderNodeParameterRef() }
...
func init() {classdb.Register("VisualShaderNodeParameterRef", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
