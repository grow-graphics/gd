...
*/
type Simple [1]classdb.ResourceImporterLayeredTexture
...
//go:nosplit
func (self class) AsResourceImporterLayeredTexture() Expert { return self[0].AsResourceImporterLayeredTexture() }


//go:nosplit
func (self Simple) AsResourceImporterLayeredTexture() Simple { return self[0].AsResourceImporterLayeredTexture() }
...
func init() {classdb.Register("ResourceImporterLayeredTexture", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
