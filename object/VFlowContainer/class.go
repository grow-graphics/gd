...
import "grow.graphics/gd/object/FlowContainer"
...
*/
type Simple [1]classdb.VFlowContainer
...
//go:nosplit
func (self class) AsVFlowContainer() Expert { return self[0].AsVFlowContainer() }


//go:nosplit
func (self Simple) AsVFlowContainer() Simple { return self[0].AsVFlowContainer() }


//go:nosplit
func (self class) AsFlowContainer() FlowContainer.Expert { return self[0].AsFlowContainer() }


//go:nosplit
func (self Simple) AsFlowContainer() FlowContainer.Simple { return self[0].AsFlowContainer() }
...
func init() {classdb.Register("VFlowContainer", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
