...
*/
type Simple [1]classdb.VisualShaderNodeTexture2DArrayParameter
...
//go:nosplit
func (self class) AsVisualShaderNodeTexture2DArrayParameter() Expert { return self[0].AsVisualShaderNodeTexture2DArrayParameter() }


//go:nosplit
func (self Simple) AsVisualShaderNodeTexture2DArrayParameter() Simple { return self[0].AsVisualShaderNodeTexture2DArrayParameter() }
...
func init() {classdb.Register("VisualShaderNodeTexture2DArrayParameter", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
