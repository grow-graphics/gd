...
[/codeblock]
	...
	type VisualShaderNodeCustom interface {
		...
		GetInputPortType(port gd.Int) classdb.VisualShaderNodePortType
		...
		GetDefaultInputPort(atype classdb.VisualShaderNodePortType) gd.Int
		...
		GetOutputPortType(port gd.Int) classdb.VisualShaderNodePortType
		...
		GetCode(input_vars gd.ArrayOf[gd.String], output_vars gd.ArrayOf[gd.String], mode classdb.ShaderMode, atype classdb.VisualShaderType) gd.String
		...
		//You can customize the generated code based on the shader [param mode] (see [enum Shader.Mode]) and/or [param type] (see [enum VisualShader.Type]).
		//Defining this method is [b]optional[/b].
		GetFuncCode(mode classdb.ShaderMode, atype classdb.VisualShaderType) gd.String
		...
		//Defining this method is [b]optional[/b].
		GetGlobalCode(mode classdb.ShaderMode) gd.String
...
//go:nosplit
func (self class) AsVisualShaderNodeCustom() Expert { return self[0].AsVisualShaderNodeCustom() }


//go:nosplit
func (self Simple) AsVisualShaderNodeCustom() Simple { return self[0].AsVisualShaderNodeCustom() }
...
func init() {classdb.Register("VisualShaderNodeCustom", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
