...
*/
type Simple [1]classdb.HScrollBar
...
//go:nosplit
func (self class) AsHScrollBar() Expert { return self[0].AsHScrollBar() }


//go:nosplit
func (self Simple) AsHScrollBar() Simple { return self[0].AsHScrollBar() }
...
func init() {classdb.Register("HScrollBar", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
