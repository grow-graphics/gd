...
*/
type Simple [1]classdb.EditorExportPlatformWindows
...
//go:nosplit
func (self class) AsEditorExportPlatformWindows() Expert { return self[0].AsEditorExportPlatformWindows() }


//go:nosplit
func (self Simple) AsEditorExportPlatformWindows() Simple { return self[0].AsEditorExportPlatformWindows() }
...
func init() {classdb.Register("EditorExportPlatformWindows", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
