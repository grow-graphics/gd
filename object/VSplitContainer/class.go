...
import "grow.graphics/gd/object/SplitContainer"
...
*/
type Simple [1]classdb.VSplitContainer
...
//go:nosplit
func (self class) AsVSplitContainer() Expert { return self[0].AsVSplitContainer() }


//go:nosplit
func (self Simple) AsVSplitContainer() Simple { return self[0].AsVSplitContainer() }


//go:nosplit
func (self class) AsSplitContainer() SplitContainer.Expert { return self[0].AsSplitContainer() }


//go:nosplit
func (self Simple) AsSplitContainer() SplitContainer.Simple { return self[0].AsSplitContainer() }
...
func init() {classdb.Register("VSplitContainer", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
