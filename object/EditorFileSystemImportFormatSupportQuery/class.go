...
//go:nosplit
func (self class) AsEditorFileSystemImportFormatSupportQuery() Expert { return self[0].AsEditorFileSystemImportFormatSupportQuery() }


//go:nosplit
func (self Simple) AsEditorFileSystemImportFormatSupportQuery() Simple { return self[0].AsEditorFileSystemImportFormatSupportQuery() }
...
func init() {classdb.Register("EditorFileSystemImportFormatSupportQuery", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
