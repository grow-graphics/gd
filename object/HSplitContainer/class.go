...
*/
type Simple [1]classdb.HSplitContainer
...
//go:nosplit
func (self class) AsHSplitContainer() Expert { return self[0].AsHSplitContainer() }


//go:nosplit
func (self Simple) AsHSplitContainer() Simple { return self[0].AsHSplitContainer() }
...
func init() {classdb.Register("HSplitContainer", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
