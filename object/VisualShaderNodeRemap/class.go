...
*/
type Simple [1]classdb.VisualShaderNodeRemap
...
//go:nosplit
func (self class) AsVisualShaderNodeRemap() Expert { return self[0].AsVisualShaderNodeRemap() }


//go:nosplit
func (self Simple) AsVisualShaderNodeRemap() Simple { return self[0].AsVisualShaderNodeRemap() }
...
func init() {classdb.Register("VisualShaderNodeRemap", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
