...
*/
type Simple [1]classdb.VBoxContainer
...
//go:nosplit
func (self class) AsVBoxContainer() Expert { return self[0].AsVBoxContainer() }


//go:nosplit
func (self Simple) AsVBoxContainer() Simple { return self[0].AsVBoxContainer() }
...
func init() {classdb.Register("VBoxContainer", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
