...
*/
type Simple [1]classdb.JavaScriptBridge
...
//go:nosplit
func (self class) AsJavaScriptBridge() Expert { return self[0].AsJavaScriptBridge() }


//go:nosplit
func (self Simple) AsJavaScriptBridge() Simple { return self[0].AsJavaScriptBridge() }
...
func init() {classdb.Register("JavaScriptBridge", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
