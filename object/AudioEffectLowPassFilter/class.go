...
*/
type Simple [1]classdb.AudioEffectLowPassFilter
...
//go:nosplit
func (self class) AsAudioEffectLowPassFilter() Expert { return self[0].AsAudioEffectLowPassFilter() }


//go:nosplit
func (self Simple) AsAudioEffectLowPassFilter() Simple { return self[0].AsAudioEffectLowPassFilter() }
...
func init() {classdb.Register("AudioEffectLowPassFilter", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
