...
*/
type Simple [1]classdb.GPUParticlesAttractorSphere3D
...
func (self class) SetRadius(radius gd.Float)  {
	...
	mmm.API(selfPtr).Object.MethodBindPointerCall(mmm.API(selfPtr).Methods.GPUParticlesAttractorSphere3D.Bind_set_radius, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	frame.Free()
}
//go:nosplit
func (self class) GetRadius() gd.Float {
	...
	mmm.API(selfPtr).Object.MethodBindPointerCall(mmm.API(selfPtr).Methods.GPUParticlesAttractorSphere3D.Bind_get_radius, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
//go:nosplit
func (self class) AsGPUParticlesAttractorSphere3D() Expert { return self[0].AsGPUParticlesAttractorSphere3D() }


//go:nosplit
func (self Simple) AsGPUParticlesAttractorSphere3D() Simple { return self[0].AsGPUParticlesAttractorSphere3D() }
...
func init() {classdb.Register("GPUParticlesAttractorSphere3D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
