...
*/
type Simple [1]classdb.VisualShaderNodeParticleRingEmitter
...
//go:nosplit
func (self class) AsVisualShaderNodeParticleRingEmitter() Expert { return self[0].AsVisualShaderNodeParticleRingEmitter() }


//go:nosplit
func (self Simple) AsVisualShaderNodeParticleRingEmitter() Simple { return self[0].AsVisualShaderNodeParticleRingEmitter() }
...
func init() {classdb.Register("VisualShaderNodeParticleRingEmitter", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
