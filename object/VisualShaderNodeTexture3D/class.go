...
*/
type Simple [1]classdb.VisualShaderNodeTexture3D
func (self Simple) SetTexture(value [1]classdb.Texture3D) {
...
//go:nosplit
func (self class) SetTexture(value object.Texture3D)  {
...
//go:nosplit
func (self class) AsVisualShaderNodeTexture3D() Expert { return self[0].AsVisualShaderNodeTexture3D() }


//go:nosplit
func (self Simple) AsVisualShaderNodeTexture3D() Simple { return self[0].AsVisualShaderNodeTexture3D() }
...
func init() {classdb.Register("VisualShaderNodeTexture3D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
