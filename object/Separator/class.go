...
*/
type Simple [1]classdb.Separator
...
//go:nosplit
func (self class) AsSeparator() Expert { return self[0].AsSeparator() }


//go:nosplit
func (self Simple) AsSeparator() Simple { return self[0].AsSeparator() }
...
func init() {classdb.Register("Separator", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
