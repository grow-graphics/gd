...
*/
type Simple [1]classdb.PanelContainer
...
//go:nosplit
func (self class) AsPanelContainer() Expert { return self[0].AsPanelContainer() }


//go:nosplit
func (self Simple) AsPanelContainer() Simple { return self[0].AsPanelContainer() }
...
func init() {classdb.Register("PanelContainer", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
