...
*/
type Simple [1]classdb.RenderingDevice
func (self Simple) TextureCreate(format [1]classdb.RDTextureFormat, view [1]classdb.RDTextureView, data gd.ArrayOf[gd.PackedByteArray]) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).TextureCreate(format, view, data))
}
func (self Simple) TextureCreateShared(view [1]classdb.RDTextureView, with_texture gd.RID) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).TextureCreateShared(view, with_texture))
}
func (self Simple) TextureCreateSharedFromSlice(view [1]classdb.RDTextureView, with_texture gd.RID, layer int, mipmap int, mipmaps int, slice_type classdb.RenderingDeviceTextureSliceType) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).TextureCreateSharedFromSlice(view, with_texture, gd.Int(layer), gd.Int(mipmap), gd.Int(mipmaps), slice_type))
}
func (self Simple) TextureCreateFromExtension(atype classdb.RenderingDeviceTextureType, format classdb.RenderingDeviceDataFormat, samples classdb.RenderingDeviceTextureSamples, usage_flags classdb.RenderingDeviceTextureUsageBits, image int, width int, height int, depth int, layers int) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).TextureCreateFromExtension(atype, format, samples, usage_flags, gd.Int(image), gd.Int(width), gd.Int(height), gd.Int(depth), gd.Int(layers)))
}
func (self Simple) TextureUpdate(texture gd.RID, layer int, data []byte) gd.Error {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Error(Expert(self).TextureUpdate(texture, gd.Int(layer), gc.PackedByteSlice(data)))
}
func (self Simple) TextureGetData(texture gd.RID, layer int) []byte {
	gc := gd.GarbageCollector(); _ = gc
	return []byte(Expert(self).TextureGetData(gc, texture, gd.Int(layer)).Bytes())
}
func (self Simple) TextureIsFormatSupportedForUsage(format classdb.RenderingDeviceDataFormat, usage_flags classdb.RenderingDeviceTextureUsageBits) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).TextureIsFormatSupportedForUsage(format, usage_flags))
}
func (self Simple) TextureIsShared(texture gd.RID) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).TextureIsShared(texture))
}
func (self Simple) TextureIsValid(texture gd.RID) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).TextureIsValid(texture))
}
func (self Simple) TextureCopy(from_texture gd.RID, to_texture gd.RID, from_pos gd.Vector3, to_pos gd.Vector3, size gd.Vector3, src_mipmap int, dst_mipmap int, src_layer int, dst_layer int) gd.Error {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Error(Expert(self).TextureCopy(from_texture, to_texture, from_pos, to_pos, size, gd.Int(src_mipmap), gd.Int(dst_mipmap), gd.Int(src_layer), gd.Int(dst_layer)))
}
func (self Simple) TextureClear(texture gd.RID, color gd.Color, base_mipmap int, mipmap_count int, base_layer int, layer_count int) gd.Error {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Error(Expert(self).TextureClear(texture, color, gd.Int(base_mipmap), gd.Int(mipmap_count), gd.Int(base_layer), gd.Int(layer_count)))
}
func (self Simple) TextureResolveMultisample(from_texture gd.RID, to_texture gd.RID) gd.Error {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Error(Expert(self).TextureResolveMultisample(from_texture, to_texture))
}
func (self Simple) TextureGetFormat(texture gd.RID) [1]classdb.RDTextureFormat {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.RDTextureFormat(Expert(self).TextureGetFormat(gc, texture))
}
func (self Simple) TextureGetNativeHandle(texture gd.RID) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).TextureGetNativeHandle(texture)))
}
func (self Simple) FramebufferFormatCreate(attachments gd.ArrayOf[[1]classdb.RDAttachmentFormat], view_count int) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).FramebufferFormatCreate(attachments, gd.Int(view_count))))
}
func (self Simple) FramebufferFormatCreateMultipass(attachments gd.ArrayOf[[1]classdb.RDAttachmentFormat], passes gd.ArrayOf[[1]classdb.RDFramebufferPass], view_count int) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).FramebufferFormatCreateMultipass(attachments, passes, gd.Int(view_count))))
}
func (self Simple) FramebufferFormatCreateEmpty(samples classdb.RenderingDeviceTextureSamples) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).FramebufferFormatCreateEmpty(samples)))
}
func (self Simple) FramebufferFormatGetTextureSamples(format int, render_pass int) classdb.RenderingDeviceTextureSamples {
	gc := gd.GarbageCollector(); _ = gc
	return classdb.RenderingDeviceTextureSamples(Expert(self).FramebufferFormatGetTextureSamples(gd.Int(format), gd.Int(render_pass)))
}
func (self Simple) FramebufferCreate(textures gd.ArrayOf[gd.RID], validate_with_format int, view_count int) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).FramebufferCreate(textures, gd.Int(validate_with_format), gd.Int(view_count)))
}
func (self Simple) FramebufferCreateMultipass(textures gd.ArrayOf[gd.RID], passes gd.ArrayOf[[1]classdb.RDFramebufferPass], validate_with_format int, view_count int) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).FramebufferCreateMultipass(textures, passes, gd.Int(validate_with_format), gd.Int(view_count)))
}
func (self Simple) FramebufferCreateEmpty(size gd.Vector2i, samples classdb.RenderingDeviceTextureSamples, validate_with_format int) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).FramebufferCreateEmpty(size, samples, gd.Int(validate_with_format)))
}
func (self Simple) FramebufferGetFormat(framebuffer gd.RID) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).FramebufferGetFormat(framebuffer)))
}
func (self Simple) FramebufferIsValid(framebuffer gd.RID) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).FramebufferIsValid(framebuffer))
}
func (self Simple) SamplerCreate(state [1]classdb.RDSamplerState) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).SamplerCreate(state))
}
func (self Simple) SamplerIsFormatSupportedForFilter(format classdb.RenderingDeviceDataFormat, sampler_filter classdb.RenderingDeviceSamplerFilter) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).SamplerIsFormatSupportedForFilter(format, sampler_filter))
}
func (self Simple) VertexBufferCreate(size_bytes int, data []byte, use_as_storage bool) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).VertexBufferCreate(gd.Int(size_bytes), gc.PackedByteSlice(data), use_as_storage))
}
func (self Simple) VertexFormatCreate(vertex_descriptions gd.ArrayOf[[1]classdb.RDVertexAttribute]) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).VertexFormatCreate(vertex_descriptions)))
}
func (self Simple) VertexArrayCreate(vertex_count int, vertex_format int, src_buffers gd.ArrayOf[gd.RID], offsets gd.PackedInt64Array) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).VertexArrayCreate(gd.Int(vertex_count), gd.Int(vertex_format), src_buffers, offsets))
}
func (self Simple) IndexBufferCreate(size_indices int, format classdb.RenderingDeviceIndexBufferFormat, data []byte, use_restart_indices bool) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).IndexBufferCreate(gd.Int(size_indices), format, gc.PackedByteSlice(data), use_restart_indices))
}
func (self Simple) IndexArrayCreate(index_buffer gd.RID, index_offset int, index_count int) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).IndexArrayCreate(index_buffer, gd.Int(index_offset), gd.Int(index_count)))
}
func (self Simple) ShaderCompileSpirvFromSource(shader_source [1]classdb.RDShaderSource, allow_cache bool) [1]classdb.RDShaderSPIRV {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.RDShaderSPIRV(Expert(self).ShaderCompileSpirvFromSource(gc, shader_source, allow_cache))
}
func (self Simple) ShaderCompileBinaryFromSpirv(spirv_data [1]classdb.RDShaderSPIRV, name string) []byte {
	gc := gd.GarbageCollector(); _ = gc
	return []byte(Expert(self).ShaderCompileBinaryFromSpirv(gc, spirv_data, gc.String(name)).Bytes())
}
func (self Simple) ShaderCreateFromSpirv(spirv_data [1]classdb.RDShaderSPIRV, name string) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).ShaderCreateFromSpirv(spirv_data, gc.String(name)))
}
func (self Simple) ShaderCreateFromBytecode(binary_data []byte, placeholder_rid gd.RID) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).ShaderCreateFromBytecode(gc.PackedByteSlice(binary_data), placeholder_rid))
}
func (self Simple) ShaderCreatePlaceholder() gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).ShaderCreatePlaceholder())
}
func (self Simple) ShaderGetVertexInputAttributeMask(shader gd.RID) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).ShaderGetVertexInputAttributeMask(shader)))
}
func (self Simple) UniformBufferCreate(size_bytes int, data []byte) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).UniformBufferCreate(gd.Int(size_bytes), gc.PackedByteSlice(data)))
}
func (self Simple) StorageBufferCreate(size_bytes int, data []byte, usage classdb.RenderingDeviceStorageBufferUsage) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).StorageBufferCreate(gd.Int(size_bytes), gc.PackedByteSlice(data), usage))
}
func (self Simple) TextureBufferCreate(size_bytes int, format classdb.RenderingDeviceDataFormat, data []byte) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).TextureBufferCreate(gd.Int(size_bytes), format, gc.PackedByteSlice(data)))
}
func (self Simple) UniformSetCreate(uniforms gd.ArrayOf[[1]classdb.RDUniform], shader gd.RID, shader_set int) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).UniformSetCreate(uniforms, shader, gd.Int(shader_set)))
}
func (self Simple) UniformSetIsValid(uniform_set gd.RID) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).UniformSetIsValid(uniform_set))
}
func (self Simple) BufferCopy(src_buffer gd.RID, dst_buffer gd.RID, src_offset int, dst_offset int, size int) gd.Error {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Error(Expert(self).BufferCopy(src_buffer, dst_buffer, gd.Int(src_offset), gd.Int(dst_offset), gd.Int(size)))
}
func (self Simple) BufferUpdate(buffer gd.RID, offset int, size_bytes int, data []byte) gd.Error {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Error(Expert(self).BufferUpdate(buffer, gd.Int(offset), gd.Int(size_bytes), gc.PackedByteSlice(data)))
}
func (self Simple) BufferClear(buffer gd.RID, offset int, size_bytes int) gd.Error {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Error(Expert(self).BufferClear(buffer, gd.Int(offset), gd.Int(size_bytes)))
}
func (self Simple) BufferGetData(buffer gd.RID, offset_bytes int, size_bytes int) []byte {
	gc := gd.GarbageCollector(); _ = gc
	return []byte(Expert(self).BufferGetData(gc, buffer, gd.Int(offset_bytes), gd.Int(size_bytes)).Bytes())
}
func (self Simple) RenderPipelineCreate(shader gd.RID, framebuffer_format int, vertex_format int, primitive classdb.RenderingDeviceRenderPrimitive, rasterization_state [1]classdb.RDPipelineRasterizationState, multisample_state [1]classdb.RDPipelineMultisampleState, stencil_state [1]classdb.RDPipelineDepthStencilState, color_blend_state [1]classdb.RDPipelineColorBlendState, dynamic_state_flags classdb.RenderingDevicePipelineDynamicStateFlags, for_render_pass int, specialization_constants gd.ArrayOf[[1]classdb.RDPipelineSpecializationConstant]) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).RenderPipelineCreate(shader, gd.Int(framebuffer_format), gd.Int(vertex_format), primitive, rasterization_state, multisample_state, stencil_state, color_blend_state, dynamic_state_flags, gd.Int(for_render_pass), specialization_constants))
}
func (self Simple) RenderPipelineIsValid(render_pipeline gd.RID) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).RenderPipelineIsValid(render_pipeline))
}
func (self Simple) ComputePipelineCreate(shader gd.RID, specialization_constants gd.ArrayOf[[1]classdb.RDPipelineSpecializationConstant]) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
	return gd.RID(Expert(self).ComputePipelineCreate(shader, specialization_constants))
}
func (self Simple) ComputePipelineIsValid(compute_pipeline gd.RID) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).ComputePipelineIsValid(compute_pipeline))
}
func (self Simple) ScreenGetWidth(screen int) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).ScreenGetWidth(gd.Int(screen))))
}
func (self Simple) ScreenGetHeight(screen int) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).ScreenGetHeight(gd.Int(screen))))
}
func (self Simple) ScreenGetFramebufferFormat(screen int) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).ScreenGetFramebufferFormat(gd.Int(screen))))
}
func (self Simple) DrawListBeginForScreen(screen int, clear_color gd.Color) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).DrawListBeginForScreen(gd.Int(screen), clear_color)))
}
func (self Simple) DrawListBegin(framebuffer gd.RID, initial_color_action classdb.RenderingDeviceInitialAction, final_color_action classdb.RenderingDeviceFinalAction, initial_depth_action classdb.RenderingDeviceInitialAction, final_depth_action classdb.RenderingDeviceFinalAction, clear_color_values gd.PackedColorArray, clear_depth float64, clear_stencil int, region gd.Rect2) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).DrawListBegin(framebuffer, initial_color_action, final_color_action, initial_depth_action, final_depth_action, clear_color_values, gd.Float(clear_depth), gd.Int(clear_stencil), region)))
}
func (self Simple) DrawListBeginSplit(framebuffer gd.RID, splits int, initial_color_action classdb.RenderingDeviceInitialAction, final_color_action classdb.RenderingDeviceFinalAction, initial_depth_action classdb.RenderingDeviceInitialAction, final_depth_action classdb.RenderingDeviceFinalAction, clear_color_values gd.PackedColorArray, clear_depth float64, clear_stencil int, region gd.Rect2, storage_textures gd.ArrayOf[gd.RID]) gd.PackedInt64Array {
	gc := gd.GarbageCollector(); _ = gc
	return gd.PackedInt64Array(Expert(self).DrawListBeginSplit(gc, framebuffer, gd.Int(splits), initial_color_action, final_color_action, initial_depth_action, final_depth_action, clear_color_values, gd.Float(clear_depth), gd.Int(clear_stencil), region, storage_textures))
}
func (self Simple) DrawListSetBlendConstants(draw_list int, color gd.Color) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).DrawListSetBlendConstants(gd.Int(draw_list), color)
}
func (self Simple) DrawListBindRenderPipeline(draw_list int, render_pipeline gd.RID) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).DrawListBindRenderPipeline(gd.Int(draw_list), render_pipeline)
}
func (self Simple) DrawListBindUniformSet(draw_list int, uniform_set gd.RID, set_index int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).DrawListBindUniformSet(gd.Int(draw_list), uniform_set, gd.Int(set_index))
}
func (self Simple) DrawListBindVertexArray(draw_list int, vertex_array gd.RID) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).DrawListBindVertexArray(gd.Int(draw_list), vertex_array)
}
func (self Simple) DrawListBindIndexArray(draw_list int, index_array gd.RID) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).DrawListBindIndexArray(gd.Int(draw_list), index_array)
}
func (self Simple) DrawListSetPushConstant(draw_list int, buffer []byte, size_bytes int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).DrawListSetPushConstant(gd.Int(draw_list), gc.PackedByteSlice(buffer), gd.Int(size_bytes))
}
func (self Simple) DrawListDraw(draw_list int, use_indices bool, instances int, procedural_vertex_count int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).DrawListDraw(gd.Int(draw_list), use_indices, gd.Int(instances), gd.Int(procedural_vertex_count))
}
func (self Simple) DrawListEnableScissor(draw_list int, rect gd.Rect2) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).DrawListEnableScissor(gd.Int(draw_list), rect)
}
func (self Simple) DrawListDisableScissor(draw_list int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).DrawListDisableScissor(gd.Int(draw_list))
}
func (self Simple) DrawListSwitchToNextPass() int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).DrawListSwitchToNextPass()))
}
func (self Simple) DrawListSwitchToNextPassSplit(splits int) gd.PackedInt64Array {
	gc := gd.GarbageCollector(); _ = gc
	return gd.PackedInt64Array(Expert(self).DrawListSwitchToNextPassSplit(gc, gd.Int(splits)))
}
func (self Simple) DrawListEnd() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).DrawListEnd()
}
func (self Simple) ComputeListBegin() int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).ComputeListBegin()))
}
func (self Simple) ComputeListBindComputePipeline(compute_list int, compute_pipeline gd.RID) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ComputeListBindComputePipeline(gd.Int(compute_list), compute_pipeline)
}
func (self Simple) ComputeListSetPushConstant(compute_list int, buffer []byte, size_bytes int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ComputeListSetPushConstant(gd.Int(compute_list), gc.PackedByteSlice(buffer), gd.Int(size_bytes))
}
func (self Simple) ComputeListBindUniformSet(compute_list int, uniform_set gd.RID, set_index int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ComputeListBindUniformSet(gd.Int(compute_list), uniform_set, gd.Int(set_index))
}
func (self Simple) ComputeListDispatch(compute_list int, x_groups int, y_groups int, z_groups int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ComputeListDispatch(gd.Int(compute_list), gd.Int(x_groups), gd.Int(y_groups), gd.Int(z_groups))
}
func (self Simple) ComputeListDispatchIndirect(compute_list int, buffer gd.RID, offset int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ComputeListDispatchIndirect(gd.Int(compute_list), buffer, gd.Int(offset))
}
func (self Simple) ComputeListAddBarrier(compute_list int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ComputeListAddBarrier(gd.Int(compute_list))
}
func (self Simple) ComputeListEnd() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ComputeListEnd()
}
func (self Simple) FreeRid(rid gd.RID) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).FreeRid(rid)
}
func (self Simple) CaptureTimestamp(name string) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).CaptureTimestamp(gc.String(name))
}
func (self Simple) GetCapturedTimestampsCount() int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetCapturedTimestampsCount()))
}
func (self Simple) GetCapturedTimestampsFrame() int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetCapturedTimestampsFrame()))
}
func (self Simple) GetCapturedTimestampGpuTime(index int) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetCapturedTimestampGpuTime(gd.Int(index))))
}
func (self Simple) GetCapturedTimestampCpuTime(index int) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetCapturedTimestampCpuTime(gd.Int(index))))
}
func (self Simple) GetCapturedTimestampName(index int) string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetCapturedTimestampName(gc, gd.Int(index)).String())
}
func (self Simple) LimitGet(limit classdb.RenderingDeviceLimit) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).LimitGet(limit)))
}
func (self Simple) GetFrameDelay() int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetFrameDelay()))
}
func (self Simple) Submit() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).Submit()
}
func (self Simple) Sync() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).Sync()
}
func (self Simple) Barrier(from classdb.RenderingDeviceBarrierMask, to classdb.RenderingDeviceBarrierMask) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).Barrier(from, to)
}
func (self Simple) FullBarrier() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).FullBarrier()
}
func (self Simple) CreateLocalDevice() [1]classdb.RenderingDevice {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.RenderingDevice(Expert(self).CreateLocalDevice(gc))
}
func (self Simple) SetResourceName(id gd.RID, name string) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetResourceName(id, gc.String(name))
}
func (self Simple) DrawCommandBeginLabel(name string, color gd.Color) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).DrawCommandBeginLabel(gc.String(name), color)
}
func (self Simple) DrawCommandInsertLabel(name string, color gd.Color) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).DrawCommandInsertLabel(gc.String(name), color)
}
func (self Simple) DrawCommandEndLabel() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).DrawCommandEndLabel()
}
func (self Simple) GetDeviceVendorName() string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetDeviceVendorName(gc).String())
}
func (self Simple) GetDeviceName() string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetDeviceName(gc).String())
}
func (self Simple) GetDevicePipelineCacheUuid() string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetDevicePipelineCacheUuid(gc).String())
}
func (self Simple) GetMemoryUsage(atype classdb.RenderingDeviceMemoryType) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetMemoryUsage(atype)))
}
func (self Simple) GetDriverResource(resource classdb.RenderingDeviceDriverResource, rid gd.RID, index int) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetDriverResource(resource, rid, gd.Int(index))))
}
...
*/
//go:nosplit
func (self class) TextureCreate(format object.RDTextureFormat, view object.RDTextureView, data gd.ArrayOf[gd.PackedByteArray]) gd.RID {
...
*/
//go:nosplit
func (self class) TextureCreateShared(view object.RDTextureView, with_texture gd.RID) gd.RID {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(view[0].AsPointer())[0])
...
*/
//go:nosplit
func (self class) TextureCreateSharedFromSlice(view object.RDTextureView, with_texture gd.RID, layer gd.Int, mipmap gd.Int, mipmaps gd.Int, slice_type classdb.RenderingDeviceTextureSliceType) gd.RID {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(view[0].AsPointer())[0])
	callframe.Arg(frame, with_texture)
...
*/
//go:nosplit
func (self class) TextureGetFormat(ctx gd.Lifetime, texture gd.RID) object.RDTextureFormat {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, texture)
...
*/
//go:nosplit
func (self class) FramebufferFormatCreate(attachments gd.ArrayOf[object.RDAttachmentFormat], view_count gd.Int) gd.Int {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) FramebufferFormatCreateMultipass(attachments gd.ArrayOf[object.RDAttachmentFormat], passes gd.ArrayOf[object.RDFramebufferPass], view_count gd.Int) gd.Int {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(attachments))
...
*/
//go:nosplit
func (self class) FramebufferCreateMultipass(textures gd.ArrayOf[gd.RID], passes gd.ArrayOf[object.RDFramebufferPass], validate_with_format gd.Int, view_count gd.Int) gd.RID {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(textures))
	callframe.Arg(frame, mmm.Get(passes))
...
*/
//go:nosplit
func (self class) SamplerCreate(state object.RDSamplerState) gd.RID {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) VertexFormatCreate(vertex_descriptions gd.ArrayOf[object.RDVertexAttribute]) gd.Int {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) ShaderCompileSpirvFromSource(ctx gd.Lifetime, shader_source object.RDShaderSource, allow_cache bool) object.RDShaderSPIRV {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) ShaderCompileBinaryFromSpirv(ctx gd.Lifetime, spirv_data object.RDShaderSPIRV, name gd.String) gd.PackedByteArray {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) ShaderCreateFromSpirv(spirv_data object.RDShaderSPIRV, name gd.String) gd.RID {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(spirv_data[0].AsPointer())[0])
	callframe.Arg(frame, mmm.Get(name))
...
*/
//go:nosplit
func (self class) UniformSetCreate(uniforms gd.ArrayOf[object.RDUniform], shader gd.RID, shader_set gd.Int) gd.RID {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) RenderPipelineCreate(shader gd.RID, framebuffer_format gd.Int, vertex_format gd.Int, primitive classdb.RenderingDeviceRenderPrimitive, rasterization_state object.RDPipelineRasterizationState, multisample_state object.RDPipelineMultisampleState, stencil_state object.RDPipelineDepthStencilState, color_blend_state object.RDPipelineColorBlendState, dynamic_state_flags classdb.RenderingDevicePipelineDynamicStateFlags, for_render_pass gd.Int, specialization_constants gd.ArrayOf[object.RDPipelineSpecializationConstant]) gd.RID {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, shader)
...
*/
//go:nosplit
func (self class) ComputePipelineCreate(shader gd.RID, specialization_constants gd.ArrayOf[object.RDPipelineSpecializationConstant]) gd.RID {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, shader)
	callframe.Arg(frame, mmm.Get(specialization_constants))
...
*/
//go:nosplit
func (self class) CreateLocalDevice(ctx gd.Lifetime) object.RenderingDevice {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
//go:nosplit
func (self class) AsRenderingDevice() Expert { return self[0].AsRenderingDevice() }


//go:nosplit
func (self Simple) AsRenderingDevice() Simple { return self[0].AsRenderingDevice() }
...
func init() {classdb.Register("RenderingDevice", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
