...
*/
type Simple [1]classdb.VisualShaderNodeIntOp
func (self Simple) SetOperator(op classdb.VisualShaderNodeIntOpOperator) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetOperator(op)
}
func (self Simple) GetOperator() classdb.VisualShaderNodeIntOpOperator {
	gc := gd.GarbageCollector(); _ = gc
	return classdb.VisualShaderNodeIntOpOperator(Expert(self).GetOperator())
}
...
func (self class) SetOperator(op classdb.VisualShaderNodeIntOpOperator)  {
	...
	mmm.API(selfPtr).Object.MethodBindPointerCall(mmm.API(selfPtr).Methods.VisualShaderNodeIntOp.Bind_set_operator, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	frame.Free()
}
//go:nosplit
func (self class) GetOperator() classdb.VisualShaderNodeIntOpOperator {
	...
	mmm.API(selfPtr).Object.MethodBindPointerCall(mmm.API(selfPtr).Methods.VisualShaderNodeIntOp.Bind_get_operator, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
//go:nosplit
func (self class) AsVisualShaderNodeIntOp() Expert { return self[0].AsVisualShaderNodeIntOp() }


//go:nosplit
func (self Simple) AsVisualShaderNodeIntOp() Simple { return self[0].AsVisualShaderNodeIntOp() }
...
func init() {classdb.Register("VisualShaderNodeIntOp", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
