...
*/
type Simple [1]classdb.SpriteBase3D
...
func (self Simple) SetAxis(axis gd.Vector3Axis) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetAxis(axis)
}
func (self Simple) GetAxis() gd.Vector3Axis {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector3Axis(Expert(self).GetAxis())
}
func (self Simple) SetDrawFlag(flag classdb.SpriteBase3DDrawFlags, enabled bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetDrawFlag(flag, enabled)
}
func (self Simple) GetDrawFlag(flag classdb.SpriteBase3DDrawFlags) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).GetDrawFlag(flag))
}
func (self Simple) SetAlphaCutMode(mode classdb.SpriteBase3DAlphaCutMode) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetAlphaCutMode(mode)
}
func (self Simple) GetAlphaCutMode() classdb.SpriteBase3DAlphaCutMode {
	gc := gd.GarbageCollector(); _ = gc
	return classdb.SpriteBase3DAlphaCutMode(Expert(self).GetAlphaCutMode())
}
...
func (self Simple) GetItemRect() gd.Rect2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Rect2(Expert(self).GetItemRect())
}
...
//go:nosplit
func (self class) AsSpriteBase3D() Expert { return self[0].AsSpriteBase3D() }


//go:nosplit
func (self Simple) AsSpriteBase3D() Simple { return self[0].AsSpriteBase3D() }
...
func init() {classdb.Register("SpriteBase3D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
