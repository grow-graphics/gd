...
*/
type Simple [1]classdb.VSeparator
...
//go:nosplit
func (self class) AsVSeparator() Expert { return self[0].AsVSeparator() }


//go:nosplit
func (self Simple) AsVSeparator() Simple { return self[0].AsVSeparator() }
...
func init() {classdb.Register("VSeparator", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
