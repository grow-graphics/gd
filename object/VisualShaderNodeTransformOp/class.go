...
*/
type Simple [1]classdb.VisualShaderNodeTransformOp
func (self Simple) SetOperator(op classdb.VisualShaderNodeTransformOpOperator) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetOperator(op)
}
func (self Simple) GetOperator() classdb.VisualShaderNodeTransformOpOperator {
	gc := gd.GarbageCollector(); _ = gc
	return classdb.VisualShaderNodeTransformOpOperator(Expert(self).GetOperator())
}
...
//go:nosplit
func (self class) AsVisualShaderNodeTransformOp() Expert { return self[0].AsVisualShaderNodeTransformOp() }


//go:nosplit
func (self Simple) AsVisualShaderNodeTransformOp() Simple { return self[0].AsVisualShaderNodeTransformOp() }
...
func init() {classdb.Register("VisualShaderNodeTransformOp", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
