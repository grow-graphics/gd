...
*/
type Simple [1]classdb.Marker3D
...
//go:nosplit
func (self class) AsMarker3D() Expert { return self[0].AsMarker3D() }


//go:nosplit
func (self Simple) AsMarker3D() Simple { return self[0].AsMarker3D() }
...
func init() {classdb.Register("Marker3D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
