...
*/
type Simple [1]classdb.SphereShape3D
...
//go:nosplit
func (self class) AsSphereShape3D() Expert { return self[0].AsSphereShape3D() }


//go:nosplit
func (self Simple) AsSphereShape3D() Simple { return self[0].AsSphereShape3D() }
...
func init() {classdb.Register("SphereShape3D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
