...
*/
type Simple [1]classdb.VisualShaderNodeVaryingSetter
...
//go:nosplit
func (self class) AsVisualShaderNodeVaryingSetter() Expert { return self[0].AsVisualShaderNodeVaryingSetter() }


//go:nosplit
func (self Simple) AsVisualShaderNodeVaryingSetter() Simple { return self[0].AsVisualShaderNodeVaryingSetter() }
...
func init() {classdb.Register("VisualShaderNodeVaryingSetter", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
