...
*/
type Simple [1]classdb.HFlowContainer
...
//go:nosplit
func (self class) AsHFlowContainer() Expert { return self[0].AsHFlowContainer() }


//go:nosplit
func (self Simple) AsHFlowContainer() Simple { return self[0].AsHFlowContainer() }
...
func init() {classdb.Register("HFlowContainer", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
