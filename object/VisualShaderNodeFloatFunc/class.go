...
*/
type Simple [1]classdb.VisualShaderNodeFloatFunc
func (self Simple) SetFunction(fn classdb.VisualShaderNodeFloatFuncFunction) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetFunction(fn)
}
func (self Simple) GetFunction() classdb.VisualShaderNodeFloatFuncFunction {
	gc := gd.GarbageCollector(); _ = gc
	return classdb.VisualShaderNodeFloatFuncFunction(Expert(self).GetFunction())
}
...
//go:nosplit
func (self class) AsVisualShaderNodeFloatFunc() Expert { return self[0].AsVisualShaderNodeFloatFunc() }


//go:nosplit
func (self Simple) AsVisualShaderNodeFloatFunc() Simple { return self[0].AsVisualShaderNodeFloatFunc() }
...
func init() {classdb.Register("VisualShaderNodeFloatFunc", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
