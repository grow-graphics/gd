...
*/
type Simple [1]classdb.Time
func (self Simple) GetDatetimeDictFromUnixTime(unix_time_val int) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(Expert(self).GetDatetimeDictFromUnixTime(gc, gd.Int(unix_time_val)))
}
func (self Simple) GetDateDictFromUnixTime(unix_time_val int) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(Expert(self).GetDateDictFromUnixTime(gc, gd.Int(unix_time_val)))
}
func (self Simple) GetTimeDictFromUnixTime(unix_time_val int) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(Expert(self).GetTimeDictFromUnixTime(gc, gd.Int(unix_time_val)))
}
func (self Simple) GetDatetimeStringFromUnixTime(unix_time_val int, use_space bool) string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetDatetimeStringFromUnixTime(gc, gd.Int(unix_time_val), use_space).String())
}
func (self Simple) GetDateStringFromUnixTime(unix_time_val int) string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetDateStringFromUnixTime(gc, gd.Int(unix_time_val)).String())
}
func (self Simple) GetTimeStringFromUnixTime(unix_time_val int) string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetTimeStringFromUnixTime(gc, gd.Int(unix_time_val)).String())
}
func (self Simple) GetDatetimeDictFromDatetimeString(datetime string, weekday bool) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(Expert(self).GetDatetimeDictFromDatetimeString(gc, gc.String(datetime), weekday))
}
func (self Simple) GetDatetimeStringFromDatetimeDict(datetime gd.Dictionary, use_space bool) string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetDatetimeStringFromDatetimeDict(gc, datetime, use_space).String())
}
func (self Simple) GetUnixTimeFromDatetimeDict(datetime gd.Dictionary) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetUnixTimeFromDatetimeDict(datetime)))
}
func (self Simple) GetUnixTimeFromDatetimeString(datetime string) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetUnixTimeFromDatetimeString(gc.String(datetime))))
}
func (self Simple) GetOffsetStringFromOffsetMinutes(offset_minutes int) string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetOffsetStringFromOffsetMinutes(gc, gd.Int(offset_minutes)).String())
}
func (self Simple) GetDatetimeDictFromSystem(utc bool) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(Expert(self).GetDatetimeDictFromSystem(gc, utc))
}
func (self Simple) GetDateDictFromSystem(utc bool) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(Expert(self).GetDateDictFromSystem(gc, utc))
}
func (self Simple) GetTimeDictFromSystem(utc bool) gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(Expert(self).GetTimeDictFromSystem(gc, utc))
}
func (self Simple) GetDatetimeStringFromSystem(utc bool, use_space bool) string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetDatetimeStringFromSystem(gc, utc, use_space).String())
}
func (self Simple) GetDateStringFromSystem(utc bool) string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetDateStringFromSystem(gc, utc).String())
}
func (self Simple) GetTimeStringFromSystem(utc bool) string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetTimeStringFromSystem(gc, utc).String())
}
func (self Simple) GetTimeZoneFromSystem() gd.Dictionary {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Dictionary(Expert(self).GetTimeZoneFromSystem(gc))
}
func (self Simple) GetUnixTimeFromSystem() float64 {
	gc := gd.GarbageCollector(); _ = gc
	return float64(float64(Expert(self).GetUnixTimeFromSystem()))
}
func (self Simple) GetTicksMsec() int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetTicksMsec()))
}
func (self Simple) GetTicksUsec() int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetTicksUsec()))
}
...
//go:nosplit
func (self class) AsTime() Expert { return self[0].AsTime() }


//go:nosplit
func (self Simple) AsTime() Simple { return self[0].AsTime() }
...
func init() {classdb.Register("Time", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
