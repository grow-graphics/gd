...
*/
type Simple [1]classdb.EditorExportPlatformPC
...
//go:nosplit
func (self class) AsEditorExportPlatformPC() Expert { return self[0].AsEditorExportPlatformPC() }


//go:nosplit
func (self Simple) AsEditorExportPlatformPC() Simple { return self[0].AsEditorExportPlatformPC() }
...
func init() {classdb.Register("EditorExportPlatformPC", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
