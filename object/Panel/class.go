...
//go:nosplit
func (self class) AsPanel() Expert { return self[0].AsPanel() }


//go:nosplit
func (self Simple) AsPanel() Simple { return self[0].AsPanel() }
...
func init() {classdb.Register("Panel", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
