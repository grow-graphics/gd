...
[b]Note:[/b] The [code]script[/code] property is part of the [Object] class, not [Node]. It isn't exposed like most properties but does have a setter and getter (see [method Object.set_script] and [method Object.get_script]).
	...
	type Node interface {
		...
		ShortcutInput(event object.InputEvent) 
		...
		//[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).
		UnhandledInput(event object.InputEvent) 
		...
		//[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).
		UnhandledKeyInput(event object.InputEvent) 
	}
...
func (self Simple) AddSibling(sibling [1]classdb.Node, force_readable_name bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).AddSibling(sibling, force_readable_name)
}
...
func (self Simple) AddChild(node [1]classdb.Node, force_readable_name bool, internal_ classdb.NodeInternalMode) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).AddChild(node, force_readable_name, internal_)
}
func (self Simple) RemoveChild(node [1]classdb.Node) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).RemoveChild(node)
}
func (self Simple) Reparent(new_parent [1]classdb.Node, keep_global_transform bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).Reparent(new_parent, keep_global_transform)
}
func (self Simple) GetChildCount(include_internal bool) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetChildCount(include_internal)))
}
func (self Simple) GetChildren(include_internal bool) gd.ArrayOf[[1]classdb.Node] {
	gc := gd.GarbageCollector(); _ = gc
	return gd.ArrayOf[[1]classdb.Node](Expert(self).GetChildren(gc, include_internal))
}
func (self Simple) GetChild(idx int, include_internal bool) [1]classdb.Node {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Node(Expert(self).GetChild(gc, gd.Int(idx), include_internal))
}
func (self Simple) HasNode(path gd.NodePath) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).HasNode(path))
}
func (self Simple) GetNode(path gd.NodePath) [1]classdb.Node {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Node(Expert(self).GetNode(gc, path))
}
func (self Simple) GetNodeOrNull(path gd.NodePath) [1]classdb.Node {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Node(Expert(self).GetNodeOrNull(gc, path))
}
func (self Simple) GetParent() [1]classdb.Node {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Node(Expert(self).GetParent(gc))
}
func (self Simple) FindChild(pattern string, recursive bool, owned bool) [1]classdb.Node {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Node(Expert(self).FindChild(gc, gc.String(pattern), recursive, owned))
}
func (self Simple) FindChildren(pattern string, atype string, recursive bool, owned bool) gd.ArrayOf[[1]classdb.Node] {
	gc := gd.GarbageCollector(); _ = gc
	return gd.ArrayOf[[1]classdb.Node](Expert(self).FindChildren(gc, gc.String(pattern), gc.String(atype), recursive, owned))
}
func (self Simple) FindParent(pattern string) [1]classdb.Node {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Node(Expert(self).FindParent(gc, gc.String(pattern)))
}
func (self Simple) HasNodeAndResource(path gd.NodePath) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).HasNodeAndResource(path))
}
func (self Simple) GetNodeAndResource(path gd.NodePath) gd.Array {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Array(Expert(self).GetNodeAndResource(gc, path))
}
func (self Simple) IsInsideTree() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsInsideTree())
}
func (self Simple) IsPartOfEditedScene() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsPartOfEditedScene())
}
func (self Simple) IsAncestorOf(node [1]classdb.Node) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsAncestorOf(node))
}
func (self Simple) IsGreaterThan(node [1]classdb.Node) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsGreaterThan(node))
}
func (self Simple) GetPath() gd.NodePath {
	gc := gd.GarbageCollector(); _ = gc
	return gd.NodePath(Expert(self).GetPath(gc))
}
func (self Simple) GetPathTo(node [1]classdb.Node, use_unique_path bool) gd.NodePath {
	gc := gd.GarbageCollector(); _ = gc
	return gd.NodePath(Expert(self).GetPathTo(gc, node, use_unique_path))
}
func (self Simple) AddToGroup(group string, persistent bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).AddToGroup(gc.StringName(group), persistent)
}
func (self Simple) RemoveFromGroup(group string) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).RemoveFromGroup(gc.StringName(group))
}
func (self Simple) IsInGroup(group string) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsInGroup(gc.StringName(group)))
}
func (self Simple) MoveChild(child_node [1]classdb.Node, to_index int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).MoveChild(child_node, gd.Int(to_index))
}
func (self Simple) GetGroups() gd.ArrayOf[gd.StringName] {
	gc := gd.GarbageCollector(); _ = gc
	return gd.ArrayOf[gd.StringName](Expert(self).GetGroups(gc))
}
func (self Simple) SetOwner(owner [1]classdb.Node) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetOwner(owner)
}
func (self Simple) GetOwner() [1]classdb.Node {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Node(Expert(self).GetOwner(gc))
}
func (self Simple) GetIndex(include_internal bool) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetIndex(include_internal)))
}
func (self Simple) PrintTree() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).PrintTree()
}
func (self Simple) PrintTreePretty() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).PrintTreePretty()
}
func (self Simple) GetTreeString() string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetTreeString(gc).String())
}
func (self Simple) GetTreeStringPretty() string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetTreeStringPretty(gc).String())
}
func (self Simple) SetSceneFilePath(scene_file_path string) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetSceneFilePath(gc.String(scene_file_path))
}
func (self Simple) GetSceneFilePath() string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetSceneFilePath(gc).String())
}
func (self Simple) PropagateNotification(what int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).PropagateNotification(gd.Int(what))
}
func (self Simple) PropagateCall(method string, args gd.Array, parent_first bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).PropagateCall(gc.StringName(method), args, parent_first)
}
func (self Simple) SetPhysicsProcess(enable bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetPhysicsProcess(enable)
}
func (self Simple) GetPhysicsProcessDeltaTime() float64 {
	gc := gd.GarbageCollector(); _ = gc
	return float64(float64(Expert(self).GetPhysicsProcessDeltaTime()))
}
func (self Simple) IsPhysicsProcessing() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsPhysicsProcessing())
}
func (self Simple) GetProcessDeltaTime() float64 {
	gc := gd.GarbageCollector(); _ = gc
	return float64(float64(Expert(self).GetProcessDeltaTime()))
}
func (self Simple) SetProcess(enable bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetProcess(enable)
}
func (self Simple) SetProcessPriority(priority int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetProcessPriority(gd.Int(priority))
}
func (self Simple) GetProcessPriority() int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetProcessPriority()))
}
func (self Simple) SetPhysicsProcessPriority(priority int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetPhysicsProcessPriority(gd.Int(priority))
}
func (self Simple) GetPhysicsProcessPriority() int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetPhysicsProcessPriority()))
}
func (self Simple) IsProcessing() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsProcessing())
}
func (self Simple) SetProcessInput(enable bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetProcessInput(enable)
}
func (self Simple) IsProcessingInput() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsProcessingInput())
}
func (self Simple) SetProcessShortcutInput(enable bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetProcessShortcutInput(enable)
}
func (self Simple) IsProcessingShortcutInput() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsProcessingShortcutInput())
}
func (self Simple) SetProcessUnhandledInput(enable bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetProcessUnhandledInput(enable)
}
func (self Simple) IsProcessingUnhandledInput() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsProcessingUnhandledInput())
}
func (self Simple) SetProcessUnhandledKeyInput(enable bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetProcessUnhandledKeyInput(enable)
}
func (self Simple) IsProcessingUnhandledKeyInput() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsProcessingUnhandledKeyInput())
}
func (self Simple) SetProcessMode(mode classdb.NodeProcessMode) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetProcessMode(mode)
}
func (self Simple) GetProcessMode() classdb.NodeProcessMode {
	gc := gd.GarbageCollector(); _ = gc
	return classdb.NodeProcessMode(Expert(self).GetProcessMode())
}
func (self Simple) CanProcess() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).CanProcess())
}
func (self Simple) SetProcessThreadGroup(mode classdb.NodeProcessThreadGroup) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetProcessThreadGroup(mode)
}
func (self Simple) GetProcessThreadGroup() classdb.NodeProcessThreadGroup {
	gc := gd.GarbageCollector(); _ = gc
	return classdb.NodeProcessThreadGroup(Expert(self).GetProcessThreadGroup())
}
func (self Simple) SetProcessThreadMessages(flags classdb.NodeProcessThreadMessages) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetProcessThreadMessages(flags)
}
func (self Simple) GetProcessThreadMessages() classdb.NodeProcessThreadMessages {
	gc := gd.GarbageCollector(); _ = gc
	return classdb.NodeProcessThreadMessages(Expert(self).GetProcessThreadMessages())
}
func (self Simple) SetProcessThreadGroupOrder(order int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetProcessThreadGroupOrder(gd.Int(order))
}
func (self Simple) GetProcessThreadGroupOrder() int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetProcessThreadGroupOrder()))
}
func (self Simple) SetDisplayFolded(fold bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetDisplayFolded(fold)
}
func (self Simple) IsDisplayedFolded() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsDisplayedFolded())
}
func (self Simple) SetProcessInternal(enable bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetProcessInternal(enable)
}
func (self Simple) IsProcessingInternal() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsProcessingInternal())
}
func (self Simple) SetPhysicsProcessInternal(enable bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetPhysicsProcessInternal(enable)
}
func (self Simple) IsPhysicsProcessingInternal() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsPhysicsProcessingInternal())
}
func (self Simple) SetPhysicsInterpolationMode(mode classdb.NodePhysicsInterpolationMode) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetPhysicsInterpolationMode(mode)
}
func (self Simple) GetPhysicsInterpolationMode() classdb.NodePhysicsInterpolationMode {
	gc := gd.GarbageCollector(); _ = gc
	return classdb.NodePhysicsInterpolationMode(Expert(self).GetPhysicsInterpolationMode())
}
func (self Simple) IsPhysicsInterpolated() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsPhysicsInterpolated())
}
func (self Simple) IsPhysicsInterpolatedAndEnabled() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsPhysicsInterpolatedAndEnabled())
}
func (self Simple) ResetPhysicsInterpolation() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ResetPhysicsInterpolation()
}
func (self Simple) SetAutoTranslateMode(mode classdb.NodeAutoTranslateMode) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetAutoTranslateMode(mode)
}
func (self Simple) GetAutoTranslateMode() classdb.NodeAutoTranslateMode {
	gc := gd.GarbageCollector(); _ = gc
	return classdb.NodeAutoTranslateMode(Expert(self).GetAutoTranslateMode())
}
func (self Simple) GetWindow() [1]classdb.Window {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Window(Expert(self).GetWindow(gc))
}
func (self Simple) GetLastExclusiveWindow() [1]classdb.Window {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Window(Expert(self).GetLastExclusiveWindow(gc))
}
func (self Simple) GetTree() [1]classdb.SceneTree {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.SceneTree(Expert(self).GetTree(gc))
}
func (self Simple) CreateTween() [1]classdb.Tween {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Tween(Expert(self).CreateTween(gc))
}
func (self Simple) Duplicate(flags int) [1]classdb.Node {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Node(Expert(self).Duplicate(gc, gd.Int(flags)))
}
func (self Simple) ReplaceBy(node [1]classdb.Node, keep_groups bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ReplaceBy(node, keep_groups)
}
func (self Simple) SetSceneInstanceLoadPlaceholder(load_placeholder bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetSceneInstanceLoadPlaceholder(load_placeholder)
}
func (self Simple) GetSceneInstanceLoadPlaceholder() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).GetSceneInstanceLoadPlaceholder())
}
func (self Simple) SetEditableInstance(node [1]classdb.Node, is_editable bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetEditableInstance(node, is_editable)
}
func (self Simple) IsEditableInstance(node [1]classdb.Node) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsEditableInstance(node))
}
func (self Simple) GetViewport() [1]classdb.Viewport {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Viewport(Expert(self).GetViewport(gc))
}
func (self Simple) QueueFree() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).QueueFree()
}
func (self Simple) RequestReady() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).RequestReady()
}
func (self Simple) IsNodeReady() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsNodeReady())
}
func (self Simple) SetMultiplayerAuthority(id int, recursive bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetMultiplayerAuthority(gd.Int(id), recursive)
}
func (self Simple) GetMultiplayerAuthority() int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetMultiplayerAuthority()))
}
func (self Simple) IsMultiplayerAuthority() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsMultiplayerAuthority())
}
func (self Simple) GetMultiplayer() [1]classdb.MultiplayerAPI {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.MultiplayerAPI(Expert(self).GetMultiplayer(gc))
}
func (self Simple) RpcConfig(method string, config gd.Variant) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).RpcConfig(gc.StringName(method), config)
}
func (self Simple) SetEditorDescription(editor_description string) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetEditorDescription(gc.String(editor_description))
}
func (self Simple) GetEditorDescription() string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetEditorDescription(gc).String())
}
func (self Simple) SetUniqueNameInOwner(enable bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetUniqueNameInOwner(enable)
}
func (self Simple) IsUniqueNameInOwner() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsUniqueNameInOwner())
}
func (self Simple) Atr(message string, context string) string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).Atr(gc, gc.String(message), gc.StringName(context)).String())
}
func (self Simple) AtrN(message string, plural_message string, n int, context string) string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).AtrN(gc, gc.String(message), gc.StringName(plural_message), gd.Int(n), gc.StringName(context)).String())
}
func (self Simple) UpdateConfigurationWarnings() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).UpdateConfigurationWarnings()
}
func (self Simple) SetDeferredThreadGroup(property string, value gd.Variant) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetDeferredThreadGroup(gc.StringName(property), value)
}
func (self Simple) NotifyDeferredThreadGroup(what int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).NotifyDeferredThreadGroup(gd.Int(what))
}
func (self Simple) SetThreadSafe(property string, value gd.Variant) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetThreadSafe(gc.StringName(property), value)
}
func (self Simple) NotifyThreadSafe(what int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).NotifyThreadSafe(gd.Int(what))
}
...
[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).
*/
func (class) _input(impl func(ptr unsafe.Pointer, event object.InputEvent) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		ctx := gd.NewLifetime(api)
		class.SetTemporary(ctx)
...
[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not orphan).
*/
func (class) _shortcut_input(impl func(ptr unsafe.Pointer, event object.InputEvent) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		ctx := gd.NewLifetime(api)
		class.SetTemporary(ctx)
		var event object.InputEvent
...
[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).
*/
func (class) _unhandled_input(impl func(ptr unsafe.Pointer, event object.InputEvent) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		ctx := gd.NewLifetime(api)
		class.SetTemporary(ctx)
		var event object.InputEvent
...
[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).
*/
func (class) _unhandled_key_input(impl func(ptr unsafe.Pointer, event object.InputEvent) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		ctx := gd.NewLifetime(api)
		class.SetTemporary(ctx)
		var event object.InputEvent
...
*/
//go:nosplit
func (self class) AddSibling(sibling object.Node, force_readable_name bool)  {
...
*/
//go:nosplit
func (self class) AddChild(node object.Node, force_readable_name bool, internal_ classdb.NodeInternalMode)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) RemoveChild(node object.Node)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) Reparent(new_parent object.Node, keep_global_transform bool)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetChildren(ctx gd.Lifetime, include_internal bool) gd.ArrayOf[object.Node] {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, include_internal)
	var r_ret = callframe.Ret[uintptr](frame)
...
*/
//go:nosplit
func (self class) GetChild(ctx gd.Lifetime, idx gd.Int, include_internal bool) object.Node {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetNode(ctx gd.Lifetime, path gd.NodePath) object.Node {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(path))
	var r_ret = callframe.Ret[uintptr](frame)
...
*/
//go:nosplit
func (self class) GetNodeOrNull(ctx gd.Lifetime, path gd.NodePath) object.Node {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(path))
	var r_ret = callframe.Ret[uintptr](frame)
...
*/
//go:nosplit
func (self class) GetParent(ctx gd.Lifetime) object.Node {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
*/
//go:nosplit
func (self class) FindChild(ctx gd.Lifetime, pattern gd.String, recursive bool, owned bool) object.Node {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) FindChildren(ctx gd.Lifetime, pattern gd.String, atype gd.String, recursive bool, owned bool) gd.ArrayOf[object.Node] {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(pattern))
...
*/
//go:nosplit
func (self class) FindParent(ctx gd.Lifetime, pattern gd.String) object.Node {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(pattern))
	var r_ret = callframe.Ret[uintptr](frame)
...
*/
//go:nosplit
func (self class) IsAncestorOf(node object.Node) bool {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(node[0].AsPointer())[0])
	var r_ret = callframe.Ret[bool](frame)
...
*/
//go:nosplit
func (self class) IsGreaterThan(node object.Node) bool {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(node[0].AsPointer())[0])
	var r_ret = callframe.Ret[bool](frame)
...
*/
//go:nosplit
func (self class) GetPathTo(ctx gd.Lifetime, node object.Node, use_unique_path bool) gd.NodePath {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(node[0].AsPointer())[0])
...
*/
//go:nosplit
func (self class) MoveChild(child_node object.Node, to_index gd.Int)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
//go:nosplit
func (self class) SetOwner(owner object.Node)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetOwner(ctx gd.Lifetime) object.Node {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
*/
//go:nosplit
func (self class) GetWindow(ctx gd.Lifetime) object.Window {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
*/
//go:nosplit
func (self class) GetLastExclusiveWindow(ctx gd.Lifetime) object.Window {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
*/
//go:nosplit
func (self class) GetTree(ctx gd.Lifetime) object.SceneTree {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
*/
//go:nosplit
func (self class) Duplicate(ctx gd.Lifetime, flags gd.Int) object.Node {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, flags)
	var r_ret = callframe.Ret[uintptr](frame)
...
*/
//go:nosplit
func (self class) ReplaceBy(node object.Node, keep_groups bool)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.End(node[0].AsPointer())[0])
...
*/
//go:nosplit
func (self class) SetEditableInstance(node object.Node, is_editable bool)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(node[0].AsPointer())[0])
...
*/
//go:nosplit
func (self class) IsEditableInstance(node object.Node) bool {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(node[0].AsPointer())[0])
	var r_ret = callframe.Ret[bool](frame)
...
*/
//go:nosplit
func (self class) GetViewport(ctx gd.Lifetime) object.Viewport {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
//go:nosplit
func (self class) GetMultiplayer(ctx gd.Lifetime) object.MultiplayerAPI {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
//go:nosplit
func (self class) AsNode() Expert { return self[0].AsNode() }
...
func init() {classdb.Register("Node", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
