...
*/
type Simple [1]classdb.ShapeCast3D
...
func (self Simple) GetCollisionPoint(index int) gd.Vector3 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector3(Expert(self).GetCollisionPoint(gd.Int(index)))
}
func (self Simple) GetCollisionNormal(index int) gd.Vector3 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector3(Expert(self).GetCollisionNormal(gd.Int(index)))
}
...
//go:nosplit
func (self class) AsShapeCast3D() Expert { return self[0].AsShapeCast3D() }


//go:nosplit
func (self Simple) AsShapeCast3D() Simple { return self[0].AsShapeCast3D() }
...
func init() {classdb.Register("ShapeCast3D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
