...
*/
type Simple [1]classdb.NavigationServer2D
...
func (self Simple) MapGetPath(mapping gd.RID, origin gd.Vector2, destination gd.Vector2, optimize bool, navigation_layers int) gd.PackedVector2Array {
	gc := gd.GarbageCollector(); _ = gc
	return gd.PackedVector2Array(Expert(self).MapGetPath(gc, mapping, origin, destination, optimize, gd.Int(navigation_layers)))
}
func (self Simple) MapGetClosestPoint(mapping gd.RID, to_point gd.Vector2) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).MapGetClosestPoint(mapping, to_point))
}
func (self Simple) MapGetClosestPointOwner(mapping gd.RID, to_point gd.Vector2) gd.RID {
	gc := gd.GarbageCollector(); _ = gc
...
func (self Simple) MapGetRandomPoint(mapping gd.RID, navigation_layers int, uniformly bool) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).MapGetRandomPoint(mapping, gd.Int(navigation_layers), uniformly))
}
func (self Simple) QueryPath(parameters [1]classdb.NavigationPathQueryParameters2D, result [1]classdb.NavigationPathQueryResult2D) {
	gc := gd.GarbageCollector(); _ = gc
...
func (self Simple) RegionOwnsPoint(region gd.RID, point gd.Vector2) bool {
	gc := gd.GarbageCollector(); _ = gc
...
func (self Simple) RegionSetTransform(region gd.RID, transform gd.Transform2D) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).RegionSetTransform(region, transform)
}
func (self Simple) RegionGetTransform(region gd.RID) gd.Transform2D {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Transform2D(Expert(self).RegionGetTransform(region))
}
func (self Simple) RegionSetNavigationPolygon(region gd.RID, navigation_polygon [1]classdb.NavigationPolygon) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).RegionSetNavigationPolygon(region, navigation_polygon)
}
func (self Simple) RegionGetConnectionsCount(region gd.RID) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).RegionGetConnectionsCount(region)))
}
func (self Simple) RegionGetConnectionPathwayStart(region gd.RID, connection int) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).RegionGetConnectionPathwayStart(region, gd.Int(connection)))
}
func (self Simple) RegionGetConnectionPathwayEnd(region gd.RID, connection int) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).RegionGetConnectionPathwayEnd(region, gd.Int(connection)))
}
func (self Simple) RegionGetRandomPoint(region gd.RID, navigation_layers int, uniformly bool) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).RegionGetRandomPoint(region, gd.Int(navigation_layers), uniformly))
}
...
func (self Simple) LinkSetStartPosition(link gd.RID, position gd.Vector2) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).LinkSetStartPosition(link, position)
}
func (self Simple) LinkGetStartPosition(link gd.RID) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).LinkGetStartPosition(link))
}
func (self Simple) LinkSetEndPosition(link gd.RID, position gd.Vector2) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).LinkSetEndPosition(link, position)
}
func (self Simple) LinkGetEndPosition(link gd.RID) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).LinkGetEndPosition(link))
}
...
func (self Simple) AgentSetVelocityForced(agent gd.RID, velocity gd.Vector2) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).AgentSetVelocityForced(agent, velocity)
}
func (self Simple) AgentSetVelocity(agent gd.RID, velocity gd.Vector2) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).AgentSetVelocity(agent, velocity)
}
func (self Simple) AgentGetVelocity(agent gd.RID) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).AgentGetVelocity(agent))
}
func (self Simple) AgentSetPosition(agent gd.RID, position gd.Vector2) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).AgentSetPosition(agent, position)
}
func (self Simple) AgentGetPosition(agent gd.RID) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).AgentGetPosition(agent))
}
...
func (self Simple) ObstacleSetVelocity(obstacle gd.RID, velocity gd.Vector2) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ObstacleSetVelocity(obstacle, velocity)
}
func (self Simple) ObstacleGetVelocity(obstacle gd.RID) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).ObstacleGetVelocity(obstacle))
}
func (self Simple) ObstacleSetPosition(obstacle gd.RID, position gd.Vector2) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ObstacleSetPosition(obstacle, position)
}
func (self Simple) ObstacleGetPosition(obstacle gd.RID) gd.Vector2 {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Vector2(Expert(self).ObstacleGetPosition(obstacle))
}
func (self Simple) ObstacleSetVertices(obstacle gd.RID, vertices gd.PackedVector2Array) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ObstacleSetVertices(obstacle, vertices)
}
func (self Simple) ObstacleGetVertices(obstacle gd.RID) gd.PackedVector2Array {
	gc := gd.GarbageCollector(); _ = gc
	return gd.PackedVector2Array(Expert(self).ObstacleGetVertices(gc, obstacle))
}
...
func (self Simple) ParseSourceGeometryData(navigation_polygon [1]classdb.NavigationPolygon, source_geometry_data [1]classdb.NavigationMeshSourceGeometryData2D, root_node [1]classdb.Node, callback gd.Callable) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ParseSourceGeometryData(navigation_polygon, source_geometry_data, root_node, callback)
}
func (self Simple) BakeFromSourceGeometryData(navigation_polygon [1]classdb.NavigationPolygon, source_geometry_data [1]classdb.NavigationMeshSourceGeometryData2D, callback gd.Callable) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).BakeFromSourceGeometryData(navigation_polygon, source_geometry_data, callback)
}
func (self Simple) BakeFromSourceGeometryDataAsync(navigation_polygon [1]classdb.NavigationPolygon, source_geometry_data [1]classdb.NavigationMeshSourceGeometryData2D, callback gd.Callable) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).BakeFromSourceGeometryDataAsync(navigation_polygon, source_geometry_data, callback)
}
func (self Simple) IsBakingNavigationPolygon(navigation_polygon [1]classdb.NavigationPolygon) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsBakingNavigationPolygon(navigation_polygon))
}
...
func (self Simple) SimplifyPath(path gd.PackedVector2Array, epsilon float64) gd.PackedVector2Array {
	gc := gd.GarbageCollector(); _ = gc
	return gd.PackedVector2Array(Expert(self).SimplifyPath(gc, path, gd.Float(epsilon)))
}
...
*/
//go:nosplit
func (self class) QueryPath(parameters object.NavigationPathQueryParameters2D, result object.NavigationPathQueryResult2D)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) RegionSetNavigationPolygon(region gd.RID, navigation_polygon object.NavigationPolygon)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, region)
...
*/
//go:nosplit
func (self class) ParseSourceGeometryData(navigation_polygon object.NavigationPolygon, source_geometry_data object.NavigationMeshSourceGeometryData2D, root_node object.Node, callback gd.Callable)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(navigation_polygon[0].AsPointer())[0])
...
*/
//go:nosplit
func (self class) BakeFromSourceGeometryData(navigation_polygon object.NavigationPolygon, source_geometry_data object.NavigationMeshSourceGeometryData2D, callback gd.Callable)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(navigation_polygon[0].AsPointer())[0])
	callframe.Arg(frame, mmm.Get(source_geometry_data[0].AsPointer())[0])
...
*/
//go:nosplit
func (self class) BakeFromSourceGeometryDataAsync(navigation_polygon object.NavigationPolygon, source_geometry_data object.NavigationMeshSourceGeometryData2D, callback gd.Callable)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(navigation_polygon[0].AsPointer())[0])
	callframe.Arg(frame, mmm.Get(source_geometry_data[0].AsPointer())[0])
...
*/
//go:nosplit
func (self class) IsBakingNavigationPolygon(navigation_polygon object.NavigationPolygon) bool {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mmm.Get(navigation_polygon[0].AsPointer())[0])
	var r_ret = callframe.Ret[bool](frame)
...
//go:nosplit
func (self class) AsNavigationServer2D() Expert { return self[0].AsNavigationServer2D() }
...
func init() {classdb.Register("NavigationServer2D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
