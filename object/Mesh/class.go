...
Mesh is a type of [Resource] that contains vertex array-based geometry, divided in [i]surfaces[/i]. Each surface contains a completely separate array and a material used to draw it. Design wise, a mesh with multiple surfaces is preferred to a single surface, because objects created in 3D editing software commonly contain multiple materials. The maximum number of surfaces per mesh is [constant RenderingServer.MAX_MESH_SURFACES].
	...
	type Mesh interface {
		...
		SurfaceSetMaterial(index gd.Int, material object.Material) 
		//Virtual method to override the surface material for a custom class extending [Mesh].
		SurfaceGetMaterial(index gd.Int) object.Material
...
func (self Simple) SurfaceGetArrays(surf_idx int) gd.Array {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Array(Expert(self).SurfaceGetArrays(gc, gd.Int(surf_idx)))
}
func (self Simple) SurfaceGetBlendShapeArrays(surf_idx int) gd.ArrayOf[gd.Array] {
	gc := gd.GarbageCollector(); _ = gc
	return gd.ArrayOf[gd.Array](Expert(self).SurfaceGetBlendShapeArrays(gc, gd.Int(surf_idx)))
}
func (self Simple) SurfaceSetMaterial(surf_idx int, material [1]classdb.Material) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SurfaceSetMaterial(gd.Int(surf_idx), material)
}
func (self Simple) SurfaceGetMaterial(surf_idx int) [1]classdb.Material {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Material(Expert(self).SurfaceGetMaterial(gc, gd.Int(surf_idx)))
}
func (self Simple) CreatePlaceholder() [1]classdb.Resource {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Resource(Expert(self).CreatePlaceholder(gc))
}
func (self Simple) CreateTrimeshShape() [1]classdb.ConcavePolygonShape3D {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.ConcavePolygonShape3D(Expert(self).CreateTrimeshShape(gc))
}
func (self Simple) CreateConvexShape(clean bool, simplify bool) [1]classdb.ConvexPolygonShape3D {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.ConvexPolygonShape3D(Expert(self).CreateConvexShape(gc, clean, simplify))
}
func (self Simple) CreateOutline(margin float64) [1]classdb.Mesh {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Mesh(Expert(self).CreateOutline(gc, gd.Float(margin)))
}
...
Virtual method to override the setting of a [param material] at the given [param index] for a custom class extending [Mesh].
*/
func (class) _surface_set_material(impl func(ptr unsafe.Pointer, index gd.Int, material object.Material) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		ctx := gd.NewLifetime(api)
		class.SetTemporary(ctx)
		var index = gd.UnsafeGet[gd.Int](p_args,0)
...
Virtual method to override the surface material for a custom class extending [Mesh].
*/
func (class) _surface_get_material(impl func(ptr unsafe.Pointer, index gd.Int) object.Material, api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class gd.ExtensionClass, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		ctx := gd.NewLifetime(api)
		class.SetTemporary(ctx)
		var index = gd.UnsafeGet[gd.Int](p_args,0)
...
*/
//go:nosplit
func (self class) SurfaceSetMaterial(surf_idx gd.Int, material object.Material)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, surf_idx)
...
*/
//go:nosplit
func (self class) SurfaceGetMaterial(ctx gd.Lifetime, surf_idx gd.Int) object.Material {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, surf_idx)
	var r_ret = callframe.Ret[uintptr](frame)
...
*/
//go:nosplit
func (self class) CreateTrimeshShape(ctx gd.Lifetime) object.ConcavePolygonShape3D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
	...
	var ret object.ConcavePolygonShape3D
	ret[0].SetPointer(gd.PointerWithOwnershipTransferredToGo(ctx,r_ret.Get()))
	frame.Free()
	return ret
}
...
*/
//go:nosplit
func (self class) CreateConvexShape(ctx gd.Lifetime, clean bool, simplify bool) object.ConvexPolygonShape3D {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	...
	var ret object.ConvexPolygonShape3D
	ret[0].SetPointer(gd.PointerWithOwnershipTransferredToGo(ctx,r_ret.Get()))
	frame.Free()
	return ret
}
...
*/
//go:nosplit
func (self class) CreateOutline(ctx gd.Lifetime, margin gd.Float) object.Mesh {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
//go:nosplit
func (self class) AsMesh() Expert { return self[0].AsMesh() }


//go:nosplit
func (self Simple) AsMesh() Simple { return self[0].AsMesh() }
...
func init() {classdb.Register("Mesh", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
