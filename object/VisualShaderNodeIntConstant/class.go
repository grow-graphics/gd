...
*/
type Simple [1]classdb.VisualShaderNodeIntConstant
...
func (self class) SetConstant(constant gd.Int)  {
	...
	mmm.API(selfPtr).Object.MethodBindPointerCall(mmm.API(selfPtr).Methods.VisualShaderNodeIntConstant.Bind_set_constant, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	frame.Free()
}
//go:nosplit
func (self class) GetConstant() gd.Int {
	...
	mmm.API(selfPtr).Object.MethodBindPointerCall(mmm.API(selfPtr).Methods.VisualShaderNodeIntConstant.Bind_get_constant, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
//go:nosplit
func (self class) AsVisualShaderNodeIntConstant() Expert { return self[0].AsVisualShaderNodeIntConstant() }


//go:nosplit
func (self Simple) AsVisualShaderNodeIntConstant() Simple { return self[0].AsVisualShaderNodeIntConstant() }
...
func init() {classdb.Register("VisualShaderNodeIntConstant", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
