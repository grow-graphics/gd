...
*/
type Simple [1]classdb.SeparationRayShape2D
...
//go:nosplit
func (self class) AsSeparationRayShape2D() Expert { return self[0].AsSeparationRayShape2D() }


//go:nosplit
func (self Simple) AsSeparationRayShape2D() Simple { return self[0].AsSeparationRayShape2D() }
...
func init() {classdb.Register("SeparationRayShape2D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
