...
*/
type Simple [1]classdb.CompressedTextureLayered
...
//go:nosplit
func (self class) AsCompressedTextureLayered() Expert { return self[0].AsCompressedTextureLayered() }


//go:nosplit
func (self Simple) AsCompressedTextureLayered() Simple { return self[0].AsCompressedTextureLayered() }
...
func init() {classdb.Register("CompressedTextureLayered", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
