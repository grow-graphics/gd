...
*/
type Simple [1]classdb.VisualShaderNodeFloatConstant
func (self Simple) SetConstant(constant float64) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetConstant(gd.Float(constant))
}
func (self Simple) GetConstant() float64 {
	gc := gd.GarbageCollector(); _ = gc
	return float64(float64(Expert(self).GetConstant()))
}
...
//go:nosplit
func (self class) AsVisualShaderNodeFloatConstant() Expert { return self[0].AsVisualShaderNodeFloatConstant() }


//go:nosplit
func (self Simple) AsVisualShaderNodeFloatConstant() Simple { return self[0].AsVisualShaderNodeFloatConstant() }
...
func init() {classdb.Register("VisualShaderNodeFloatConstant", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
