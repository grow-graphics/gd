...
*/
type Simple [1]classdb.NavigationPathQueryParameters2D
...
func (self Simple) SetStartPosition(start_position gd.Vector2) {
	gc := gd.GarbageCollector(); _ = gc
...
func (self Simple) SetTargetPosition(target_position gd.Vector2) {
	gc := gd.GarbageCollector(); _ = gc
...
func (self Simple) SetMetadataFlags(flags classdb.NavigationPathQueryParameters2DPathMetadataFlags) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetMetadataFlags(flags)
}
func (self Simple) GetMetadataFlags() classdb.NavigationPathQueryParameters2DPathMetadataFlags {
	gc := gd.GarbageCollector(); _ = gc
	return classdb.NavigationPathQueryParameters2DPathMetadataFlags(Expert(self).GetMetadataFlags())
}
...
//go:nosplit
func (self class) AsNavigationPathQueryParameters2D() Expert { return self[0].AsNavigationPathQueryParameters2D() }


//go:nosplit
func (self Simple) AsNavigationPathQueryParameters2D() Simple { return self[0].AsNavigationPathQueryParameters2D() }
...
func init() {classdb.Register("NavigationPathQueryParameters2D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
