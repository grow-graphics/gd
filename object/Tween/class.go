...
*/
type Simple [1]classdb.Tween
func (self Simple) TweenProperty(obj gd.Object, property gd.NodePath, final_val gd.Variant, duration float64) [1]classdb.PropertyTweener {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.PropertyTweener(Expert(self).TweenProperty(gc, obj, property, final_val, gd.Float(duration)))
}
func (self Simple) TweenInterval(time float64) [1]classdb.IntervalTweener {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.IntervalTweener(Expert(self).TweenInterval(gc, gd.Float(time)))
}
func (self Simple) TweenCallback(callback gd.Callable) [1]classdb.CallbackTweener {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.CallbackTweener(Expert(self).TweenCallback(gc, callback))
}
func (self Simple) TweenMethod(method gd.Callable, from gd.Variant, to gd.Variant, duration float64) [1]classdb.MethodTweener {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.MethodTweener(Expert(self).TweenMethod(gc, method, from, to, gd.Float(duration)))
}
func (self Simple) CustomStep(delta float64) bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).CustomStep(gd.Float(delta)))
}
...
func (self Simple) Kill() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).Kill()
}
func (self Simple) GetTotalElapsedTime() float64 {
	gc := gd.GarbageCollector(); _ = gc
	return float64(float64(Expert(self).GetTotalElapsedTime()))
}
...
func (self Simple) BindNode(node [1]classdb.Node) [1]classdb.Tween {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Tween(Expert(self).BindNode(gc, node))
}
func (self Simple) SetProcessMode(mode classdb.TweenTweenProcessMode) [1]classdb.Tween {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Tween(Expert(self).SetProcessMode(gc, mode))
}
func (self Simple) SetPauseMode(mode classdb.TweenTweenPauseMode) [1]classdb.Tween {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Tween(Expert(self).SetPauseMode(gc, mode))
}
func (self Simple) SetParallel(parallel bool) [1]classdb.Tween {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Tween(Expert(self).SetParallel(gc, parallel))
}
func (self Simple) SetLoops(loops int) [1]classdb.Tween {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Tween(Expert(self).SetLoops(gc, gd.Int(loops)))
}
func (self Simple) GetLoopsLeft() int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetLoopsLeft()))
}
func (self Simple) SetSpeedScale(speed float64) [1]classdb.Tween {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Tween(Expert(self).SetSpeedScale(gc, gd.Float(speed)))
}
func (self Simple) SetTrans(trans classdb.TweenTransitionType) [1]classdb.Tween {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Tween(Expert(self).SetTrans(gc, trans))
}
func (self Simple) SetEase(ease classdb.TweenEaseType) [1]classdb.Tween {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Tween(Expert(self).SetEase(gc, ease))
}
func (self Simple) Parallel() [1]classdb.Tween {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Tween(Expert(self).Parallel(gc))
}
func (self Simple) Chain() [1]classdb.Tween {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.Tween(Expert(self).Chain(gc))
}
func (self Simple) InterpolateValue(initial_value gd.Variant, delta_value gd.Variant, elapsed_time float64, duration float64, trans_type classdb.TweenTransitionType, ease_type classdb.TweenEaseType) gd.Variant {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Variant(Expert(self).InterpolateValue(gc, initial_value, delta_value, gd.Float(elapsed_time), gd.Float(duration), trans_type, ease_type))
}
...
*/
//go:nosplit
func (self class) TweenProperty(ctx gd.Lifetime, obj gd.Object, property gd.NodePath, final_val gd.Variant, duration gd.Float) object.PropertyTweener {
...
*/
//go:nosplit
func (self class) TweenInterval(ctx gd.Lifetime, time gd.Float) object.IntervalTweener {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	...
	var ret object.IntervalTweener
	ret[0].SetPointer(gd.PointerWithOwnershipTransferredToGo(ctx,r_ret.Get()))
	frame.Free()
	return ret
}
...
*/
//go:nosplit
func (self class) TweenCallback(ctx gd.Lifetime, callback gd.Callable) object.CallbackTweener {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) TweenMethod(ctx gd.Lifetime, method gd.Callable, from gd.Variant, to gd.Variant, duration gd.Float) object.MethodTweener {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) BindNode(ctx gd.Lifetime, node object.Node) object.Tween {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetProcessMode(ctx gd.Lifetime, mode classdb.TweenTweenProcessMode) object.Tween {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetPauseMode(ctx gd.Lifetime, mode classdb.TweenTweenPauseMode) object.Tween {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, mode)
	var r_ret = callframe.Ret[uintptr](frame)
...
*/
//go:nosplit
func (self class) SetParallel(ctx gd.Lifetime, parallel bool) object.Tween {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetLoops(ctx gd.Lifetime, loops gd.Int) object.Tween {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetSpeedScale(ctx gd.Lifetime, speed gd.Float) object.Tween {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetTrans(ctx gd.Lifetime, trans classdb.TweenTransitionType) object.Tween {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetEase(ctx gd.Lifetime, ease classdb.TweenEaseType) object.Tween {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) Parallel(ctx gd.Lifetime) object.Tween {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
*/
//go:nosplit
func (self class) Chain(ctx gd.Lifetime) object.Tween {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
//go:nosplit
func (self class) AsTween() Expert { return self[0].AsTween() }


//go:nosplit
func (self Simple) AsTween() Simple { return self[0].AsTween() }
...
func init() {classdb.Register("Tween", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
