...
*/
type Simple [1]classdb.RectangleShape2D
...
//go:nosplit
func (self class) AsRectangleShape2D() Expert { return self[0].AsRectangleShape2D() }


//go:nosplit
func (self Simple) AsRectangleShape2D() Simple { return self[0].AsRectangleShape2D() }
...
func init() {classdb.Register("RectangleShape2D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
