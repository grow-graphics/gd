...
*/
type Simple [1]classdb.GPUParticlesCollision3D
...
//go:nosplit
func (self class) AsGPUParticlesCollision3D() Expert { return self[0].AsGPUParticlesCollision3D() }


//go:nosplit
func (self Simple) AsGPUParticlesCollision3D() Simple { return self[0].AsGPUParticlesCollision3D() }
...
func init() {classdb.Register("GPUParticlesCollision3D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
