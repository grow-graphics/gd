...
*/
type Simple [1]classdb.AudioEffectBandPassFilter
...
//go:nosplit
func (self class) AsAudioEffectBandPassFilter() Expert { return self[0].AsAudioEffectBandPassFilter() }


//go:nosplit
func (self Simple) AsAudioEffectBandPassFilter() Simple { return self[0].AsAudioEffectBandPassFilter() }
...
func init() {classdb.Register("AudioEffectBandPassFilter", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
