...
*/
type Simple [1]classdb.AudioEffectHighPassFilter
...
//go:nosplit
func (self class) AsAudioEffectHighPassFilter() Expert { return self[0].AsAudioEffectHighPassFilter() }


//go:nosplit
func (self Simple) AsAudioEffectHighPassFilter() Simple { return self[0].AsAudioEffectHighPassFilter() }
...
func init() {classdb.Register("AudioEffectHighPassFilter", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
