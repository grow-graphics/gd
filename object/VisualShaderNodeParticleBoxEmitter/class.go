...
*/
type Simple [1]classdb.VisualShaderNodeParticleBoxEmitter
...
//go:nosplit
func (self class) AsVisualShaderNodeParticleBoxEmitter() Expert { return self[0].AsVisualShaderNodeParticleBoxEmitter() }


//go:nosplit
func (self Simple) AsVisualShaderNodeParticleBoxEmitter() Simple { return self[0].AsVisualShaderNodeParticleBoxEmitter() }
...
func init() {classdb.Register("VisualShaderNodeParticleBoxEmitter", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
