...
*/
type Simple [1]classdb.NavigationPathQueryResult3D
func (self Simple) SetPath(path gd.PackedVector3Array) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetPath(path)
}
func (self Simple) GetPath() gd.PackedVector3Array {
	gc := gd.GarbageCollector(); _ = gc
	return gd.PackedVector3Array(Expert(self).GetPath(gc))
}
...
//go:nosplit
func (self class) AsNavigationPathQueryResult3D() Expert { return self[0].AsNavigationPathQueryResult3D() }


//go:nosplit
func (self Simple) AsNavigationPathQueryResult3D() Simple { return self[0].AsNavigationPathQueryResult3D() }
...
func init() {classdb.Register("NavigationPathQueryResult3D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
