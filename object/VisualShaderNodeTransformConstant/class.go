...
*/
type Simple [1]classdb.VisualShaderNodeTransformConstant
func (self Simple) SetConstant(constant gd.Transform3D) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetConstant(constant)
}
func (self Simple) GetConstant() gd.Transform3D {
	gc := gd.GarbageCollector(); _ = gc
	return gd.Transform3D(Expert(self).GetConstant())
}
...
//go:nosplit
func (self class) AsVisualShaderNodeTransformConstant() Expert { return self[0].AsVisualShaderNodeTransformConstant() }


//go:nosplit
func (self Simple) AsVisualShaderNodeTransformConstant() Simple { return self[0].AsVisualShaderNodeTransformConstant() }
...
func init() {classdb.Register("VisualShaderNodeTransformConstant", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
