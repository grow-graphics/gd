...
*/
type Simple [1]classdb.CompressedTexture2DArray
...
//go:nosplit
func (self class) AsCompressedTexture2DArray() Expert { return self[0].AsCompressedTexture2DArray() }


//go:nosplit
func (self Simple) AsCompressedTexture2DArray() Simple { return self[0].AsCompressedTexture2DArray() }
...
func init() {classdb.Register("CompressedTexture2DArray", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
