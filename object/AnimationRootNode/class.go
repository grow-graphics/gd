...
*/
type Simple [1]classdb.AnimationRootNode
...
//go:nosplit
func (self class) AsAnimationRootNode() Expert { return self[0].AsAnimationRootNode() }


//go:nosplit
func (self Simple) AsAnimationRootNode() Simple { return self[0].AsAnimationRootNode() }
...
func init() {classdb.Register("AnimationRootNode", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
