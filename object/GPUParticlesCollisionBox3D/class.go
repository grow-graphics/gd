...
*/
type Simple [1]classdb.GPUParticlesCollisionBox3D
...
//go:nosplit
func (self class) AsGPUParticlesCollisionBox3D() Expert { return self[0].AsGPUParticlesCollisionBox3D() }


//go:nosplit
func (self Simple) AsGPUParticlesCollisionBox3D() Simple { return self[0].AsGPUParticlesCollisionBox3D() }
...
func init() {classdb.Register("GPUParticlesCollisionBox3D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
