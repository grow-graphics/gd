...
*/
type Simple [1]classdb.UPNP
func (self Simple) GetDeviceCount() int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetDeviceCount()))
}
func (self Simple) GetDevice(index int) [1]classdb.UPNPDevice {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.UPNPDevice(Expert(self).GetDevice(gc, gd.Int(index)))
}
func (self Simple) AddDevice(device [1]classdb.UPNPDevice) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).AddDevice(device)
}
func (self Simple) SetDevice(index int, device [1]classdb.UPNPDevice) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetDevice(gd.Int(index), device)
}
func (self Simple) RemoveDevice(index int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).RemoveDevice(gd.Int(index))
}
func (self Simple) ClearDevices() {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).ClearDevices()
}
func (self Simple) GetGateway() [1]classdb.UPNPDevice {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.UPNPDevice(Expert(self).GetGateway(gc))
}
func (self Simple) Discover(timeout int, ttl int, device_filter string) int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).Discover(gd.Int(timeout), gd.Int(ttl), gc.String(device_filter))))
}
...
func (self Simple) SetDiscoverMulticastIf(m_if string) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetDiscoverMulticastIf(gc.String(m_if))
}
func (self Simple) GetDiscoverMulticastIf() string {
	gc := gd.GarbageCollector(); _ = gc
	return string(Expert(self).GetDiscoverMulticastIf(gc).String())
}
func (self Simple) SetDiscoverLocalPort(port int) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetDiscoverLocalPort(gd.Int(port))
}
func (self Simple) GetDiscoverLocalPort() int {
	gc := gd.GarbageCollector(); _ = gc
	return int(int(Expert(self).GetDiscoverLocalPort()))
}
func (self Simple) SetDiscoverIpv6(ipv6 bool) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetDiscoverIpv6(ipv6)
}
func (self Simple) IsDiscoverIpv6() bool {
	gc := gd.GarbageCollector(); _ = gc
	return bool(Expert(self).IsDiscoverIpv6())
}
...
*/
//go:nosplit
func (self class) GetDevice(ctx gd.Lifetime, index gd.Int) object.UPNPDevice {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) AddDevice(device object.UPNPDevice)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetDevice(index gd.Int, device object.UPNPDevice)  {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	callframe.Arg(frame, index)
	callframe.Arg(frame, mmm.Get(device[0].AsPointer())[0])
...
*/
//go:nosplit
func (self class) GetGateway(ctx gd.Lifetime) object.UPNPDevice {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	var r_ret = callframe.Ret[uintptr](frame)
...
//go:nosplit
func (self class) AsUPNP() Expert { return self[0].AsUPNP() }


//go:nosplit
func (self Simple) AsUPNP() Simple { return self[0].AsUPNP() }
...
func init() {classdb.Register("UPNP", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
