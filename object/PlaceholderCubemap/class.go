...
*/
type Simple [1]classdb.PlaceholderCubemap
...
//go:nosplit
func (self class) AsPlaceholderCubemap() Expert { return self[0].AsPlaceholderCubemap() }


//go:nosplit
func (self Simple) AsPlaceholderCubemap() Simple { return self[0].AsPlaceholderCubemap() }
...
func init() {classdb.Register("PlaceholderCubemap", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
