...
*/
type Simple [1]classdb.EditorTranslationParserPlugin
func (Simple) _parse_file(impl func(ptr unsafe.Pointer, path string, msgids gd.ArrayOf[gd.String], msgids_context_plural gd.ArrayOf[gd.Array]) , api *gd.API) (cb gd.ExtensionClassCallVirtualFunc) {
...
//go:nosplit
func (self class) AsEditorTranslationParserPlugin() Expert { return self[0].AsEditorTranslationParserPlugin() }


//go:nosplit
func (self Simple) AsEditorTranslationParserPlugin() Simple { return self[0].AsEditorTranslationParserPlugin() }
...
func init() {classdb.Register("EditorTranslationParserPlugin", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
