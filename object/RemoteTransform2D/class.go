...
*/
type Simple [1]classdb.RemoteTransform2D
...
//go:nosplit
func (self class) AsRemoteTransform2D() Expert { return self[0].AsRemoteTransform2D() }


//go:nosplit
func (self Simple) AsRemoteTransform2D() Simple { return self[0].AsRemoteTransform2D() }
...
func init() {classdb.Register("RemoteTransform2D", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
