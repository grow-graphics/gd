...
*/
type Simple [1]classdb.VisualShaderNodeCurveXYZTexture
func (self Simple) SetTexture(texture [1]classdb.CurveXYZTexture) {
	gc := gd.GarbageCollector(); _ = gc
	Expert(self).SetTexture(texture)
}
func (self Simple) GetTexture() [1]classdb.CurveXYZTexture {
	gc := gd.GarbageCollector(); _ = gc
	return [1]classdb.CurveXYZTexture(Expert(self).GetTexture(gc))
}
...
//go:nosplit
func (self class) SetTexture(texture object.CurveXYZTexture)  {
...
//go:nosplit
func (self class) GetTexture(ctx gd.Lifetime) object.CurveXYZTexture {
	var selfPtr = self[0].AsPointer()
	var frame = callframe.New()
	...
	var ret object.CurveXYZTexture
...
//go:nosplit
func (self class) AsVisualShaderNodeCurveXYZTexture() Expert { return self[0].AsVisualShaderNodeCurveXYZTexture() }


//go:nosplit
func (self Simple) AsVisualShaderNodeCurveXYZTexture() Simple { return self[0].AsVisualShaderNodeCurveXYZTexture() }
...
func init() {classdb.Register("VisualShaderNodeCurveXYZTexture", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
