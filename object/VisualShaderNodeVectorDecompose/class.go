...
*/
type Simple [1]classdb.VisualShaderNodeVectorDecompose
...
//go:nosplit
func (self class) AsVisualShaderNodeVectorDecompose() Expert { return self[0].AsVisualShaderNodeVectorDecompose() }


//go:nosplit
func (self Simple) AsVisualShaderNodeVectorDecompose() Simple { return self[0].AsVisualShaderNodeVectorDecompose() }
...
func init() {classdb.Register("VisualShaderNodeVectorDecompose", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
