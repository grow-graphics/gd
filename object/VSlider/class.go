...
//go:nosplit
func (self class) AsVSlider() Expert { return self[0].AsVSlider() }


//go:nosplit
func (self Simple) AsVSlider() Simple { return self[0].AsVSlider() }
...
func init() {classdb.Register("VSlider", func(ptr gd.Pointer) any {var class Expert; class[0].SetPointer(ptr); return class })}
