...
*/
type Instance [1]classdb.TileSetAtlasSource
type Any interface {
	gd.IsClass
...
*/
func (self Instance) GetRuntimeTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetRuntimeTexture())
}
...
*/
//go:nosplit
func (self class) GetTilesToBeRemovedOnChange(texture objects.Texture2D, margins gd.Vector2i, separation gd.Vector2i, texture_region_size gd.Vector2i) gd.PackedVector2Array {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(texture[0])[0])
	callframe.Arg(frame, margins)
	callframe.Arg(frame, separation)
...
*/
//go:nosplit
func (self class) GetTileData(atlas_coords gd.Vector2i, alternative_tile gd.Int) objects.TileData {
	var frame = callframe.New()
	callframe.Arg(frame, atlas_coords)
	callframe.Arg(frame, alternative_tile)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetRuntimeTexture() objects.Texture2D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
