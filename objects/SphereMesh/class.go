...
func New() Instance {
	...
	return Instance{*(*classdb.SphereMesh)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("SphereMesh", func(ptr gd.Object) any { return [1]classdb.SphereMesh{*(*classdb.SphereMesh)(unsafe.Pointer(&ptr))} })
}
