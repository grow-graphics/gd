...
*/
type Instance [1]classdb.SkeletonProfile
type Any interface {
	gd.IsClass
...
*/
func (self Instance) GetTexture(group_idx int) objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(gd.Int(group_idx)))
}

/*
Sets the texture of the group at [param group_idx] that will be the drawing group background image in the [BoneMap] editor.
*/
func (self Instance) SetTexture(group_idx int, texture objects.Texture2D) {
...
*/
func (self Instance) GetTailDirection(bone_idx int) classdb.SkeletonProfileTailDirection {
...
*/
func (self Instance) SetTailDirection(bone_idx int, tail_direction classdb.SkeletonProfileTailDirection) {
...
*/
//go:nosplit
func (self class) GetTexture(group_idx gd.Int) objects.Texture2D {
	var frame = callframe.New()
	callframe.Arg(frame, group_idx)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) SetTexture(group_idx gd.Int, texture objects.Texture2D) {
	var frame = callframe.New()
	callframe.Arg(frame, group_idx)
