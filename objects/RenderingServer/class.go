...
*/
var self objects.RenderingServer
var once sync.Once

func singleton() {
	obj := gd.Global.Object.GetSingleton(gd.Global.Singletons.RenderingServer)
	self = *(*objects.RenderingServer)(unsafe.Pointer(&obj))
}
...
*/
func GetRenderingDevice() objects.RenderingDevice {
	once.Do(singleton)
	return objects.RenderingDevice(class(self).GetRenderingDevice())
}
...
[b]Note:[/b] When using the OpenGL backend or when running in headless mode, this function always returns [code]null[/code].
*/
func CreateLocalRenderingDevice() objects.RenderingDevice {
	once.Do(singleton)
	return objects.RenderingDevice(class(self).CreateLocalRenderingDevice())
}
...
*/
//go:nosplit
func (self class) Texture2dCreate(image objects.Image) gd.RID {
...
*/
//go:nosplit
func (self class) Texture2dUpdate(texture gd.RID, image objects.Image, layer gd.Int) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) Texture2dGet(texture gd.RID) objects.Image {
	var frame = callframe.New()
	callframe.Arg(frame, texture)
...
*/
//go:nosplit
func (self class) Texture2dLayerGet(texture gd.RID, layer gd.Int) objects.Image {
	var frame = callframe.New()
	callframe.Arg(frame, texture)
	callframe.Arg(frame, layer)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) SkyBakePanorama(sky gd.RID, energy gd.Float, bake_irradiance bool, size gd.Vector2i) objects.Image {
	var frame = callframe.New()
	callframe.Arg(frame, sky)
	callframe.Arg(frame, energy)
...
*/
//go:nosplit
func (self class) EnvironmentBakePanorama(environment gd.RID, bake_irradiance bool, size gd.Vector2i) objects.Image {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetBootImage(image objects.Image, color gd.Color, scale bool, use_filter bool) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(image[0])[0])
	callframe.Arg(frame, color)
	callframe.Arg(frame, scale)
...
*/
//go:nosplit
func (self class) GetRenderingDevice() objects.RenderingDevice {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) CreateLocalRenderingDevice() objects.RenderingDevice {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
