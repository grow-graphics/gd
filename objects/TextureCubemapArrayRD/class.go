...
func New() Instance {
	...
	return Instance{*(*classdb.TextureCubemapArrayRD)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("TextureCubemapArrayRD", func(ptr gd.Object) any {
		return [1]classdb.TextureCubemapArrayRD{*(*classdb.TextureCubemapArrayRD)(unsafe.Pointer(&ptr))}
	})
}
