...
func New() Instance {
	...
	return Instance{*(*classdb.RemoteTransform2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("RemoteTransform2D", func(ptr gd.Object) any {
		return [1]classdb.RemoteTransform2D{*(*classdb.RemoteTransform2D)(unsafe.Pointer(&ptr))}
	})
}
