...
*/
func (self Instance) SetOccluder(layer_id int, occluder_polygon objects.OccluderPolygon2D) {
...
*/
func (self Instance) GetOccluder(layer_id int) objects.OccluderPolygon2D {
	return objects.OccluderPolygon2D(class(self).GetOccluder(gd.Int(layer_id), false, false, false))
}
...
*/
func (self Instance) SetNavigationPolygon(layer_id int, navigation_polygon objects.NavigationPolygon) {
...
[param flip_h], [param flip_v], and [param transpose] allow transforming the returned polygon.
*/
func (self Instance) GetNavigationPolygon(layer_id int) objects.NavigationPolygon {
	return objects.NavigationPolygon(class(self).GetNavigationPolygon(gd.Int(layer_id), false, false, false))
}
...
*/
//go:nosplit
func (self class) SetOccluder(layer_id gd.Int, occluder_polygon objects.OccluderPolygon2D) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetOccluder(layer_id gd.Int, flip_h bool, flip_v bool, transpose bool) objects.OccluderPolygon2D {
	var frame = callframe.New()
	callframe.Arg(frame, layer_id)
	callframe.Arg(frame, flip_h)
	callframe.Arg(frame, flip_v)
...
*/
//go:nosplit
func (self class) SetNavigationPolygon(layer_id gd.Int, navigation_polygon objects.NavigationPolygon) {
	var frame = callframe.New()
	callframe.Arg(frame, layer_id)
...
*/
//go:nosplit
func (self class) GetNavigationPolygon(layer_id gd.Int, flip_h bool, flip_v bool, transpose bool) objects.NavigationPolygon {
	var frame = callframe.New()
	callframe.Arg(frame, layer_id)
	callframe.Arg(frame, flip_h)
	callframe.Arg(frame, flip_v)
