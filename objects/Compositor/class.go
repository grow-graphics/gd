...
func New() Instance {
	...
	return Instance{*(*classdb.Compositor)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("Compositor", func(ptr gd.Object) any { return [1]classdb.Compositor{*(*classdb.Compositor)(unsafe.Pointer(&ptr))} })
}
