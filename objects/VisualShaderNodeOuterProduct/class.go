...
*/
type Instance [1]classdb.VisualShaderNodeOuterProduct
...
func init() {
	classdb.Register("VisualShaderNodeOuterProduct", func(ptr gd.Object) any { return classdb.VisualShaderNodeOuterProduct(ptr) })
}
