...
func New() Instance {
	...
	return Instance{*(*classdb.EditorResourcePreviewGenerator)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("EditorResourcePreviewGenerator", func(ptr gd.Object) any {
		return [1]classdb.EditorResourcePreviewGenerator{*(*classdb.EditorResourcePreviewGenerator)(unsafe.Pointer(&ptr))}
	})
}
