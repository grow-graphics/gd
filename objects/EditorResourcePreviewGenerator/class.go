...
Custom code to generate previews. Please check [code]file_dialog/thumbnail_size[/code] in [EditorSettings] to find out the right size to do previews at.
	...
	type EditorResourcePreviewGenerator interface {
		...
		Generate(resource objects.Resource, size gd.Vector2i, metadata gd.Dictionary) objects.Texture2D
		...
		//Care must be taken because this function is always called from a thread (not the main thread).
		//[param metadata] dictionary can be modified to store file-specific metadata that can be used in [method EditorResourceTooltipPlugin._make_tooltip_for_path] (like image size, sample length etc.).
		GenerateFromPath(path string, size gd.Vector2i, metadata gd.Dictionary) objects.Texture2D
...
[param metadata] dictionary can be modified to store file-specific metadata that can be used in [method EditorResourceTooltipPlugin._make_tooltip_for_path] (like image size, sample length etc.).
*/
func (Instance) _generate(impl func(ptr unsafe.Pointer, resource objects.Resource, size gd.Vector2i, metadata gd.Dictionary) objects.Texture2D) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
...
[param metadata] dictionary can be modified to store file-specific metadata that can be used in [method EditorResourceTooltipPlugin._make_tooltip_for_path] (like image size, sample length etc.).
*/
func (Instance) _generate_from_path(impl func(ptr unsafe.Pointer, path string, size gd.Vector2i, metadata gd.Dictionary) objects.Texture2D) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
