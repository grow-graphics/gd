...
*/
func (self Instance) SetSlotCustomIconLeft(slot_index int, custom_icon objects.Texture2D) {
...
*/
func (self Instance) GetSlotCustomIconLeft(slot_index int) objects.Texture2D {
	return objects.Texture2D(class(self).GetSlotCustomIconLeft(gd.Int(slot_index)))
}
...
*/
func (self Instance) SetSlotCustomIconRight(slot_index int, custom_icon objects.Texture2D) {
...
*/
func (self Instance) GetSlotCustomIconRight(slot_index int) objects.Texture2D {
	return objects.Texture2D(class(self).GetSlotCustomIconRight(gd.Int(slot_index)))
}
...
*/
//go:nosplit
func (self class) SetSlot(slot_index gd.Int, enable_left_port bool, type_left gd.Int, color_left gd.Color, enable_right_port bool, type_right gd.Int, color_right gd.Color, custom_icon_left objects.Texture2D, custom_icon_right objects.Texture2D, draw_stylebox bool) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetSlotCustomIconLeft(slot_index gd.Int, custom_icon objects.Texture2D) {
	var frame = callframe.New()
	callframe.Arg(frame, slot_index)
...
*/
//go:nosplit
func (self class) GetSlotCustomIconLeft(slot_index gd.Int) objects.Texture2D {
	var frame = callframe.New()
	callframe.Arg(frame, slot_index)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) SetSlotCustomIconRight(slot_index gd.Int, custom_icon objects.Texture2D) {
	var frame = callframe.New()
	callframe.Arg(frame, slot_index)
	callframe.Arg(frame, pointers.Get(custom_icon[0])[0])
	var r_ret callframe.Nil
...
*/
//go:nosplit
func (self class) GetSlotCustomIconRight(slot_index gd.Int) objects.Texture2D {
	var frame = callframe.New()
	callframe.Arg(frame, slot_index)
	var r_ret = callframe.Ret[[1]uintptr](frame)
