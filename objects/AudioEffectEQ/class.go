...
func New() Instance {
	...
	return Instance{classdb.AudioEffectEQ(object)}
}
...
func init() {
	classdb.Register("AudioEffectEQ", func(ptr gd.Object) any { return [1]classdb.AudioEffectEQ{classdb.AudioEffectEQ(ptr)} })
}
