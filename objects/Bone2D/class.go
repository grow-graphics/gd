...
func New() Instance {
	...
	return Instance{*(*classdb.Bone2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("Bone2D", func(ptr gd.Object) any { return [1]classdb.Bone2D{*(*classdb.Bone2D)(unsafe.Pointer(&ptr))} })
}
