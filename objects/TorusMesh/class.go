...
func New() Instance {
	...
	return Instance{*(*classdb.TorusMesh)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("TorusMesh", func(ptr gd.Object) any { return [1]classdb.TorusMesh{*(*classdb.TorusMesh)(unsafe.Pointer(&ptr))} })
}
