...
func New() Instance {
	...
	return Instance{classdb.AudioEffectLowShelfFilter(object)}
}
...
func init() {
	classdb.Register("AudioEffectLowShelfFilter", func(ptr gd.Object) any { return classdb.AudioEffectLowShelfFilter(ptr) })
}
