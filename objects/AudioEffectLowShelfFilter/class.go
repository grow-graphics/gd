...
*/
type Instance [1]classdb.AudioEffectLowShelfFilter
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.AudioEffectLowShelfFilter)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("AudioEffectLowShelfFilter", func(ptr gd.Object) any {
		return [1]classdb.AudioEffectLowShelfFilter{*(*classdb.AudioEffectLowShelfFilter)(unsafe.Pointer(&ptr))}
	})
}
