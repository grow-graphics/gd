...
*/
type Instance [1]classdb.SyntaxHighlighter
...
*/
func (self Instance) GetTextEdit() objects.TextEdit {
	return objects.TextEdit(class(self).GetTextEdit())
}
...
*/
//go:nosplit
func (self class) GetTextEdit() objects.TextEdit {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
