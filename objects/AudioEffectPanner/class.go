...
func New() Instance {
	...
	return Instance{*(*classdb.AudioEffectPanner)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("AudioEffectPanner", func(ptr gd.Object) any {
		return [1]classdb.AudioEffectPanner{*(*classdb.AudioEffectPanner)(unsafe.Pointer(&ptr))}
	})
}
