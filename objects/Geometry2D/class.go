...
*/
var self objects.Geometry2D
var once sync.Once

func singleton() {
	obj := gd.Global.Object.GetSingleton(gd.Global.Singletons.Geometry2D)
	self = *(*objects.Geometry2D)(unsafe.Pointer(&obj))
}
...
func init() {
	classdb.Register("Geometry2D", func(ptr gd.Object) any { return [1]classdb.Geometry2D{*(*classdb.Geometry2D)(unsafe.Pointer(&ptr))} })
}
