...
*/
func (self Instance) TakeConnection() objects.StreamPeerTCP {
	return objects.StreamPeerTCP(class(self).TakeConnection())
}
...
*/
//go:nosplit
func (self class) TakeConnection() objects.StreamPeerTCP {
	var frame = callframe.New()
