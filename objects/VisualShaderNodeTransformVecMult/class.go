...
func New() Instance {
	...
	return Instance{classdb.VisualShaderNodeTransformVecMult(object)}
}
...
func init() {
	classdb.Register("VisualShaderNodeTransformVecMult", func(ptr gd.Object) any { return classdb.VisualShaderNodeTransformVecMult(ptr) })
}
