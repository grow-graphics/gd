...
func New() Instance {
	...
	return Instance{*(*classdb.FogMaterial)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("FogMaterial", func(ptr gd.Object) any { return [1]classdb.FogMaterial{*(*classdb.FogMaterial)(unsafe.Pointer(&ptr))} })
}
