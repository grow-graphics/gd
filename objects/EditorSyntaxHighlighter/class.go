...
func New() Instance {
	...
	return Instance{*(*classdb.EditorSyntaxHighlighter)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("EditorSyntaxHighlighter", func(ptr gd.Object) any {
		return [1]classdb.EditorSyntaxHighlighter{*(*classdb.EditorSyntaxHighlighter)(unsafe.Pointer(&ptr))}
	})
}
