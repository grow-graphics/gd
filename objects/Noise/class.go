...
*/
func (self Instance) GetImage(width int, height int) objects.Image {
	return objects.Image(class(self).GetImage(gd.Int(width), gd.Int(height), false, false, true))
}
...
[b]Note:[/b] With [param normalize] set to [code]false[/code], the default implementation expects the noise generator to return values in the range [code]-1.0[/code] to [code]1.0[/code].
*/
func (self Instance) GetSeamlessImage(width int, height int) objects.Image {
	return objects.Image(class(self).GetSeamlessImage(gd.Int(width), gd.Int(height), false, false, gd.Float(0.1), true))
}
...
*/
//go:nosplit
func (self class) GetImage(width gd.Int, height gd.Int, invert bool, in_3d_space bool, normalize bool) objects.Image {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetSeamlessImage(width gd.Int, height gd.Int, invert bool, in_3d_space bool, skirt gd.Float, normalize bool) objects.Image {
	var frame = callframe.New()
	callframe.Arg(frame, width)
	callframe.Arg(frame, height)
	callframe.Arg(frame, invert)
