...
func New() Instance {
	...
	return Instance{*(*classdb.Shape3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("Shape3D", func(ptr gd.Object) any { return [1]classdb.Shape3D{*(*classdb.Shape3D)(unsafe.Pointer(&ptr))} })
}
