...
*/
var self objects.EngineDebugger
var once sync.Once

func singleton() {
	obj := gd.Global.Object.GetSingleton(gd.Global.Singletons.EngineDebugger)
	self = *(*objects.EngineDebugger)(unsafe.Pointer(&obj))
}
...
*/
func RegisterProfiler(name string, profiler objects.EngineProfiler) {
	once.Do(singleton)
...
Starts a debug break in script execution, optionally specifying whether the program can continue based on [param can_continue] and whether the break was due to a breakpoint.
*/
func ScriptDebug(language objects.ScriptLanguage) {
	once.Do(singleton)
...
func (self class) IsActive() bool {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.EngineDebugger.Bind_is_active, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
*/
//go:nosplit
func (self class) RegisterProfiler(name gd.StringName, profiler objects.EngineProfiler) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) ScriptDebug(language objects.ScriptLanguage, can_continue bool, is_error_breakpoint bool) {
	var frame = callframe.New()
...
func (self class) GetLinesLeft() gd.Int {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.EngineDebugger.Bind_get_lines_left, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
func (self class) GetDepth() gd.Int {
	var frame = callframe.New()
	var r_ret = callframe.Ret[gd.Int](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.EngineDebugger.Bind_get_depth, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
func (self class) IsSkippingBreakpoints() bool {
	var frame = callframe.New()
	var r_ret = callframe.Ret[bool](frame)
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.EngineDebugger.Bind_is_skipping_breakpoints, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
