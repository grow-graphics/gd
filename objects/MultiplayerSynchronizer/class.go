...
func New() Instance {
	...
	return Instance{*(*classdb.MultiplayerSynchronizer)(unsafe.Pointer(&object))}
}
...
func (self Instance) ReplicationConfig() objects.SceneReplicationConfig {
	return objects.SceneReplicationConfig(class(self).GetReplicationConfig())
}

func (self Instance) SetReplicationConfig(value objects.SceneReplicationConfig) {
	class(self).SetReplicationConfig(value)
}

func (self Instance) VisibilityUpdateMode() classdb.MultiplayerSynchronizerVisibilityUpdateMode {
	return classdb.MultiplayerSynchronizerVisibilityUpdateMode(class(self).GetVisibilityUpdateMode())
}

func (self Instance) SetVisibilityUpdateMode(value classdb.MultiplayerSynchronizerVisibilityUpdateMode) {
...
//go:nosplit
func (self class) SetReplicationConfig(config objects.SceneReplicationConfig) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetReplicationConfig() objects.SceneReplicationConfig {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
	...
	var ret = objects.SceneReplicationConfig{gd.PointerWithOwnershipTransferredToGo[classdb.SceneReplicationConfig](r_ret.Get())}
	frame.Free()
	return ret
}
...
func init() {
	classdb.Register("MultiplayerSynchronizer", func(ptr gd.Object) any {
		return [1]classdb.MultiplayerSynchronizer{*(*classdb.MultiplayerSynchronizer)(unsafe.Pointer(&ptr))}
	})
}
