...
Intended for use with GDExtension to create custom implementations of [PhysicsDirectBodyState2D].
	...
	type PhysicsDirectBodyState2DExtension interface {
		...
		GetSpaceState() objects.PhysicsDirectSpaceState2D
	}
*/
...
Overridable version of [method PhysicsDirectBodyState2D.get_space_state].
*/
func (Instance) _get_space_state(impl func(ptr unsafe.Pointer) objects.PhysicsDirectSpaceState2D) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self)
...
Overridable version of [method PhysicsDirectBodyState2D.get_space_state].
*/
func (class) _get_space_state(impl func(ptr unsafe.Pointer) objects.PhysicsDirectSpaceState2D) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self)
		ptr, ok := pointers.End(ret[0])
...
func init() {
	classdb.Register("PhysicsDirectBodyState2DExtension", func(ptr gd.Object) any { return classdb.PhysicsDirectBodyState2DExtension(ptr) })
}
