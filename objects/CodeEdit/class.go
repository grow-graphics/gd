...
import "graphics.gd/objects/TextEdit"
...
*/
type Instance [1]classdb.CodeEdit
type Any interface {
	gd.IsClass
	AsCodeEdit() Instance
}
...
func New() Instance {
	...
	return Instance{*(*classdb.CodeEdit)(unsafe.Pointer(&object))}
}
...
*/
//go:nosplit
func (self class) AddCodeCompletionOption(atype classdb.CodeEditCodeCompletionKind, display_text gd.String, insert_text gd.String, text_color gd.Color, icon objects.Resource, value gd.Variant, location gd.Int) {
	var frame = callframe.New()
...
func init() {
	classdb.Register("CodeEdit", func(ptr gd.Object) any { return [1]classdb.CodeEdit{*(*classdb.CodeEdit)(unsafe.Pointer(&ptr))} })
}
