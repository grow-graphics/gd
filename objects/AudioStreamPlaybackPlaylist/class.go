...
func New() Instance {
	...
	return Instance{*(*classdb.AudioStreamPlaybackPlaylist)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("AudioStreamPlaybackPlaylist", func(ptr gd.Object) any {
		return [1]classdb.AudioStreamPlaybackPlaylist{*(*classdb.AudioStreamPlaybackPlaylist)(unsafe.Pointer(&ptr))}
	})
}
