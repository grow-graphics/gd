...
*/
var self objects.AudioServer
var once sync.Once

func singleton() {
	obj := gd.Global.Object.GetSingleton(gd.Global.Singletons.AudioServer)
	self = *(*objects.AudioServer)(unsafe.Pointer(&obj))
}
...
*/
func AddBusEffect(bus_idx int, effect objects.AudioEffect) {
	once.Do(singleton)
...
*/
func GetBusEffect(bus_idx int, effect_idx int) objects.AudioEffect {
	once.Do(singleton)
	return objects.AudioEffect(class(self).GetBusEffect(gd.Int(bus_idx), gd.Int(effect_idx)))
}

/*
Returns the [AudioEffectInstance] assigned to the given bus and effect indices (and optionally channel).
*/
func GetBusEffectInstance(bus_idx int, effect_idx int) objects.AudioEffectInstance {
	once.Do(singleton)
	return objects.AudioEffectInstance(class(self).GetBusEffectInstance(gd.Int(bus_idx), gd.Int(effect_idx), gd.Int(0)))
}
...
*/
func SetBusLayout(bus_layout objects.AudioBusLayout) {
	once.Do(singleton)
...
*/
func GenerateBusLayout() objects.AudioBusLayout {
	once.Do(singleton)
	return objects.AudioBusLayout(class(self).GenerateBusLayout())
}
...
*/
func IsStreamRegisteredAsSample(stream objects.AudioStream) bool {
	once.Do(singleton)
...
*/
func RegisterStreamAsSample(stream objects.AudioStream) {
	once.Do(singleton)
...
*/
//go:nosplit
func (self class) AddBusEffect(bus_idx gd.Int, effect objects.AudioEffect, at_position gd.Int) {
	var frame = callframe.New()
	callframe.Arg(frame, bus_idx)
...
*/
//go:nosplit
func (self class) GetBusEffect(bus_idx gd.Int, effect_idx gd.Int) objects.AudioEffect {
	var frame = callframe.New()
	callframe.Arg(frame, bus_idx)
	callframe.Arg(frame, effect_idx)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetBusEffectInstance(bus_idx gd.Int, effect_idx gd.Int, channel gd.Int) objects.AudioEffectInstance {
	var frame = callframe.New()
	callframe.Arg(frame, bus_idx)
	callframe.Arg(frame, effect_idx)
...
*/
//go:nosplit
func (self class) SetBusLayout(bus_layout objects.AudioBusLayout) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GenerateBusLayout() objects.AudioBusLayout {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) IsStreamRegisteredAsSample(stream objects.AudioStream) bool {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) RegisterStreamAsSample(stream objects.AudioStream) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(stream[0])[0])
	var r_ret callframe.Nil
