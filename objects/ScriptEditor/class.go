...
import "grow.graphics/gd/objects/PanelContainer"
...
*/
func (self Instance) GetCurrentEditor() objects.ScriptEditorBase {
	return objects.ScriptEditorBase(class(self).GetCurrentEditor())
}
...
*/
func (self Instance) RegisterSyntaxHighlighter(syntax_highlighter objects.EditorSyntaxHighlighter) {
...
*/
func (self Instance) UnregisterSyntaxHighlighter(syntax_highlighter objects.EditorSyntaxHighlighter) {
...
*/
func (self Instance) GetCurrentScript() objects.Script {
	return objects.Script(class(self).GetCurrentScript())
}
...
*/
//go:nosplit
func (self class) GetCurrentEditor() objects.ScriptEditorBase {
...
*/
//go:nosplit
func (self class) RegisterSyntaxHighlighter(syntax_highlighter objects.EditorSyntaxHighlighter) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) UnregisterSyntaxHighlighter(syntax_highlighter objects.EditorSyntaxHighlighter) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(syntax_highlighter[0])[0])
	var r_ret callframe.Nil
...
*/
//go:nosplit
func (self class) GetCurrentScript() objects.Script {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func (self Instance) OnEditorScriptChanged(cb func(script objects.Script)) {
	self[0].AsObject().Connect(gd.NewStringName("editor_script_changed"), gd.NewCallable(cb), 0)
}

func (self Instance) OnScriptClose(cb func(script objects.Script)) {
