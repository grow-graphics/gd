...
*/
type Instance [1]classdb.ResourcePreloader
type Any interface {
	gd.IsClass
...
*/
func (self Instance) AddResource(name string, resource objects.Resource) {
...
*/
func (self Instance) GetResource(name string) objects.Resource {
	return objects.Resource(class(self).GetResource(gd.NewStringName(name)))
}
...
func New() Instance {
	...
	return Instance{*(*classdb.ResourcePreloader)(unsafe.Pointer(&object))}
}
...
*/
//go:nosplit
func (self class) AddResource(name gd.StringName, resource objects.Resource) {
...
*/
//go:nosplit
func (self class) GetResource(name gd.StringName) objects.Resource {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(name))
...
func init() {
	classdb.Register("ResourcePreloader", func(ptr gd.Object) any {
		return [1]classdb.ResourcePreloader{*(*classdb.ResourcePreloader)(unsafe.Pointer(&ptr))}
	})
}
