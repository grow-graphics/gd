...
*/
func (self Instance) Search(subject string) objects.RegExMatch {
	return objects.RegExMatch(class(self).Search(gd.NewString(subject), gd.Int(0), gd.Int(-1)))
}
...
*/
//go:nosplit
func (self class) CreateFromString(pattern gd.String) objects.RegEx {
...
*/
//go:nosplit
func (self class) Search(subject gd.String, offset gd.Int, end gd.Int) objects.RegExMatch {
	var frame = callframe.New()
