...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeVec2Parameter)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("VisualShaderNodeVec2Parameter", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeVec2Parameter{*(*classdb.VisualShaderNodeVec2Parameter)(unsafe.Pointer(&ptr))}
	})
}
