...
func New() Instance {
	...
	return Instance{*(*classdb.Curve)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("Curve", func(ptr gd.Object) any { return [1]classdb.Curve{*(*classdb.Curve)(unsafe.Pointer(&ptr))} })
}
