...
func New() Instance {
	...
	return Instance{*(*classdb.PathFollow2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("PathFollow2D", func(ptr gd.Object) any {
		return [1]classdb.PathFollow2D{*(*classdb.PathFollow2D)(unsafe.Pointer(&ptr))}
	})
}
