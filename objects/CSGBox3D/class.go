...
func New() Instance {
	...
	return Instance{*(*classdb.CSGBox3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("CSGBox3D", func(ptr gd.Object) any { return [1]classdb.CSGBox3D{*(*classdb.CSGBox3D)(unsafe.Pointer(&ptr))} })
}
