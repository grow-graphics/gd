...
*/
type Instance [1]classdb.GridMap
...
func (self Instance) MeshLibrary() objects.MeshLibrary {
	return objects.MeshLibrary(class(self).GetMeshLibrary())
}

func (self Instance) SetMeshLibrary(value objects.MeshLibrary) {
	class(self).SetMeshLibrary(value)
}

func (self Instance) PhysicsMaterial() objects.PhysicsMaterial {
	return objects.PhysicsMaterial(class(self).GetPhysicsMaterial())
}

func (self Instance) SetPhysicsMaterial(value objects.PhysicsMaterial) {
...
//go:nosplit
func (self class) SetPhysicsMaterial(material objects.PhysicsMaterial) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetPhysicsMaterial() objects.PhysicsMaterial {
	var frame = callframe.New()
...
//go:nosplit
func (self class) SetMeshLibrary(mesh_library objects.MeshLibrary) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetMeshLibrary() objects.MeshLibrary {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
