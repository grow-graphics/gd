...
*/
type Instance [1]classdb.EditorFileSystem
type Any interface {
	gd.IsClass
...
*/
func (self Instance) GetFilesystem() objects.EditorFileSystemDirectory {
	return objects.EditorFileSystemDirectory(class(self).GetFilesystem())
}
...
*/
func (self Instance) GetFilesystemPath(path string) objects.EditorFileSystemDirectory {
	return objects.EditorFileSystemDirectory(class(self).GetFilesystemPath(gd.NewString(path)))
}
...
*/
//go:nosplit
func (self class) GetFilesystem() objects.EditorFileSystemDirectory {
...
*/
//go:nosplit
func (self class) GetFilesystemPath(path gd.String) objects.EditorFileSystemDirectory {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(path))
	var r_ret = callframe.Ret[[1]uintptr](frame)
