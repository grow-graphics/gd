...
func New() Instance {
	...
	return Instance{*(*classdb.PhysicsTestMotionParameters3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("PhysicsTestMotionParameters3D", func(ptr gd.Object) any {
		return [1]classdb.PhysicsTestMotionParameters3D{*(*classdb.PhysicsTestMotionParameters3D)(unsafe.Pointer(&ptr))}
	})
}
