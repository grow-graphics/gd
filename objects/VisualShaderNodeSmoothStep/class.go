...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeSmoothStep)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("VisualShaderNodeSmoothStep", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeSmoothStep{*(*classdb.VisualShaderNodeSmoothStep)(unsafe.Pointer(&ptr))}
	})
}
