...
func New() Instance {
	...
	return Instance{classdb.AudioEffectEQ6(object)}
}
...
func init() {
	classdb.Register("AudioEffectEQ6", func(ptr gd.Object) any { return [1]classdb.AudioEffectEQ6{classdb.AudioEffectEQ6(ptr)} })
}
