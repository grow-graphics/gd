...
*/
func (self Instance) SetSkinWeightCount(count classdb.SurfaceToolSkinWeightCount) {
...
*/
func (self Instance) GetSkinWeightCount() classdb.SurfaceToolSkinWeightCount {
...
*/
func (self Instance) SetCustomFormat(channel_index int, format classdb.SurfaceToolCustomFormat) {
...
*/
func (self Instance) GetCustomFormat(channel_index int) classdb.SurfaceToolCustomFormat {
...
*/
func (self Instance) Begin(primitive classdb.MeshPrimitiveType) {
...
*/
func (self Instance) SetMaterial(material objects.Material) {
...
*/
func (self Instance) GetPrimitiveType() classdb.MeshPrimitiveType {
...
*/
func (self Instance) CreateFrom(existing objects.Mesh, surface int) {
...
*/
func (self Instance) CreateFromBlendShape(existing objects.Mesh, surface int, blend_shape string) {
...
*/
//go:nosplit
func (self class) CreateFrom(existing objects.Mesh, surface gd.Int) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) CreateFromBlendShape(existing objects.Mesh, surface gd.Int, blend_shape gd.String) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(existing[0])[0])
	callframe.Arg(frame, surface)
...
*/
//go:nosplit
func (self class) AppendFrom(existing objects.Mesh, surface gd.Int, transform gd.Transform3D) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(existing[0])[0])
	callframe.Arg(frame, surface)
...
*/
//go:nosplit
func (self class) Commit(existing objects.ArrayMesh, flags gd.Int) objects.ArrayMesh {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(existing[0])[0])
