...
*/
func (self Instance) Convert(format classdb.ImageFormat) {
...
*/
func (self Instance) GenerateMipmaps() gd.Error {
...
*/
func (self Instance) SetData(width int, height int, use_mipmaps bool, format classdb.ImageFormat, data []byte) {
...
*/
func (self Instance) SavePng(path string) gd.Error {
...
*/
func (self Instance) SaveJpg(path string) gd.Error {
...
*/
func (self Instance) SaveExr(path string) gd.Error {
...
*/
func (self Instance) SaveWebp(path string) gd.Error {
...
*/
func (self Instance) DetectAlpha() classdb.ImageAlphaMode {
...
*/
func (self Instance) DetectUsedChannels() classdb.ImageUsedChannels {
...
*/
func (self Instance) Compress(mode classdb.ImageCompressMode) gd.Error {
...
For ASTC compression, the [param astc_format] parameter must be supplied.
*/
func (self Instance) CompressFromChannels(mode classdb.ImageCompressMode, channels classdb.ImageUsedChannels) gd.Error {
...
*/
func (self Instance) Decompress() gd.Error {
...
*/
func (self Instance) Rotate90(direction gdconst.ClockDirection) {
...
*/
func (self Instance) RgbeToSrgb() objects.Image {
	return objects.Image(class(self).RgbeToSrgb())
}
...
*/
func (self Instance) CopyFrom(src objects.Image) {
...
*/
func (self Instance) LoadPngFromBuffer(buffer []byte) gd.Error {
...
*/
func (self Instance) LoadJpgFromBuffer(buffer []byte) gd.Error {
...
*/
func (self Instance) LoadWebpFromBuffer(buffer []byte) gd.Error {
...
*/
func (self Instance) LoadTgaFromBuffer(buffer []byte) gd.Error {
...
*/
func (self Instance) LoadBmpFromBuffer(buffer []byte) gd.Error {
...
*/
func (self Instance) LoadKtxFromBuffer(buffer []byte) gd.Error {
...
*/
func (self Instance) LoadSvgFromBuffer(buffer []byte) gd.Error {
...
[b]Note:[/b] This method is only available in engine builds with the SVG module enabled. By default, the SVG module is enabled, but it can be disabled at build-time using the [code]module_svg_enabled=no[/code] SCons option.
*/
func (self Instance) LoadSvgFromString(svg_str string) gd.Error {
...
func New() Instance {
	...
	return Instance{classdb.Image(object)}
}
...
*/
//go:nosplit
func (self class) Create(width gd.Int, height gd.Int, use_mipmaps bool, format classdb.ImageFormat) objects.Image {
	var frame = callframe.New()
	callframe.Arg(frame, width)
	callframe.Arg(frame, height)
...
*/
//go:nosplit
func (self class) CreateEmpty(width gd.Int, height gd.Int, use_mipmaps bool, format classdb.ImageFormat) objects.Image {
	var frame = callframe.New()
	callframe.Arg(frame, width)
	callframe.Arg(frame, height)
	callframe.Arg(frame, use_mipmaps)
...
*/
//go:nosplit
func (self class) CreateFromData(width gd.Int, height gd.Int, use_mipmaps bool, format classdb.ImageFormat, data gd.PackedByteArray) objects.Image {
	var frame = callframe.New()
	callframe.Arg(frame, width)
	callframe.Arg(frame, height)
	callframe.Arg(frame, use_mipmaps)
...
*/
//go:nosplit
func (self class) LoadFromFile(path gd.String) objects.Image {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(path))
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) Rotate90(direction gdconst.ClockDirection) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) RgbeToSrgb() objects.Image {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) ComputeImageMetrics(compared_image objects.Image, use_luma bool) gd.Dictionary {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) BlitRect(src objects.Image, src_rect gd.Rect2i, dst gd.Vector2i) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) BlitRectMask(src objects.Image, mask objects.Image, src_rect gd.Rect2i, dst gd.Vector2i) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(src[0])[0])
...
*/
//go:nosplit
func (self class) BlendRect(src objects.Image, src_rect gd.Rect2i, dst gd.Vector2i) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(src[0])[0])
	callframe.Arg(frame, src_rect)
	callframe.Arg(frame, dst)
...
*/
//go:nosplit
func (self class) BlendRectMask(src objects.Image, mask objects.Image, src_rect gd.Rect2i, dst gd.Vector2i) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(src[0])[0])
	callframe.Arg(frame, pointers.Get(mask[0])[0])
	callframe.Arg(frame, src_rect)
...
*/
//go:nosplit
func (self class) GetRegion(region gd.Rect2i) objects.Image {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) CopyFrom(src objects.Image) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(src[0])[0])
	var r_ret callframe.Nil
