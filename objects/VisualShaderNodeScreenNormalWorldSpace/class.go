...
func New() Instance {
	...
	return Instance{classdb.VisualShaderNodeScreenNormalWorldSpace(object)}
}
...
func init() {
	classdb.Register("VisualShaderNodeScreenNormalWorldSpace", func(ptr gd.Object) any { return classdb.VisualShaderNodeScreenNormalWorldSpace(ptr) })
}
