...
type Instance [1]classdb.EditorExportPlatformAndroid
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.EditorExportPlatformAndroid)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("EditorExportPlatformAndroid", func(ptr gd.Object) any {
		return [1]classdb.EditorExportPlatformAndroid{*(*classdb.EditorExportPlatformAndroid)(unsafe.Pointer(&ptr))}
	})
}
