...
*/
func (self Instance) GetDeviceCount() int {
...
*/
func (self Instance) GetDevice(index int) objects.UPNPDevice {
	return objects.UPNPDevice(class(self).GetDevice(gd.Int(index)))
}

/*
Adds the given [UPNPDevice] to the list of discovered devices.
*/
func (self Instance) AddDevice(device objects.UPNPDevice) {
...
*/
func (self Instance) SetDevice(index int, device objects.UPNPDevice) {
...
*/
func (self Instance) RemoveDevice(index int) {
...
*/
func (self Instance) ClearDevices() {
...
*/
func (self Instance) GetGateway() objects.UPNPDevice {
	return objects.UPNPDevice(class(self).GetGateway())
}
...
*/
func (self Instance) Discover() int {
...
*/
//go:nosplit
func (self class) GetDevice(index gd.Int) objects.UPNPDevice {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) AddDevice(device objects.UPNPDevice) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetDevice(index gd.Int, device objects.UPNPDevice) {
	var frame = callframe.New()
	callframe.Arg(frame, index)
	callframe.Arg(frame, pointers.Get(device[0])[0])
	var r_ret callframe.Nil
...
*/
//go:nosplit
func (self class) GetGateway() objects.UPNPDevice {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
