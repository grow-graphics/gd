...
func New() Instance {
	...
	return Instance{*(*classdb.RayCast2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("RayCast2D", func(ptr gd.Object) any { return [1]classdb.RayCast2D{*(*classdb.RayCast2D)(unsafe.Pointer(&ptr))} })
}
