...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeFloatOp)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("VisualShaderNodeFloatOp", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeFloatOp{*(*classdb.VisualShaderNodeFloatOp)(unsafe.Pointer(&ptr))}
	})
}
