...
*/
type Instance [1]classdb.GPUParticles3D
...
func (self Instance) DrawOrder() classdb.GPUParticles3DDrawOrder {
	return classdb.GPUParticles3DDrawOrder(class(self).GetDrawOrder())
}

func (self Instance) SetDrawOrder(value classdb.GPUParticles3DDrawOrder) {
	class(self).SetDrawOrder(value)
}

func (self Instance) TransformAlign() classdb.GPUParticles3DTransformAlign {
	return classdb.GPUParticles3DTransformAlign(class(self).GetTransformAlign())
}

func (self Instance) SetTransformAlign(value classdb.GPUParticles3DTransformAlign) {
...
func (self Instance) DrawPass1() objects.Mesh {
	return objects.Mesh(class(self).GetDrawPassMesh(0))
}

func (self Instance) SetDrawPass1(value objects.Mesh) {
	class(self).SetDrawPassMesh(0, value)
}

func (self Instance) DrawPass2() objects.Mesh {
	return objects.Mesh(class(self).GetDrawPassMesh(1))
}

func (self Instance) SetDrawPass2(value objects.Mesh) {
	class(self).SetDrawPassMesh(1, value)
}

func (self Instance) DrawPass3() objects.Mesh {
	return objects.Mesh(class(self).GetDrawPassMesh(2))
}

func (self Instance) SetDrawPass3(value objects.Mesh) {
	class(self).SetDrawPassMesh(2, value)
}

func (self Instance) DrawPass4() objects.Mesh {
	return objects.Mesh(class(self).GetDrawPassMesh(3))
}

func (self Instance) SetDrawPass4(value objects.Mesh) {
	class(self).SetDrawPassMesh(3, value)
}

func (self Instance) DrawSkin() objects.Skin {
	return objects.Skin(class(self).GetSkin())
}

func (self Instance) SetDrawSkin(value objects.Skin) {
...
*/
//go:nosplit
func (self class) SetDrawPassMesh(pass gd.Int, mesh objects.Mesh) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetDrawPassMesh(pass gd.Int) objects.Mesh {
	var frame = callframe.New()
	callframe.Arg(frame, pass)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func init() {
	classdb.Register("GPUParticles3D", func(ptr gd.Object) any { return classdb.GPUParticles3D(ptr) })
}
