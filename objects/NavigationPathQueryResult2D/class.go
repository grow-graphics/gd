...
func New() Instance {
	...
	return Instance{*(*classdb.NavigationPathQueryResult2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("NavigationPathQueryResult2D", func(ptr gd.Object) any {
		return [1]classdb.NavigationPathQueryResult2D{*(*classdb.NavigationPathQueryResult2D)(unsafe.Pointer(&ptr))}
	})
}
