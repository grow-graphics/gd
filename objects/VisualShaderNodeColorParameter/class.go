...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeColorParameter)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("VisualShaderNodeColorParameter", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeColorParameter{*(*classdb.VisualShaderNodeColorParameter)(unsafe.Pointer(&ptr))}
	})
}
