...
*/
func (self Instance) GetCurrentNavigationResult() objects.NavigationPathQueryResult3D {
	return objects.NavigationPathQueryResult3D(class(self).GetCurrentNavigationResult())
}
...
*/
//go:nosplit
func (self class) GetCurrentNavigationResult() objects.NavigationPathQueryResult3D {
	var frame = callframe.New()
