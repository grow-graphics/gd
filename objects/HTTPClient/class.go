...
func (self Instance) Connection() objects.StreamPeer {
	return objects.StreamPeer(class(self).GetConnection())
}

func (self Instance) SetConnection(value objects.StreamPeer) {
...
//go:nosplit
func (self class) SetConnection(connection objects.StreamPeer) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetConnection() objects.StreamPeer {
	var frame = callframe.New()
