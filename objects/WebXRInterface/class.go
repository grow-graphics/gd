...
- [signal squeezestart]
*/
func (self Instance) GetInputSourceTracker(input_source_id int) objects.XRControllerTracker {
	return objects.XRControllerTracker(class(self).GetInputSourceTracker(gd.Int(input_source_id)))
}
...
*/
func (self Instance) GetInputSourceTargetRayMode(input_source_id int) classdb.WebXRInterfaceTargetRayMode {
...
*/
//go:nosplit
func (self class) GetInputSourceTracker(input_source_id gd.Int) objects.XRControllerTracker {
	var frame = callframe.New()
	callframe.Arg(frame, input_source_id)
	var r_ret = callframe.Ret[[1]uintptr](frame)
