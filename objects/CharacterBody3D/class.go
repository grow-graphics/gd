...
import "graphics.gd/objects/PhysicsBody3D"
import "graphics.gd/objects/CollisionObject3D"
...
*/
type Instance [1]classdb.CharacterBody3D
type Any interface {
	gd.IsClass
...
*/
func (self Instance) GetSlideCollision(slide_idx int) objects.KinematicCollision3D {
	return objects.KinematicCollision3D(class(self).GetSlideCollision(gd.Int(slide_idx)))
}
...
*/
func (self Instance) GetLastSlideCollision() objects.KinematicCollision3D {
	return objects.KinematicCollision3D(class(self).GetLastSlideCollision())
}
...
func (self Instance) SetMotionMode(value classdb.CharacterBody3DMotionMode) {
...
func (self Instance) PlatformOnLeave() classdb.CharacterBody3DPlatformOnLeave {
	return classdb.CharacterBody3DPlatformOnLeave(class(self).GetPlatformOnLeave())
}

func (self Instance) SetPlatformOnLeave(value classdb.CharacterBody3DPlatformOnLeave) {
...
*/
//go:nosplit
func (self class) GetSlideCollision(slide_idx gd.Int) objects.KinematicCollision3D {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetLastSlideCollision() objects.KinematicCollision3D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
