...
*/
type Instance [1]classdb.VisualShaderNodeMix
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeMix)(unsafe.Pointer(&object))}
}

func (self Instance) OpType() classdb.VisualShaderNodeMixOpType {
	return classdb.VisualShaderNodeMixOpType(class(self).GetOpType())
}

func (self Instance) SetOpType(value classdb.VisualShaderNodeMixOpType) {
...
func (self class) SetOpType(op_type classdb.VisualShaderNodeMixOpType) {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.VisualShaderNodeMix.Bind_set_op_type, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	frame.Free()
}
...
func (self class) GetOpType() classdb.VisualShaderNodeMixOpType {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.VisualShaderNodeMix.Bind_get_op_type, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
func init() {
	classdb.Register("VisualShaderNodeMix", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeMix{*(*classdb.VisualShaderNodeMix)(unsafe.Pointer(&ptr))}
	})
}
