...
To force an update earlier on, call [method update_internals].
	...
	type TileMapLayer interface {
		...
		TileDataRuntimeUpdate(coords Vector2i.XY, tile_data objects.TileData)
	}
*/
type Instance [1]classdb.TileMapLayer
type Any interface {
	gd.IsClass
...
[b]Note:[/b] If the properties of [param tile_data] object should change over time, use [method notify_runtime_tile_data_update] to notify the [TileMapLayer] it needs an update.
*/
func (Instance) _tile_data_runtime_update(impl func(ptr unsafe.Pointer, coords Vector2i.XY, tile_data objects.TileData)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var coords = gd.UnsafeGet[gd.Vector2i](p_args, 0)
		var tile_data = objects.TileData{pointers.New[classdb.TileData]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
[/codeblock]
*/
func (self Instance) GetCellTileData(coords Vector2i.XY) objects.TileData {
	return objects.TileData(class(self).GetCellTileData(gd.Vector2i(coords)))
}
...
*/
func (self Instance) GetPattern(coords_array gd.Array) objects.TileMapPattern {
	return objects.TileMapPattern(class(self).GetPattern(coords_array))
}

/*
Pastes the [TileMapPattern] at the given [param position] in the tile map. See also [method get_pattern].
*/
func (self Instance) SetPattern(position Vector2i.XY, pattern objects.TileMapPattern) {
...
*/
func (self Instance) HasBodyRid(body Resource.ID) bool {
...
*/
func (self Instance) MapPattern(position_in_tilemap Vector2i.XY, coords_in_pattern Vector2i.XY, pattern objects.TileMapPattern) Vector2i.XY {
...
*/
func (self Instance) GetNeighborCell(coords Vector2i.XY, neighbor classdb.TileSetCellNeighbor) Vector2i.XY {
...
*/
func (self Instance) SetNavigationMap(mapping Resource.ID) {
...
func New() Instance {
	...
	return Instance{*(*classdb.TileMapLayer)(unsafe.Pointer(&object))}
}
...
func (self Instance) CollisionVisibilityMode() classdb.TileMapLayerDebugVisibilityMode {
	return classdb.TileMapLayerDebugVisibilityMode(class(self).GetCollisionVisibilityMode())
}

func (self Instance) SetCollisionVisibilityMode(value classdb.TileMapLayerDebugVisibilityMode) {
...
func (self Instance) NavigationVisibilityMode() classdb.TileMapLayerDebugVisibilityMode {
	return classdb.TileMapLayerDebugVisibilityMode(class(self).GetNavigationVisibilityMode())
}

func (self Instance) SetNavigationVisibilityMode(value classdb.TileMapLayerDebugVisibilityMode) {
...
[b]Note:[/b] If the properties of [param tile_data] object should change over time, use [method notify_runtime_tile_data_update] to notify the [TileMapLayer] it needs an update.
*/
func (class) _tile_data_runtime_update(impl func(ptr unsafe.Pointer, coords gd.Vector2i, tile_data objects.TileData)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var coords = gd.UnsafeGet[gd.Vector2i](p_args, 0)
		var tile_data = objects.TileData{pointers.New[classdb.TileData]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
		defer pointers.End(tile_data[0])
...
*/
//go:nosplit
func (self class) GetCellTileData(coords gd.Vector2i) objects.TileData {
	var frame = callframe.New()
	callframe.Arg(frame, coords)
	...
	var ret = objects.TileData{gd.PointerWithOwnershipTransferredToGo[classdb.TileData](r_ret.Get())}
	frame.Free()
	return ret
}
...
*/
//go:nosplit
func (self class) GetPattern(coords_array gd.Array) objects.TileMapPattern {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetPattern(position gd.Vector2i, pattern objects.TileMapPattern) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) SetTileSet(tile_set objects.TileSet) {
	var frame = callframe.New()
...
func init() {
	classdb.Register("TileMapLayer", func(ptr gd.Object) any {
		return [1]classdb.TileMapLayer{*(*classdb.TileMapLayer)(unsafe.Pointer(&ptr))}
	})
}
