...
*/
type Instance [1]classdb.SpriteFrames
type Any interface {
	gd.IsClass
...
*/
func (self Instance) AddFrame(anim string, texture objects.Texture2D) {
...
*/
func (self Instance) SetFrame(anim string, idx int, texture objects.Texture2D) {
...
*/
func (self Instance) GetFrameTexture(anim string, idx int) objects.Texture2D {
	return objects.Texture2D(class(self).GetFrameTexture(gd.NewStringName(anim), gd.Int(idx)))
}
...
*/
//go:nosplit
func (self class) AddFrame(anim gd.StringName, texture objects.Texture2D, duration gd.Float, at_position gd.Int) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(anim))
...
*/
//go:nosplit
func (self class) SetFrame(anim gd.StringName, idx gd.Int, texture objects.Texture2D, duration gd.Float) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(anim))
...
*/
//go:nosplit
func (self class) GetFrameTexture(anim gd.StringName, idx gd.Int) objects.Texture2D {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(anim))
	callframe.Arg(frame, idx)
