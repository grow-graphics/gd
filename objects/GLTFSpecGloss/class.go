...
func (self Instance) DiffuseImg() objects.Image {
	return objects.Image(class(self).GetDiffuseImg())
}

func (self Instance) SetDiffuseImg(value objects.Image) {
...
func (self Instance) SpecGlossImg() objects.Image {
	return objects.Image(class(self).GetSpecGlossImg())
}

func (self Instance) SetSpecGlossImg(value objects.Image) {
	class(self).SetSpecGlossImg(value)
}

//go:nosplit
func (self class) GetDiffuseImg() objects.Image {
...
//go:nosplit
func (self class) SetDiffuseImg(diffuse_img objects.Image) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetSpecGlossImg() objects.Image {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
//go:nosplit
func (self class) SetSpecGlossImg(spec_gloss_img objects.Image) {
	var frame = callframe.New()
