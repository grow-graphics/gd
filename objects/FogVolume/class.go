...
func New() Instance {
	...
	return Instance{*(*classdb.FogVolume)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("FogVolume", func(ptr gd.Object) any { return [1]classdb.FogVolume{*(*classdb.FogVolume)(unsafe.Pointer(&ptr))} })
}
