...
func New() Instance {
	...
	return Instance{classdb.VisualShaderNodeSDFRaymarch(object)}
}
...
func init() {
	classdb.Register("VisualShaderNodeSDFRaymarch", func(ptr gd.Object) any { return classdb.VisualShaderNodeSDFRaymarch(ptr) })
}
