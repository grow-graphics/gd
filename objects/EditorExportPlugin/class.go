...
To use [EditorExportPlugin], register it using the [method EditorPlugin.add_export_plugin] method first.
	...
	type EditorExportPlugin interface {
		...
		BeginCustomizeResources(platform objects.EditorExportPlatform, features []string) bool
		...
		CustomizeResource(resource objects.Resource, path string) objects.Resource
		...
		BeginCustomizeScenes(platform objects.EditorExportPlatform, features []string) bool
		...
		CustomizeScene(scene objects.Node, path string) objects.Node
		...
		GetExportOptions(platform objects.EditorExportPlatform) gd.Array
		...
		GetExportOptionWarning(platform objects.EditorExportPlatform, option string) string
		//Return a [PackedStringArray] of additional features this preset, for the given [param platform], should have.
		GetExportFeatures(platform objects.EditorExportPlatform, debug bool) []string
		//Return the name identifier of this plugin (for future identification by the exporter). The plugins are sorted by name before exporting.
		//Implementing this method is required.
		GetName() string
		//Return [code]true[/code] if the plugin supports the given [param platform].
		SupportsPlatform(platform objects.EditorExportPlatform) bool
		...
		GetAndroidDependencies(platform objects.EditorExportPlatform, debug bool) []string
		...
		//[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
		GetAndroidDependenciesMavenRepos(platform objects.EditorExportPlatform, debug bool) []string
		...
		//[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
		GetAndroidLibraries(platform objects.EditorExportPlatform, debug bool) []string
		...
		//[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
		GetAndroidManifestActivityElementContents(platform objects.EditorExportPlatform, debug bool) string
		...
		//[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
		GetAndroidManifestApplicationElementContents(platform objects.EditorExportPlatform, debug bool) string
		...
		//[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
		GetAndroidManifestElementContents(platform objects.EditorExportPlatform, debug bool) string
	}
*/
...
When enabled, [method _get_customization_configuration_hash] and [method _customize_resource] will be called and must be implemented.
*/
func (Instance) _begin_customize_resources(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, features []string) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
...
Implementing this method is required if [method _begin_customize_resources] returns [code]true[/code].
*/
func (Instance) _customize_resource(impl func(ptr unsafe.Pointer, resource objects.Resource, path string) objects.Resource) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
...
When enabled, [method _get_customization_configuration_hash] and [method _customize_scene] will be called and must be implemented.
*/
func (Instance) _begin_customize_scenes(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, features []string) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var features = pointers.New[gd.PackedStringArray](gd.UnsafeGet[[2]uintptr](p_args, 1))
...
Implementing this method is required if [method _begin_customize_scenes] returns [code]true[/code].
*/
func (Instance) _customize_scene(impl func(ptr unsafe.Pointer, scene objects.Node, path string) objects.Node) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
...
- [code]update_visibility[/code]: An optional boolean value. If set to [code]true[/code], the preset will emit [signal Object.property_list_changed] when the option is changed.
*/
func (Instance) _get_export_options(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform) gd.Array) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
Return [code]true[/code], if the result of [method _get_export_options] has changed and the export options of preset corresponding to [param platform] should be updated.
*/
func (Instance) _should_update_export_options(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
[b]Note:[/b] Use [method get_option] to check the value of the export options.
*/
func (Instance) _get_export_option_warning(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, option string) string) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
...
Return a [PackedStringArray] of additional features this preset, for the given [param platform], should have.
*/
func (Instance) _get_export_features(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, debug bool) []string) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
...
Return [code]true[/code] if the plugin supports the given [param platform].
*/
func (Instance) _supports_platform(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
*/
func (Instance) _get_android_dependencies(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, debug bool) []string) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var debug = gd.UnsafeGet[bool](p_args, 1)
...
[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
*/
func (Instance) _get_android_dependencies_maven_repos(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, debug bool) []string) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var debug = gd.UnsafeGet[bool](p_args, 1)
...
[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
*/
func (Instance) _get_android_libraries(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, debug bool) []string) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var debug = gd.UnsafeGet[bool](p_args, 1)
...
[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
*/
func (Instance) _get_android_manifest_activity_element_contents(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, debug bool) string) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var debug = gd.UnsafeGet[bool](p_args, 1)
...
[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
*/
func (Instance) _get_android_manifest_application_element_contents(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, debug bool) string) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var debug = gd.UnsafeGet[bool](p_args, 1)
...
[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
*/
func (Instance) _get_android_manifest_element_contents(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, debug bool) string) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var debug = gd.UnsafeGet[bool](p_args, 1)
...
When enabled, [method _get_customization_configuration_hash] and [method _customize_resource] will be called and must be implemented.
*/
func (class) _begin_customize_resources(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, features gd.PackedStringArray) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var features = pointers.New[gd.PackedStringArray](gd.UnsafeGet[[2]uintptr](p_args, 1))
...
Implementing this method is required if [method _begin_customize_resources] returns [code]true[/code].
*/
func (class) _customize_resource(impl func(ptr unsafe.Pointer, resource objects.Resource, path gd.String) objects.Resource) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var resource = objects.Resource{pointers.New[classdb.Resource]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(resource[0])
		var path = pointers.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args, 1))
...
When enabled, [method _get_customization_configuration_hash] and [method _customize_scene] will be called and must be implemented.
*/
func (class) _begin_customize_scenes(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, features gd.PackedStringArray) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var features = pointers.New[gd.PackedStringArray](gd.UnsafeGet[[2]uintptr](p_args, 1))
...
Implementing this method is required if [method _begin_customize_scenes] returns [code]true[/code].
*/
func (class) _customize_scene(impl func(ptr unsafe.Pointer, scene objects.Node, path gd.String) objects.Node) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var scene = objects.Node{pointers.New[classdb.Node]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(scene[0])
		var path = pointers.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args, 1))
...
- [code]update_visibility[/code]: An optional boolean value. If set to [code]true[/code], the preset will emit [signal Object.property_list_changed] when the option is changed.
*/
func (class) _get_export_options(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform) gd.Array) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
[/codeblock]
*/
func (class) _get_export_options_overrides(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform) gd.Dictionary) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
Return [code]true[/code], if the result of [method _get_export_options] has changed and the export options of preset corresponding to [param platform] should be updated.
*/
func (class) _should_update_export_options(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
[b]Note:[/b] Use [method get_option] to check the value of the export options.
*/
func (class) _get_export_option_warning(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, option gd.String) gd.String) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var option = pointers.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args, 1))
...
Return a [PackedStringArray] of additional features this preset, for the given [param platform], should have.
*/
func (class) _get_export_features(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, debug bool) gd.PackedStringArray) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var debug = gd.UnsafeGet[bool](p_args, 1)
...
Return [code]true[/code] if the plugin supports the given [param platform].
*/
func (class) _supports_platform(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
*/
func (class) _get_android_dependencies(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, debug bool) gd.PackedStringArray) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var debug = gd.UnsafeGet[bool](p_args, 1)
...
[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
*/
func (class) _get_android_dependencies_maven_repos(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, debug bool) gd.PackedStringArray) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var debug = gd.UnsafeGet[bool](p_args, 1)
...
[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
*/
func (class) _get_android_libraries(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, debug bool) gd.PackedStringArray) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var debug = gd.UnsafeGet[bool](p_args, 1)
...
[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
*/
func (class) _get_android_manifest_activity_element_contents(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, debug bool) gd.String) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var debug = gd.UnsafeGet[bool](p_args, 1)
...
[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
*/
func (class) _get_android_manifest_application_element_contents(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, debug bool) gd.String) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var debug = gd.UnsafeGet[bool](p_args, 1)
...
[b]Note:[/b] Only supported on Android and requires [member EditorExportPlatformAndroid.gradle_build/use_gradle_build] to be enabled.
*/
func (class) _get_android_manifest_element_contents(impl func(ptr unsafe.Pointer, platform objects.EditorExportPlatform, debug bool) gd.String) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var platform = objects.EditorExportPlatform{pointers.New[classdb.EditorExportPlatform]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(platform[0])
		var debug = gd.UnsafeGet[bool](p_args, 1)
