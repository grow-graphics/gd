...
func (self Instance) SetAlbedoTexture(value objects.Texture2D) {
...
func (self Instance) OrmTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(17))
}

func (self Instance) SetOrmTexture(value objects.Texture2D) {
...
func (self Instance) MetallicTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(1))
}

func (self Instance) SetMetallicTexture(value objects.Texture2D) {
...
func (self Instance) RoughnessTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(2))
}

func (self Instance) SetRoughnessTexture(value objects.Texture2D) {
...
func (self Instance) EmissionTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(3))
}

func (self Instance) SetEmissionTexture(value objects.Texture2D) {
...
func (self Instance) NormalTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(4))
}
...
func (self Instance) RimTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(5))
}

func (self Instance) SetRimTexture(value objects.Texture2D) {
...
func (self Instance) ClearcoatTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(6))
}

func (self Instance) SetClearcoatTexture(value objects.Texture2D) {
...
func (self Instance) AnisotropyFlowmap() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(7))
}

func (self Instance) SetAnisotropyFlowmap(value objects.Texture2D) {
...
func (self Instance) AoTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(8))
}

func (self Instance) SetAoTexture(value objects.Texture2D) {
...
func (self Instance) HeightmapTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(9))
}

func (self Instance) SetHeightmapTexture(value objects.Texture2D) {
...
func (self Instance) SubsurfScatterTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(10))
}

func (self Instance) SetSubsurfScatterTexture(value objects.Texture2D) {
...
func (self Instance) SubsurfScatterTransmittanceTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(11))
}

func (self Instance) SetSubsurfScatterTransmittanceTexture(value objects.Texture2D) {
...
func (self Instance) BacklightTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(12))
}

func (self Instance) SetBacklightTexture(value objects.Texture2D) {
...
func (self Instance) RefractionTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(13))
}

func (self Instance) SetRefractionTexture(value objects.Texture2D) {
...
func (self Instance) DetailMask() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(14))
}

func (self Instance) SetDetailMask(value objects.Texture2D) {
...
func (self Instance) DetailAlbedo() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(15))
}

func (self Instance) SetDetailAlbedo(value objects.Texture2D) {
	class(self).SetTexture(15, value)
}

func (self Instance) DetailNormal() objects.Texture2D {
	return objects.Texture2D(class(self).GetTexture(16))
}

func (self Instance) SetDetailNormal(value objects.Texture2D) {
...
*/
//go:nosplit
func (self class) SetTexture(param classdb.BaseMaterial3DTextureParam, texture objects.Texture2D) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetTexture(param classdb.BaseMaterial3DTextureParam) objects.Texture2D {
	var frame = callframe.New()
	callframe.Arg(frame, param)
