...
*/
type Instance [1]classdb.VisualShaderNodeFresnel
...
func init() {
	classdb.Register("VisualShaderNodeFresnel", func(ptr gd.Object) any { return classdb.VisualShaderNodeFresnel(ptr) })
}
