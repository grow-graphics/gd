...
import "graphics.gd/objects/VisualShaderNodeExpression"
import "graphics.gd/objects/VisualShaderNodeGroupBase"
...
*/
type Instance [1]classdb.VisualShaderNodeGlobalExpression
type Any interface {
	gd.IsClass
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default:
		return gd.VirtualByName(self.AsVisualShaderNodeExpression(), name)
	}
}
...
func init() {
	classdb.Register("VisualShaderNodeGlobalExpression", func(ptr gd.Object) any { return classdb.VisualShaderNodeGlobalExpression(ptr) })
}
