...
func New() Instance {
	...
	return Instance{*(*classdb.GPUParticlesCollisionSphere3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("GPUParticlesCollisionSphere3D", func(ptr gd.Object) any {
		return [1]classdb.GPUParticlesCollisionSphere3D{*(*classdb.GPUParticlesCollisionSphere3D)(unsafe.Pointer(&ptr))}
	})
}
