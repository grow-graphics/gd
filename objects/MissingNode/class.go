...
func New() Instance {
	...
	return Instance{*(*classdb.MissingNode)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("MissingNode", func(ptr gd.Object) any { return [1]classdb.MissingNode{*(*classdb.MissingNode)(unsafe.Pointer(&ptr))} })
}
