...
func (self Instance) ButtonGroup() objects.ButtonGroup {
	return objects.ButtonGroup(class(self).GetButtonGroup())
}

func (self Instance) SetButtonGroup(value objects.ButtonGroup) {
...
//go:nosplit
func (self class) SetButtonGroup(button_group objects.ButtonGroup) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetButtonGroup() objects.ButtonGroup {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
