...
*/
func (self Instance) AppendFromFile(path string, state objects.GLTFState) gd.Error {
...
*/
func (self Instance) AppendFromBuffer(bytes []byte, base_path string, state objects.GLTFState) gd.Error {
...
*/
func (self Instance) AppendFromScene(node objects.Node, state objects.GLTFState) gd.Error {
...
*/
func (self Instance) WriteToFilesystem(state objects.GLTFState, path string) gd.Error {
...
*/
//go:nosplit
func (self class) AppendFromFile(path gd.String, state objects.GLTFState, flags gd.Int, base_path gd.String) int64 {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) AppendFromBuffer(bytes gd.PackedByteArray, base_path gd.String, state objects.GLTFState, flags gd.Int) int64 {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) AppendFromScene(node objects.Node, state objects.GLTFState, flags gd.Int) int64 {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) WriteToFilesystem(state objects.GLTFState, path gd.String) int64 {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(state[0])[0])
	callframe.Arg(frame, pointers.Get(path))
	var r_ret = callframe.Ret[int64](frame)
