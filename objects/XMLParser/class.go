...
[/codeblocks]
*/
type Instance [1]classdb.XMLParser

/*
Parses the next node in the file. This method returns an error code.
*/
func (self Instance) Read() gd.Error {
...
*/
func (self Instance) GetNodeType() classdb.XMLParserNodeType {
...
*/
func (self Instance) SeekTo(position int) gd.Error {
...
*/
func (self Instance) Open(file string) gd.Error {
...
*/
func (self Instance) OpenBuffer(buffer []byte) gd.Error {
