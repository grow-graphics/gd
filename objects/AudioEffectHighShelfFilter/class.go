...
import "grow.graphics/gd/objects/AudioEffectFilter"
...
func New() Instance {
	...
	return Instance{classdb.AudioEffectHighShelfFilter(object)}
}
...
func init() {
	classdb.Register("AudioEffectHighShelfFilter", func(ptr gd.Object) any { return classdb.AudioEffectHighShelfFilter(ptr) })
}
