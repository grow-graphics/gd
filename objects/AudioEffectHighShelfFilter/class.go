...
*/
type Instance [1]classdb.AudioEffectHighShelfFilter
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.AudioEffectHighShelfFilter)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("AudioEffectHighShelfFilter", func(ptr gd.Object) any {
		return [1]classdb.AudioEffectHighShelfFilter{*(*classdb.AudioEffectHighShelfFilter)(unsafe.Pointer(&ptr))}
	})
}
