...
func New() Instance {
	...
	return Instance{*(*classdb.Texture2DRD)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("Texture2DRD", func(ptr gd.Object) any { return [1]classdb.Texture2DRD{*(*classdb.Texture2DRD)(unsafe.Pointer(&ptr))} })
}
