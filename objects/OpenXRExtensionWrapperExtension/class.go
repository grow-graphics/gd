...
func New() Instance {
	...
	return Instance{*(*classdb.OpenXRExtensionWrapperExtension)(unsafe.Pointer(&object))}
}
...
func (self class) GetOpenxrApi() objects.OpenXRAPIExtension {
	...
	var ret = objects.OpenXRAPIExtension{gd.PointerWithOwnershipTransferredToGo[classdb.OpenXRAPIExtension](r_ret.Get())}
	frame.Free()
	return ret
}
...
func init() {
	classdb.Register("OpenXRExtensionWrapperExtension", func(ptr gd.Object) any {
		return [1]classdb.OpenXRExtensionWrapperExtension{*(*classdb.OpenXRExtensionWrapperExtension)(unsafe.Pointer(&ptr))}
	})
}
