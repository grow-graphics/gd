...
Implement this in GDExtension to handle the (re)sizing of a viewport.
*/
func (Instance) _configure(impl func(ptr unsafe.Pointer, config objects.RenderSceneBuffersConfiguration)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var config = objects.RenderSceneBuffersConfiguration{pointers.New[classdb.RenderSceneBuffersConfiguration]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
...
func New() Instance {
	...
	return Instance{*(*classdb.RenderSceneBuffersExtension)(unsafe.Pointer(&object))}
}

/*
Implement this in GDExtension to handle the (re)sizing of a viewport.
*/
func (class) _configure(impl func(ptr unsafe.Pointer, config objects.RenderSceneBuffersConfiguration)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var config = objects.RenderSceneBuffersConfiguration{pointers.New[classdb.RenderSceneBuffersConfiguration]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(config[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
func init() {
	classdb.Register("RenderSceneBuffersExtension", func(ptr gd.Object) any {
		return [1]classdb.RenderSceneBuffersExtension{*(*classdb.RenderSceneBuffersExtension)(unsafe.Pointer(&ptr))}
	})
}
