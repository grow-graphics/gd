...
[/codeblocks]
*/
type Instance [1]classdb.HMACContext

/*
Initializes the HMACContext. This method cannot be called again on the same HMACContext until [method finish] has been called.
*/
func (self Instance) Start(hash_type classdb.HashingContextHashType, key []byte) error {
...
*/
//go:nosplit
func (self class) Start(hash_type classdb.HashingContextHashType, key gd.PackedByteArray) error {
