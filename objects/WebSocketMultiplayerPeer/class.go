...
*/
//go:nosplit
func (self class) CreateClient(url gd.String, tls_client_options objects.TLSOptions) error {
...
*/
//go:nosplit
func (self class) CreateServer(port gd.Int, bind_address gd.String, tls_server_options objects.TLSOptions) error {
	var frame = callframe.New()
