...
func New() Instance {
	...
	return Instance{*(*classdb.PlaceholderTextureLayered)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("PlaceholderTextureLayered", func(ptr gd.Object) any {
		return [1]classdb.PlaceholderTextureLayered{*(*classdb.PlaceholderTextureLayered)(unsafe.Pointer(&ptr))}
	})
}
