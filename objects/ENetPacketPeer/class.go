...
*/
type Instance [1]classdb.ENetPacketPeer
...
*/
func (self Instance) Send(channel int, packet []byte, flags int) gd.Error {
...
*/
func (self Instance) GetState() classdb.ENetPacketPeerPeerState {
