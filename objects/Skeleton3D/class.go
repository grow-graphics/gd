...
*/
func (self Instance) RegisterSkin(skin objects.Skin) objects.SkinReference {
	return objects.SkinReference(class(self).RegisterSkin(skin))
}
...
//go:nosplit
func (self class) CreateSkinFromRestTransforms() objects.Skin {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) RegisterSkin(skin objects.Skin) objects.SkinReference {
	var frame = callframe.New()
