...
func (self Instance) Bitmask() objects.BitMap {
	return objects.BitMap(class(self).GetBitmask())
}

func (self Instance) SetBitmask(value objects.BitMap) {
...
//go:nosplit
func (self class) SetBitmask(bitmask objects.BitMap) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetBitmask() objects.BitMap {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
