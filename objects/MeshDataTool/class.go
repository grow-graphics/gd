...
*/
func (self Instance) CreateFromSurface(mesh objects.ArrayMesh, surface int) gd.Error {
...
*/
func (self Instance) CommitToSurface(mesh objects.ArrayMesh) gd.Error {
...
func New() Instance {
	...
	return Instance{classdb.MeshDataTool(object)}
}
...
*/
//go:nosplit
func (self class) CreateFromSurface(mesh objects.ArrayMesh, surface gd.Int) int64 {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) CommitToSurface(mesh objects.ArrayMesh, compression_flags gd.Int) int64 {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(mesh[0])[0])
