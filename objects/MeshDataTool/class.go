...
*/
type Instance [1]classdb.MeshDataTool
type Any interface {
	gd.IsClass
...
*/
func (self Instance) CreateFromSurface(mesh objects.ArrayMesh, surface int) error {
...
*/
func (self Instance) CommitToSurface(mesh objects.ArrayMesh) error {
...
*/
func (self Instance) GetMaterial() objects.Material {
...
func New() Instance {
	...
	return Instance{*(*classdb.MeshDataTool)(unsafe.Pointer(&object))}
}
...
*/
//go:nosplit
func (self class) CreateFromSurface(mesh objects.ArrayMesh, surface gd.Int) error {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) CommitToSurface(mesh objects.ArrayMesh, compression_flags gd.Int) error {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(mesh[0])[0])
...
func init() {
	classdb.Register("MeshDataTool", func(ptr gd.Object) any {
		return [1]classdb.MeshDataTool{*(*classdb.MeshDataTool)(unsafe.Pointer(&ptr))}
	})
}
