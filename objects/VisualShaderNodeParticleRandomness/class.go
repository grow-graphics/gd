...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeParticleRandomness)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("VisualShaderNodeParticleRandomness", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeParticleRandomness{*(*classdb.VisualShaderNodeParticleRandomness)(unsafe.Pointer(&ptr))}
	})
}
