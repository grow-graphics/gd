...
func New() Instance {
	...
	return Instance{*(*classdb.CapsuleShape3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("CapsuleShape3D", func(ptr gd.Object) any {
		return [1]classdb.CapsuleShape3D{*(*classdb.CapsuleShape3D)(unsafe.Pointer(&ptr))}
	})
}
