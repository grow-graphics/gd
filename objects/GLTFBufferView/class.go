...
*/
type Instance [1]classdb.GLTFBufferView
...
*/
func (self Instance) LoadBufferViewData(state objects.GLTFState) []byte {
...
*/
//go:nosplit
func (self class) LoadBufferViewData(state objects.GLTFState) gd.PackedByteArray {
