...
func New() Instance {
	...
	return Instance{*(*classdb.PhysicsDirectBodyState2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("PhysicsDirectBodyState2D", func(ptr gd.Object) any {
		return [1]classdb.PhysicsDirectBodyState2D{*(*classdb.PhysicsDirectBodyState2D)(unsafe.Pointer(&ptr))}
	})
}
