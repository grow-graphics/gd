...
*/
type Instance [1]classdb.VisualShaderNodeParticleRingEmitter
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeParticleRingEmitter)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("VisualShaderNodeParticleRingEmitter", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeParticleRingEmitter{*(*classdb.VisualShaderNodeParticleRingEmitter)(unsafe.Pointer(&ptr))}
	})
}
