...
*/
type Instance [1]classdb.GLTFAccessor
...
func (self Instance) AccessorType() classdb.GLTFAccessorGLTFAccessorType {
	return classdb.GLTFAccessorGLTFAccessorType(class(self).GetAccessorType())
}

func (self Instance) SetAccessorType(value classdb.GLTFAccessorGLTFAccessorType) {
