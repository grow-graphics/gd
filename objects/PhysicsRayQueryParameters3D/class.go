...
func New() Instance {
	...
	return Instance{*(*classdb.PhysicsRayQueryParameters3D)(unsafe.Pointer(&object))}
}
...
func (self class) Create(from gd.Vector3, to gd.Vector3, collision_mask gd.Int, exclude gd.Array) objects.PhysicsRayQueryParameters3D {
	...
	var ret = objects.PhysicsRayQueryParameters3D{gd.PointerWithOwnershipTransferredToGo[classdb.PhysicsRayQueryParameters3D](r_ret.Get())}
	frame.Free()
	return ret
}
...
func init() {
	classdb.Register("PhysicsRayQueryParameters3D", func(ptr gd.Object) any {
		return [1]classdb.PhysicsRayQueryParameters3D{*(*classdb.PhysicsRayQueryParameters3D)(unsafe.Pointer(&ptr))}
	})
}
