...
*/
func (self Instance) CreateSceneTile(packed_scene objects.PackedScene) int {
...
*/
func (self Instance) SetSceneTileScene(id int, packed_scene objects.PackedScene) {
...
*/
func (self Instance) GetSceneTileScene(id int) objects.PackedScene {
	return objects.PackedScene(class(self).GetSceneTileScene(gd.Int(id)))
}
...
*/
//go:nosplit
func (self class) CreateSceneTile(packed_scene objects.PackedScene, id_override gd.Int) gd.Int {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetSceneTileScene(id gd.Int, packed_scene objects.PackedScene) {
	var frame = callframe.New()
	callframe.Arg(frame, id)
	callframe.Arg(frame, pointers.Get(packed_scene[0])[0])
	var r_ret callframe.Nil
...
*/
//go:nosplit
func (self class) GetSceneTileScene(id gd.Int) objects.PackedScene {
	var frame = callframe.New()
	callframe.Arg(frame, id)
