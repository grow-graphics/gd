...
[b]Note:[/b] Theme items are [i]not[/i] [Object] properties. This means you can't access their values using [method Object.get] and [method Object.set]. Instead, use the [code]get_theme_*[/code] and [code]add_theme_*_override[/code] methods provided by this class.
	...
	type Control interface {
		...
		GuiInput(event objects.InputEvent)
	}
*/
type Instance [1]classdb.Control
...
[b]Note:[/b] Event position is relative to the control origin.
*/
func (Instance) _gui_input(impl func(ptr unsafe.Pointer, event objects.InputEvent)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
...
*/
func (self Instance) SetAnchorsPreset(preset classdb.ControlLayoutPreset) {
...
*/
func (self Instance) SetOffsetsPreset(preset classdb.ControlLayoutPreset) {
...
*/
func (self Instance) SetAnchorsAndOffsetsPreset(preset classdb.ControlLayoutPreset) {
...
*/
func (self Instance) FindPrevValidFocus() objects.Control {
	return objects.Control(class(self).FindPrevValidFocus())
}

/*
Finds the next (below in the tree) [Control] that can receive the focus.
*/
func (self Instance) FindNextValidFocus() objects.Control {
	return objects.Control(class(self).FindNextValidFocus())
}
...
*/
func (self Instance) GetParentControl() objects.Control {
	return objects.Control(class(self).GetParentControl())
}
...
[/codeblocks]
*/
func (self Instance) SetDragPreview(control objects.Control) {
...
func (self Instance) SetLayoutDirection(value classdb.ControlLayoutDirection) {
...
func (self Instance) GrowHorizontal() classdb.ControlGrowDirection {
	return classdb.ControlGrowDirection(class(self).GetHGrowDirection())
}

func (self Instance) SetGrowHorizontal(value classdb.ControlGrowDirection) {
	class(self).SetHGrowDirection(value)
}

func (self Instance) GrowVertical() classdb.ControlGrowDirection {
	return classdb.ControlGrowDirection(class(self).GetVGrowDirection())
}

func (self Instance) SetGrowVertical(value classdb.ControlGrowDirection) {
...
func (self Instance) SetSizeFlagsHorizontal(value classdb.ControlSizeFlags) {
	class(self).SetHSizeFlags(value)
}

func (self Instance) SizeFlagsVertical() classdb.ControlSizeFlags {
	return classdb.ControlSizeFlags(class(self).GetVSizeFlags())
}

func (self Instance) SetSizeFlagsVertical(value classdb.ControlSizeFlags) {
...
func (self Instance) SetFocusMode(value classdb.ControlFocusMode) {
	class(self).SetFocusMode(value)
}

func (self Instance) MouseFilter() classdb.ControlMouseFilter {
	return classdb.ControlMouseFilter(class(self).GetMouseFilter())
}

func (self Instance) SetMouseFilter(value classdb.ControlMouseFilter) {
...
func (self Instance) MouseDefaultCursorShape() classdb.ControlCursorShape {
	return classdb.ControlCursorShape(class(self).GetDefaultCursorShape())
}

func (self Instance) SetMouseDefaultCursorShape(value classdb.ControlCursorShape) {
	class(self).SetDefaultCursorShape(value)
}

func (self Instance) ShortcutContext() objects.Node {
	return objects.Node(class(self).GetShortcutContext())
}

func (self Instance) SetShortcutContext(value objects.Node) {
...
[b]Note:[/b] Event position is relative to the control origin.
*/
func (class) _gui_input(impl func(ptr unsafe.Pointer, event objects.InputEvent)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var event = objects.InputEvent{pointers.New[classdb.InputEvent]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(event[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
*/
//go:nosplit
func (self class) FindPrevValidFocus() objects.Control {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) FindNextValidFocus() objects.Control {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetParentControl() objects.Control {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
//go:nosplit
func (self class) SetShortcutContext(node objects.Node) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetShortcutContext() objects.Node {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func (self Instance) OnGuiInput(cb func(event objects.InputEvent)) {
