...
*/
func (self Instance) PushFont(font objects.Font) {
...
*/
//go:nosplit
func (self class) PushFont(font objects.Font, font_size gd.Int) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) PushDropcap(s gd.String, font objects.Font, size gd.Int, dropcap_margins gd.Rect2, color gd.Color, outline_size gd.Int, outline_color gd.Color) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) PushCustomfx(effect objects.RichTextEffect, env gd.Dictionary) {
	var frame = callframe.New()
