...
*/
var self objects.ProjectSettings
var once sync.Once

func singleton() {
	obj := gd.Global.Object.GetSingleton(gd.Global.Singletons.ProjectSettings)
	self = *(*objects.ProjectSettings)(unsafe.Pointer(&obj))
}
...
*/
//go:nosplit
func (self class) SaveCustom(file gd.String) error {
	var frame = callframe.New()
