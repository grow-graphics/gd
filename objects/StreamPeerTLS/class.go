...
*/
func (self Instance) AcceptStream(stream objects.StreamPeer, server_options objects.TLSOptions) error {
...
*/
//go:nosplit
func (self class) AcceptStream(stream objects.StreamPeer, server_options objects.TLSOptions) error {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) ConnectToStream(stream objects.StreamPeer, common_name gd.String, client_options objects.TLSOptions) error {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(stream[0])[0])
