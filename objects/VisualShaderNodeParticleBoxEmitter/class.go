...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeParticleBoxEmitter)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("VisualShaderNodeParticleBoxEmitter", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeParticleBoxEmitter{*(*classdb.VisualShaderNodeParticleBoxEmitter)(unsafe.Pointer(&ptr))}
	})
}
