...
func (self Instance) OnBodyEntered(cb func(body objects.Node3D)) {
	self[0].AsObject().Connect(gd.NewStringName("body_entered"), gd.NewCallable(cb), 0)
}

func (self Instance) OnBodyExited(cb func(body objects.Node3D)) {
...
func (self Instance) OnAreaEntered(cb func(area objects.Area3D)) {
	self[0].AsObject().Connect(gd.NewStringName("area_entered"), gd.NewCallable(cb), 0)
}

func (self Instance) OnAreaExited(cb func(area objects.Area3D)) {
