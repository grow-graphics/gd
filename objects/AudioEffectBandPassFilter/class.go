...
*/
type Instance [1]classdb.AudioEffectBandPassFilter
...
func init() {
	classdb.Register("AudioEffectBandPassFilter", func(ptr gd.Object) any { return classdb.AudioEffectBandPassFilter(ptr) })
}
