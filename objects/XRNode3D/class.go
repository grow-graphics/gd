...
*/
type Instance [1]classdb.XRNode3D
type Any interface {
	gd.IsClass
	AsXRNode3D() Instance
}
...
*/
func (self Instance) GetPose() objects.XRPose {
	return objects.XRPose(class(self).GetPose())
}
...
func New() Instance {
	...
	return Instance{*(*classdb.XRNode3D)(unsafe.Pointer(&object))}
}
...
*/
//go:nosplit
func (self class) GetPose() objects.XRPose {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func init() {
	classdb.Register("XRNode3D", func(ptr gd.Object) any { return [1]classdb.XRNode3D{*(*classdb.XRNode3D)(unsafe.Pointer(&ptr))} })
}
