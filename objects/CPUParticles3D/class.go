...
func New() Instance {
	...
	return Instance{*(*classdb.CPUParticles3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("CPUParticles3D", func(ptr gd.Object) any {
		return [1]classdb.CPUParticles3D{*(*classdb.CPUParticles3D)(unsafe.Pointer(&ptr))}
	})
}
