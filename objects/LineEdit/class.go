...
*/
type Instance [1]classdb.LineEdit
...
func (self Instance) VirtualKeyboardType() classdb.LineEditVirtualKeyboardType {
	return classdb.LineEditVirtualKeyboardType(class(self).GetVirtualKeyboardType())
}

func (self Instance) SetVirtualKeyboardType(value classdb.LineEditVirtualKeyboardType) {
...
func (self Instance) RightIcon() objects.Texture2D {
	return objects.Texture2D(class(self).GetRightIcon())
}

func (self Instance) SetRightIcon(value objects.Texture2D) {
...
//go:nosplit
func (self class) SetRightIcon(icon objects.Texture2D) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetRightIcon() objects.Texture2D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
