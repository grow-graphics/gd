...
*/
type Instance [1]classdb.CapsuleShape2D
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.CapsuleShape2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("CapsuleShape2D", func(ptr gd.Object) any {
		return [1]classdb.CapsuleShape2D{*(*classdb.CapsuleShape2D)(unsafe.Pointer(&ptr))}
	})
}
