...
func New() Instance {
	...
	return Instance{classdb.CapsuleShape2D(object)}
}
...
func init() {
	classdb.Register("CapsuleShape2D", func(ptr gd.Object) any { return [1]classdb.CapsuleShape2D{classdb.CapsuleShape2D(ptr)} })
}
