...
[/codeblocks]
*/
type Instance [1]classdb.DTLSServer

/*
Setup the DTLS server to use the given [param server_options]. See [method TLSOptions.server].
*/
func (self Instance) Setup(server_options objects.TLSOptions) gd.Error {
...
*/
func (self Instance) TakeConnection(udp_peer objects.PacketPeerUDP) objects.PacketPeerDTLS {
	return objects.PacketPeerDTLS(class(self).TakeConnection(udp_peer))
}
...
*/
//go:nosplit
func (self class) Setup(server_options objects.TLSOptions) int64 {
...
*/
//go:nosplit
func (self class) TakeConnection(udp_peer objects.PacketPeerUDP) objects.PacketPeerDTLS {
	var frame = callframe.New()
