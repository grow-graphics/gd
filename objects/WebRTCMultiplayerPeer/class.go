...
*/
func (self Instance) AddPeer(peer objects.WebRTCPeerConnection, peer_id int) error {
...
*/
//go:nosplit
func (self class) AddPeer(peer objects.WebRTCPeerConnection, peer_id gd.Int, unreliable_lifetime gd.Int) error {
	var frame = callframe.New()
