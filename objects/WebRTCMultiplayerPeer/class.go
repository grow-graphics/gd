...
*/
type Instance [1]classdb.WebRTCMultiplayerPeer
...
*/
func (self Instance) CreateServer() gd.Error {
...
You can optionally specify a [param channels_config] array of [enum MultiplayerPeer.TransferMode] which will be used to create extra channels (WebRTC only supports one transfer mode per channel).
*/
func (self Instance) CreateClient(peer_id int) gd.Error {
...
*/
func (self Instance) CreateMesh(peer_id int) gd.Error {
...
*/
func (self Instance) AddPeer(peer objects.WebRTCPeerConnection, peer_id int) gd.Error {
...
*/
//go:nosplit
func (self class) AddPeer(peer objects.WebRTCPeerConnection, peer_id gd.Int, unreliable_lifetime gd.Int) int64 {
	var frame = callframe.New()
...
func init() {
	classdb.Register("WebRTCMultiplayerPeer", func(ptr gd.Object) any { return classdb.WebRTCMultiplayerPeer(ptr) })
}
