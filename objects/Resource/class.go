...
*/
func (self Instance) GetLocalScene() objects.Node {
	return objects.Node(class(self).GetLocalScene())
}
...
*/
func (self Instance) Duplicate() objects.Resource {
	return objects.Resource(class(self).Duplicate(false))
}
...
func New() Instance {
	...
	return Instance{*(*classdb.Resource)(unsafe.Pointer(&object))}
}
...
*/
//go:nosplit
func (self class) GetLocalScene() objects.Node {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) Duplicate(subresources bool) objects.Resource {
	var frame = callframe.New()
...
func init() {
	classdb.Register("Resource", func(ptr gd.Object) any { return [1]classdb.Resource{*(*classdb.Resource)(unsafe.Pointer(&ptr))} })
}
