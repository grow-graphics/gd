...
*/
func (self Instance) ConnectToPeer(packet_peer objects.PacketPeerUDP, hostname string) gd.Error {
	return gd.Error(class(self).ConnectToPeer(packet_peer, gd.NewString(hostname), ([1]objects.TLSOptions{}[0])))
}
...
*/
//go:nosplit
func (self class) ConnectToPeer(packet_peer objects.PacketPeerUDP, hostname gd.String, client_options objects.TLSOptions) int64 {
	var frame = callframe.New()
