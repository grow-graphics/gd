...
*/
func (self Instance) GetLineObjects(line int) Array.Any {
	return Array.Any(class(self).GetLineObjects(gd.Int(line)))
}
...
func New() Instance {
	...
	return Instance{*(*classdb.TextParagraph)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("TextParagraph", func(ptr gd.Object) any {
		return [1]classdb.TextParagraph{*(*classdb.TextParagraph)(unsafe.Pointer(&ptr))}
	})
}
