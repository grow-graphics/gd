...
*/
var self objects.DisplayServer
var once sync.Once

func singleton() {
	obj := gd.Global.Object.GetSingleton(gd.Global.Singletons.DisplayServer)
	self = *(*objects.DisplayServer)(unsafe.Pointer(&obj))
}
...
[b]Note:[/b] This method is implemented only on macOS.
*/
func GlobalMenuGetItemIcon(menu_root string, idx int) objects.Texture2D {
	once.Do(singleton)
	return objects.Texture2D(class(self).GlobalMenuGetItemIcon(gd.NewString(menu_root), gd.Int(idx)))
}
...
*/
func GlobalMenuSetItemIcon(menu_root string, idx int, icon objects.Texture2D) {
	once.Do(singleton)
...
*/
func ClipboardGetImage() objects.Image {
	once.Do(singleton)
	return objects.Image(class(self).ClipboardGetImage())
}
...
[b]Note:[/b] On macOS, this method requires "Screen Recording" permission, if permission is not granted it will return desktop wallpaper color.
*/
func ScreenGetImage() objects.Image {
	once.Do(singleton)
	return objects.Image(class(self).ScreenGetImage(gd.Int(-1)))
}
...
*/
func SetIcon(image objects.Image) {
	once.Do(singleton)
...
[b]Note:[/b] This method is implemented on macOS and Windows.
*/
func StatusIndicatorSetIcon(id int, icon objects.Texture2D) {
	once.Do(singleton)
...
*/
//go:nosplit
func (self class) GlobalMenuGetItemIcon(menu_root gd.String, idx gd.Int) objects.Texture2D {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(menu_root))
	callframe.Arg(frame, idx)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GlobalMenuSetItemIcon(menu_root gd.String, idx gd.Int, icon objects.Texture2D) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(menu_root))
	callframe.Arg(frame, idx)
	callframe.Arg(frame, pointers.Get(icon[0])[0])
...
*/
//go:nosplit
func (self class) ClipboardGetImage() objects.Image {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) ScreenGetImage(screen gd.Int) objects.Image {
	var frame = callframe.New()
	callframe.Arg(frame, screen)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) CursorSetCustomImage(cursor objects.Resource, shape classdb.DisplayServerCursorShape, hotspot gd.Vector2) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetIcon(image objects.Image) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) CreateStatusIndicator(icon objects.Texture2D, tooltip gd.String, callback gd.Callable) gd.Int {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(icon[0])[0])
	callframe.Arg(frame, pointers.Get(tooltip))
	callframe.Arg(frame, pointers.Get(callback))
...
*/
//go:nosplit
func (self class) StatusIndicatorSetIcon(id gd.Int, icon objects.Texture2D) {
	var frame = callframe.New()
