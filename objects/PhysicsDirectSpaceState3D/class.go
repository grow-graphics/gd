...
*/
type Instance [1]classdb.PhysicsDirectSpaceState3D
type Any interface {
	gd.IsClass
...
*/
func (self Instance) IntersectPoint(parameters objects.PhysicsPointQueryParameters3D) gd.Array {
...
*/
func (self Instance) IntersectRay(parameters objects.PhysicsRayQueryParameters3D) Dictionary.Any {
...
*/
func (self Instance) IntersectShape(parameters objects.PhysicsShapeQueryParameters3D) gd.Array {
...
*/
func (self Instance) CastMotion(parameters objects.PhysicsShapeQueryParameters3D) []float32 {
...
[b]Note:[/b] This method does not take into account the [code]motion[/code] property of the object.
*/
func (self Instance) CollideShape(parameters objects.PhysicsShapeQueryParameters3D) gd.Array {
...
[b]Note:[/b] This method does not take into account the [code]motion[/code] property of the object.
*/
func (self Instance) GetRestInfo(parameters objects.PhysicsShapeQueryParameters3D) Dictionary.Any {
...
func New() Instance {
	...
	return Instance{*(*classdb.PhysicsDirectSpaceState3D)(unsafe.Pointer(&object))}
}
...
*/
//go:nosplit
func (self class) IntersectPoint(parameters objects.PhysicsPointQueryParameters3D, max_results gd.Int) gd.Array {
...
*/
//go:nosplit
func (self class) IntersectRay(parameters objects.PhysicsRayQueryParameters3D) gd.Dictionary {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(parameters[0])[0])
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) IntersectShape(parameters objects.PhysicsShapeQueryParameters3D, max_results gd.Int) gd.Array {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(parameters[0])[0])
	callframe.Arg(frame, max_results)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) CastMotion(parameters objects.PhysicsShapeQueryParameters3D) gd.PackedFloat32Array {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(parameters[0])[0])
...
*/
//go:nosplit
func (self class) CollideShape(parameters objects.PhysicsShapeQueryParameters3D, max_results gd.Int) gd.Array {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(parameters[0])[0])
	callframe.Arg(frame, max_results)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetRestInfo(parameters objects.PhysicsShapeQueryParameters3D) gd.Dictionary {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(parameters[0])[0])
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func init() {
	classdb.Register("PhysicsDirectSpaceState3D", func(ptr gd.Object) any {
		return [1]classdb.PhysicsDirectSpaceState3D{*(*classdb.PhysicsDirectSpaceState3D)(unsafe.Pointer(&ptr))}
	})
}
