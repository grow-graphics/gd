...
func (self Instance) LayerViewport() objects.SubViewport {
	return objects.SubViewport(class(self).GetLayerViewport())
}

func (self Instance) SetLayerViewport(value objects.SubViewport) {
...
//go:nosplit
func (self class) SetLayerViewport(viewport objects.SubViewport) {
...
//go:nosplit
func (self class) GetLayerViewport() objects.SubViewport {
	var frame = callframe.New()
