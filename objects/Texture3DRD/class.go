...
func New() Instance {
	...
	return Instance{*(*classdb.Texture3DRD)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("Texture3DRD", func(ptr gd.Object) any { return [1]classdb.Texture3DRD{*(*classdb.Texture3DRD)(unsafe.Pointer(&ptr))} })
}
