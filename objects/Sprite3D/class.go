...
func New() Instance {
	...
	return Instance{*(*classdb.Sprite3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("Sprite3D", func(ptr gd.Object) any { return [1]classdb.Sprite3D{*(*classdb.Sprite3D)(unsafe.Pointer(&ptr))} })
}
