...
*/
type Instance [1]classdb.PanoramaSkyMaterial
type Any interface {
	gd.IsClass
...
func (self Instance) Panorama() objects.Texture2D {
	return objects.Texture2D(class(self).GetPanorama())
}

func (self Instance) SetPanorama(value objects.Texture2D) {
...
//go:nosplit
func (self class) SetPanorama(texture objects.Texture2D) {
...
//go:nosplit
func (self class) GetPanorama() objects.Texture2D {
	var frame = callframe.New()
