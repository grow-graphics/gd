...
import "grow.graphics/gd/objects/PlaceholderTextureLayered"
...
*/
type Instance [1]classdb.PlaceholderTexture2DArray
...
func init() {
	classdb.Register("PlaceholderTexture2DArray", func(ptr gd.Object) any { return classdb.PlaceholderTexture2DArray(ptr) })
}
