...
func (self Instance) FileMode() classdb.FileDialogFileMode {
	return classdb.FileDialogFileMode(class(self).GetFileMode())
}

func (self Instance) SetFileMode(value classdb.FileDialogFileMode) {
	class(self).SetFileMode(value)
}

func (self Instance) Access() classdb.FileDialogAccess {
	return classdb.FileDialogAccess(class(self).GetAccess())
}

func (self Instance) SetAccess(value classdb.FileDialogAccess) {
