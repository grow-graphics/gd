...
func New() Instance {
	...
	return Instance{*(*classdb.PlaceholderTexture2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("PlaceholderTexture2D", func(ptr gd.Object) any {
		return [1]classdb.PlaceholderTexture2D{*(*classdb.PlaceholderTexture2D)(unsafe.Pointer(&ptr))}
	})
}
