...
func New() Instance {
	...
	return Instance{*(*classdb.GLTFPhysicsBody)(unsafe.Pointer(&object))}
}
...
func (self class) FromNode(body_node objects.CollisionObject3D) objects.GLTFPhysicsBody {
	...
	var ret = objects.GLTFPhysicsBody{gd.PointerWithOwnershipTransferredToGo[classdb.GLTFPhysicsBody](r_ret.Get())}
	frame.Free()
	return ret
}
...
func (self class) ToNode() objects.CollisionObject3D {
	...
	var ret = objects.CollisionObject3D{gd.PointerWithOwnershipTransferredToGo[classdb.CollisionObject3D](r_ret.Get())}
	frame.Free()
	return ret
}
...
func init() {
	classdb.Register("GLTFPhysicsBody", func(ptr gd.Object) any {
		return [1]classdb.GLTFPhysicsBody{*(*classdb.GLTFPhysicsBody)(unsafe.Pointer(&ptr))}
	})
}
