...
func (self Instance) EnvironmentCustomSky() objects.Sky {
	return objects.Sky(class(self).GetEnvironmentCustomSky())
}

func (self Instance) SetEnvironmentCustomSky(value objects.Sky) {
...
func (self Instance) LightData() objects.LightmapGIData {
	return objects.LightmapGIData(class(self).GetLightData())
}

func (self Instance) SetLightData(value objects.LightmapGIData) {
	class(self).SetLightData(value)
}

//go:nosplit
func (self class) SetLightData(data objects.LightmapGIData) {
...
//go:nosplit
func (self class) GetLightData() objects.LightmapGIData {
	var frame = callframe.New()
...
//go:nosplit
func (self class) SetEnvironmentCustomSky(sky objects.Sky) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetEnvironmentCustomSky() objects.Sky {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
