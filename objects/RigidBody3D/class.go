...
func New() Instance {
	...
	return Instance{*(*classdb.RigidBody3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("RigidBody3D", func(ptr gd.Object) any { return [1]classdb.RigidBody3D{*(*classdb.RigidBody3D)(unsafe.Pointer(&ptr))} })
}
