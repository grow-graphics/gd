...
func New() Instance {
	...
	return Instance{*(*classdb.RenderSceneData)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("RenderSceneData", func(ptr gd.Object) any {
		return [1]classdb.RenderSceneData{*(*classdb.RenderSceneData)(unsafe.Pointer(&ptr))}
	})
}
