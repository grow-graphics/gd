...
func singleton() {
	...
	self = *(*objects.IP)(unsafe.Pointer(&obj))
}
...
func (self class) GetResolveItemStatus(id gd.Int) classdb.IPResolverStatus {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.IP.Bind_get_resolve_item_status, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
