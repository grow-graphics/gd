...
[/codeblocks]
*/
func (self Instance) AddAnimationLibrary(name string, library objects.AnimationLibrary) gd.Error {
...
*/
func (self Instance) GetAnimationLibrary(name string) objects.AnimationLibrary {
	return objects.AnimationLibrary(class(self).GetAnimationLibrary(gd.NewStringName(name)))
}
...
*/
func (self Instance) FindAnimation(animation objects.Animation) string {
...
*/
func (self Instance) FindAnimationLibrary(animation objects.Animation) string {
...
func (self Instance) CallbackModeProcess() classdb.AnimationMixerAnimationCallbackModeProcess {
	return classdb.AnimationMixerAnimationCallbackModeProcess(class(self).GetCallbackModeProcess())
}

func (self Instance) SetCallbackModeProcess(value classdb.AnimationMixerAnimationCallbackModeProcess) {
	class(self).SetCallbackModeProcess(value)
}

func (self Instance) CallbackModeMethod() classdb.AnimationMixerAnimationCallbackModeMethod {
	return classdb.AnimationMixerAnimationCallbackModeMethod(class(self).GetCallbackModeMethod())
}

func (self Instance) SetCallbackModeMethod(value classdb.AnimationMixerAnimationCallbackModeMethod) {
	class(self).SetCallbackModeMethod(value)
}

func (self Instance) CallbackModeDiscrete() classdb.AnimationMixerAnimationCallbackModeDiscrete {
	return classdb.AnimationMixerAnimationCallbackModeDiscrete(class(self).GetCallbackModeDiscrete())
}

func (self Instance) SetCallbackModeDiscrete(value classdb.AnimationMixerAnimationCallbackModeDiscrete) {
...
A virtual function for processing after getting a key during playback.
*/
func (class) _post_process_key_value(impl func(ptr unsafe.Pointer, animation objects.Animation, track gd.Int, value gd.Variant, object_id gd.Int, object_sub_idx gd.Int) gd.Variant) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var animation = objects.Animation{pointers.New[classdb.Animation]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(animation[0])
		var track = gd.UnsafeGet[gd.Int](p_args, 1)
...
*/
//go:nosplit
func (self class) AddAnimationLibrary(name gd.StringName, library objects.AnimationLibrary) int64 {
...
*/
//go:nosplit
func (self class) GetAnimationLibrary(name gd.StringName) objects.AnimationLibrary {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(name))
...
*/
//go:nosplit
func (self class) FindAnimation(animation objects.Animation) gd.StringName {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) FindAnimationLibrary(animation objects.Animation) gd.StringName {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(animation[0])[0])
	var r_ret = callframe.Ret[[1]uintptr](frame)
