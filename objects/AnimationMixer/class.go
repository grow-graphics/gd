...
[/codeblocks]
*/
func (self Instance) AddAnimationLibrary(name string, library objects.AnimationLibrary) error {
...
*/
//go:nosplit
func (self class) AddAnimationLibrary(name gd.StringName, library objects.AnimationLibrary) error {
