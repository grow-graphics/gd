...
func New() Instance {
	...
	return Instance{classdb.ResourceImporterMP3(object)}
}
...
func init() {
	classdb.Register("ResourceImporterMP3", func(ptr gd.Object) any { return [1]classdb.ResourceImporterMP3{classdb.ResourceImporterMP3(ptr)} })
}
