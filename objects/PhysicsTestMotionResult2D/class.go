...
func New() Instance {
	...
	return Instance{*(*classdb.PhysicsTestMotionResult2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("PhysicsTestMotionResult2D", func(ptr gd.Object) any {
		return [1]classdb.PhysicsTestMotionResult2D{*(*classdb.PhysicsTestMotionResult2D)(unsafe.Pointer(&ptr))}
	})
}
