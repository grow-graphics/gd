...
*/
type Instance [1]classdb.VisualShaderNodeTransformCompose
...
func init() {
	classdb.Register("VisualShaderNodeTransformCompose", func(ptr gd.Object) any { return classdb.VisualShaderNodeTransformCompose(ptr) })
}
