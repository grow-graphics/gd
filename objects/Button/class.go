...
func New() Instance {
	...
	return Instance{*(*classdb.Button)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("Button", func(ptr gd.Object) any { return [1]classdb.Button{*(*classdb.Button)(unsafe.Pointer(&ptr))} })
}
