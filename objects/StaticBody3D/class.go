...
func New() Instance {
	...
	return Instance{*(*classdb.StaticBody3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("StaticBody3D", func(ptr gd.Object) any {
		return [1]classdb.StaticBody3D{*(*classdb.StaticBody3D)(unsafe.Pointer(&ptr))}
	})
}
