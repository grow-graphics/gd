...
*/
type Instance [1]classdb.LinkButton
type Any interface {
	gd.IsClass
...
func (self Instance) Underline() classdb.LinkButtonUnderlineMode {
	return classdb.LinkButtonUnderlineMode(class(self).GetUnderlineMode())
}

func (self Instance) SetUnderline(value classdb.LinkButtonUnderlineMode) {
