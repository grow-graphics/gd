...
import "graphics.gd/objects/RenderSceneBuffers"
...
*/
func (self Instance) GetTextureFormat(context string, name string) objects.RDTextureFormat {
	return objects.RDTextureFormat(class(self).GetTextureFormat(gd.NewStringName(context), gd.NewStringName(name)))
}
...
*/
//go:nosplit
func (self class) CreateTextureFromFormat(context gd.StringName, name gd.StringName, format objects.RDTextureFormat, view objects.RDTextureView, unique bool) gd.RID {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(context))
	callframe.Arg(frame, pointers.Get(name))
...
*/
//go:nosplit
func (self class) CreateTextureView(context gd.StringName, name gd.StringName, view_name gd.StringName, view objects.RDTextureView) gd.RID {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(context))
	callframe.Arg(frame, pointers.Get(name))
...
*/
//go:nosplit
func (self class) GetTextureFormat(context gd.StringName, name gd.StringName) objects.RDTextureFormat {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(context))
	callframe.Arg(frame, pointers.Get(name))
...
*/
//go:nosplit
func (self class) GetTextureSliceView(context gd.StringName, name gd.StringName, layer gd.Int, mipmap gd.Int, layers gd.Int, mipmaps gd.Int, view objects.RDTextureView) gd.RID {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(context))
	callframe.Arg(frame, pointers.Get(name))
	callframe.Arg(frame, layer)
