...
*/
func (self Instance) GetPicker() objects.ColorPicker {
	return objects.ColorPicker(class(self).GetPicker())
}
...
*/
func (self Instance) GetPopup() objects.PopupPanel {
	return objects.PopupPanel(class(self).GetPopup())
}
...
*/
//go:nosplit
func (self class) GetPicker() objects.ColorPicker {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetPopup() objects.PopupPanel {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
