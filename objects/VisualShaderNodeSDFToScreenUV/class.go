...
*/
type Instance [1]classdb.VisualShaderNodeSDFToScreenUV
...
func init() {
	classdb.Register("VisualShaderNodeSDFToScreenUV", func(ptr gd.Object) any { return classdb.VisualShaderNodeSDFToScreenUV(ptr) })
}
