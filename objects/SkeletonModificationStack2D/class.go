...
*/
type Instance [1]classdb.SkeletonModificationStack2D
...
*/
func (self Instance) GetModification(mod_idx int) objects.SkeletonModification2D {
	return objects.SkeletonModification2D(class(self).GetModification(gd.Int(mod_idx)))
}

/*
Adds the passed-in [SkeletonModification2D] to the stack.
*/
func (self Instance) AddModification(modification objects.SkeletonModification2D) {
...
*/
func (self Instance) SetModification(mod_idx int, modification objects.SkeletonModification2D) {
...
*/
func (self Instance) GetSkeleton() objects.Skeleton2D {
	return objects.Skeleton2D(class(self).GetSkeleton())
}
...
*/
//go:nosplit
func (self class) GetModification(mod_idx gd.Int) objects.SkeletonModification2D {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) AddModification(modification objects.SkeletonModification2D) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetModification(mod_idx gd.Int, modification objects.SkeletonModification2D) {
	var frame = callframe.New()
	callframe.Arg(frame, mod_idx)
	callframe.Arg(frame, pointers.Get(modification[0])[0])
	var r_ret callframe.Nil
...
*/
//go:nosplit
func (self class) GetSkeleton() objects.Skeleton2D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func init() {
	classdb.Register("SkeletonModificationStack2D", func(ptr gd.Object) any { return classdb.SkeletonModificationStack2D(ptr) })
}
