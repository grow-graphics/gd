...
func New() Instance {
	...
	return Instance{*(*classdb.RDPipelineRasterizationState)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("RDPipelineRasterizationState", func(ptr gd.Object) any {
		return [1]classdb.RDPipelineRasterizationState{*(*classdb.RDPipelineRasterizationState)(unsafe.Pointer(&ptr))}
	})
}
