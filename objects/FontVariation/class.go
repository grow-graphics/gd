...
func (self Instance) BaseFont() objects.Font {
	return objects.Font(class(self).GetBaseFont())
}

func (self Instance) SetBaseFont(value objects.Font) {
...
//go:nosplit
func (self class) SetBaseFont(font objects.Font) {
...
//go:nosplit
func (self class) GetBaseFont() objects.Font {
	var frame = callframe.New()
