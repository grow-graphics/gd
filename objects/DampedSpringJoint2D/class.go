...
func New() Instance {
	...
	return Instance{*(*classdb.DampedSpringJoint2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("DampedSpringJoint2D", func(ptr gd.Object) any {
		return [1]classdb.DampedSpringJoint2D{*(*classdb.DampedSpringJoint2D)(unsafe.Pointer(&ptr))}
	})
}
