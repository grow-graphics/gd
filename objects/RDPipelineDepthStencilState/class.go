...
func New() Instance {
	...
	return Instance{*(*classdb.RDPipelineDepthStencilState)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("RDPipelineDepthStencilState", func(ptr gd.Object) any {
		return [1]classdb.RDPipelineDepthStencilState{*(*classdb.RDPipelineDepthStencilState)(unsafe.Pointer(&ptr))}
	})
}
