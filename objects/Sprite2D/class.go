...
*/
type Instance [1]classdb.Sprite2D
type Any interface {
	gd.IsClass
	AsSprite2D() Instance
}
...
func New() Instance {
	...
	return Instance{*(*classdb.Sprite2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("Sprite2D", func(ptr gd.Object) any { return [1]classdb.Sprite2D{*(*classdb.Sprite2D)(unsafe.Pointer(&ptr))} })
}
