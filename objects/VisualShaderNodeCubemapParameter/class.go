...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeCubemapParameter)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("VisualShaderNodeCubemapParameter", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeCubemapParameter{*(*classdb.VisualShaderNodeCubemapParameter)(unsafe.Pointer(&ptr))}
	})
}
