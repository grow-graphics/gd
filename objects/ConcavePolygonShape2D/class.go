...
func New() Instance {
	...
	return Instance{*(*classdb.ConcavePolygonShape2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("ConcavePolygonShape2D", func(ptr gd.Object) any {
		return [1]classdb.ConcavePolygonShape2D{*(*classdb.ConcavePolygonShape2D)(unsafe.Pointer(&ptr))}
	})
}
