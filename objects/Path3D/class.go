...
func (self Instance) Curve() objects.Curve3D {
	return objects.Curve3D(class(self).GetCurve())
}

func (self Instance) SetCurve(value objects.Curve3D) {
	class(self).SetCurve(value)
}

//go:nosplit
func (self class) SetCurve(curve objects.Curve3D) {
...
//go:nosplit
func (self class) GetCurve() objects.Curve3D {
	var frame = callframe.New()
