...
*/
func (self Instance) FindWorld2d() objects.World2D {
	return objects.World2D(class(self).FindWorld2d())
}
...
[/codeblock]
*/
func (self Instance) GetTexture() objects.ViewportTexture {
	return objects.ViewportTexture(class(self).GetTexture())
}
...
*/
func (self Instance) PushInput(event objects.InputEvent) {
...
*/
func (self Instance) PushUnhandledInput(event objects.InputEvent) {
...
*/
func (self Instance) GuiGetFocusOwner() objects.Control {
	return objects.Control(class(self).GuiGetFocusOwner())
}
...
*/
func (self Instance) GuiGetHoveredControl() objects.Control {
	return objects.Control(class(self).GuiGetHoveredControl())
}
...
*/
func (self Instance) GetCamera2d() objects.Camera2D {
	return objects.Camera2D(class(self).GetCamera2d())
}
...
*/
func (self Instance) FindWorld3d() objects.World3D {
	return objects.World3D(class(self).FindWorld3d())
}

/*
Returns the currently active 3D camera.
*/
func (self Instance) GetCamera3d() objects.Camera3D {
	return objects.Camera3D(class(self).GetCamera3d())
}
...
func (self Instance) World3d() objects.World3D {
	return objects.World3D(class(self).GetWorld3d())
}

func (self Instance) SetWorld3d(value objects.World3D) {
	class(self).SetWorld3d(value)
}

func (self Instance) World2d() objects.World2D {
	return objects.World2D(class(self).GetWorld2d())
}

func (self Instance) SetWorld2d(value objects.World2D) {
...
func (self Instance) VrsTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetVrsTexture())
}

func (self Instance) SetVrsTexture(value objects.Texture2D) {
...
//go:nosplit
func (self class) SetWorld2d(world_2d objects.World2D) {
...
*/
//go:nosplit
func (self class) FindWorld2d() objects.World2D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetTexture() objects.ViewportTexture {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) PushInput(event objects.InputEvent, in_local_coords bool) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) PushUnhandledInput(event objects.InputEvent, in_local_coords bool) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(event[0])[0])
	callframe.Arg(frame, in_local_coords)
	var r_ret callframe.Nil
...
*/
//go:nosplit
func (self class) GuiGetFocusOwner() objects.Control {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GuiGetHoveredControl() objects.Control {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetCamera2d() objects.Camera2D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
//go:nosplit
func (self class) SetWorld3d(world_3d objects.World3D) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetWorld3d() objects.World3D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) FindWorld3d() objects.World3D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetCamera3d() objects.Camera3D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
//go:nosplit
func (self class) SetVrsTexture(texture objects.Texture2D) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetVrsTexture() objects.Texture2D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func (self Instance) OnGuiFocusChanged(cb func(node objects.Control)) {
