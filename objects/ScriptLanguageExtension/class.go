...
func (Instance) _make_template(impl func(ptr unsafe.Pointer, template string, class_name string, base_class_name string) objects.Script) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
...
func (Instance) _open_in_external_editor(impl func(ptr unsafe.Pointer, script objects.Script, line int, column int) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
...
func (Instance) _reload_tool_script(impl func(ptr unsafe.Pointer, script objects.Script, soft_reload bool)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var script = objects.Script{pointers.New[classdb.Script]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(script[0])
...
func (class) _make_template(impl func(ptr unsafe.Pointer, template gd.String, class_name gd.String, base_class_name gd.String) objects.Script) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var template = pointers.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args, 0))
		var class_name = pointers.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args, 1))
		var base_class_name = pointers.New[gd.String](gd.UnsafeGet[[1]uintptr](p_args, 2))
...
func (class) _open_in_external_editor(impl func(ptr unsafe.Pointer, script objects.Script, line gd.Int, column gd.Int) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var script = objects.Script{pointers.New[classdb.Script]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(script[0])
		var line = gd.UnsafeGet[gd.Int](p_args, 1)
...
func (class) _reload_tool_script(impl func(ptr unsafe.Pointer, script objects.Script, soft_reload bool)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var script = objects.Script{pointers.New[classdb.Script]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(script[0])
		var soft_reload = gd.UnsafeGet[bool](p_args, 1)
