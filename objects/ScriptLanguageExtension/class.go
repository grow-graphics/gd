...
func (Instance) _open_in_external_editor(impl func(ptr unsafe.Pointer, script objects.Script, line int, column int) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
...
func (class) _open_in_external_editor(impl func(ptr unsafe.Pointer, script objects.Script, line gd.Int, column gd.Int) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var script = objects.Script{pointers.New[classdb.Script]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(script[0])
		var line = gd.UnsafeGet[gd.Int](p_args, 1)
