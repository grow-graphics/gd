...
func New() Instance {
	...
	return Instance{*(*classdb.BoneAttachment3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("BoneAttachment3D", func(ptr gd.Object) any {
		return [1]classdb.BoneAttachment3D{*(*classdb.BoneAttachment3D)(unsafe.Pointer(&ptr))}
	})
}
