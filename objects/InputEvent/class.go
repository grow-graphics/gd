...
func New() Instance {
	...
	return Instance{*(*classdb.InputEvent)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("InputEvent", func(ptr gd.Object) any { return [1]classdb.InputEvent{*(*classdb.InputEvent)(unsafe.Pointer(&ptr))} })
}
