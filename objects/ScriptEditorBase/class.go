...
*/
func (self Instance) GetBaseEditor() objects.Control {
	return objects.Control(class(self).GetBaseEditor())
}

/*
Adds a [EditorSyntaxHighlighter] to the open script.
*/
func (self Instance) AddSyntaxHighlighter(highlighter objects.EditorSyntaxHighlighter) {
...
*/
//go:nosplit
func (self class) GetBaseEditor() objects.Control {
...
*/
//go:nosplit
func (self class) AddSyntaxHighlighter(highlighter objects.EditorSyntaxHighlighter) {
	var frame = callframe.New()
