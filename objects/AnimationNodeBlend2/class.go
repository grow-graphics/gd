...
func New() Instance {
	...
	return Instance{*(*classdb.AnimationNodeBlend2)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("AnimationNodeBlend2", func(ptr gd.Object) any {
		return [1]classdb.AnimationNodeBlend2{*(*classdb.AnimationNodeBlend2)(unsafe.Pointer(&ptr))}
	})
}
