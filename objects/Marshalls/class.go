...
*/
var self objects.Marshalls
var once sync.Once

func singleton() {
	obj := gd.Global.Object.GetSingleton(gd.Global.Singletons.Marshalls)
	self = *(*objects.Marshalls)(unsafe.Pointer(&obj))
}
...
func init() {
	classdb.Register("Marshalls", func(ptr gd.Object) any { return [1]classdb.Marshalls{*(*classdb.Marshalls)(unsafe.Pointer(&ptr))} })
}
