...
func New() Instance {
	...
	return Instance{*(*classdb.RDPipelineColorBlendStateAttachment)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("RDPipelineColorBlendStateAttachment", func(ptr gd.Object) any {
		return [1]classdb.RDPipelineColorBlendStateAttachment{*(*classdb.RDPipelineColorBlendStateAttachment)(unsafe.Pointer(&ptr))}
	})
}
