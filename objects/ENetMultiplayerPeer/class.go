...
*/
type Instance [1]classdb.ENetMultiplayerPeer
...
*/
func (self Instance) CreateClient(address string, port int) gd.Error {
...
*/
func (self Instance) CreateMesh(unique_id int) gd.Error {
...
*/
func (self Instance) AddMeshPeer(peer_id int, host objects.ENetConnection) gd.Error {
...
*/
func (self Instance) GetPeer(id int) objects.ENetPacketPeer {
	return objects.ENetPacketPeer(class(self).GetPeer(gd.Int(id)))
}
...
func (self Instance) Host() objects.ENetConnection {
	return objects.ENetConnection(class(self).GetHost())
}
...
*/
//go:nosplit
func (self class) AddMeshPeer(peer_id gd.Int, host objects.ENetConnection) int64 {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetHost() objects.ENetConnection {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetPeer(id gd.Int) objects.ENetPacketPeer {
	var frame = callframe.New()
