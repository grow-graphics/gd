...
*/
func (self Instance) AddMeshPeer(peer_id int, host objects.ENetConnection) error {
...
*/
//go:nosplit
func (self class) AddMeshPeer(peer_id gd.Int, host objects.ENetConnection) error {
	var frame = callframe.New()
