...
import "graphics.gd/objects/EditorExportPlatformPC"
...
func New() Instance {
	...
	return Instance{*(*classdb.EditorExportPlatformLinuxBSD)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("EditorExportPlatformLinuxBSD", func(ptr gd.Object) any {
		return [1]classdb.EditorExportPlatformLinuxBSD{*(*classdb.EditorExportPlatformLinuxBSD)(unsafe.Pointer(&ptr))}
	})
}
