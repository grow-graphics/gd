...
*/
type Instance [1]classdb.VisualShaderNodeRandomRange
...
func init() {
	classdb.Register("VisualShaderNodeRandomRange", func(ptr gd.Object) any { return classdb.VisualShaderNodeRandomRange(ptr) })
}
