...
func New() Instance {
	...
	return Instance{*(*classdb.CylinderMesh)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("CylinderMesh", func(ptr gd.Object) any {
		return [1]classdb.CylinderMesh{*(*classdb.CylinderMesh)(unsafe.Pointer(&ptr))}
	})
}
