...
*/
func (self Instance) GetNodeInstance(idx int) objects.PackedScene {
	return objects.PackedScene(class(self).GetNodeInstance(gd.Int(idx)))
}
...
*/
//go:nosplit
func (self class) GetNodeInstance(idx gd.Int) objects.PackedScene {
	var frame = callframe.New()
	callframe.Arg(frame, idx)
	var r_ret = callframe.Ret[[1]uintptr](frame)
