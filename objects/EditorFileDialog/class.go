...
*/
func (self Instance) GetVbox() objects.VBoxContainer {
	return objects.VBoxContainer(class(self).GetVbox())
}
...
[b]Warning:[/b] This is a required internal node, removing and freeing it may cause a crash. If you wish to hide it or any of its children, use their [member CanvasItem.visible] property.
*/
func (self Instance) GetLineEdit() objects.LineEdit {
	return objects.LineEdit(class(self).GetLineEdit())
}
...
*/
func (self Instance) AddSideMenu(menu objects.Control) {
...
func New() Instance {
	...
	return Instance{*(*classdb.EditorFileDialog)(unsafe.Pointer(&object))}
}

func (self Instance) Access() classdb.EditorFileDialogAccess {
	return classdb.EditorFileDialogAccess(class(self).GetAccess())
}

func (self Instance) SetAccess(value classdb.EditorFileDialogAccess) {
	class(self).SetAccess(value)
}

func (self Instance) DisplayMode() classdb.EditorFileDialogDisplayMode {
	return classdb.EditorFileDialogDisplayMode(class(self).GetDisplayMode())
}

func (self Instance) SetDisplayMode(value classdb.EditorFileDialogDisplayMode) {
	class(self).SetDisplayMode(value)
}

func (self Instance) FileMode() classdb.EditorFileDialogFileMode {
	return classdb.EditorFileDialogFileMode(class(self).GetFileMode())
}

func (self Instance) SetFileMode(value classdb.EditorFileDialogFileMode) {
...
*/
//go:nosplit
func (self class) GetVbox() objects.VBoxContainer {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetLineEdit() objects.LineEdit {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) AddSideMenu(menu objects.Control, title gd.String) {
	var frame = callframe.New()
...
func init() {
	classdb.Register("EditorFileDialog", func(ptr gd.Object) any {
		return [1]classdb.EditorFileDialog{*(*classdb.EditorFileDialog)(unsafe.Pointer(&ptr))}
	})
}
