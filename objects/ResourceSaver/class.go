...
*/
var self objects.ResourceSaver
var once sync.Once

func singleton() {
	obj := gd.Global.Object.GetSingleton(gd.Global.Singletons.ResourceSaver)
	self = *(*objects.ResourceSaver)(unsafe.Pointer(&obj))
}
...
*/
func Save(resource objects.Resource) gd.Error {
	once.Do(singleton)
...
*/
func GetRecognizedExtensions(atype objects.Resource) []string {
	once.Do(singleton)
...
*/
func AddResourceFormatSaver(format_saver objects.ResourceFormatSaver) {
	once.Do(singleton)
...
*/
func RemoveResourceFormatSaver(format_saver objects.ResourceFormatSaver) {
	once.Do(singleton)
...
*/
//go:nosplit
func (self class) Save(resource objects.Resource, path gd.String, flags classdb.ResourceSaverSaverFlags) int64 {
...
*/
//go:nosplit
func (self class) GetRecognizedExtensions(atype objects.Resource) gd.PackedStringArray {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) AddResourceFormatSaver(format_saver objects.ResourceFormatSaver, at_front bool) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) RemoveResourceFormatSaver(format_saver objects.ResourceFormatSaver) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(format_saver[0])[0])
	var r_ret callframe.Nil
