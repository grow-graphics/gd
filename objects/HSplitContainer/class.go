...
*/
type Instance [1]classdb.HSplitContainer
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.HSplitContainer)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("HSplitContainer", func(ptr gd.Object) any {
		return [1]classdb.HSplitContainer{*(*classdb.HSplitContainer)(unsafe.Pointer(&ptr))}
	})
}
