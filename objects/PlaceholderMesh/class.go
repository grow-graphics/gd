...
func New() Instance {
	...
	return Instance{*(*classdb.PlaceholderMesh)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("PlaceholderMesh", func(ptr gd.Object) any {
		return [1]classdb.PlaceholderMesh{*(*classdb.PlaceholderMesh)(unsafe.Pointer(&ptr))}
	})
}
