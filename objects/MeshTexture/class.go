...
*/
type Instance [1]classdb.MeshTexture
...
func (self Instance) BaseTexture() objects.Texture2D {
	return objects.Texture2D(class(self).GetBaseTexture())
}

func (self Instance) SetBaseTexture(value objects.Texture2D) {
...
//go:nosplit
func (self class) SetBaseTexture(texture objects.Texture2D) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetBaseTexture() objects.Texture2D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func init() {
	classdb.Register("MeshTexture", func(ptr gd.Object) any { return classdb.MeshTexture(ptr) })
}
