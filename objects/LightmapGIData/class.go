...
func (self Instance) LightTexture() objects.TextureLayered {
	return objects.TextureLayered(class(self).GetLightTexture())
}

func (self Instance) SetLightTexture(value objects.TextureLayered) {
...
//go:nosplit
func (self class) SetLightTexture(light_texture objects.TextureLayered) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetLightTexture() objects.TextureLayered {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
