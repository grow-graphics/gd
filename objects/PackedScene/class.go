...
*/
func (self Instance) Pack(path objects.Node) gd.Error {
...
*/
func (self Instance) Instantiate() objects.Node {
	return objects.Node(class(self).Instantiate(0))
}
...
*/
func (self Instance) GetState() objects.SceneState {
	return objects.SceneState(class(self).GetState())
}
...
*/
//go:nosplit
func (self class) Pack(path objects.Node) int64 {
...
*/
//go:nosplit
func (self class) Instantiate(edit_state classdb.PackedSceneGenEditState) objects.Node {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetState() objects.SceneState {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
