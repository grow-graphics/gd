...
func New() Instance {
	...
	return Instance{*(*classdb.ResourceImporterTexture)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("ResourceImporterTexture", func(ptr gd.Object) any {
		return [1]classdb.ResourceImporterTexture{*(*classdb.ResourceImporterTexture)(unsafe.Pointer(&ptr))}
	})
}
