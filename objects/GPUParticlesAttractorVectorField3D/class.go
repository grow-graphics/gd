...
func New() Instance {
	...
	return Instance{*(*classdb.GPUParticlesAttractorVectorField3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("GPUParticlesAttractorVectorField3D", func(ptr gd.Object) any {
		return [1]classdb.GPUParticlesAttractorVectorField3D{*(*classdb.GPUParticlesAttractorVectorField3D)(unsafe.Pointer(&ptr))}
	})
}
