...
*/
func (self Instance) Start(mode classdb.AESContextMode, key []byte) error {
...
*/
//go:nosplit
func (self class) Start(mode classdb.AESContextMode, key gd.PackedByteArray, iv gd.PackedByteArray) error {
