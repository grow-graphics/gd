...
*/
type Instance [1]classdb.AudioEffectHighPassFilter
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.AudioEffectHighPassFilter)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("AudioEffectHighPassFilter", func(ptr gd.Object) any {
		return [1]classdb.AudioEffectHighPassFilter{*(*classdb.AudioEffectHighPassFilter)(unsafe.Pointer(&ptr))}
	})
}
