...
func New() Instance {
	...
	return Instance{*(*classdb.AnimationNodeAdd2)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("AnimationNodeAdd2", func(ptr gd.Object) any {
		return [1]classdb.AnimationNodeAdd2{*(*classdb.AnimationNodeAdd2)(unsafe.Pointer(&ptr))}
	})
}
