...
func New() Instance {
	...
	return Instance{*(*classdb.XRControllerTracker)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("XRControllerTracker", func(ptr gd.Object) any {
		return [1]classdb.XRControllerTracker{*(*classdb.XRControllerTracker)(unsafe.Pointer(&ptr))}
	})
}
