...
func New() Instance {
	...
	return Instance{*(*classdb.CSGCylinder3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("CSGCylinder3D", func(ptr gd.Object) any {
		return [1]classdb.CSGCylinder3D{*(*classdb.CSGCylinder3D)(unsafe.Pointer(&ptr))}
	})
}
