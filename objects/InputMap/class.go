...
*/
var self objects.InputMap
var once sync.Once

func singleton() {
	obj := gd.Global.Object.GetSingleton(gd.Global.Singletons.InputMap)
	self = *(*objects.InputMap)(unsafe.Pointer(&obj))
}
...
*/
func ActionAddEvent(action string, event objects.InputEvent) {
	once.Do(singleton)
...
*/
func ActionHasEvent(action string, event objects.InputEvent) bool {
	once.Do(singleton)
...
*/
func ActionEraseEvent(action string, event objects.InputEvent) {
	once.Do(singleton)
...
*/
func EventIsAction(event objects.InputEvent, action string) bool {
	once.Do(singleton)
...
*/
//go:nosplit
func (self class) ActionAddEvent(action gd.StringName, event objects.InputEvent) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(action))
...
*/
//go:nosplit
func (self class) ActionHasEvent(action gd.StringName, event objects.InputEvent) bool {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(action))
	callframe.Arg(frame, pointers.Get(event[0])[0])
	var r_ret = callframe.Ret[bool](frame)
...
*/
//go:nosplit
func (self class) ActionEraseEvent(action gd.StringName, event objects.InputEvent) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(action))
	callframe.Arg(frame, pointers.Get(event[0])[0])
	var r_ret callframe.Nil
...
*/
//go:nosplit
func (self class) EventIsAction(event objects.InputEvent, action gd.StringName, exact_match bool) bool {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(event[0])[0])
	callframe.Arg(frame, pointers.Get(action))
