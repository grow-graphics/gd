...
func New() Instance {
	...
	return Instance{classdb.VisualShaderNodeTextureSDF(object)}
}
...
func init() {
	classdb.Register("VisualShaderNodeTextureSDF", func(ptr gd.Object) any { return classdb.VisualShaderNodeTextureSDF(ptr) })
}
