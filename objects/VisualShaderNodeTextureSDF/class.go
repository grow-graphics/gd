...
*/
type Instance [1]classdb.VisualShaderNodeTextureSDF
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeTextureSDF)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("VisualShaderNodeTextureSDF", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeTextureSDF{*(*classdb.VisualShaderNodeTextureSDF)(unsafe.Pointer(&ptr))}
	})
}
