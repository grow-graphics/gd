...
func New() Instance {
	...
	return Instance{*(*classdb.PhysicsPointQueryParameters3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("PhysicsPointQueryParameters3D", func(ptr gd.Object) any {
		return [1]classdb.PhysicsPointQueryParameters3D{*(*classdb.PhysicsPointQueryParameters3D)(unsafe.Pointer(&ptr))}
	})
}
