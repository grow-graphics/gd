...
*/
func (self Instance) FindTrack(path Path.String, atype classdb.AnimationTrackType) int {
...
*/
func (self Instance) AudioTrackInsertKey(track_idx int, time Float.X, stream objects.Resource) int {
