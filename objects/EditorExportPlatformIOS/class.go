...
type Instance [1]classdb.EditorExportPlatformIOS
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.EditorExportPlatformIOS)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("EditorExportPlatformIOS", func(ptr gd.Object) any {
		return [1]classdb.EditorExportPlatformIOS{*(*classdb.EditorExportPlatformIOS)(unsafe.Pointer(&ptr))}
	})
}
