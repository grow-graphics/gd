...
*/
type Instance [1]classdb.NavigationMeshSourceGeometryData2D
...
*/
func (self Instance) Merge(other_geometry objects.NavigationMeshSourceGeometryData2D) {
...
*/
//go:nosplit
func (self class) Merge(other_geometry objects.NavigationMeshSourceGeometryData2D) {
	var frame = callframe.New()
...
func init() {
	classdb.Register("NavigationMeshSourceGeometryData2D", func(ptr gd.Object) any { return classdb.NavigationMeshSourceGeometryData2D(ptr) })
}
