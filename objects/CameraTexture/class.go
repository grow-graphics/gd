...
func New() Instance {
	...
	return Instance{*(*classdb.CameraTexture)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("CameraTexture", func(ptr gd.Object) any {
		return [1]classdb.CameraTexture{*(*classdb.CameraTexture)(unsafe.Pointer(&ptr))}
	})
}
