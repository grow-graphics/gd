...
func New() Instance {
	...
	return Instance{*(*classdb.XRAnchor3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("XRAnchor3D", func(ptr gd.Object) any { return [1]classdb.XRAnchor3D{*(*classdb.XRAnchor3D)(unsafe.Pointer(&ptr))} })
}
