...
import "graphics.gd/objects/Light3D"
...
*/
type Instance [1]classdb.SpotLight3D
type Any interface {
	gd.IsClass
...
func init() {
	classdb.Register("SpotLight3D", func(ptr gd.Object) any { return classdb.SpotLight3D(ptr) })
}
