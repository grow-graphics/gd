...
*/
type Instance [1]classdb.VisualShaderNodeVec4Parameter
...
func New() Instance {
	...
	return Instance{classdb.VisualShaderNodeVec4Parameter(object)}
}
...
func (self Instance) DefaultValue() gd.Vector4 {
	return gd.Vector4(class(self).GetDefaultValue())
}

func (self Instance) SetDefaultValue(value gd.Vector4) {
...
func init() {
	classdb.Register("VisualShaderNodeVec4Parameter", func(ptr gd.Object) any { return classdb.VisualShaderNodeVec4Parameter(ptr) })
}
