...
*/
type Instance [1]classdb.TextureProgressBar
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.TextureProgressBar)(unsafe.Pointer(&object))}
}
...
func (self Instance) TextureUnder() objects.Texture2D {
	return objects.Texture2D(class(self).GetUnderTexture())
}

func (self Instance) SetTextureUnder(value objects.Texture2D) {
	class(self).SetUnderTexture(value)
}

func (self Instance) TextureOver() objects.Texture2D {
	return objects.Texture2D(class(self).GetOverTexture())
}

func (self Instance) SetTextureOver(value objects.Texture2D) {
	class(self).SetOverTexture(value)
}

func (self Instance) TextureProgress() objects.Texture2D {
	return objects.Texture2D(class(self).GetProgressTexture())
}

func (self Instance) SetTextureProgress(value objects.Texture2D) {
...
//go:nosplit
func (self class) SetUnderTexture(tex objects.Texture2D) {
...
//go:nosplit
func (self class) GetUnderTexture() objects.Texture2D {
	var frame = callframe.New()
...
//go:nosplit
func (self class) SetProgressTexture(tex objects.Texture2D) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(tex[0])[0])
	var r_ret callframe.Nil
...
//go:nosplit
func (self class) GetProgressTexture() objects.Texture2D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
//go:nosplit
func (self class) SetOverTexture(tex objects.Texture2D) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(tex[0])[0])
	var r_ret callframe.Nil
...
//go:nosplit
func (self class) GetOverTexture() objects.Texture2D {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func init() {
	classdb.Register("TextureProgressBar", func(ptr gd.Object) any {
		return [1]classdb.TextureProgressBar{*(*classdb.TextureProgressBar)(unsafe.Pointer(&ptr))}
	})
}
