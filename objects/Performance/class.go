...
*/
var self objects.Performance
var once sync.Once

func singleton() {
	obj := gd.Global.Object.GetSingleton(gd.Global.Singletons.Performance)
	self = *(*objects.Performance)(unsafe.Pointer(&obj))
}
...
func init() {
	classdb.Register("Performance", func(ptr gd.Object) any { return classdb.Performance(ptr) })
}
