...
*/
type Instance [1]classdb.NavigationPathQueryParameters2D
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.NavigationPathQueryParameters2D)(unsafe.Pointer(&object))}
}
...
func (self Instance) MetadataFlags() classdb.NavigationPathQueryParameters2DPathMetadataFlags {
	return classdb.NavigationPathQueryParameters2DPathMetadataFlags(class(self).GetMetadataFlags())
}

func (self Instance) SetMetadataFlags(value classdb.NavigationPathQueryParameters2DPathMetadataFlags) {
...
func init() {
	classdb.Register("NavigationPathQueryParameters2D", func(ptr gd.Object) any {
		return [1]classdb.NavigationPathQueryParameters2D{*(*classdb.NavigationPathQueryParameters2D)(unsafe.Pointer(&ptr))}
	})
}
