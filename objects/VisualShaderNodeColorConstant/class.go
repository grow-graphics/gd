...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeColorConstant)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("VisualShaderNodeColorConstant", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeColorConstant{*(*classdb.VisualShaderNodeColorConstant)(unsafe.Pointer(&ptr))}
	})
}
