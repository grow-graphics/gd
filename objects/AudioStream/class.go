...
Base class for audio streams. Audio streams are used for sound effects and music playback, and support WAV (via [AudioStreamWAV]) and Ogg (via [AudioStreamOggVorbis]) file formats.
	...
	type AudioStream interface {
		...
		InstantiatePlayback() objects.AudioStreamPlayback
...
Override this method to customize the returned value of [method instantiate_playback]. Should returned a new [AudioStreamPlayback] created when the stream is played (such as by an [AudioStreamPlayer])..
*/
func (Instance) _instantiate_playback(impl func(ptr unsafe.Pointer) objects.AudioStreamPlayback) (cb gd.ExtensionClassCallVirtualFunc) {
...
*/
func (self Instance) InstantiatePlayback() objects.AudioStreamPlayback {
	return objects.AudioStreamPlayback(class(self).InstantiatePlayback())
}
...
*/
func (self Instance) GenerateSample() objects.AudioSample {
	return objects.AudioSample(class(self).GenerateSample())
}
...
Override this method to customize the returned value of [method instantiate_playback]. Should returned a new [AudioStreamPlayback] created when the stream is played (such as by an [AudioStreamPlayer])..
*/
func (class) _instantiate_playback(impl func(ptr unsafe.Pointer) objects.AudioStreamPlayback) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		self := reflect.ValueOf(class).UnsafePointer()
		ret := impl(self)
		ptr, ok := pointers.End(ret[0])
...
*/
//go:nosplit
func (self class) InstantiatePlayback() objects.AudioStreamPlayback {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GenerateSample() objects.AudioSample {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
