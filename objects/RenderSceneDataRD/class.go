...
func New() Instance {
	...
	return Instance{*(*classdb.RenderSceneDataRD)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("RenderSceneDataRD", func(ptr gd.Object) any {
		return [1]classdb.RenderSceneDataRD{*(*classdb.RenderSceneDataRD)(unsafe.Pointer(&ptr))}
	})
}
