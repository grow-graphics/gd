...
func New() Instance {
	...
	return Instance{*(*classdb.WebRTCDataChannel)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("WebRTCDataChannel", func(ptr gd.Object) any {
		return [1]classdb.WebRTCDataChannel{*(*classdb.WebRTCDataChannel)(unsafe.Pointer(&ptr))}
	})
}
