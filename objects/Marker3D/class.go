...
func New() Instance {
	...
	return Instance{*(*classdb.Marker3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("Marker3D", func(ptr gd.Object) any { return [1]classdb.Marker3D{*(*classdb.Marker3D)(unsafe.Pointer(&ptr))} })
}
