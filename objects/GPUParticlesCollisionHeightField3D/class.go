...
*/
type Instance [1]classdb.GPUParticlesCollisionHeightField3D
...
func (self Instance) SetResolution(value classdb.GPUParticlesCollisionHeightField3DResolution) {
	class(self).SetResolution(value)
}

func (self Instance) UpdateMode() classdb.GPUParticlesCollisionHeightField3DUpdateMode {
	return classdb.GPUParticlesCollisionHeightField3DUpdateMode(class(self).GetUpdateMode())
}

func (self Instance) SetUpdateMode(value classdb.GPUParticlesCollisionHeightField3DUpdateMode) {
