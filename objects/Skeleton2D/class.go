...
func New() Instance {
	...
	return Instance{*(*classdb.Skeleton2D)(unsafe.Pointer(&object))}
}
...
func (self class) GetBone(idx gd.Int) objects.Bone2D {
	...
	var ret = objects.Bone2D{gd.PointerMustAssertInstanceID[classdb.Bone2D](r_ret.Get())}
	frame.Free()
	return ret
}
...
func init() {
	classdb.Register("Skeleton2D", func(ptr gd.Object) any { return [1]classdb.Skeleton2D{*(*classdb.Skeleton2D)(unsafe.Pointer(&ptr))} })
}
