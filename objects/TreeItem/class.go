...
*/
func (self Instance) SetIcon(column int, texture objects.Texture2D) {
...
*/
func (self Instance) GetIcon(column int) objects.Texture2D {
	return objects.Texture2D(class(self).GetIcon(gd.Int(column)))
}
...
*/
func (self Instance) SetCustomFont(column int, font objects.Font) {
...
*/
func (self Instance) GetCustomFont(column int) objects.Font {
	return objects.Font(class(self).GetCustomFont(gd.Int(column)))
}
...
*/
func (self Instance) AddButton(column int, button objects.Texture2D) {
...
*/
func (self Instance) GetButton(column int, button_index int) objects.Texture2D {
	return objects.Texture2D(class(self).GetButton(gd.Int(column), gd.Int(button_index)))
}
...
*/
func (self Instance) SetButton(column int, button_index int, button objects.Texture2D) {
...
*/
func (self Instance) CreateChild() objects.TreeItem {
	return objects.TreeItem(class(self).CreateChild(gd.Int(-1)))
}
...
*/
func (self Instance) AddChild(child objects.TreeItem) {
...
*/
func (self Instance) RemoveChild(child objects.TreeItem) {
...
*/
func (self Instance) GetTree() objects.Tree {
	return objects.Tree(class(self).GetTree())
}

/*
Returns the next sibling TreeItem in the tree or a null object if there is none.
*/
func (self Instance) GetNext() objects.TreeItem {
	return objects.TreeItem(class(self).GetNext())
}

/*
Returns the previous sibling TreeItem in the tree or a null object if there is none.
*/
func (self Instance) GetPrev() objects.TreeItem {
	return objects.TreeItem(class(self).GetPrev())
}

/*
Returns the parent TreeItem or a null object if there is none.
*/
func (self Instance) GetParent() objects.TreeItem {
	return objects.TreeItem(class(self).GetParent())
}

/*
Returns the TreeItem's first child.
*/
func (self Instance) GetFirstChild() objects.TreeItem {
	return objects.TreeItem(class(self).GetFirstChild())
}
...
*/
func (self Instance) GetNextInTree() objects.TreeItem {
	return objects.TreeItem(class(self).GetNextInTree(false))
}
...
*/
func (self Instance) GetPrevInTree() objects.TreeItem {
	return objects.TreeItem(class(self).GetPrevInTree(false))
}
...
*/
func (self Instance) GetNextVisible() objects.TreeItem {
	return objects.TreeItem(class(self).GetNextVisible(false))
}
...
*/
func (self Instance) GetPrevVisible() objects.TreeItem {
	return objects.TreeItem(class(self).GetPrevVisible(false))
}
...
*/
func (self Instance) GetChild(index int) objects.TreeItem {
	return objects.TreeItem(class(self).GetChild(gd.Int(index)))
}
...
*/
func (self Instance) MoveBefore(item objects.TreeItem) {
...
[b]Note:[/b] You can't move to the root or move the root.
*/
func (self Instance) MoveAfter(item objects.TreeItem) {
...
*/
//go:nosplit
func (self class) SetIcon(column gd.Int, texture objects.Texture2D) {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) GetIcon(column gd.Int) objects.Texture2D {
	var frame = callframe.New()
	callframe.Arg(frame, column)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) SetCustomFont(column gd.Int, font objects.Font) {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) GetCustomFont(column gd.Int) objects.Font {
	var frame = callframe.New()
	callframe.Arg(frame, column)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) AddButton(column gd.Int, button objects.Texture2D, id gd.Int, disabled bool, tooltip_text gd.String) {
	var frame = callframe.New()
	callframe.Arg(frame, column)
...
*/
//go:nosplit
func (self class) GetButton(column gd.Int, button_index gd.Int) objects.Texture2D {
	var frame = callframe.New()
	callframe.Arg(frame, column)
	callframe.Arg(frame, button_index)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) SetButton(column gd.Int, button_index gd.Int, button objects.Texture2D) {
	var frame = callframe.New()
	callframe.Arg(frame, column)
	callframe.Arg(frame, button_index)
	callframe.Arg(frame, pointers.Get(button[0])[0])
...
*/
//go:nosplit
func (self class) CreateChild(index gd.Int) objects.TreeItem {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) RemoveChild(child objects.TreeItem) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetTree() objects.Tree {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetNext() objects.TreeItem {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetPrev() objects.TreeItem {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetParent() objects.TreeItem {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetFirstChild() objects.TreeItem {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetNextInTree(wrap bool) objects.TreeItem {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetPrevInTree(wrap bool) objects.TreeItem {
	var frame = callframe.New()
	callframe.Arg(frame, wrap)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetNextVisible(wrap bool) objects.TreeItem {
	var frame = callframe.New()
	callframe.Arg(frame, wrap)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetPrevVisible(wrap bool) objects.TreeItem {
	var frame = callframe.New()
	callframe.Arg(frame, wrap)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetChild(index gd.Int) objects.TreeItem {
	var frame = callframe.New()
	callframe.Arg(frame, index)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) MoveBefore(item objects.TreeItem) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) MoveAfter(item objects.TreeItem) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(item[0])[0])
	var r_ret callframe.Nil
