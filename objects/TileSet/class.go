...
*/
func (self Instance) AddSource(source objects.TileSetSource) int {
...
*/
func (self Instance) GetSource(source_id int) objects.TileSetSource {
	return objects.TileSetSource(class(self).GetSource(gd.Int(source_id)))
}
...
*/
func (self Instance) SetPhysicsLayerPhysicsMaterial(layer_index int, physics_material objects.PhysicsMaterial) {
...
*/
func (self Instance) GetPhysicsLayerPhysicsMaterial(layer_index int) objects.PhysicsMaterial {
	return objects.PhysicsMaterial(class(self).GetPhysicsLayerPhysicsMaterial(gd.Int(layer_index)))
}
...
*/
func (self Instance) SetTerrainSetMode(terrain_set int, mode classdb.TileSetTerrainMode) {
...
*/
func (self Instance) GetTerrainSetMode(terrain_set int) classdb.TileSetTerrainMode {
...
*/
func (self Instance) AddPattern(pattern objects.TileMapPattern) int {
...
*/
func (self Instance) GetPattern() objects.TileMapPattern {
	return objects.TileMapPattern(class(self).GetPattern(gd.Int(-1)))
}
...
func (self Instance) SetTileShape(value classdb.TileSetTileShape) {
	class(self).SetTileShape(value)
}

func (self Instance) TileLayout() classdb.TileSetTileLayout {
	return classdb.TileSetTileLayout(class(self).GetTileLayout())
}

func (self Instance) SetTileLayout(value classdb.TileSetTileLayout) {
	class(self).SetTileLayout(value)
}

func (self Instance) TileOffsetAxis() classdb.TileSetTileOffsetAxis {
	return classdb.TileSetTileOffsetAxis(class(self).GetTileOffsetAxis())
}

func (self Instance) SetTileOffsetAxis(value classdb.TileSetTileOffsetAxis) {
...
*/
//go:nosplit
func (self class) AddSource(source objects.TileSetSource, atlas_source_id_override gd.Int) gd.Int {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetSource(source_id gd.Int) objects.TileSetSource {
	var frame = callframe.New()
	callframe.Arg(frame, source_id)
...
*/
//go:nosplit
func (self class) SetPhysicsLayerPhysicsMaterial(layer_index gd.Int, physics_material objects.PhysicsMaterial) {
	var frame = callframe.New()
	callframe.Arg(frame, layer_index)
...
*/
//go:nosplit
func (self class) GetPhysicsLayerPhysicsMaterial(layer_index gd.Int) objects.PhysicsMaterial {
	var frame = callframe.New()
	callframe.Arg(frame, layer_index)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) AddPattern(pattern objects.TileMapPattern, index gd.Int) gd.Int {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetPattern(index gd.Int) objects.TileMapPattern {
	var frame = callframe.New()
	callframe.Arg(frame, index)
	var r_ret = callframe.Ret[[1]uintptr](frame)
