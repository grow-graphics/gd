...
import "graphics.gd/objects/Shader"
...
*/
func (self Instance) GetNode(atype classdb.VisualShaderType, id int) objects.VisualShaderNode {
	return objects.VisualShaderNode(class(self).GetNode(atype, gd.Int(id)))
}
...
*/
func (self Instance) ConnectNodes(atype classdb.VisualShaderType, from_node int, from_port int, to_node int, to_port int) error {
...
*/
//go:nosplit
func (self class) AddNode(atype classdb.VisualShaderType, node objects.VisualShaderNode, position gd.Vector2, id gd.Int) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetNode(atype classdb.VisualShaderType, id gd.Int) objects.VisualShaderNode {
	var frame = callframe.New()
	callframe.Arg(frame, atype)
	callframe.Arg(frame, id)
...
*/
//go:nosplit
func (self class) ConnectNodes(atype classdb.VisualShaderType, from_node gd.Int, from_port gd.Int, to_node gd.Int, to_port gd.Int) error {
	var frame = callframe.New()
	callframe.Arg(frame, atype)
	callframe.Arg(frame, from_node)
	callframe.Arg(frame, from_port)
