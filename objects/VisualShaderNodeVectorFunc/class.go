...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeVectorFunc)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("VisualShaderNodeVectorFunc", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeVectorFunc{*(*classdb.VisualShaderNodeVectorFunc)(unsafe.Pointer(&ptr))}
	})
}
