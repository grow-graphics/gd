...
*/
type Instance [1]classdb.VisualShaderNodeGroupBase
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeGroupBase)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("VisualShaderNodeGroupBase", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeGroupBase{*(*classdb.VisualShaderNodeGroupBase)(unsafe.Pointer(&ptr))}
	})
}
