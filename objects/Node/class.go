...
[b]Note:[/b] The [code]script[/code] property is part of the [Object] class, not [Node]. It isn't exposed like most properties but does have a setter and getter (see [method Object.set_script] and [method Object.get_script]).
	...
	type Node interface {
		...
		//[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).
		Input(event objects.InputEvent)
		...
		ShortcutInput(event objects.InputEvent)
		...
		//[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).
		UnhandledInput(event objects.InputEvent)
		...
		//[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).
		UnhandledKeyInput(event objects.InputEvent)
	}
*/
...
[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).
*/
func (Instance) _input(impl func(ptr unsafe.Pointer, event objects.InputEvent)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
...
[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not orphan).
*/
func (Instance) _shortcut_input(impl func(ptr unsafe.Pointer, event objects.InputEvent)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var event = objects.InputEvent{pointers.New[classdb.InputEvent]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(event[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).
*/
func (Instance) _unhandled_input(impl func(ptr unsafe.Pointer, event objects.InputEvent)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var event = objects.InputEvent{pointers.New[classdb.InputEvent]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(event[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).
*/
func (Instance) _unhandled_key_input(impl func(ptr unsafe.Pointer, event objects.InputEvent)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var event = objects.InputEvent{pointers.New[classdb.InputEvent]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(event[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
*/
func (self Instance) AddSibling(sibling objects.Node) {
...
*/
func (self Instance) AddChild(node objects.Node) {
...
*/
func (self Instance) RemoveChild(node objects.Node) {
...
*/
func (self Instance) Reparent(new_parent objects.Node) {
...
*/
func (self Instance) GetChild(idx int) objects.Node {
	return objects.Node(class(self).GetChild(gd.Int(idx), false))
}
...
*/
func (self Instance) GetParent() objects.Node {
	return objects.Node(class(self).GetParent())
}
...
*/
func (self Instance) FindChild(pattern string) objects.Node {
	return objects.Node(class(self).FindChild(gd.NewString(pattern), true, true))
}
...
*/
func (self Instance) FindParent(pattern string) objects.Node {
	return objects.Node(class(self).FindParent(gd.NewString(pattern)))
}
...
*/
func (self Instance) IsAncestorOf(node objects.Node) bool {
...
*/
func (self Instance) IsGreaterThan(node objects.Node) bool {
...
*/
func (self Instance) MoveChild(child_node objects.Node, to_index int) {
...
*/
func (self Instance) GetWindow() objects.Window {
	return objects.Window(class(self).GetWindow())
}

/*
Returns the [Window] that contains this node, or the last exclusive child in a chain of windows starting with the one that contains this node.
*/
func (self Instance) GetLastExclusiveWindow() objects.Window {
	return objects.Window(class(self).GetLastExclusiveWindow())
}
...
*/
func (self Instance) GetTree() objects.SceneTree {
	return objects.SceneTree(class(self).GetTree())
}
...
*/
func (self Instance) Duplicate() objects.Node {
	return objects.Node(class(self).Duplicate(gd.Int(15)))
}
...
*/
func (self Instance) ReplaceBy(node objects.Node) {
...
*/
func (self Instance) SetEditableInstance(node objects.Node, is_editable bool) {
...
*/
func (self Instance) IsEditableInstance(node objects.Node) bool {
...
*/
func (self Instance) GetViewport() objects.Viewport {
	return objects.Viewport(class(self).GetViewport())
}
...
func (self Instance) Owner() objects.Node {
	return objects.Node(class(self).GetOwner())
}

func (self Instance) SetOwner(value objects.Node) {
	class(self).SetOwner(value)
}

func (self Instance) Multiplayer() objects.MultiplayerAPI {
	return objects.MultiplayerAPI(class(self).GetMultiplayer())
}
...
[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).
*/
func (class) _input(impl func(ptr unsafe.Pointer, event objects.InputEvent)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var event = objects.InputEvent{pointers.New[classdb.InputEvent]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(event[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not orphan).
*/
func (class) _shortcut_input(impl func(ptr unsafe.Pointer, event objects.InputEvent)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var event = objects.InputEvent{pointers.New[classdb.InputEvent]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(event[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).
*/
func (class) _unhandled_input(impl func(ptr unsafe.Pointer, event objects.InputEvent)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var event = objects.InputEvent{pointers.New[classdb.InputEvent]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(event[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
[b]Note:[/b] This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).
*/
func (class) _unhandled_key_input(impl func(ptr unsafe.Pointer, event objects.InputEvent)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var event = objects.InputEvent{pointers.New[classdb.InputEvent]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(event[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
*/
//go:nosplit
func (self class) RemoveChild(node objects.Node) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) Reparent(new_parent objects.Node, keep_global_transform bool) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetChild(idx gd.Int, include_internal bool) objects.Node {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetNode(path gd.NodePath) objects.Node {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(path))
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetNodeOrNull(path gd.NodePath) objects.Node {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(path))
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetParent() objects.Node {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) FindChild(pattern gd.String, recursive bool, owned bool) objects.Node {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) FindParent(pattern gd.String) objects.Node {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(pattern))
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) IsAncestorOf(node objects.Node) bool {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(node[0])[0])
	var r_ret = callframe.Ret[bool](frame)
...
*/
//go:nosplit
func (self class) IsGreaterThan(node objects.Node) bool {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(node[0])[0])
	var r_ret = callframe.Ret[bool](frame)
...
*/
//go:nosplit
func (self class) GetPathTo(node objects.Node, use_unique_path bool) gd.NodePath {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(node[0])[0])
...
*/
//go:nosplit
func (self class) MoveChild(child_node objects.Node, to_index gd.Int) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) SetOwner(owner objects.Node) {
	var frame = callframe.New()
...
//go:nosplit
func (self class) GetOwner() objects.Node {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetWindow() objects.Window {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetLastExclusiveWindow() objects.Window {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetTree() objects.SceneTree {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) Duplicate(flags gd.Int) objects.Node {
	var frame = callframe.New()
	callframe.Arg(frame, flags)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) SetEditableInstance(node objects.Node, is_editable bool) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(node[0])[0])
...
*/
//go:nosplit
func (self class) IsEditableInstance(node objects.Node) bool {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(node[0])[0])
	var r_ret = callframe.Ret[bool](frame)
...
*/
//go:nosplit
func (self class) GetViewport() objects.Viewport {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
//go:nosplit
func (self class) GetMultiplayer() objects.MultiplayerAPI {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
func (self Instance) OnChildEnteredTree(cb func(node objects.Node)) {
	self[0].AsObject().Connect(gd.NewStringName("child_entered_tree"), gd.NewCallable(cb), 0)
}

func (self Instance) OnChildExitingTree(cb func(node objects.Node)) {
...
func (self Instance) OnReplacingBy(cb func(node objects.Node)) {
	self[0].AsObject().Connect(gd.NewStringName("replacing_by"), gd.NewCallable(cb), 0)
}

func (self Instance) OnEditorDescriptionChanged(cb func(node objects.Node)) {
