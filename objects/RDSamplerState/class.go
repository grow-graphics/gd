...
func New() Instance {
	...
	return Instance{*(*classdb.RDSamplerState)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("RDSamplerState", func(ptr gd.Object) any {
		return [1]classdb.RDSamplerState{*(*classdb.RDSamplerState)(unsafe.Pointer(&ptr))}
	})
}
