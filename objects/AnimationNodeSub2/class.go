...
*/
type Instance [1]classdb.AnimationNodeSub2
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.AnimationNodeSub2)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("AnimationNodeSub2", func(ptr gd.Object) any {
		return [1]classdb.AnimationNodeSub2{*(*classdb.AnimationNodeSub2)(unsafe.Pointer(&ptr))}
	})
}
