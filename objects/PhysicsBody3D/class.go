...
func New() Instance {
	...
	return Instance{*(*classdb.PhysicsBody3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("PhysicsBody3D", func(ptr gd.Object) any {
		return [1]classdb.PhysicsBody3D{*(*classdb.PhysicsBody3D)(unsafe.Pointer(&ptr))}
	})
}
