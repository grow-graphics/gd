...
*/
func ShapeGetType(shape Resource.ID) classdb.PhysicsServer2DShapeType {
	once.Do(singleton)
...
*/
func SpaceSetParam(space Resource.ID, param classdb.PhysicsServer2DSpaceParameter, value Float.X) {
	once.Do(singleton)
...
*/
func SpaceGetParam(space Resource.ID, param classdb.PhysicsServer2DSpaceParameter) Float.X {
	once.Do(singleton)
...
*/
func SpaceGetDirectState(space Resource.ID) objects.PhysicsDirectSpaceState2D {
	once.Do(singleton)
...
*/
func AreaSetParam(area Resource.ID, param classdb.PhysicsServer2DAreaParameter, value any) {
	once.Do(singleton)
...
*/
func AreaGetParam(area Resource.ID, param classdb.PhysicsServer2DAreaParameter) any {
	once.Do(singleton)
...
*/
func BodySetMode(body Resource.ID, mode classdb.PhysicsServer2DBodyMode) {
	once.Do(singleton)
...
*/
func BodyGetMode(body Resource.ID) classdb.PhysicsServer2DBodyMode {
	once.Do(singleton)
...
*/
func BodySetContinuousCollisionDetectionMode(body Resource.ID, mode classdb.PhysicsServer2DCCDMode) {
	once.Do(singleton)
...
*/
func BodyGetContinuousCollisionDetectionMode(body Resource.ID) classdb.PhysicsServer2DCCDMode {
	once.Do(singleton)
...
*/
func BodySetParam(body Resource.ID, param classdb.PhysicsServer2DBodyParameter, value any) {
	once.Do(singleton)
...
*/
func BodyGetParam(body Resource.ID, param classdb.PhysicsServer2DBodyParameter) any {
	once.Do(singleton)
...
*/
func BodySetState(body Resource.ID, state classdb.PhysicsServer2DBodyState, value any) {
	once.Do(singleton)
...
*/
func BodyGetState(body Resource.ID, state classdb.PhysicsServer2DBodyState) any {
	once.Do(singleton)
...
*/
func BodySetStateSyncCallback(body Resource.ID, callable func(state objects.PhysicsDirectBodyState2D)) {
	once.Do(singleton)
...
*/
func BodySetForceIntegrationCallback(body Resource.ID, callable func(state objects.PhysicsDirectBodyState2D, userdata any)) {
	once.Do(singleton)
...
*/
func BodyTestMotion(body Resource.ID, parameters objects.PhysicsTestMotionParameters2D) bool {
	once.Do(singleton)
...
*/
func BodyGetDirectState(body Resource.ID) objects.PhysicsDirectBodyState2D {
	once.Do(singleton)
...
*/
func JointSetParam(joint Resource.ID, param classdb.PhysicsServer2DJointParam, value Float.X) {
	once.Do(singleton)
...
*/
func JointGetParam(joint Resource.ID, param classdb.PhysicsServer2DJointParam) Float.X {
	once.Do(singleton)
...
*/
func PinJointSetFlag(joint Resource.ID, flag classdb.PhysicsServer2DPinJointFlag, enabled bool) {
	once.Do(singleton)
...
*/
func PinJointGetFlag(joint Resource.ID, flag classdb.PhysicsServer2DPinJointFlag) bool {
	once.Do(singleton)
...
*/
func PinJointSetParam(joint Resource.ID, param classdb.PhysicsServer2DPinJointParam, value Float.X) {
	once.Do(singleton)
...
*/
func PinJointGetParam(joint Resource.ID, param classdb.PhysicsServer2DPinJointParam) Float.X {
	once.Do(singleton)
...
*/
func DampedSpringJointSetParam(joint Resource.ID, param classdb.PhysicsServer2DDampedSpringParam, value Float.X) {
	once.Do(singleton)
...
*/
func DampedSpringJointGetParam(joint Resource.ID, param classdb.PhysicsServer2DDampedSpringParam) Float.X {
	once.Do(singleton)
...
*/
func JointGetType(joint Resource.ID) classdb.PhysicsServer2DJointType {
	once.Do(singleton)
...
func (self class) SpaceGetDirectState(space gd.RID) objects.PhysicsDirectSpaceState2D {
	...
	var ret = objects.PhysicsDirectSpaceState2D{gd.PointerMustAssertInstanceID[classdb.PhysicsDirectSpaceState2D](r_ret.Get())}
	frame.Free()
	return ret
}
...
func (self class) BodyGetDirectState(body gd.RID) objects.PhysicsDirectBodyState2D {
	...
	var ret = objects.PhysicsDirectBodyState2D{gd.PointerMustAssertInstanceID[classdb.PhysicsDirectBodyState2D](r_ret.Get())}
	frame.Free()
	return ret
}
...
func init() {
	classdb.Register("PhysicsServer2D", func(ptr gd.Object) any {
		return [1]classdb.PhysicsServer2D{*(*classdb.PhysicsServer2D)(unsafe.Pointer(&ptr))}
	})
}
