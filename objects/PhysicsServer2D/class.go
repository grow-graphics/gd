...
*/
var self objects.PhysicsServer2D
var once sync.Once

func singleton() {
	obj := gd.Global.Object.GetSingleton(gd.Global.Singletons.PhysicsServer2D)
	self = *(*objects.PhysicsServer2D)(unsafe.Pointer(&obj))
}
...
*/
func SpaceGetDirectState(space gd.RID) objects.PhysicsDirectSpaceState2D {
	once.Do(singleton)
	return objects.PhysicsDirectSpaceState2D(class(self).SpaceGetDirectState(space))
}
...
*/
func BodyTestMotion(body gd.RID, parameters objects.PhysicsTestMotionParameters2D) bool {
	once.Do(singleton)
	return bool(class(self).BodyTestMotion(body, parameters, ([1]objects.PhysicsTestMotionResult2D{}[0])))
}
...
*/
func BodyGetDirectState(body gd.RID) objects.PhysicsDirectBodyState2D {
	once.Do(singleton)
	return objects.PhysicsDirectBodyState2D(class(self).BodyGetDirectState(body))
}
...
*/
//go:nosplit
func (self class) SpaceGetDirectState(space gd.RID) objects.PhysicsDirectSpaceState2D {
	var frame = callframe.New()
	callframe.Arg(frame, space)
...
*/
//go:nosplit
func (self class) BodyTestMotion(body gd.RID, parameters objects.PhysicsTestMotionParameters2D, result objects.PhysicsTestMotionResult2D) bool {
	var frame = callframe.New()
	callframe.Arg(frame, body)
...
*/
//go:nosplit
func (self class) BodyGetDirectState(body gd.RID) objects.PhysicsDirectBodyState2D {
	var frame = callframe.New()
	callframe.Arg(frame, body)
	var r_ret = callframe.Ret[[1]uintptr](frame)
	...
	var ret = objects.PhysicsDirectBodyState2D{classdb.PhysicsDirectBodyState2D(gd.PointerMustAssertInstanceID(r_ret.Get()))}
	frame.Free()
	return ret
}
