...
*/
func (self Instance) ReplaceNode(name string, node objects.AnimationNode) {
...
*/
func (self Instance) GetNodeName(node objects.AnimationNode) string {
...
*/
func (self Instance) AddTransition(from string, to string, transition objects.AnimationNodeStateMachineTransition) {
...
*/
func (self Instance) GetTransition(idx int) objects.AnimationNodeStateMachineTransition {
	return objects.AnimationNodeStateMachineTransition(class(self).GetTransition(gd.Int(idx)))
}
...
*/
//go:nosplit
func (self class) ReplaceNode(name gd.StringName, node objects.AnimationNode) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(name))
	callframe.Arg(frame, pointers.Get(node[0])[0])
	var r_ret callframe.Nil
...
*/
//go:nosplit
func (self class) GetNodeName(node objects.AnimationNode) gd.StringName {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(node[0])[0])
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) AddTransition(from gd.StringName, to gd.StringName, transition objects.AnimationNodeStateMachineTransition) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(from))
	callframe.Arg(frame, pointers.Get(to))
...
*/
//go:nosplit
func (self class) GetTransition(idx gd.Int) objects.AnimationNodeStateMachineTransition {
	var frame = callframe.New()
