...
func New() Instance {
	...
	return Instance{*(*classdb.AnimationNodeTransition)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("AnimationNodeTransition", func(ptr gd.Object) any {
		return [1]classdb.AnimationNodeTransition{*(*classdb.AnimationNodeTransition)(unsafe.Pointer(&ptr))}
	})
}
