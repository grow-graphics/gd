...
*/
func (self Instance) SetJointFlags(joint classdb.XRBodyTrackerJoint, flags classdb.XRBodyTrackerJointFlags) {
...
*/
func (self Instance) GetJointFlags(joint classdb.XRBodyTrackerJoint) classdb.XRBodyTrackerJointFlags {
...
func (self Instance) BodyFlags() classdb.XRBodyTrackerBodyFlags {
	return classdb.XRBodyTrackerBodyFlags(class(self).GetBodyFlags())
}

func (self Instance) SetBodyFlags(value classdb.XRBodyTrackerBodyFlags) {
