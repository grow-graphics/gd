...
func New() Instance {
	...
	return Instance{*(*classdb.X509Certificate)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("X509Certificate", func(ptr gd.Object) any {
		return [1]classdb.X509Certificate{*(*classdb.X509Certificate)(unsafe.Pointer(&ptr))}
	})
}
