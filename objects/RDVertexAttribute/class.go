...
func New() Instance {
	...
	return Instance{*(*classdb.RDVertexAttribute)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("RDVertexAttribute", func(ptr gd.Object) any {
		return [1]classdb.RDVertexAttribute{*(*classdb.RDVertexAttribute)(unsafe.Pointer(&ptr))}
	})
}
