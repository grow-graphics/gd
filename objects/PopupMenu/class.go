...
*/
func (self Instance) ActivateItemByEvent(event objects.InputEvent) bool {
...
[b]Note:[/b] Checkable items just display a checkmark, but don't have any built-in checking behavior and must be checked/unchecked manually. See [method set_item_checked] for more info on how to control it.
*/
func (self Instance) AddIconCheckItem(texture objects.Texture2D, label string) {
...
*/
func (self Instance) AddIconRadioCheckItem(texture objects.Texture2D, label string) {
...
*/
func (self Instance) AddShortcut(shortcut objects.Shortcut) {
...
If [param allow_echo] is [code]true[/code], the shortcut can be activated with echo events.
*/
func (self Instance) AddIconShortcut(texture objects.Texture2D, shortcut objects.Shortcut) {
...
[b]Note:[/b] Checkable items just display a checkmark, but don't have any built-in checking behavior and must be checked/unchecked manually. See [method set_item_checked] for more info on how to control it.
*/
func (self Instance) AddCheckShortcut(shortcut objects.Shortcut) {
...
[b]Note:[/b] Checkable items just display a checkmark, but don't have any built-in checking behavior and must be checked/unchecked manually. See [method set_item_checked] for more info on how to control it.
*/
func (self Instance) AddIconCheckShortcut(texture objects.Texture2D, shortcut objects.Shortcut) {
...
[b]Note:[/b] Checkable items just display a checkmark, but don't have any built-in checking behavior and must be checked/unchecked manually. See [method set_item_checked] for more info on how to control it.
*/
func (self Instance) AddRadioCheckShortcut(shortcut objects.Shortcut) {
...
*/
func (self Instance) AddIconRadioCheckShortcut(texture objects.Texture2D, shortcut objects.Shortcut) {
...
An [param id] can optionally be provided. If no [param id] is provided, one will be created from the index.
*/
func (self Instance) AddSubmenuNodeItem(label string, submenu objects.PopupMenu) {
...
*/
func (self Instance) SetItemIcon(index int, icon objects.Texture2D) {
...
*/
func (self Instance) SetItemSubmenuNode(index int, submenu objects.PopupMenu) {
...
*/
func (self Instance) SetItemShortcut(index int, shortcut objects.Shortcut) {
...
*/
func (self Instance) GetItemIcon(index int) objects.Texture2D {
	return objects.Texture2D(class(self).GetItemIcon(gd.Int(index)))
}
...
*/
func (self Instance) GetItemSubmenuNode(index int) objects.PopupMenu {
	return objects.PopupMenu(class(self).GetItemSubmenuNode(gd.Int(index)))
}
...
*/
func (self Instance) GetItemShortcut(index int) objects.Shortcut {
	return objects.Shortcut(class(self).GetItemShortcut(gd.Int(index)))
}
...
*/
//go:nosplit
func (self class) ActivateItemByEvent(event objects.InputEvent, for_global_only bool) bool {
...
*/
//go:nosplit
func (self class) AddIconItem(texture objects.Texture2D, label gd.String, id gd.Int, accel gdconst.Key) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) AddIconCheckItem(texture objects.Texture2D, label gd.String, id gd.Int, accel gdconst.Key) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(texture[0])[0])
	callframe.Arg(frame, pointers.Get(label))
	callframe.Arg(frame, id)
...
*/
//go:nosplit
func (self class) AddIconRadioCheckItem(texture objects.Texture2D, label gd.String, id gd.Int, accel gdconst.Key) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(texture[0])[0])
	callframe.Arg(frame, pointers.Get(label))
	callframe.Arg(frame, id)
...
*/
//go:nosplit
func (self class) AddShortcut(shortcut objects.Shortcut, id gd.Int, global bool, allow_echo bool) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) AddIconShortcut(texture objects.Texture2D, shortcut objects.Shortcut, id gd.Int, global bool, allow_echo bool) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(texture[0])[0])
	callframe.Arg(frame, pointers.Get(shortcut[0])[0])
	callframe.Arg(frame, id)
...
*/
//go:nosplit
func (self class) AddCheckShortcut(shortcut objects.Shortcut, id gd.Int, global bool) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(shortcut[0])[0])
	callframe.Arg(frame, id)
	callframe.Arg(frame, global)
...
*/
//go:nosplit
func (self class) AddIconCheckShortcut(texture objects.Texture2D, shortcut objects.Shortcut, id gd.Int, global bool) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(texture[0])[0])
	callframe.Arg(frame, pointers.Get(shortcut[0])[0])
	callframe.Arg(frame, id)
...
*/
//go:nosplit
func (self class) AddRadioCheckShortcut(shortcut objects.Shortcut, id gd.Int, global bool) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(shortcut[0])[0])
	callframe.Arg(frame, id)
	callframe.Arg(frame, global)
...
*/
//go:nosplit
func (self class) AddIconRadioCheckShortcut(texture objects.Texture2D, shortcut objects.Shortcut, id gd.Int, global bool) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(texture[0])[0])
	callframe.Arg(frame, pointers.Get(shortcut[0])[0])
	callframe.Arg(frame, id)
...
*/
//go:nosplit
func (self class) AddSubmenuNodeItem(label gd.String, submenu objects.PopupMenu, id gd.Int) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(label))
...
*/
//go:nosplit
func (self class) SetItemIcon(index gd.Int, icon objects.Texture2D) {
	var frame = callframe.New()
	callframe.Arg(frame, index)
...
*/
//go:nosplit
func (self class) SetItemSubmenuNode(index gd.Int, submenu objects.PopupMenu) {
	var frame = callframe.New()
	callframe.Arg(frame, index)
	callframe.Arg(frame, pointers.Get(submenu[0])[0])
	var r_ret callframe.Nil
...
*/
//go:nosplit
func (self class) SetItemShortcut(index gd.Int, shortcut objects.Shortcut, global bool) {
	var frame = callframe.New()
	callframe.Arg(frame, index)
	callframe.Arg(frame, pointers.Get(shortcut[0])[0])
	callframe.Arg(frame, global)
...
*/
//go:nosplit
func (self class) GetItemIcon(index gd.Int) objects.Texture2D {
	var frame = callframe.New()
	callframe.Arg(frame, index)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetItemSubmenuNode(index gd.Int) objects.PopupMenu {
	var frame = callframe.New()
	callframe.Arg(frame, index)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetItemShortcut(index gd.Int) objects.Shortcut {
	var frame = callframe.New()
	callframe.Arg(frame, index)
	var r_ret = callframe.Ret[[1]uintptr](frame)
