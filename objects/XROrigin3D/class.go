...
func New() Instance {
	...
	return Instance{*(*classdb.XROrigin3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("XROrigin3D", func(ptr gd.Object) any { return [1]classdb.XROrigin3D{*(*classdb.XROrigin3D)(unsafe.Pointer(&ptr))} })
}
