...
func New() Instance {
	...
	return Instance{*(*classdb.OggPacketSequencePlayback)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("OggPacketSequencePlayback", func(ptr gd.Object) any {
		return [1]classdb.OggPacketSequencePlayback{*(*classdb.OggPacketSequencePlayback)(unsafe.Pointer(&ptr))}
	})
}
