...
func New() Instance {
	...
	return Instance{*(*classdb.AudioEffectLowPassFilter)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("AudioEffectLowPassFilter", func(ptr gd.Object) any {
		return [1]classdb.AudioEffectLowPassFilter{*(*classdb.AudioEffectLowPassFilter)(unsafe.Pointer(&ptr))}
	})
}
