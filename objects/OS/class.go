...
func singleton() {
	...
	self = *(*objects.OS)(unsafe.Pointer(&obj))
}
...
*/
func GetKeycodeString(code gdconst.Key) string {
	once.Do(singleton)
...
*/
func FindKeycodeFromString(s string) gdconst.Key {
	once.Do(singleton)
	return gdconst.Key(class(self).FindKeycodeFromString(gd.NewString(s)))
}
...
*/
//go:nosplit
func (self class) GetKeycodeString(code gdconst.Key) gd.String {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) FindKeycodeFromString(s gd.String) gdconst.Key {
	var frame = callframe.New()
