...
*/
func (self Instance) AddAnimation(name string, animation objects.Animation) error {
...
*/
//go:nosplit
func (self class) AddAnimation(name gd.StringName, animation objects.Animation) error {
