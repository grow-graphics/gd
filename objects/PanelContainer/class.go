...
*/
type Instance [1]classdb.PanelContainer
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.PanelContainer)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("PanelContainer", func(ptr gd.Object) any {
		return [1]classdb.PanelContainer{*(*classdb.PanelContainer)(unsafe.Pointer(&ptr))}
	})
}
