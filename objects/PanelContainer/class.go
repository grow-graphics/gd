...
func New() Instance {
	...
	return Instance{classdb.PanelContainer(object)}
}
...
func init() {
	classdb.Register("PanelContainer", func(ptr gd.Object) any { return [1]classdb.PanelContainer{classdb.PanelContainer(ptr)} })
}
