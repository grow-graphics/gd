...
func New() Instance {
	...
	return Instance{*(*classdb.WorldBoundaryShape2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("WorldBoundaryShape2D", func(ptr gd.Object) any {
		return [1]classdb.WorldBoundaryShape2D{*(*classdb.WorldBoundaryShape2D)(unsafe.Pointer(&ptr))}
	})
}
