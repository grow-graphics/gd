...
func New() Instance {
	...
	return Instance{*(*classdb.Shortcut)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("Shortcut", func(ptr gd.Object) any { return [1]classdb.Shortcut{*(*classdb.Shortcut)(unsafe.Pointer(&ptr))} })
}
