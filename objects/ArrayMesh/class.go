...
func New() Instance {
	...
	return Instance{*(*classdb.ArrayMesh)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("ArrayMesh", func(ptr gd.Object) any { return [1]classdb.ArrayMesh{*(*classdb.ArrayMesh)(unsafe.Pointer(&ptr))} })
}
