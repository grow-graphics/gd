...
func New() Instance {
	...
	return Instance{*(*classdb.XRHandTracker)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("XRHandTracker", func(ptr gd.Object) any {
		return [1]classdb.XRHandTracker{*(*classdb.XRHandTracker)(unsafe.Pointer(&ptr))}
	})
}
