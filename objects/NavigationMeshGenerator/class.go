...
*/
func Clear(navigation_mesh objects.NavigationMesh) {
	once.Do(singleton)
...
*/
//go:nosplit
func (self class) Bake(navigation_mesh objects.NavigationMesh, root_node objects.Node) {
...
*/
//go:nosplit
func (self class) Clear(navigation_mesh objects.NavigationMesh) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(navigation_mesh[0])[0])
	var r_ret callframe.Nil
