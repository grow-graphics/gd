...
func New() Instance {
	...
	return Instance{*(*classdb.TextureRect)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("TextureRect", func(ptr gd.Object) any { return [1]classdb.TextureRect{*(*classdb.TextureRect)(unsafe.Pointer(&ptr))} })
}
