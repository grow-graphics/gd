...
func New() Instance {
	...
	return Instance{*(*classdb.AudioListener2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("AudioListener2D", func(ptr gd.Object) any {
		return [1]classdb.AudioListener2D{*(*classdb.AudioListener2D)(unsafe.Pointer(&ptr))}
	})
}
