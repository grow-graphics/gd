...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeBooleanParameter)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("VisualShaderNodeBooleanParameter", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeBooleanParameter{*(*classdb.VisualShaderNodeBooleanParameter)(unsafe.Pointer(&ptr))}
	})
}
