...
*/
type Instance [1]classdb.VisualShaderNodeUIntParameter
type Any interface {
	gd.IsClass
...
func New() Instance {
	...
	return Instance{*(*classdb.VisualShaderNodeUIntParameter)(unsafe.Pointer(&object))}
}
...
func (self class) SetDefaultValueEnabled(enabled bool) {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.VisualShaderNodeUIntParameter.Bind_set_default_value_enabled, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	frame.Free()
}
...
func (self class) IsDefaultValueEnabled() bool {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.VisualShaderNodeUIntParameter.Bind_is_default_value_enabled, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
func (self class) SetDefaultValue(value gd.Int) {
	...
	var r_ret callframe.Nil
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.VisualShaderNodeUIntParameter.Bind_set_default_value, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	frame.Free()
}
...
func (self class) GetDefaultValue() gd.Int {
	...
	gd.Global.Object.MethodBindPointerCall(gd.Global.Methods.VisualShaderNodeUIntParameter.Bind_get_default_value, self.AsObject(), frame.Array(0), r_ret.Uintptr())
	var ret = r_ret.Get()
	frame.Free()
	return ret
}
...
func init() {
	classdb.Register("VisualShaderNodeUIntParameter", func(ptr gd.Object) any {
		return [1]classdb.VisualShaderNodeUIntParameter{*(*classdb.VisualShaderNodeUIntParameter)(unsafe.Pointer(&ptr))}
	})
}
