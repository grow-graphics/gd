...
func (self Instance) Shader() objects.Shader {
	return objects.Shader(class(self).GetShader())
}

func (self Instance) SetShader(value objects.Shader) {
	class(self).SetShader(value)
}

//go:nosplit
func (self class) SetShader(shader objects.Shader) {
...
//go:nosplit
func (self class) GetShader() objects.Shader {
	var frame = callframe.New()
