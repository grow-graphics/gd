...
func New() Instance {
	...
	return Instance{*(*classdb.RectangleShape2D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("RectangleShape2D", func(ptr gd.Object) any {
		return [1]classdb.RectangleShape2D{*(*classdb.RectangleShape2D)(unsafe.Pointer(&ptr))}
	})
}
