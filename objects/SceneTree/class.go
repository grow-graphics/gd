...
*/
func (self Instance) CreateTween() objects.Tween {
	return objects.Tween(class(self).CreateTween())
}
...
*/
func (self Instance) GetFirstNodeInGroup(group string) objects.Node {
	return objects.Node(class(self).GetFirstNodeInGroup(gd.NewStringName(group)))
}
...
*/
func (self Instance) ChangeSceneToPacked(packed_scene objects.PackedScene) gd.Error {
...
func (self Instance) EditedSceneRoot() objects.Node {
	return objects.Node(class(self).GetEditedSceneRoot())
}

func (self Instance) SetEditedSceneRoot(value objects.Node) {
	class(self).SetEditedSceneRoot(value)
}

func (self Instance) CurrentScene() objects.Node {
	return objects.Node(class(self).GetCurrentScene())
}

func (self Instance) SetCurrentScene(value objects.Node) {
	class(self).SetCurrentScene(value)
}

func (self Instance) Root() objects.Window {
	return objects.Window(class(self).GetRoot())
}
...
//go:nosplit
func (self class) GetRoot() objects.Window {
...
*/
//go:nosplit
func (self class) CreateTimer(time_sec gd.Float, process_always bool, process_in_physics bool, ignore_time_scale bool) objects.SceneTreeTimer {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) CreateTween() objects.Tween {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetFirstNodeInGroup(group gd.StringName) objects.Node {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(group))
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
//go:nosplit
func (self class) GetCurrentScene() objects.Node {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) ChangeSceneToPacked(packed_scene objects.PackedScene) int64 {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetMultiplayer(multiplayer objects.MultiplayerAPI, root_path gd.NodePath) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetMultiplayer(for_path gd.NodePath) objects.MultiplayerAPI {
	var frame = callframe.New()
...
func (self Instance) OnNodeAdded(cb func(node objects.Node)) {
	self[0].AsObject().Connect(gd.NewStringName("node_added"), gd.NewCallable(cb), 0)
}

func (self Instance) OnNodeRemoved(cb func(node objects.Node)) {
	self[0].AsObject().Connect(gd.NewStringName("node_removed"), gd.NewCallable(cb), 0)
}

func (self Instance) OnNodeRenamed(cb func(node objects.Node)) {
	self[0].AsObject().Connect(gd.NewStringName("node_renamed"), gd.NewCallable(cb), 0)
}

func (self Instance) OnNodeConfigurationWarningChanged(cb func(node objects.Node)) {
