...
func New() Instance {
	...
	return Instance{*(*classdb.Panel)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("Panel", func(ptr gd.Object) any { return [1]classdb.Panel{*(*classdb.Panel)(unsafe.Pointer(&ptr))} })
}
