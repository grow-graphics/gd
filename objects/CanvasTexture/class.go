...
func New() Instance {
	...
	return Instance{*(*classdb.CanvasTexture)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("CanvasTexture", func(ptr gd.Object) any {
		return [1]classdb.CanvasTexture{*(*classdb.CanvasTexture)(unsafe.Pointer(&ptr))}
	})
}
