...
*/
func (self Instance) GetParentNode3d() objects.Node3D {
	return objects.Node3D(class(self).GetParentNode3d())
}
...
*/
func (self Instance) GetWorld3d() objects.World3D {
...
*/
func (self Instance) AddGizmo(gizmo objects.Node3DGizmo) {
...
*/
//go:nosplit
func (self class) GetParentNode3d() objects.Node3D {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) AddGizmo(gizmo objects.Node3DGizmo) {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) SetSubgizmoSelection(gizmo objects.Node3DGizmo, id gd.Int, transform gd.Transform3D) {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(gizmo[0])[0])
