...
func New() Instance {
	...
	return Instance{*(*classdb.TextureLayered)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("TextureLayered", func(ptr gd.Object) any {
		return [1]classdb.TextureLayered{*(*classdb.TextureLayered)(unsafe.Pointer(&ptr))}
	})
}
