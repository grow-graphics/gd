...
func New() Instance {
	...
	return Instance{*(*classdb.OccluderInstance3D)(unsafe.Pointer(&object))}
}
...
func (self class) GetOccluder() objects.Occluder3D {
	...
	var ret = objects.Occluder3D{gd.PointerWithOwnershipTransferredToGo[classdb.Occluder3D](r_ret.Get())}
	frame.Free()
	return ret
}
...
func init() {
	classdb.Register("OccluderInstance3D", func(ptr gd.Object) any {
		return [1]classdb.OccluderInstance3D{*(*classdb.OccluderInstance3D)(unsafe.Pointer(&ptr))}
	})
}
