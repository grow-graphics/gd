...
func New() Instance {
	...
	return Instance{*(*classdb.SphereShape3D)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("SphereShape3D", func(ptr gd.Object) any {
		return [1]classdb.SphereShape3D{*(*classdb.SphereShape3D)(unsafe.Pointer(&ptr))}
	})
}
