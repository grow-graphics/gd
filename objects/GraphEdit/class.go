...
*/
type Instance [1]classdb.GraphEdit
...
*/
func (self Instance) ConnectNode(from_node string, from_port int, to_node string, to_port int) gd.Error {
...
*/
func (self Instance) GetElementFrame(element string) objects.GraphFrame {
	return objects.GraphFrame(class(self).GetElementFrame(gd.NewStringName(element)))
}
...
*/
func (self Instance) GetMenuHbox() objects.HBoxContainer {
	return objects.HBoxContainer(class(self).GetMenuHbox())
}
...
*/
func (self Instance) SetSelected(node objects.Node) {
...
func (self Instance) GridPattern() classdb.GraphEditGridPattern {
	return classdb.GraphEditGridPattern(class(self).GetGridPattern())
}

func (self Instance) SetGridPattern(value classdb.GraphEditGridPattern) {
...
func (self Instance) PanningScheme() classdb.GraphEditPanningScheme {
	return classdb.GraphEditPanningScheme(class(self).GetPanningScheme())
}

func (self Instance) SetPanningScheme(value classdb.GraphEditPanningScheme) {
...
*/
//go:nosplit
func (self class) GetElementFrame(element gd.StringName) objects.GraphFrame {
	var frame = callframe.New()
	callframe.Arg(frame, pointers.Get(element))
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetMenuHbox() objects.HBoxContainer {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) SetSelected(node objects.Node) {
	var frame = callframe.New()
...
func (self Instance) OnNodeSelected(cb func(node objects.Node)) {
	self[0].AsObject().Connect(gd.NewStringName("node_selected"), gd.NewCallable(cb), 0)
}

func (self Instance) OnNodeDeselected(cb func(node objects.Node)) {
