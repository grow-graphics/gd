...
*/
func RegisterScriptLanguage(language objects.ScriptLanguage) gd.Error {
	once.Do(singleton)
...
*/
func UnregisterScriptLanguage(language objects.ScriptLanguage) gd.Error {
	once.Do(singleton)
...
*/
//go:nosplit
func (self class) RegisterScriptLanguage(language objects.ScriptLanguage) int64 {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) UnregisterScriptLanguage(language objects.ScriptLanguage) int64 {
	var frame = callframe.New()
