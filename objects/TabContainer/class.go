...
*/
type Instance [1]classdb.TabContainer
type Any interface {
	gd.IsClass
...
*/
func (self Instance) GetCurrentTabControl() objects.Control {
	return objects.Control(class(self).GetCurrentTabControl())
}
...
*/
func (self Instance) GetTabBar() objects.TabBar {
	return objects.TabBar(class(self).GetTabBar())
}

/*
Returns the [Control] node from the tab at index [param tab_idx].
*/
func (self Instance) GetTabControl(tab_idx int) objects.Control {
	return objects.Control(class(self).GetTabControl(gd.Int(tab_idx)))
}
...
*/
func (self Instance) GetTabIdxFromControl(control objects.Control) int {
...
*/
func (self Instance) SetPopup(popup objects.Node) {
...
*/
func (self Instance) GetPopup() objects.Popup {
	return objects.Popup(class(self).GetPopup())
}
...
func (self Instance) TabsPosition() classdb.TabContainerTabPosition {
	return classdb.TabContainerTabPosition(class(self).GetTabsPosition())
}

func (self Instance) SetTabsPosition(value classdb.TabContainerTabPosition) {
...
func (self Instance) TabFocusMode() classdb.ControlFocusMode {
	return classdb.ControlFocusMode(class(self).GetTabFocusMode())
}

func (self Instance) SetTabFocusMode(value classdb.ControlFocusMode) {
...
*/
//go:nosplit
func (self class) GetCurrentTabControl() objects.Control {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetTabBar() objects.TabBar {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetTabControl(tab_idx gd.Int) objects.Control {
	var frame = callframe.New()
	callframe.Arg(frame, tab_idx)
	var r_ret = callframe.Ret[[1]uintptr](frame)
...
*/
//go:nosplit
func (self class) GetTabIdxFromControl(control objects.Control) gd.Int {
	var frame = callframe.New()
...
*/
//go:nosplit
func (self class) GetPopup() objects.Popup {
	var frame = callframe.New()
	var r_ret = callframe.Ret[[1]uintptr](frame)
