...
func New() Instance {
	...
	return Instance{*(*classdb.AudioEffectEQ10)(unsafe.Pointer(&object))}
}
...
func init() {
	classdb.Register("AudioEffectEQ10", func(ptr gd.Object) any {
		return [1]classdb.AudioEffectEQ10{*(*classdb.AudioEffectEQ10)(unsafe.Pointer(&ptr))}
	})
}
