...
[b]Note:[/b] Like GLTFDocument itself, all GLTFDocumentExtension classes must be stateless in order to function properly. If you need to store data, use the [code]set_additional_data[/code] and [code]get_additional_data[/code] methods in [GLTFState] or [GLTFNode].
	...
	type GLTFDocumentExtension interface {
		...
		ImportPreflight(state objects.GLTFState, extensions []string) gd.Error
		...
		ParseNodeExtensions(state objects.GLTFState, gltf_node objects.GLTFNode, extensions gd.Dictionary) gd.Error
		...
		ParseImageData(state objects.GLTFState, image_data []byte, mime_type string, ret_image objects.Image) gd.Error
		...
		ParseTextureJson(state objects.GLTFState, texture_json gd.Dictionary, ret_gltf_texture objects.GLTFTexture) gd.Error
		...
		GenerateSceneNode(state objects.GLTFState, gltf_node objects.GLTFNode, scene_parent objects.Node) objects.Node3D
		...
		ImportPostParse(state objects.GLTFState) gd.Error
		...
		ImportNode(state objects.GLTFState, gltf_node objects.GLTFNode, json gd.Dictionary, node objects.Node) gd.Error
		//Part of the import process. This method is run last, after all other parts of the import process.
		//This method can be used to modify the final Godot scene generated by the import process.
		ImportPost(state objects.GLTFState, root objects.Node) gd.Error
		...
		ExportPreflight(state objects.GLTFState, root objects.Node) gd.Error
		...
		ConvertSceneNode(state objects.GLTFState, gltf_node objects.GLTFNode, scene_node objects.Node)
		...
		ExportPreserialize(state objects.GLTFState) gd.Error
		...
		SerializeImageToBytes(state objects.GLTFState, image objects.Image, image_dict gd.Dictionary, image_format string, lossy_quality float64) []byte
		//Part of the export process. This method is run after [method _get_saveable_image_formats] and before [method _serialize_texture_json].
		...
		SaveImageAtPath(state objects.GLTFState, image objects.Image, file_path string, image_format string, lossy_quality float64) gd.Error
		...
		SerializeTextureJson(state objects.GLTFState, texture_json gd.Dictionary, gltf_texture objects.GLTFTexture, image_format string) gd.Error
		...
		ExportNode(state objects.GLTFState, gltf_node objects.GLTFNode, json gd.Dictionary, node objects.Node) gd.Error
		//Part of the export process. This method is run last, after all other parts of the export process.
		//This method can be used to modify the final JSON of the generated GLTF file.
		ExportPost(state objects.GLTFState) gd.Error
	}
*/
...
The return value is used to determine if this [GLTFDocumentExtension] instance should be used for importing a given GLTF file. If [constant OK], the import will use this [GLTFDocumentExtension] instance. If not overridden, [constant OK] is returned.
*/
func (Instance) _import_preflight(impl func(ptr unsafe.Pointer, state objects.GLTFState, extensions []string) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
...
Runs when parsing the node extensions of a GLTFNode. This method can be used to process the extension JSON data into a format that can be used by [method _generate_scene_node]. The return value should be a member of the [enum Error] enum.
*/
func (Instance) _parse_node_extensions(impl func(ptr unsafe.Pointer, state objects.GLTFState, gltf_node objects.GLTFNode, extensions gd.Dictionary) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var gltf_node = objects.GLTFNode{pointers.New[classdb.GLTFNode]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
Runs when parsing image data from a GLTF file. The data could be sourced from a separate file, a URI, or a buffer, and then is passed as a byte array.
*/
func (Instance) _parse_image_data(impl func(ptr unsafe.Pointer, state objects.GLTFState, image_data []byte, mime_type string, ret_image objects.Image) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		...
		var ret_image = objects.Image{pointers.New[classdb.Image]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 3)})}
...
Runs when parsing the texture JSON from the GLTF textures array. This can be used to set the source image index to use as the texture.
*/
func (Instance) _parse_texture_json(impl func(ptr unsafe.Pointer, state objects.GLTFState, texture_json gd.Dictionary, ret_gltf_texture objects.GLTFTexture) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var texture_json = pointers.New[gd.Dictionary](gd.UnsafeGet[[1]uintptr](p_args, 1))
		defer pointers.End(texture_json)
		var ret_gltf_texture = objects.GLTFTexture{pointers.New[classdb.GLTFTexture]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 2)})}
...
[b]Note:[/b] The [param scene_parent] parameter may be null if this is the single root node.
*/
func (Instance) _generate_scene_node(impl func(ptr unsafe.Pointer, state objects.GLTFState, gltf_node objects.GLTFNode, scene_parent objects.Node) objects.Node3D) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var gltf_node = objects.GLTFNode{pointers.New[classdb.GLTFNode]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
		defer pointers.End(gltf_node[0])
		var scene_parent = objects.Node{pointers.New[classdb.Node]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 2)})}
...
This method can be used to modify any of the data imported so far after parsing, before generating the nodes and then running the final per-node import step.
*/
func (Instance) _import_post_parse(impl func(ptr unsafe.Pointer, state objects.GLTFState) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
This method can be used to make modifications to each of the generated Godot scene nodes.
*/
func (Instance) _import_node(impl func(ptr unsafe.Pointer, state objects.GLTFState, gltf_node objects.GLTFNode, json gd.Dictionary, node objects.Node) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var gltf_node = objects.GLTFNode{pointers.New[classdb.GLTFNode]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
		...
		var node = objects.Node{pointers.New[classdb.Node]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 3)})}
...
This method can be used to modify the final Godot scene generated by the import process.
*/
func (Instance) _import_post(impl func(ptr unsafe.Pointer, state objects.GLTFState, root objects.Node) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var root = objects.Node{pointers.New[classdb.Node]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
The return value is used to determine if this [GLTFDocumentExtension] instance should be used for exporting a given GLTF file. If [constant OK], the export will use this [GLTFDocumentExtension] instance. If not overridden, [constant OK] is returned.
*/
func (Instance) _export_preflight(impl func(ptr unsafe.Pointer, state objects.GLTFState, root objects.Node) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var root = objects.Node{pointers.New[classdb.Node]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
Runs when converting the data from a Godot scene node. This method can be used to process the Godot scene node data into a format that can be used by [method _export_node].
*/
func (Instance) _convert_scene_node(impl func(ptr unsafe.Pointer, state objects.GLTFState, gltf_node objects.GLTFNode, scene_node objects.Node)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var gltf_node = objects.GLTFNode{pointers.New[classdb.GLTFNode]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
		defer pointers.End(gltf_node[0])
		var scene_node = objects.Node{pointers.New[classdb.Node]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 2)})}
...
This method can be used to alter the state before performing serialization. It runs every time when generating a buffer with [method GLTFDocument.generate_buffer] or writing to the file system with [method GLTFDocument.write_to_filesystem].
*/
func (Instance) _export_preserialize(impl func(ptr unsafe.Pointer, state objects.GLTFState) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
This method must set the image MIME type in the [param image_dict] with the [code]"mimeType"[/code] key. For example, for a PNG image, it would be set to [code]"image/png"[/code]. The return value must be a [PackedByteArray] containing the image data.
*/
func (Instance) _serialize_image_to_bytes(impl func(ptr unsafe.Pointer, state objects.GLTFState, image objects.Image, image_dict gd.Dictionary, image_format string, lossy_quality float64) []byte) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var image = objects.Image{pointers.New[classdb.Image]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
This method is run when saving images separately from the GLTF file. When images are embedded, [method _serialize_image_to_bytes] runs instead. Note that these methods only run when this [GLTFDocumentExtension] is selected as the image exporter.
*/
func (Instance) _save_image_at_path(impl func(ptr unsafe.Pointer, state objects.GLTFState, image objects.Image, file_path string, image_format string, lossy_quality float64) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var image = objects.Image{pointers.New[classdb.Image]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
This method can be used to set up the extensions for the texture JSON by editing [param texture_json]. The extension must also be added as used extension with [method GLTFState.add_used_extension], be sure to set [code]required[/code] to [code]true[/code] if you are not providing a fallback.
*/
func (Instance) _serialize_texture_json(impl func(ptr unsafe.Pointer, state objects.GLTFState, texture_json gd.Dictionary, gltf_texture objects.GLTFTexture, image_format string) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var texture_json = pointers.New[gd.Dictionary](gd.UnsafeGet[[1]uintptr](p_args, 1))
		defer pointers.End(texture_json)
		var gltf_texture = objects.GLTFTexture{pointers.New[classdb.GLTFTexture]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 2)})}
...
This method can be used to modify the final JSON of each node. Data should be primarily stored in [param gltf_node] prior to serializing the JSON, but the original Godot [param node] is also provided if available. The node may be null if not available, such as when exporting GLTF data not generated from a Godot scene.
*/
func (Instance) _export_node(impl func(ptr unsafe.Pointer, state objects.GLTFState, gltf_node objects.GLTFNode, json gd.Dictionary, node objects.Node) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var gltf_node = objects.GLTFNode{pointers.New[classdb.GLTFNode]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
This method can be used to modify the final JSON of the generated GLTF file.
*/
func (Instance) _export_post(impl func(ptr unsafe.Pointer, state objects.GLTFState) gd.Error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
The return value is used to determine if this [GLTFDocumentExtension] instance should be used for importing a given GLTF file. If [constant OK], the import will use this [GLTFDocumentExtension] instance. If not overridden, [constant OK] is returned.
*/
func (class) _import_preflight(impl func(ptr unsafe.Pointer, state objects.GLTFState, extensions gd.PackedStringArray) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var extensions = pointers.New[gd.PackedStringArray](gd.UnsafeGet[[2]uintptr](p_args, 1))
...
Runs when parsing the node extensions of a GLTFNode. This method can be used to process the extension JSON data into a format that can be used by [method _generate_scene_node]. The return value should be a member of the [enum Error] enum.
*/
func (class) _parse_node_extensions(impl func(ptr unsafe.Pointer, state objects.GLTFState, gltf_node objects.GLTFNode, extensions gd.Dictionary) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var gltf_node = objects.GLTFNode{pointers.New[classdb.GLTFNode]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
Runs when parsing image data from a GLTF file. The data could be sourced from a separate file, a URI, or a buffer, and then is passed as a byte array.
*/
func (class) _parse_image_data(impl func(ptr unsafe.Pointer, state objects.GLTFState, image_data gd.PackedByteArray, mime_type gd.String, ret_image objects.Image) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var image_data = pointers.New[gd.PackedByteArray](gd.UnsafeGet[[2]uintptr](p_args, 1))
...
Runs when parsing the texture JSON from the GLTF textures array. This can be used to set the source image index to use as the texture.
*/
func (class) _parse_texture_json(impl func(ptr unsafe.Pointer, state objects.GLTFState, texture_json gd.Dictionary, ret_gltf_texture objects.GLTFTexture) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var texture_json = pointers.New[gd.Dictionary](gd.UnsafeGet[[1]uintptr](p_args, 1))
...
[b]Note:[/b] The [param scene_parent] parameter may be null if this is the single root node.
*/
func (class) _generate_scene_node(impl func(ptr unsafe.Pointer, state objects.GLTFState, gltf_node objects.GLTFNode, scene_parent objects.Node) objects.Node3D) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var gltf_node = objects.GLTFNode{pointers.New[classdb.GLTFNode]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
This method can be used to modify any of the data imported so far after parsing, before generating the nodes and then running the final per-node import step.
*/
func (class) _import_post_parse(impl func(ptr unsafe.Pointer, state objects.GLTFState) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
This method can be used to make modifications to each of the generated Godot scene nodes.
*/
func (class) _import_node(impl func(ptr unsafe.Pointer, state objects.GLTFState, gltf_node objects.GLTFNode, json gd.Dictionary, node objects.Node) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var gltf_node = objects.GLTFNode{pointers.New[classdb.GLTFNode]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
This method can be used to modify the final Godot scene generated by the import process.
*/
func (class) _import_post(impl func(ptr unsafe.Pointer, state objects.GLTFState, root objects.Node) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var root = objects.Node{pointers.New[classdb.Node]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
The return value is used to determine if this [GLTFDocumentExtension] instance should be used for exporting a given GLTF file. If [constant OK], the export will use this [GLTFDocumentExtension] instance. If not overridden, [constant OK] is returned.
*/
func (class) _export_preflight(impl func(ptr unsafe.Pointer, state objects.GLTFState, root objects.Node) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var root = objects.Node{pointers.New[classdb.Node]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
Runs when converting the data from a Godot scene node. This method can be used to process the Godot scene node data into a format that can be used by [method _export_node].
*/
func (class) _convert_scene_node(impl func(ptr unsafe.Pointer, state objects.GLTFState, gltf_node objects.GLTFNode, scene_node objects.Node)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var gltf_node = objects.GLTFNode{pointers.New[classdb.GLTFNode]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
This method can be used to alter the state before performing serialization. It runs every time when generating a buffer with [method GLTFDocument.generate_buffer] or writing to the file system with [method GLTFDocument.write_to_filesystem].
*/
func (class) _export_preserialize(impl func(ptr unsafe.Pointer, state objects.GLTFState) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		self := reflect.ValueOf(class).UnsafePointer()
...
This method must set the image MIME type in the [param image_dict] with the [code]"mimeType"[/code] key. For example, for a PNG image, it would be set to [code]"image/png"[/code]. The return value must be a [PackedByteArray] containing the image data.
*/
func (class) _serialize_image_to_bytes(impl func(ptr unsafe.Pointer, state objects.GLTFState, image objects.Image, image_dict gd.Dictionary, image_format gd.String, lossy_quality gd.Float) gd.PackedByteArray) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var image = objects.Image{pointers.New[classdb.Image]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
This method is run when saving images separately from the GLTF file. When images are embedded, [method _serialize_image_to_bytes] runs instead. Note that these methods only run when this [GLTFDocumentExtension] is selected as the image exporter.
*/
func (class) _save_image_at_path(impl func(ptr unsafe.Pointer, state objects.GLTFState, image objects.Image, file_path gd.String, image_format gd.String, lossy_quality gd.Float) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var image = objects.Image{pointers.New[classdb.Image]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
This method can be used to set up the extensions for the texture JSON by editing [param texture_json]. The extension must also be added as used extension with [method GLTFState.add_used_extension], be sure to set [code]required[/code] to [code]true[/code] if you are not providing a fallback.
*/
func (class) _serialize_texture_json(impl func(ptr unsafe.Pointer, state objects.GLTFState, texture_json gd.Dictionary, gltf_texture objects.GLTFTexture, image_format gd.String) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var texture_json = pointers.New[gd.Dictionary](gd.UnsafeGet[[1]uintptr](p_args, 1))
...
This method can be used to modify the final JSON of each node. Data should be primarily stored in [param gltf_node] prior to serializing the JSON, but the original Godot [param node] is also provided if available. The node may be null if not available, such as when exporting GLTF data not generated from a Godot scene.
*/
func (class) _export_node(impl func(ptr unsafe.Pointer, state objects.GLTFState, gltf_node objects.GLTFNode, json gd.Dictionary, node objects.Node) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var gltf_node = objects.GLTFNode{pointers.New[classdb.GLTFNode]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
This method can be used to modify the final JSON of the generated GLTF file.
*/
func (class) _export_post(impl func(ptr unsafe.Pointer, state objects.GLTFState) int64) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		self := reflect.ValueOf(class).UnsafePointer()
