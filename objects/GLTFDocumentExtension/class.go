...
[b]Note:[/b] Like GLTFDocument itself, all GLTFDocumentExtension classes must be stateless in order to function properly. If you need to store data, use the [code]set_additional_data[/code] and [code]get_additional_data[/code] methods in [GLTFState] or [GLTFNode].
	...
	type GLTFDocumentExtension interface {
		...
		ParseNodeExtensions(state objects.GLTFState, gltf_node objects.GLTFNode, extensions gd.Dictionary) error
		...
		ParseTextureJson(state objects.GLTFState, texture_json gd.Dictionary, ret_gltf_texture objects.GLTFTexture) error
		...
		ImportNode(state objects.GLTFState, gltf_node objects.GLTFNode, json gd.Dictionary, node objects.Node) error
		...
		SaveImageAtPath(state objects.GLTFState, image objects.Image, file_path string, image_format string, lossy_quality float64) error
		...
		SerializeTextureJson(state objects.GLTFState, texture_json gd.Dictionary, gltf_texture objects.GLTFTexture, image_format string) error
		...
		ExportNode(state objects.GLTFState, gltf_node objects.GLTFNode, json gd.Dictionary, node objects.Node) error
...
Runs when parsing the node extensions of a GLTFNode. This method can be used to process the extension JSON data into a format that can be used by [method _generate_scene_node]. The return value should be a member of the [enum Error] enum.
*/
func (Instance) _parse_node_extensions(impl func(ptr unsafe.Pointer, state objects.GLTFState, gltf_node objects.GLTFNode, extensions gd.Dictionary) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
...
Runs when parsing the texture JSON from the GLTF textures array. This can be used to set the source image index to use as the texture.
*/
func (Instance) _parse_texture_json(impl func(ptr unsafe.Pointer, state objects.GLTFState, texture_json gd.Dictionary, ret_gltf_texture objects.GLTFTexture) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
...
This method can be used to make modifications to each of the generated Godot scene nodes.
*/
func (Instance) _import_node(impl func(ptr unsafe.Pointer, state objects.GLTFState, gltf_node objects.GLTFNode, json gd.Dictionary, node objects.Node) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var gltf_node = objects.GLTFNode{pointers.New[classdb.GLTFNode]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
This method is run when saving images separately from the GLTF file. When images are embedded, [method _serialize_image_to_bytes] runs instead. Note that these methods only run when this [GLTFDocumentExtension] is selected as the image exporter.
*/
func (Instance) _save_image_at_path(impl func(ptr unsafe.Pointer, state objects.GLTFState, image objects.Image, file_path string, image_format string, lossy_quality float64) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var image = objects.Image{pointers.New[classdb.Image]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
...
This method can be used to set up the extensions for the texture JSON by editing [param texture_json]. The extension must also be added as used extension with [method GLTFState.add_used_extension], be sure to set [code]required[/code] to [code]true[/code] if you are not providing a fallback.
*/
func (Instance) _serialize_texture_json(impl func(ptr unsafe.Pointer, state objects.GLTFState, texture_json gd.Dictionary, gltf_texture objects.GLTFTexture, image_format string) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var texture_json = pointers.New[gd.Dictionary](gd.UnsafeGet[[1]uintptr](p_args, 1))
...
This method can be used to modify the final JSON of each node. Data should be primarily stored in [param gltf_node] prior to serializing the JSON, but the original Godot [param node] is also provided if available. The node may be null if not available, such as when exporting GLTF data not generated from a Godot scene.
*/
func (Instance) _export_node(impl func(ptr unsafe.Pointer, state objects.GLTFState, gltf_node objects.GLTFNode, json gd.Dictionary, node objects.Node) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args gd.UnsafeArgs, p_back gd.UnsafeBack) {
		var state = objects.GLTFState{pointers.New[classdb.GLTFState]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 0)})}
		defer pointers.End(state[0])
		var gltf_node = objects.GLTFNode{pointers.New[classdb.GLTFNode]([3]uintptr{gd.UnsafeGet[uintptr](p_args, 1)})}
