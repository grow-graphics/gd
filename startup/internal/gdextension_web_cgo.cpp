...
void gd_classdb_FileAccess_write(uintptr_t FileAccess, BUFFER buf, uint64_t len) {
    gdextension_file_access_store_buffer((GDExtensionObjectPtr)FileAccess, (const uint8_t *)BUFFER_POINTER(buf), len);
};

int64_t gd_classdb_FileAccess_read(uintptr_t FileAccess, BUFFER buf, uint64_t len) {
...
int64_t gd_classdb_XMLParser_load(uintptr_t XMLParser, BUFFER buf, uint64_t len) {
...
void gd_editor_add_documentation(STRING xml, uint64_t len) {
...
void gd_log_error(
    STRING text, uint64_t text_len,
    STRING code, uint64_t code_len,
    STRING func, uint64_t func_len,
    STRING file, uint64_t file_len,
...
uintptr_t gd_string_decode_utf32(STRING s, uint64_t len) {
    uintptr_t ptr = 0;
...
uintptr_t gd_string_intern_utf8(STRING s, uint64_t len) {
    uintptr_t ptr = 0;
