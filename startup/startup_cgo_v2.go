...
func go_on_callable_call(p0 C.uintptr_t, p1 C.int64_t, p2 *C.void) {
	gdextension.On.Callables.Call(gdextension.FunctionID(p0), int64(p1), gdextension.CallAccepts[gdextension.Variant](p2))
}
...
func go_on_callable_stringify(p0 C.uintptr_t, p1 *C.void) C.uintptr_t {
	result, _ := gdextension.On.Callables.Stringify(gdextension.FunctionID(p0), gdextension.Call(p1))
...
func go_on_callable_get_argument_count(p0 C.uintptr_t, p1 *C.void) C.int64_t {
	result, _ := gdextension.On.Callables.ArgumentCount(gdextension.FunctionID(p0), gdextension.Call(p1))
...
func go_on_extension_class_method(p0 C.uintptr_t, p1 C.uintptr_t, p2 C.uint32_t) C.uintptr_t {
	return C.uintptr_t(gdextension.On.Extension.Class.Method(gdextension.ExtensionClassID(p0), gdextension.StringName(p1), uint32(p2)))
}
...
func go_on_extension_instance_set(p0 C.uintptr_t, p1 C.uintptr_t, p2 C.uint64_t, p3 C.uint64_t, p4 C.uint64_t) C.bool {
	return C.bool(gdextension.On.Extension.Instance.Set(gdextension.ExtensionInstanceID(p0), gdextension.StringName(p1), gdextension.Variant{uint64(p2), uint64(p3), uint64(p4)}))
}
...
func go_on_extension_instance_property_has_default(p0 C.uintptr_t, p1 C.uintptr_t) C.bool {
	return C.bool(gdextension.On.Extension.Instance.PropertyHasDefault(gdextension.ExtensionInstanceID(p0), gdextension.StringName(p1)))
}
...
func go_on_extension_instance_property_get_default(p0 C.uintptr_t, p1 C.uintptr_t, p2 *C.void) C.bool {
	_, result := gdextension.On.Extension.Instance.PropertyGetDefault(gdextension.ExtensionInstanceID(p0), gdextension.StringName(p1), gdextension.Call(p2))
	return C.bool(result)
}
...
func go_on_extension_instance_stringify(p0 C.uintptr_t) C.uintptr_t {
	return C.uintptr_t(gdextension.On.Extension.Instance.Stringify(gdextension.ExtensionInstanceID(p0)))
}
...
func go_on_extension_instance_call(p0 C.uintptr_t, p1 C.uintptr_t, p2 C.int64_t, p3 *C.void) {
	gdextension.On.Extension.Instance.Call(gdextension.ExtensionInstanceID(p0), gdextension.FunctionID(p1), int64(p2), gdextension.CallAccepts[gdextension.Variant](p3))
}

//export go_on_extension_instance_call_checked
func go_on_extension_instance_call_checked(p0 C.uintptr_t, p1 C.uintptr_t, p2 *C.void) {
	gdextension.On.Extension.Instance.CallChecked(gdextension.ExtensionInstanceID(p0), gdextension.FunctionID(p1), gdextension.CallAccepts[gdextension.Variant](p2))
}
...
func go_on_extension_instance_unsafe_call(p0 C.uintptr_t, p1 C.uintptr_t, p2 *C.void) {
	gdextension.On.Extension.Instance.Unsafe.Call(gdextension.ExtensionInstanceID(p0), gdextension.FunctionID(p1), gdextension.CallAccepts[interface{}](p2))
}
...
func go_on_extension_script_get_property_type(p0 C.uintptr_t, p1 *C.void) C.uint32_t {
	result, _ := gdextension.On.Extension.Script.PropertyType(gdextension.StringName(p0), gdextension.Call(p1))
	return C.uint32_t(result)
}
...
func go_on_extension_script_get_property_state(p0 C.uintptr_t, p1 C.uintptr_t, p2 C.uintptr_t) {
	gdextension.On.Extension.Script.PropertyState(gdextension.ExtensionInstanceID(p0), gdextension.FunctionID(p1), uintptr(p2))
}
...
func go_on_extension_script_has_method(p0 C.uintptr_t, p1 C.uintptr_t) C.bool {
	return C.bool(gdextension.On.Extension.Script.HasMethod(gdextension.ExtensionInstanceID(p0), gdextension.StringName(p1)))
}
...
func go_on_extension_script_get_method_argument_count(p0 C.uintptr_t, p1 C.uintptr_t) C.int64_t {
	return C.int64_t(gdextension.On.Extension.Script.MethodArgumentCount(gdextension.ExtensionInstanceID(p0), gdextension.StringName(p1)))
}
...
func init() {
	...
	gdextension.Host.Builtins.Call = func(p0 gdextension.FunctionID, p1 int32, p2 gdextension.CallAccepts[interface{}]) (_ gdextension.CallReturns[gdextension.Variant], _ gdextension.MaybeError) {
		C.gd_builtin_call(C.uintptr_t(p0), C.int32_t(p1), unsafe.Pointer(p2))
		return
	}
	...
	gdextension.Host.ClassDB.FileAccess.Write = func(p0 gdextension.Object, p1 []byte) {
		C.gd_classdb_FileAccess_write(C.uintptr_t(p0), (*C.char)(unsafe.Pointer(unsafe.SliceData(p1))), C.uint64_t(len(p1)))
		return
	}
	gdextension.Host.ClassDB.FileAccess.Read = func(p0 gdextension.Object, p1 []byte) (result int64) {
		result = int64(C.gd_classdb_FileAccess_read(C.uintptr_t(p0), (*C.char)(unsafe.Pointer(unsafe.SliceData(p1))), C.uint64_t(len(p1))))
		return
	}
	...
	gdextension.Host.ClassDB.MethodList.Make = func(p0 int32) (result gdextension.MethodList) {
		result = gdextension.MethodList(C.gd_method_list_make(C.int32_t(p0)))
		return
	}
	gdextension.Host.ClassDB.MethodList.Push = func(p0 gdextension.MethodList, p1 gdextension.StringName, p2 gdextension.FunctionID, p3 gdextension.MethodFlags, p4 bool, p5 gdextension.PropertyList, p6 uint32, p7 gdextension.PropertyList, p8 uint32, p9 gdextension.CallAccepts[gdextension.Variant]) {
		C.gd_method_list_push(C.uintptr_t(p0), C.uintptr_t(p1), C.uintptr_t(p2), C.uint32_t(p3), C.bool(p4), C.uintptr_t(p5), C.uint32_t(p6), C.uintptr_t(p7), C.uint32_t(p8), unsafe.Pointer(p9))
		return
	}
	...
	gdextension.Host.ClassDB.PropertyList.Make = func(p0 int32) (result gdextension.PropertyList) {
		result = gdextension.PropertyList(C.gd_property_list_make(C.int32_t(p0)))
		return
	}
	gdextension.Host.ClassDB.PropertyList.Push = func(p0 gdextension.PropertyList, p1 gdextension.VariantType, p2 gdextension.StringName, p3 gdextension.StringName, p4 uint32, p5 gdextension.String, p6 uint32, p7 gdextension.ArgumentMetadata) {
		C.gd_property_list_push(C.uintptr_t(p0), C.uint32_t(p1), C.uintptr_t(p2), C.uintptr_t(p3), C.uint32_t(p4), C.uintptr_t(p5), C.uint32_t(p6), C.uint32_t(p7))
		return
	}
	...
	gdextension.Host.ClassDB.PropertyList.Info.Name = func(p0 gdextension.PropertyList) (result gdextension.StringName) {
		result = gdextension.StringName(C.gd_property_info_name(C.uintptr_t(p0)))
		return
	}
	gdextension.Host.ClassDB.PropertyList.Info.ClassName = func(p0 gdextension.PropertyList) (result gdextension.StringName) {
		result = gdextension.StringName(C.gd_property_info_class_name(C.uintptr_t(p0)))
		return
	}
	...
	gdextension.Host.ClassDB.PropertyList.Info.HinString = func(p0 gdextension.PropertyList) (result gdextension.String) {
		result = gdextension.String(C.gd_property_info_hint_string(C.uintptr_t(p0)))
		return
	}
	...
	gdextension.Host.ClassDB.Register.Class = func(p0 gdextension.StringName, p1 gdextension.StringName, p2 gdextension.ExtensionClassID, p3 bool, p4 bool, p5 bool, p6 bool, p7 gdextension.String) {
		C.gd_classdb_register(C.uintptr_t(p0), C.uintptr_t(p1), C.uintptr_t(p2), C.bool(p3), C.bool(p4), C.bool(p5), C.bool(p6), C.uintptr_t(p7))
		return
	}
	gdextension.Host.ClassDB.Register.Methods = func(p0 gdextension.StringName, p1 gdextension.MethodList) {
		C.gd_classdb_register_methods(C.uintptr_t(p0), C.uintptr_t(p1))
		return
	}
	gdextension.Host.ClassDB.Register.Constant = func(p0 gdextension.StringName, p1 gdextension.StringName, p2 gdextension.StringName, p3 int64, p4 bool) {
		C.gd_classdb_register_constant(C.uintptr_t(p0), C.uintptr_t(p1), C.uintptr_t(p2), C.int64_t(p3), C.bool(p4))
		return
	}
	gdextension.Host.ClassDB.Register.Property = func(p0 gdextension.StringName, p1 gdextension.PropertyList, p2 gdextension.StringName, p3 gdextension.StringName) {
		C.gd_classdb_register_property(C.uintptr_t(p0), C.uintptr_t(p1), C.uintptr_t(p2), C.uintptr_t(p3))
		return
	}
	gdextension.Host.ClassDB.Register.PropertyIndexed = func(p0 gdextension.StringName, p1 gdextension.PropertyList, p2 gdextension.StringName, p3 gdextension.StringName, p4 int64) {
		C.gd_classdb_register_property_indexed(C.uintptr_t(p0), C.uintptr_t(p1), C.uintptr_t(p2), C.uintptr_t(p3), C.int64_t(p4))
		return
	}
	gdextension.Host.ClassDB.Register.PropertyGroup = func(p0 gdextension.StringName, p1 gdextension.String, p2 gdextension.String) {
		C.gd_classdb_register_property_group(C.uintptr_t(p0), C.uintptr_t(p1), C.uintptr_t(p2))
		return
	}
	gdextension.Host.ClassDB.Register.PropertySubgroup = func(p0 gdextension.StringName, p1 gdextension.String, p2 gdextension.String) {
		C.gd_classdb_register_property_sub_group(C.uintptr_t(p0), C.uintptr_t(p1), C.uintptr_t(p2))
		return
	}
	gdextension.Host.ClassDB.Register.Signal = func(p0 gdextension.StringName, p1 gdextension.StringName, p2 gdextension.PropertyList) {
		C.gd_classdb_register_signal(C.uintptr_t(p0), C.uintptr_t(p1), C.uintptr_t(p2))
		return
	}
	gdextension.Host.ClassDB.Register.Removal = func(p0 gdextension.StringName) {
		C.gd_classdb_register_removal(C.uintptr_t(p0))
		return
	}
	gdextension.Host.ClassDB.WorkerThreadPool.AddTask = func(p0 gdextension.Object, p1 gdextension.TaskID, p2 bool, p3 gdextension.String) {
		C.gd_classdb_WorkerThreadPool_add_task(C.uintptr_t(p0), C.uintptr_t(p1), C.bool(p2), C.uintptr_t(p3))
		return
	}
	gdextension.Host.ClassDB.WorkerThreadPool.AddGroupTask = func(p0 gdextension.Object, p1 gdextension.TaskID, p2 int32, p3 int32, p4 bool, p5 gdextension.String) {
		C.gd_classdb_WorkerThreadPool_add_group_task(C.uintptr_t(p0), C.uintptr_t(p1), C.int32_t(p2), C.int32_t(p3), C.bool(p4), C.uintptr_t(p5))
		return
	}
	gdextension.Host.ClassDB.XMLParser.Load = func(p0 gdextension.Object, p1 []byte) (result int64) {
		result = int64(C.gd_classdb_XMLParser_load(C.uintptr_t(p0), (*C.char)(unsafe.Pointer(unsafe.SliceData(p1))), C.uint64_t(len(p1))))
		return
	}
	...
	gdextension.Host.Editor.AddDocumentation = func(p0 string) {
		C.gd_editor_add_documentation((*C.char)(unsafe.Pointer(unsafe.StringData(p0))), C.uint64_t(len(p0)))
		return
	}
	gdextension.Host.Editor.AddPlugin = func(p0 gdextension.StringName) {
		C.gd_editor_add_plugin(C.uintptr_t(p0))
		return
	}
	gdextension.Host.Editor.EndPlugin = func(p0 gdextension.StringName) {
		C.gd_editor_end_plugin(C.uintptr_t(p0))
		return
	}
	gdextension.Host.Iterators.Make = func(p0 gdextension.Variant, p1 gdextension.Call) (_ gdextension.CallReturns[gdextension.Iterator], result bool, _ gdextension.MaybeError) {
		result = bool(C.gd_iterator_make(C.uint64_t(p0[0]), C.uint64_t(p0[1]), C.uint64_t(p0[2]), unsafe.Pointer(p1)))
		return
	}
	gdextension.Host.Iterators.Next = func(p0 gdextension.Variant, p1 gdextension.Call, p2 gdextension.Iterator) (_ gdextension.CallReturns[gdextension.Iterator], result bool, _ gdextension.MaybeError) {
		result = bool(C.gd_iterator_next(C.uint64_t(p0[0]), C.uint64_t(p0[1]), C.uint64_t(p0[2]), unsafe.Pointer(p1), C.uint64_t(p2[0]), C.uint64_t(p2[1]), C.uint64_t(p2[2])))
		return
	}
	gdextension.Host.Iterators.Load = func(p0 gdextension.Variant, p1 gdextension.Call, p2 gdextension.Iterator) (_ gdextension.CallReturns[gdextension.Variant], result bool, _ gdextension.MaybeError) {
		result = bool(C.gd_iterator_load(C.uint64_t(p0[0]), C.uint64_t(p0[1]), C.uint64_t(p0[2]), unsafe.Pointer(p1), C.uint64_t(p2[0]), C.uint64_t(p2[1]), C.uint64_t(p2[2])))
		return
	}
	gdextension.Host.Log.Error = func(p0 string, p1 string, p2 string, p3 string, p4 int32, p5 bool) {
		C.gd_log_error((*C.char)(unsafe.Pointer(unsafe.StringData(p0))), C.uint64_t(len(p0)), (*C.char)(unsafe.Pointer(unsafe.StringData(p1))), C.uint64_t(len(p1)), (*C.char)(unsafe.Pointer(unsafe.StringData(p2))), C.uint64_t(len(p2)), (*C.char)(unsafe.Pointer(unsafe.StringData(p3))), C.uint64_t(len(p3)), C.int32_t(p4), C.bool(p5))
		return
	}
	gdextension.Host.Log.Warning = func(p0 string, p1 string, p2 string, p3 string, p4 int32, p5 bool) {
		C.gd_log_warning((*C.char)(unsafe.Pointer(unsafe.StringData(p0))), C.uint64_t(len(p0)), (*C.char)(unsafe.Pointer(unsafe.StringData(p1))), C.uint64_t(len(p1)), (*C.char)(unsafe.Pointer(unsafe.StringData(p2))), C.uint64_t(len(p2)), (*C.char)(unsafe.Pointer(unsafe.StringData(p3))), C.uint64_t(len(p3)), C.int32_t(p4), C.bool(p5))
		return
	}
	gdextension.Host.Memory.Malloc = func(p0 uintptr) (result gdextension.Pointer) {
		result = gdextension.Pointer(C.gd_memory_malloc(C.uintptr_t(p0)))
		return
	}
	gdextension.Host.Memory.Sizeof = func(p0 gdextension.StringName) (result uint64) {
		result = uint64(C.gd_memory_sizeof(C.uintptr_t(p0)))
		return
	}
	gdextension.Host.Memory.Resize = func(p0 gdextension.Pointer, p1 uintptr) (result gdextension.Pointer) {
		result = gdextension.Pointer(C.gd_memory_resize(C.uintptr_t(p0), C.uintptr_t(p1)))
		return
	}
	...
	gdextension.Host.Objects.Make = func(p0 gdextension.StringName) (result gdextension.Object) {
		result = gdextension.Object(C.gd_object_make(C.uintptr_t(p0)))
		return
	}
	gdextension.Host.Objects.Call = func(p0 gdextension.Object, p1 gdextension.FunctionID, p2 int64, p3 gdextension.CallAccepts[gdextension.Variant]) (_ gdextension.CallReturns[gdextension.Variant], _ gdextension.MaybeError) {
		C.gd_object_call(C.uintptr_t(p0), C.uintptr_t(p1), C.int64_t(p2), unsafe.Pointer(p3))
		return
	}
	gdextension.Host.Objects.Name = func(p0 gdextension.Object) (result gdextension.StringName) {
		result = gdextension.StringName(C.gd_object_name(C.uintptr_t(p0)))
		return
	}
	gdextension.Host.Objects.Type = func(p0 gdextension.StringName) (result gdextension.ObjectType) {
		result = gdextension.ObjectType(C.gd_object_type(C.uintptr_t(p0)))
		return
	}
	...
	gdextension.Host.Objects.Global = func(p0 gdextension.StringName) (result gdextension.Object) {
		result = gdextension.Object(C.gd_object_global(C.uintptr_t(p0)))
		return
	}
	gdextension.Host.Objects.Extension.Setup = func(p0 gdextension.Object, p1 gdextension.StringName, p2 gdextension.ExtensionInstanceID) {
		C.gd_object_extension_setup(C.uintptr_t(p0), C.uintptr_t(p1), C.uintptr_t(p2))
		return
	}
	...
	gdextension.Host.Objects.Method.Lookup = func(p0 gdextension.Object, p1 gdextension.StringName, p2 int64) (result gdextension.FunctionID) {
		result = gdextension.FunctionID(C.gd_object_method_lookup(C.uintptr_t(p0), C.uintptr_t(p1), C.int64_t(p2)))
		return
	}
	...
	gdextension.Host.Objects.Script.Call = func(p0 gdextension.Object, p1 gdextension.StringName, p2 int64, p3 gdextension.CallAccepts[gdextension.Variant]) (_ gdextension.CallReturns[gdextension.Variant], _ gdextension.MaybeError) {
		C.gd_object_script_call(C.uintptr_t(p0), C.uintptr_t(p1), C.int64_t(p2), unsafe.Pointer(p3))
		return
	}
	...
	gdextension.Host.Objects.Script.DefinesMethod = func(p0 gdextension.Object, p1 gdextension.StringName) (result bool) {
		result = bool(C.gd_object_script_defines_method(C.uintptr_t(p0), C.uintptr_t(p1)))
		return
	}
	gdextension.Host.Objects.Script.AddPropertyState = func(p0 gdextension.FunctionID, p1 uintptr, p2 gdextension.StringName, p3 gdextension.Variant) {
		C.gd_object_script_property_state_add(C.uintptr_t(p0), C.uintptr_t(p1), C.uintptr_t(p2), C.uint64_t(p3[0]), C.uint64_t(p3[1]), C.uint64_t(p3[2]))
		return
	}
	...
	gdextension.Host.Objects.Script.Placeholder.Update = func(p0 gdextension.ScriptInstance, p1 gdextension.Array, p2 gdextension.Dictionary) {
		C.gd_object_script_placeholder_update(C.uintptr_t(p0), C.uintptr_t(p1), C.uintptr_t(p2))
		return
	}
	gdextension.Host.Objects.Unsafe.Call = func(p0 gdextension.Object, p1 gdextension.FunctionID, p2 gdextension.CallAccepts[interface{}]) (_ gdextension.CallReturns[interface{}]) {
		C.gd_object_unsafe_call(C.uintptr_t(p0), C.uintptr_t(p1), unsafe.Pointer(p2))
		return
	}
	...
	gdextension.Host.Packed.Bytes.Unsafe = func(p0 gdextension.PackedArray) (result gdextension.Pointer) {
		result = gdextension.Pointer(C.gd_packed_byte_array_unsafe(C.uintptr_t(p0[0]), C.uintptr_t(p0[1])))
		return
	}
	gdextension.Host.Packed.Bytes.Access = func(p0 gdextension.PackedArray, p1 int64) (result uint8) {
		result = uint8(C.gd_packed_byte_array_access(C.uintptr_t(p0[0]), C.uintptr_t(p0[1]), C.int64_t(p1)))
		return
	}
	gdextension.Host.Packed.Colors.Unsafe = func(p0 gdextension.PackedArray) (result gdextension.Pointer) {
		result = gdextension.Pointer(C.gd_packed_color_array_unsafe(C.uintptr_t(p0[0]), C.uintptr_t(p0[1])))
		return
	}
	...
	gdextension.Host.Packed.Float32s.Access = func(p0 gdextension.PackedArray, p1 int64) (result float32) {
		result = float32(C.gd_packed_float32_array_access(C.uintptr_t(p0[0]), C.uintptr_t(p0[1]), C.int64_t(p1)))
		return
	}
	gdextension.Host.Packed.Float64s.Unsafe = func(p0 gdextension.PackedArray) (result gdextension.Pointer) {
		result = gdextension.Pointer(C.gd_packed_float64_array_unsafe(C.uintptr_t(p0[0]), C.uintptr_t(p0[1])))
		return
	}
	gdextension.Host.Packed.Float64s.Access = func(p0 gdextension.PackedArray, p1 int64) (result float64) {
		result = float64(C.gd_packed_float64_array_access(C.uintptr_t(p0[0]), C.uintptr_t(p0[1]), C.int64_t(p1)))
		return
	}
	gdextension.Host.Packed.Int32s.Unsafe = func(p0 gdextension.PackedArray) (result gdextension.Pointer) {
		result = gdextension.Pointer(C.gd_packed_int32_array_unsafe(C.uintptr_t(p0[0]), C.uintptr_t(p0[1])))
		return
	}
	gdextension.Host.Packed.Int32s.Access = func(p0 gdextension.PackedArray, p1 int64) (result int32) {
		result = int32(C.gd_packed_int32_array_access(C.uintptr_t(p0[0]), C.uintptr_t(p0[1]), C.int64_t(p1)))
		return
	}
	gdextension.Host.Packed.Int64s.Unsafe = func(p0 gdextension.PackedArray) (result gdextension.Pointer) {
		result = gdextension.Pointer(C.gd_packed_int64_array_unsafe(C.uintptr_t(p0[0]), C.uintptr_t(p0[1])))
		return
	}
	gdextension.Host.Packed.Int64s.Access = func(p0 gdextension.PackedArray, p1 int64) (result int64) {
		result = int64(C.gd_packed_int64_array_access(C.uintptr_t(p0[0]), C.uintptr_t(p0[1]), C.int64_t(p1)))
		return
	}
	gdextension.Host.Packed.Strings.Unsafe = func(p0 gdextension.PackedArray) (result gdextension.Pointer) {
		result = gdextension.Pointer(C.gd_packed_string_array_unsafe(C.uintptr_t(p0[0]), C.uintptr_t(p0[1])))
		return
	}
	...
	gdextension.Host.Packed.Vector2s.Unsafe = func(p0 gdextension.PackedArray) (result gdextension.Pointer) {
		result = gdextension.Pointer(C.gd_packed_vector2_array_unsafe(C.uintptr_t(p0[0]), C.uintptr_t(p0[1])))
		return
	}
	...
	gdextension.Host.Strings.Access = func(p0 gdextension.String, p1 int64) (result int32) {
		result = int32(C.gd_string_access(C.uintptr_t(p0), C.int64_t(p1)))
		return
	}
	gdextension.Host.Strings.Resize = func(p0 gdextension.String, p1 int64) (result gdextension.String) {
		result = gdextension.String(C.gd_string_resize(C.uintptr_t(p0), C.int64_t(p1)))
		return
	}
	gdextension.Host.Strings.Unsafe = func(p0 gdextension.String) (result gdextension.Pointer) {
		result = gdextension.Pointer(C.gd_string_unsafe(C.uintptr_t(p0)))
		return
	}
	gdextension.Host.Strings.Append.String = func(p0 gdextension.String, p1 gdextension.String) (result gdextension.String) {
		result = gdextension.String(C.gd_string_append(C.uintptr_t(p0), C.uintptr_t(p1)))
		return
	}
	gdextension.Host.Strings.Append.Rune = func(p0 gdextension.String, p1 int32) (result gdextension.String) {
		result = gdextension.String(C.gd_string_append_rune(C.uintptr_t(p0), C.int32_t(p1)))
		return
	}
	gdextension.Host.Strings.Decode.Latin1 = func(p0 string) (result gdextension.String) {
		result = gdextension.String(C.gd_string_decode_latin1((*C.char)(unsafe.Pointer(unsafe.StringData(p0))), C.uint64_t(len(p0))))
		return
	}
	gdextension.Host.Strings.Decode.UTF8 = func(p0 string) (result gdextension.String) {
		result = gdextension.String(C.gd_string_decode_utf8((*C.char)(unsafe.Pointer(unsafe.StringData(p0))), C.uint64_t(len(p0))))
		return
	}
	gdextension.Host.Strings.Decode.UTF16 = func(p0 string, p1 bool) (result gdextension.String) {
		result = gdextension.String(C.gd_string_decode_utf16((*C.char)(unsafe.Pointer(unsafe.StringData(p0))), C.uint64_t(len(p0)), C.bool(p1)))
		return
	}
	gdextension.Host.Strings.Decode.UTF32 = func(p0 string) (result gdextension.String) {
		result = gdextension.String(C.gd_string_decode_utf32((*C.char)(unsafe.Pointer(unsafe.StringData(p0))), C.uint64_t(len(p0))))
		return
	}
	gdextension.Host.Strings.Decode.Wide = func(p0 string) (result gdextension.String) {
		result = gdextension.String(C.gd_string_decode_wide((*C.char)(unsafe.Pointer(unsafe.StringData(p0))), C.uint64_t(len(p0))))
		return
	}
	gdextension.Host.Strings.Encode.Latin1 = func(p0 gdextension.String, p1 []byte) (result int64) {
		result = int64(C.gd_string_encode_latin1(C.uintptr_t(p0), (*C.char)(unsafe.Pointer(unsafe.SliceData(p1))), C.uint64_t(len(p1))))
		return
	}
	gdextension.Host.Strings.Encode.UTF8 = func(p0 gdextension.String, p1 []byte) (result int64) {
		result = int64(C.gd_string_encode_utf8(C.uintptr_t(p0), (*C.char)(unsafe.Pointer(unsafe.SliceData(p1))), C.uint64_t(len(p1))))
		return
	}
	gdextension.Host.Strings.Encode.UTF16 = func(p0 gdextension.String, p1 []byte) (result int64) {
		result = int64(C.gd_string_encode_utf16(C.uintptr_t(p0), (*C.char)(unsafe.Pointer(unsafe.SliceData(p1))), C.uint64_t(len(p1))))
		return
	}
	gdextension.Host.Strings.Encode.UTF32 = func(p0 gdextension.String, p1 []byte) (result int64) {
		result = int64(C.gd_string_encode_utf32(C.uintptr_t(p0), (*C.char)(unsafe.Pointer(unsafe.SliceData(p1))), C.uint64_t(len(p1))))
		return
	}
	gdextension.Host.Strings.Encode.Wide = func(p0 gdextension.String, p1 []byte) (result int64) {
		result = int64(C.gd_string_encode_wide(C.uintptr_t(p0), (*C.char)(unsafe.Pointer(unsafe.SliceData(p1))), C.uint64_t(len(p1))))
		return
	}
	gdextension.Host.Strings.Intern.Latin1 = func(p0 string) (result gdextension.StringName) {
		result = gdextension.StringName(C.gd_string_intern_latin1((*C.char)(unsafe.Pointer(unsafe.StringData(p0))), C.uint64_t(len(p0))))
		return
	}
	gdextension.Host.Strings.Intern.UTF8 = func(p0 string) (result gdextension.StringName) {
		result = gdextension.StringName(C.gd_string_intern_utf8((*C.char)(unsafe.Pointer(unsafe.StringData(p0))), C.uint64_t(len(p0))))
		return
	}
	gdextension.Host.VariantTypes.Name = func(p0 gdextension.VariantType) (result gdextension.String) {
		result = gdextension.String(C.gd_variant_type_name(C.uint32_t(p0)))
		return
	}
	gdextension.Host.VariantTypes.Make = func(p0 gdextension.VariantType, p1 int32, p2 gdextension.CallAccepts[gdextension.Variant]) (_ gdextension.CallReturns[gdextension.Variant], _ gdextension.MaybeError) {
		C.gd_variant_type_make(C.uint32_t(p0), C.int32_t(p1), unsafe.Pointer(p2))
		return
	}
	gdextension.Host.VariantTypes.Call = func(p0 gdextension.VariantType, p1 gdextension.StringName, p2 int64, p3 gdextension.CallAccepts[gdextension.Variant]) (_ gdextension.CallReturns[gdextension.Variant], _ gdextension.MaybeError) {
		C.gd_variant_type_call(C.uint32_t(p0), C.uintptr_t(p1), C.int64_t(p2), unsafe.Pointer(p3))
		return
	}
	...
	gdextension.Host.VariantTypes.SetupDictionary = func(p0 gdextension.Dictionary, p1 gdextension.VariantType, p2 gdextension.StringName, p3 gdextension.Variant, p4 gdextension.VariantType, p5 gdextension.StringName, p6 gdextension.Variant) {
		C.gd_variant_type_setup_dictionary(C.uintptr_t(p0), C.uint32_t(p1), C.uintptr_t(p2), C.uint64_t(p3[0]), C.uint64_t(p3[1]), C.uint64_t(p3[2]), C.uint32_t(p4), C.uintptr_t(p5), C.uint64_t(p6[0]), C.uint64_t(p6[1]), C.uint64_t(p6[2]))
		return
	}
	gdextension.Host.VariantTypes.FetchConstant = func(p0 gdextension.VariantType, p1 gdextension.StringName, p2 gdextension.Call) (_ gdextension.CallReturns[gdextension.Variant]) {
		C.gd_variant_type_fetch_constant(C.uint32_t(p0), C.uintptr_t(p1), unsafe.Pointer(p2))
		return
	}
	gdextension.Host.VariantTypes.BuiltinMethod = func(p0 gdextension.VariantType, p1 gdextension.StringName, p2 int64) (result gdextension.FunctionID) {
		result = gdextension.FunctionID(C.gd_variant_type_builtin_method(C.uint32_t(p0), C.uintptr_t(p1), C.int64_t(p2)))
		return
	}
	gdextension.Host.VariantTypes.Constructor = func(p0 gdextension.VariantType, p1 int32) (result gdextension.FunctionID) {
		result = gdextension.FunctionID(C.gd_variant_type_unsafe_constructor(C.uint32_t(p0), C.int32_t(p1)))
		return
	}
	...
	gdextension.Host.VariantTypes.Setter = func(p0 gdextension.VariantType, p1 gdextension.StringName) (result gdextension.FunctionID) {
		result = gdextension.FunctionID(C.gd_variant_type_setter(C.uint32_t(p0), C.uintptr_t(p1)))
		return
	}
	...
	gdextension.Host.VariantTypes.Unsafe.Call = func(p0 gdextension.FunctionID, p1 int64, p2 gdextension.CallAccepts[interface{}]) (_ gdextension.CallReturns[interface{}]) {
		C.gd_variant_type_unsafe_call(C.uintptr_t(p0), C.int64_t(p1), unsafe.Pointer(p2))
		return
	}
	gdextension.Host.VariantTypes.Unsafe.Make = func(p0 gdextension.FunctionID, p1 gdextension.CallAccepts[interface{}]) (_ gdextension.CallReturns[interface{}]) {
		C.gd_variant_type_unsafe_make(C.uintptr_t(p0), unsafe.Pointer(p1))
		return
	}
	gdextension.Host.VariantTypes.Unsafe.Free = func(p0 gdextension.VariantType, p1 gdextension.CallAccepts[interface{}]) (_ gdextension.CallReturns[interface{}]) {
		C.gd_variant_type_unsafe_free(C.uint32_t(p0), unsafe.Pointer(p1))
		return
	}
	...
	gdextension.Host.Variants.Call = func(p0 gdextension.Variant, p1 gdextension.StringName, p2 int64, p3 gdextension.CallAccepts[gdextension.Variant]) (_ gdextension.CallReturns[gdextension.Variant], _ gdextension.MaybeError) {
		C.gd_variant_call(C.uint64_t(p0[0]), C.uint64_t(p0[1]), C.uint64_t(p0[2]), C.uintptr_t(p1), C.int64_t(p2), unsafe.Pointer(p3))
		return
	}
	...
	gdextension.Host.Variants.Text = func(p0 gdextension.Variant) (result gdextension.String) {
		result = gdextension.String(C.gd_variant_text(C.uint64_t(p0[0]), C.uint64_t(p0[1]), C.uint64_t(p0[2])))
		return
	}
	...
	gdextension.Host.Variants.Get.Array = func(p0 gdextension.Variant, p1 int64, p2 gdextension.Call) (_ gdextension.CallReturns[gdextension.Variant], result bool, _ gdextension.MaybeError) {
		result = bool(C.gd_variant_get_array(C.uint64_t(p0[0]), C.uint64_t(p0[1]), C.uint64_t(p0[2]), C.int64_t(p1), unsafe.Pointer(p2)))
		return
	}
	...
	gdextension.Host.Variants.Has.Method = func(p0 gdextension.Variant, p1 gdextension.StringName) (result bool) {
		result = bool(C.gd_variant_has_method(C.uint64_t(p0[0]), C.uint64_t(p0[1]), C.uint64_t(p0[2]), C.uintptr_t(p1)))
		return
	}
	...
	gdextension.Host.Variants.Set.Field = func(p0 gdextension.Variant, p1 gdextension.StringName, p2 gdextension.Variant) (result bool) {
		result = bool(C.gd_variant_set_field(C.uint64_t(p0[0]), C.uint64_t(p0[1]), C.uint64_t(p0[2]), C.uintptr_t(p1), C.uint64_t(p2[0]), C.uint64_t(p2[1]), C.uint64_t(p2[2])))
		return
	}
	gdextension.Host.Variants.Unsafe.Call = func(p0 gdextension.FunctionID, p1 int32, p2 gdextension.CallAccepts[interface{}]) (_ gdextension.CallReturns[interface{}]) {
		C.gd_variant_unsafe_call(C.uintptr_t(p0), C.int32_t(p1), unsafe.Pointer(p2))
		return
	}
	gdextension.Host.Variants.Unsafe.Eval = func(p0 gdextension.FunctionID, p1 gdextension.CallAccepts[interface{}]) (_ gdextension.CallReturns[interface{}]) {
		C.gd_variant_unsafe_eval(C.uintptr_t(p0), unsafe.Pointer(p1))
		return
	}
	...
	gdextension.Host.Variants.Unsafe.MakeNative = func(p0 gdextension.VariantType, p1 gdextension.Variant, p2 gdextension.Call) (_ gdextension.CallReturns[interface{}]) {
		C.gd_variant_unsafe_make_native(C.uint32_t(p0), C.uint64_t(p1[0]), C.uint64_t(p1[1]), C.uint64_t(p1[2]), unsafe.Pointer(p2))
		return
	}
	gdextension.Host.Variants.Unsafe.FromNative = func(p0 gdextension.VariantType, p1 gdextension.CallAccepts[interface{}]) (_ gdextension.CallReturns[gdextension.Variant]) {
		C.gd_variant_unsafe_from_native(C.uint32_t(p0), unsafe.Pointer(p1))
		return
	}
	...
	gdextension.Host.Variants.Unsafe.Get.Field = func(p0 gdextension.FunctionID, p1 gdextension.CallAccepts[interface{}]) (_ gdextension.CallReturns[interface{}]) {
		C.gd_variant_unsafe_get_field(C.uintptr_t(p0), unsafe.Pointer(p1))
		return
	}
	gdextension.Host.Variants.Unsafe.Get.Array = func(p0 gdextension.VariantType, p1 int64, p2 gdextension.CallAccepts[interface{}]) (_ gdextension.CallReturns[interface{}]) {
		C.gd_variant_unsafe_get_array(C.uint32_t(p0), C.int64_t(p1), unsafe.Pointer(p2))
		return
	}
	...
	gdextension.Host.Version.Status = func() (result gdextension.String) {
		result = gdextension.String(C.gd_version_status())
		return
	}
	gdextension.Host.Version.Build = func() (result gdextension.String) {
		result = gdextension.String(C.gd_version_build())
		return
	}
	gdextension.Host.Version.Hash = func() (result gdextension.String) {
		result = gdextension.String(C.gd_version_hash())
		return
	}
	...
	gdextension.Host.Version.String = func() (result gdextension.String) {
		result = gdextension.String(C.gd_version_string())
		return
	}
}
