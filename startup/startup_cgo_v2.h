...
void gd_method_list_push(uintptr_t, uintptr_t, uintptr_t, uint32_t, bool, uintptr_t, uint32_t, uintptr_t, int64_t, void*);
...
bool gd_iterator_next(uint64_t, uint64_t, uint64_t, void*, uint64_t, uint64_t, uint64_t, void*);
void gd_iterator_load(uint64_t, uint64_t, uint64_t, void*, uint64_t, uint64_t, uint64_t, void*);
...
void gd_variant_type_unsafe_call(uintptr_t, void*, uint64_t, void*);
