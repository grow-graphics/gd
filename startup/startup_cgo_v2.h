...
void gd_classdb_FileAccess_write(uintptr_t, char*, uint64_t);
int64_t gd_classdb_FileAccess_read(uintptr_t, char*, uint64_t);
uintptr_t gd_classdb_Image_unsafe(uintptr_t);
uint8_t gd_classdb_Image_access(uintptr_t, int64_t);
uintptr_t gd_method_list_make(int32_t);
...
uintptr_t gd_property_list_make(int32_t);
...
int64_t gd_classdb_XMLParser_load(uintptr_t, char*, uint64_t);
...
void gd_editor_add_documentation(const char*, uint64_t);
...
void gd_log_error(const char*, uint64_t, const char*, uint64_t, const char*, uint64_t, const char*, uint64_t, int32_t, bool);
void gd_log_warning(const char*, uint64_t, const char*, uint64_t, const char*, uint64_t, const char*, uint64_t, int32_t, bool);
uintptr_t gd_memory_malloc(uintptr_t);
uint64_t gd_memory_sizeof(uintptr_t);
uintptr_t gd_memory_resize(uintptr_t, uintptr_t);
...
uintptr_t gd_string_decode_latin1(const char*, uint64_t);
uintptr_t gd_string_decode_utf8(const char*, uint64_t);
uintptr_t gd_string_decode_utf16(const char*, uint64_t, bool);
uintptr_t gd_string_decode_utf32(const char*, uint64_t);
uintptr_t gd_string_decode_wide(const char*, uint64_t);
int64_t gd_string_encode_latin1(uintptr_t, char*, uint64_t);
int64_t gd_string_encode_utf8(uintptr_t, char*, uint64_t);
int64_t gd_string_encode_utf16(uintptr_t, char*, uint64_t);
int64_t gd_string_encode_utf32(uintptr_t, char*, uint64_t);
int64_t gd_string_encode_wide(uintptr_t, char*, uint64_t);
uintptr_t gd_string_intern_latin1(const char*, uint64_t);
uintptr_t gd_string_intern_utf8(const char*, uint64_t);
uintptr_t gd_variant_type_name(uint32_t);
void gd_variant_type_make(uint32_t, int32_t, void*);
void gd_variant_type_call(uint32_t, uintptr_t, int64_t, void*);
bool gd_variant_type_convertable(uint32_t, uint32_t, bool);
bool gd_variant_type_setup_array(uintptr_t, uint32_t, uintptr_t, uint64_t, uint64_t, uint64_t);
...
uintptr_t gd_variant_type_unsafe_constructor(uint32_t, int32_t);
...
bool gd_variant_has_field(uint64_t, uint64_t, uint64_t, uintptr_t);
...
void gd_variant_unsafe_call(uintptr_t, int32_t, void*);
